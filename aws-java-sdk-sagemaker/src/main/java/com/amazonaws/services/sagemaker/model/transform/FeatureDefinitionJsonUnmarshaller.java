...
/**
 * FeatureDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FeatureDefinitionJsonUnmarshaller implements Unmarshaller<FeatureDefinition, JsonUnmarshallerContext> {

    public FeatureDefinition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FeatureName", targetDepth)) {
                    context.nextToken();
                    featureDefinition.setFeatureName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static FeatureDefinitionJsonUnmarshaller instance;

    public static FeatureDefinitionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FeatureDefinitionJsonUnmarshaller();
        return instance;
    }
}
