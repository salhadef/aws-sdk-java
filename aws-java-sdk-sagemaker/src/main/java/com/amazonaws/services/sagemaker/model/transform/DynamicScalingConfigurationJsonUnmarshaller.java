...
/**
 * DynamicScalingConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DynamicScalingConfigurationJsonUnmarshaller implements Unmarshaller<DynamicScalingConfiguration, JsonUnmarshallerContext> {

    public DynamicScalingConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        DynamicScalingConfiguration dynamicScalingConfiguration = new DynamicScalingConfiguration();
    ...
    private static DynamicScalingConfigurationJsonUnmarshaller instance;

    public static DynamicScalingConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DynamicScalingConfigurationJsonUnmarshaller();
        return instance;
    }
}
