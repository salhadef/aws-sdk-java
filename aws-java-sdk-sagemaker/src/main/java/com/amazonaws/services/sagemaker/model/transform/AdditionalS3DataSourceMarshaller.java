...
/**
 * AdditionalS3DataSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AdditionalS3DataSourceMarshaller {
    ...
    private static final AdditionalS3DataSourceMarshaller instance = new AdditionalS3DataSourceMarshaller();

    public static AdditionalS3DataSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AdditionalS3DataSource additionalS3DataSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(additionalS3DataSource.getS3DataType(), S3DATATYPE_BINDING);
            protocolMarshaller.marshall(additionalS3DataSource.getS3Uri(), S3URI_BINDING);
            protocolMarshaller.marshall(additionalS3DataSource.getCompressionType(), COMPRESSIONTYPE_BINDING);
        } catch (Exception e) {
