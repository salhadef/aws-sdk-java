...
public class ListDataQualityJobDefinitionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * includes a <code>NextToken</code>. To retrieve the next set of transform jobs, use the token in the next
     * request.&gt;
     * </p>
     */
    ...
    /**
     * <p>
     * A string in the data quality monitoring job definition name. This filter returns only data quality monitoring job
     * definitions whose name contains the specified string.
     * </p>
     */
     ...
     * </p>
     * 
     * @return A filter that lists the data quality job definitions associated with the specified endpoint.
     */
     ...
     *        response includes a <code>NextToken</code>. To retrieve the next set of transform jobs, use the token in
     *        the next request.&gt;
     */
     ...
     * </p>
     * 
     * @return The maximum number of data quality monitoring job definitions to return in the response.
     */
     ...
     * </p>
     * 
     * @return A string in the data quality monitoring job definition name. This filter returns only data quality
     *         monitoring job definitions whose name contains the specified string.
     */
     ...
     * </p>
     * 
     * @return A filter that returns only data quality monitoring job definitions created before the specified time.
     */
    ...
    public ListDataQualityJobDefinitionsRequest withCreationTimeBefore(java.util.Date creationTimeBefore) {
     ...
     * </p>
     * 
     * @return A filter that returns only data quality monitoring job definitions created after the specified time.
     */
    ...
    public ListDataQualityJobDefinitionsRequest withCreationTimeAfter(java.util.Date creationTimeAfter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDataQualityJobDefinitionsRequest == false)
            return false;
        ListDataQualityJobDefinitionsRequest other = (ListDataQualityJobDefinitionsRequest) obj;
    ...
    public ListDataQualityJobDefinitionsRequest clone() {
        return (ListDataQualityJobDefinitionsRequest) super.clone();
    }
