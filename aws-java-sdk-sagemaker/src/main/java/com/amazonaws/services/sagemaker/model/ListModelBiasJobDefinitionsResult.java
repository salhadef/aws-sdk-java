...
public class ListModelBiasJobDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A JSON array in which each element is a summary for a model bias jobs.
     */
    ...
    public ListModelBiasJobDefinitionsResult withJobDefinitionSummaries(MonitoringJobDefinitionSummary... jobDefinitionSummaries) {
    ...
    public ListModelBiasJobDefinitionsResult withJobDefinitionSummaries(java.util.Collection<MonitoringJobDefinitionSummary> jobDefinitionSummaries) {
    ...
    public ListModelBiasJobDefinitionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListModelBiasJobDefinitionsResult == false)
            return false;
        ListModelBiasJobDefinitionsResult other = (ListModelBiasJobDefinitionsResult) obj;
    ...
    @Override
    public ListModelBiasJobDefinitionsResult clone() {
        try {
            return (ListModelBiasJobDefinitionsResult) super.clone();
