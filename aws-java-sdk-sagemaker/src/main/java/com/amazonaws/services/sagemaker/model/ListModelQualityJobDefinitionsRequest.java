...
public class ListModelQualityJobDefinitionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * If the result of the previous <code>ListModelQualityJobDefinitions</code> request was truncated, the response
     * includes a <code>NextToken</code>. To retrieve the next set of model quality monitoring job definitions, use the
     ...
     * 
     * @param nextToken
     *        If the result of the previous <code>ListModelQualityJobDefinitions</code> request was truncated, the
     *        response includes a <code>NextToken</code>. To retrieve the next set of model quality monitoring job
     ...
     * </p>
     * 
     * @return If the result of the previous <code>ListModelQualityJobDefinitions</code> request was truncated, the
     *         response includes a <code>NextToken</code>. To retrieve the next set of model quality monitoring job
     *         definitions, use the token in the next request.
     */
     ...
     * </p>
     * 
     * @return The maximum number of results to return in a call to <code>ListModelQualityJobDefinitions</code>.
     */
    ...
    public ListModelQualityJobDefinitionsRequest withCreationTimeBefore(java.util.Date creationTimeBefore) {
    ...
    public ListModelQualityJobDefinitionsRequest withCreationTimeAfter(java.util.Date creationTimeAfter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListModelQualityJobDefinitionsRequest == false)
            return false;
    ...
    public ListModelQualityJobDefinitionsRequest clone() {
        return (ListModelQualityJobDefinitionsRequest) super.clone();
    }
