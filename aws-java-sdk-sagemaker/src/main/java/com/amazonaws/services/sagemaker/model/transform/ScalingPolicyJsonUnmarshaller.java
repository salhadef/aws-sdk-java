    ...
    public ScalingPolicy unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TargetTracking", targetDepth)) {
                    context.nextToken();
                    scalingPolicy.setTargetTracking(TargetTrackingScalingPolicyConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
