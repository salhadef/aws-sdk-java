...
public class StartPipelineExecutionRequestMarshaller {
    ...
    public void marshall(StartPipelineExecutionRequest startPipelineExecutionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startPipelineExecutionRequest.getPipelineName(), PIPELINENAME_BINDING);
            protocolMarshaller.marshall(startPipelineExecutionRequest.getPipelineExecutionDisplayName(), PIPELINEEXECUTIONDISPLAYNAME_BINDING);
