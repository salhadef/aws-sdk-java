...
/**
 * AutoMLResolvedAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AutoMLResolvedAttributesJsonUnmarshaller implements Unmarshaller<AutoMLResolvedAttributes, JsonUnmarshallerContext> {

    public AutoMLResolvedAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        AutoMLResolvedAttributes autoMLResolvedAttributes = new AutoMLResolvedAttributes();
    ...
    private static AutoMLResolvedAttributesJsonUnmarshaller instance;

    public static AutoMLResolvedAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AutoMLResolvedAttributesJsonUnmarshaller();
        return instance;
    }
}
