...
/**
 * ListInferenceRecommendationsJobsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListInferenceRecommendationsJobsRequestMarshaller {
    ...
    public static ListInferenceRecommendationsJobsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListInferenceRecommendationsJobsRequest listInferenceRecommendationsJobsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listInferenceRecommendationsJobsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listInferenceRecommendationsJobsRequest.getCreationTimeAfter(), CREATIONTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listInferenceRecommendationsJobsRequest.getCreationTimeBefore(), CREATIONTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listInferenceRecommendationsJobsRequest.getLastModifiedTimeAfter(), LASTMODIFIEDTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listInferenceRecommendationsJobsRequest.getLastModifiedTimeBefore(), LASTMODIFIEDTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listInferenceRecommendationsJobsRequest.getNameContains(), NAMECONTAINS_BINDING);
            protocolMarshaller.marshall(listInferenceRecommendationsJobsRequest.getStatusEquals(), STATUSEQUALS_BINDING);
            protocolMarshaller.marshall(listInferenceRecommendationsJobsRequest.getSortBy(), SORTBY_BINDING);
