...
public class DescribeAutoMLJobV2Request extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Requests information about an AutoML job V2 using its unique name.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAutoMLJobV2Request == false)
            return false;
        DescribeAutoMLJobV2Request other = (DescribeAutoMLJobV2Request) obj;
    ...
    @Override
    public DescribeAutoMLJobV2Request clone() {
        return (DescribeAutoMLJobV2Request) super.clone();
    }
