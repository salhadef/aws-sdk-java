...
public class ListInferenceRecommendationsJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * If the response to a previous <code>ListInferenceRecommendationsJobsRequest</code> request was truncated, the
     * response includes a <code>NextToken</code>. To retrieve the next set of recommendations, use the token in the
     * next request.
     * </p>
     */
     ...
     * </p>
     * 
     * @return A filter that returns only jobs created after the specified time (timestamp).
     */
    ...
    public ListInferenceRecommendationsJobsRequest withCreationTimeAfter(java.util.Date creationTimeAfter) {
     ...
     * </p>
     * 
     * @return A filter that returns only jobs created before the specified time (timestamp).
     */
    ...
    public ListInferenceRecommendationsJobsRequest withCreationTimeBefore(java.util.Date creationTimeBefore) {
     ...
     * </p>
     * 
     * @return A filter that returns only jobs that were last modified after the specified time (timestamp).
     */
    ...
    public ListInferenceRecommendationsJobsRequest withLastModifiedTimeAfter(java.util.Date lastModifiedTimeAfter) {
     ...
     * </p>
     * 
     * @return A filter that returns only jobs that were last modified before the specified time (timestamp).
     */
    ...
    public ListInferenceRecommendationsJobsRequest withLastModifiedTimeBefore(java.util.Date lastModifiedTimeBefore) {
     ...
     * </p>
     * 
     * @return A string in the job name. This filter returns only recommendations whose name contains the specified
     *         string.
     */
     ...
     * </p>
     * 
     * @return A filter that retrieves only inference recommendations jobs with a specific status.
     * @see RecommendationJobStatus
     */
     ...
     * @param sortBy
     *        The parameter by which to sort the results.
     * @see ListInferenceRecommendationsJobsSortBy
     */
     ...
     * </p>
     * 
     * @return The sort order for the results.
     * @see SortOrder
     */
     ...
     * 
     * @param nextToken
     *        If the response to a previous <code>ListInferenceRecommendationsJobsRequest</code> request was truncated,
     *        the response includes a <code>NextToken</code>. To retrieve the next set of recommendations, use the token
     *        in the next request.
     */
     ...
     * </p>
     * 
     * @return If the response to a previous <code>ListInferenceRecommendationsJobsRequest</code> request was truncated,
     *         the response includes a <code>NextToken</code>. To retrieve the next set of recommendations, use the
     ...
     * </p>
     * 
     * @return The maximum number of recommendations to return in the response.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListInferenceRecommendationsJobsRequest == false)
            return false;
        ListInferenceRecommendationsJobsRequest other = (ListInferenceRecommendationsJobsRequest) obj;
    ...
    public ListInferenceRecommendationsJobsRequest clone() {
        return (ListInferenceRecommendationsJobsRequest) super.clone();
    }
