...
/**
 * TimeSeriesTransformationsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TimeSeriesTransformationsMarshaller {

    private static final MarshallingInfo<Map> FILLING_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Filling").build();
    private static final MarshallingInfo<Map> AGGREGATION_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Aggregation").build();
