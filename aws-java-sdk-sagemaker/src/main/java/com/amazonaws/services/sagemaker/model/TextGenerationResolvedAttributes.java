 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/TextGenerationResolvedAttributes"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TextGenerationResolvedAttributes implements Serializable, Cloneable, StructuredPojo {
    ...
    public TextGenerationResolvedAttributes withBaseModelName(String baseModelName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextGenerationResolvedAttributes == false)
            return false;
    ...
    @Override
    public TextGenerationResolvedAttributes clone() {
        try {
            return (TextGenerationResolvedAttributes) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.TextGenerationResolvedAttributesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
