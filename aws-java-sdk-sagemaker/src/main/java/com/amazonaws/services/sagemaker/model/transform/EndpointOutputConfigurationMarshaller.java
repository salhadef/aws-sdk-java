...
/**
 * EndpointOutputConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EndpointOutputConfigurationMarshaller {
    ...
    public static EndpointOutputConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EndpointOutputConfiguration endpointOutputConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (endpointOutputConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(endpointOutputConfiguration.getEndpointName(), ENDPOINTNAME_BINDING);
