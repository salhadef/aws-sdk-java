 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/BatchTransformInput" target="_top">AWS API
 *      Documentation</a>
 */
...
public class BatchTransformInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchTransformInput withDataCapturedDestinationS3Uri(String dataCapturedDestinationS3Uri) {
        setDataCapturedDestinationS3Uri(dataCapturedDestinationS3Uri);
        return this;
    }
    ...
    public void setDatasetFormat(MonitoringDatasetFormat datasetFormat) {
    ...
    public String toString() {
        ...
        if (getDataCapturedDestinationS3Uri() != null)
            sb.append("DataCapturedDestinationS3Uri: ").append(getDataCapturedDestinationS3Uri()).append(",");
        if (getDatasetFormat() != null)
            sb.append("DatasetFormat: ").append(getDatasetFormat()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchTransformInput == false)
            return false;
        BatchTransformInput other = (BatchTransformInput) obj;
        if (other.getDataCapturedDestinationS3Uri() == null ^ this.getDataCapturedDestinationS3Uri() == null)
            return false;
        if (other.getDataCapturedDestinationS3Uri() != null && other.getDataCapturedDestinationS3Uri().equals(this.getDataCapturedDestinationS3Uri()) == false)
            return false;
        if (other.getDatasetFormat() == null ^ this.getDatasetFormat() == null)
            return false;
        if (other.getDatasetFormat() != null && other.getDatasetFormat().equals(this.getDatasetFormat()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getDataCapturedDestinationS3Uri() == null) ? 0 : getDataCapturedDestinationS3Uri().hashCode());
        hashCode = prime * hashCode + ((getDatasetFormat() == null) ? 0 : getDatasetFormat().hashCode());
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.BatchTransformInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
