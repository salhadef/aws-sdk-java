...
/**
 * OnlineStoreConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OnlineStoreConfigJsonUnmarshaller implements Unmarshaller<OnlineStoreConfig, JsonUnmarshallerContext> {

    public OnlineStoreConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        OnlineStoreConfig onlineStoreConfig = new OnlineStoreConfig();
    ...
    private static OnlineStoreConfigJsonUnmarshaller instance;

    public static OnlineStoreConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OnlineStoreConfigJsonUnmarshaller();
        return instance;
    }
}
