 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/ModelQualityJobInput" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModelQualityJobInput implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The ground truth label provided for the model.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModelQualityJobInput == false)
            return false;
    ...
    public ModelQualityJobInput clone() {
        try {
            return (ModelQualityJobInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.ModelQualityJobInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
