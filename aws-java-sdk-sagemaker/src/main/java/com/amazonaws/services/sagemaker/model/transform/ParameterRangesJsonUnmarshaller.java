...
/**
 * ParameterRanges JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParameterRangesJsonUnmarshaller implements Unmarshaller<ParameterRanges, JsonUnmarshallerContext> {

    public ParameterRanges unmarshall(JsonUnmarshallerContext context) throws Exception {
        ParameterRanges parameterRanges = new ParameterRanges();
    ...
    private static ParameterRangesJsonUnmarshaller instance;

    public static ParameterRangesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterRangesJsonUnmarshaller();
        return instance;
    }
}
