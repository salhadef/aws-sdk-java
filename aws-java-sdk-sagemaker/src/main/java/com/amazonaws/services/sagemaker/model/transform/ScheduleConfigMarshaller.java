...
@SdkInternalApi
public class ScheduleConfigMarshaller {
    ...
    public static ScheduleConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ScheduleConfig scheduleConfig, ProtocolMarshaller protocolMarshaller) {
