...
/**
 * ModelPackageContainerDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModelPackageContainerDefinitionJsonUnmarshaller implements Unmarshaller<ModelPackageContainerDefinition, JsonUnmarshallerContext> {

    public ModelPackageContainerDefinition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ModelPackageContainerDefinition modelPackageContainerDefinition = new ModelPackageContainerDefinition();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("AdditionalS3DataSource", targetDepth)) {
                    context.nextToken();
                    modelPackageContainerDefinition.setAdditionalS3DataSource(AdditionalS3DataSourceJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static ModelPackageContainerDefinitionJsonUnmarshaller instance;

    public static ModelPackageContainerDefinitionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ModelPackageContainerDefinitionJsonUnmarshaller();
        return instance;
    }
}
