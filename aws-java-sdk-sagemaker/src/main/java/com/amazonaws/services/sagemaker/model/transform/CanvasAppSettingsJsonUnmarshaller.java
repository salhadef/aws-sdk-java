...
/**
 * CanvasAppSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CanvasAppSettingsJsonUnmarshaller implements Unmarshaller<CanvasAppSettings, JsonUnmarshallerContext> {

    public CanvasAppSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        CanvasAppSettings canvasAppSettings = new CanvasAppSettings();
    ...
    private static CanvasAppSettingsJsonUnmarshaller instance;

    public static CanvasAppSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CanvasAppSettingsJsonUnmarshaller();
        return instance;
    }
}
