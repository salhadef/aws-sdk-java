...
/**
 * EndpointInputConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EndpointInputConfigurationMarshaller {
    ...
    public static EndpointInputConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EndpointInputConfiguration endpointInputConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (endpointInputConfiguration == null) {
