 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/SelectiveExecutionResult" target="_top">AWS
 *      API Documentation</a>
 */
...
public class SelectiveExecutionResult implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The ARN from an execution of the current pipeline.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SelectiveExecutionResult == false)
            return false;
        SelectiveExecutionResult other = (SelectiveExecutionResult) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.SelectiveExecutionResultMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
