...
/**
 * UpdateFeatureGroupRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateFeatureGroupRequestMarshaller {
    ...
    public static UpdateFeatureGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateFeatureGroupRequest updateFeatureGroupRequest, ProtocolMarshaller protocolMarshaller) {

        if (updateFeatureGroupRequest == null) {
