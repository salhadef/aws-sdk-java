...
public class DescribeModelCardRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        The version of the model card to describe. If a version is not provided, then the latest version of the
    ...
    public DescribeModelCardRequest withModelCardVersion(Integer modelCardVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeModelCardRequest == false)
            return false;
    ...
    @Override
    public DescribeModelCardRequest clone() {
