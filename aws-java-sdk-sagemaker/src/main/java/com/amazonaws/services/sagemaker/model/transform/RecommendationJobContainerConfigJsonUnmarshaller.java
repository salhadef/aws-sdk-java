...
/**
 * RecommendationJobContainerConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RecommendationJobContainerConfigJsonUnmarshaller implements Unmarshaller<RecommendationJobContainerConfig, JsonUnmarshallerContext> {

    public RecommendationJobContainerConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        RecommendationJobContainerConfig recommendationJobContainerConfig = new RecommendationJobContainerConfig();
    ...
    private static RecommendationJobContainerConfigJsonUnmarshaller instance;

    public static RecommendationJobContainerConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RecommendationJobContainerConfigJsonUnmarshaller();
        return instance;
    }
}
