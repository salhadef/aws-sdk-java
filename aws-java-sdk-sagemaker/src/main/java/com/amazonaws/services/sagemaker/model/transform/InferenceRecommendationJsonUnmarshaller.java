...
/**
 * InferenceRecommendation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InferenceRecommendationJsonUnmarshaller implements Unmarshaller<InferenceRecommendation, JsonUnmarshallerContext> {

    public InferenceRecommendation unmarshall(JsonUnmarshallerContext context) throws Exception {
        InferenceRecommendation inferenceRecommendation = new InferenceRecommendation();
    ...
    private static InferenceRecommendationJsonUnmarshaller instance;

    public static InferenceRecommendationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InferenceRecommendationJsonUnmarshaller();
        return instance;
    }
}
