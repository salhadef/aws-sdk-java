...
/**
 * RecommendationJobStoppingConditionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RecommendationJobStoppingConditionsMarshaller {
    ...
    public static RecommendationJobStoppingConditionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RecommendationJobStoppingConditions recommendationJobStoppingConditions, ProtocolMarshaller protocolMarshaller) {

        if (recommendationJobStoppingConditions == null) {
