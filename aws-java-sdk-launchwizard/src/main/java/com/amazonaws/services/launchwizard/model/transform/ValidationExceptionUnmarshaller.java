...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.launchwizard.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.launchwizard.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.launchwizard.model.ValidationException validationException = new com.amazonaws.services.launchwizard.model.ValidationException(
                null);
