...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.launchwizard.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.launchwizard.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.launchwizard.model.InternalServerException internalServerException = new com.amazonaws.services.launchwizard.model.InternalServerException(
                null);
