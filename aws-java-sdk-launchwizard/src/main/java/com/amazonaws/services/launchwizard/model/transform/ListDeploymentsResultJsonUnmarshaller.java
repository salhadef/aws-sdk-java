...
public class ListDeploymentsResultJsonUnmarshaller implements Unmarshaller<ListDeploymentsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("deployments", targetDepth)) {
                    context.nextToken();
                    listDeploymentsResult.setDeployments(new ListUnmarshaller<DeploymentDataSummary>(DeploymentDataSummaryJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listDeploymentsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
