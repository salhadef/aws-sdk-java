 ...
 * used to match a set of resources by specific criteria.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/launch-wizard-2018-05-10/DeploymentFilter" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeploymentFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public DeploymentFilter withName(String name) {
        setName(name);
        return this;
    }
    ...
    public DeploymentFilter withName(DeploymentFilterKey name) {
    ...
    public DeploymentFilter withValues(String... values) {
        if (this.values == null) {
    ...
    public DeploymentFilter withValues(java.util.Collection<String> values) {
        setValues(values);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeploymentFilter == false)
            return false;
        DeploymentFilter other = (DeploymentFilter) obj;
    ...
    public DeploymentFilter clone() {
        try {
            return (DeploymentFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.launchwizard.model.transform.DeploymentFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
