...
public class ResourceLimitException extends com.amazonaws.services.launchwizard.model.AWSLaunchWizardException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new ResourceLimitException with the specified error message.
     *
     * @param message
