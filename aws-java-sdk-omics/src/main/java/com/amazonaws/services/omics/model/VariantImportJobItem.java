 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/VariantImportJobItem" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VariantImportJobItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public VariantImportJobItem withCreationTime(java.util.Date creationTime) {
    ...
    public VariantImportJobItem withUpdateTime(java.util.Date updateTime) {
    ...
    public VariantImportJobItem withCompletionTime(java.util.Date completionTime) {
    ...
    public VariantImportJobItem withAnnotationFields(java.util.Map<String, String> annotationFields) {
     ...
     *
     * @see VariantImportJobItem#withAnnotationFields
     * @returns a reference to this object so that method calls can be chained together.
     */

    public VariantImportJobItem addAnnotationFieldsEntry(String key, String value) {
    ...
    public VariantImportJobItem clearAnnotationFieldsEntries() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VariantImportJobItem == false)
            return false;
        VariantImportJobItem other = (VariantImportJobItem) obj;
    ...
    public VariantImportJobItem clone() {
        try {
            return (VariantImportJobItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.VariantImportJobItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
