...
public class CreateReferenceStoreResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateReferenceStoreResult clone() {
        try {
            return (CreateReferenceStoreResult) super.clone();
