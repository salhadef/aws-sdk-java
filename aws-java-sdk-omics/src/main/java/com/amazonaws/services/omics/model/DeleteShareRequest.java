...
public class DeleteShareRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteShareRequest withShareId(String shareId) {
        setShareId(shareId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteShareRequest == false)
            return false;
        DeleteShareRequest other = (DeleteShareRequest) obj;
    ...
    @Override
    public DeleteShareRequest clone() {
        return (DeleteShareRequest) super.clone();
    }
