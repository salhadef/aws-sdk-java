...
public class GetReadSetRequestMarshaller {
    ...
    public static GetReadSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetReadSetRequest getReadSetRequest, ProtocolMarshaller protocolMarshaller) {

        if (getReadSetRequest == null) {
