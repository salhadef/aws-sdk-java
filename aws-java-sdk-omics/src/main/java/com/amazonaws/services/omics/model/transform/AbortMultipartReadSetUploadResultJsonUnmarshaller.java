...
/**
 * AbortMultipartReadSetUploadResult JSON Unmarshaller
 */
...
public class AbortMultipartReadSetUploadResultJsonUnmarshaller implements Unmarshaller<AbortMultipartReadSetUploadResult, JsonUnmarshallerContext> {
    ...
    public AbortMultipartReadSetUploadResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AbortMultipartReadSetUploadResult abortMultipartReadSetUploadResult = new AbortMultipartReadSetUploadResult();

        return abortMultipartReadSetUploadResult;
    }
