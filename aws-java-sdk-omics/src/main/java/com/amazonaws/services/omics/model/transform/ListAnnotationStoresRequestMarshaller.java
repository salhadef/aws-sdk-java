...
public class ListAnnotationStoresRequestMarshaller {
    ...
    public static ListAnnotationStoresRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListAnnotationStoresRequest listAnnotationStoresRequest, ProtocolMarshaller protocolMarshaller) {
