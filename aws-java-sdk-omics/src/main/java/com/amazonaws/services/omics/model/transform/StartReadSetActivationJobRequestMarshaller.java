...
/**
 * StartReadSetActivationJobRequestMarshaller
 */
...
public class StartReadSetActivationJobRequestMarshaller {
    ...
    private static final StartReadSetActivationJobRequestMarshaller instance = new StartReadSetActivationJobRequestMarshaller();

    public static StartReadSetActivationJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartReadSetActivationJobRequest startReadSetActivationJobRequest, ProtocolMarshaller protocolMarshaller) {
