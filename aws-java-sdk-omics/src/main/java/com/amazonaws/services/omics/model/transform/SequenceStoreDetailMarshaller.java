...
/**
 * SequenceStoreDetailMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SequenceStoreDetailMarshaller {
    ...
    public static SequenceStoreDetailMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SequenceStoreDetail sequenceStoreDetail, ProtocolMarshaller protocolMarshaller) {

        if (sequenceStoreDetail == null) {
