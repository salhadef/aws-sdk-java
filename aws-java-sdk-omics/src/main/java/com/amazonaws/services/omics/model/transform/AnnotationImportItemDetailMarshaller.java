...
/**
 * AnnotationImportItemDetailMarshaller
 */
...
public class AnnotationImportItemDetailMarshaller {
    ...
    public static AnnotationImportItemDetailMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AnnotationImportItemDetail annotationImportItemDetail, ProtocolMarshaller protocolMarshaller) {

        if (annotationImportItemDetail == null) {
