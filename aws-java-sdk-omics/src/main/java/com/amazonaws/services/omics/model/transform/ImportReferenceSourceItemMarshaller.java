...
/**
 * ImportReferenceSourceItemMarshaller
 */
...
public class ImportReferenceSourceItemMarshaller {
    ...
    private static final ImportReferenceSourceItemMarshaller instance = new ImportReferenceSourceItemMarshaller();

    public static ImportReferenceSourceItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ImportReferenceSourceItem importReferenceSourceItem, ProtocolMarshaller protocolMarshaller) {

        if (importReferenceSourceItem == null) {
