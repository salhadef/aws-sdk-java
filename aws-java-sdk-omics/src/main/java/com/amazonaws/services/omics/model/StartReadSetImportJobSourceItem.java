 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/StartReadSetImportJobSourceItem"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartReadSetImportJobSourceItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public StartReadSetImportJobSourceItem withSourceFileType(String sourceFileType) {
    ...
    public StartReadSetImportJobSourceItem withSourceFileType(FileType sourceFileType) {
     ...
     *
     * @see StartReadSetImportJobSourceItem#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public StartReadSetImportJobSourceItem addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    @Override
    public StartReadSetImportJobSourceItem clone() {
        try {
            return (StartReadSetImportJobSourceItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.StartReadSetImportJobSourceItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
