...
public class StartReadSetImportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartReadSetImportJobResult withCreationTime(java.util.Date creationTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartReadSetImportJobResult == false)
            return false;
        StartReadSetImportJobResult other = (StartReadSetImportJobResult) obj;
    ...
    public StartReadSetImportJobResult clone() {
        try {
            return (StartReadSetImportJobResult) super.clone();
