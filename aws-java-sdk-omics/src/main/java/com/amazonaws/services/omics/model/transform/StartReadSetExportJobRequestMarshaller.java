...
/**
 * StartReadSetExportJobRequestMarshaller
 */
...
public class StartReadSetExportJobRequestMarshaller {
    ...
    private static final StartReadSetExportJobRequestMarshaller instance = new StartReadSetExportJobRequestMarshaller();

    public static StartReadSetExportJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartReadSetExportJobRequest startReadSetExportJobRequest, ProtocolMarshaller protocolMarshaller) {
