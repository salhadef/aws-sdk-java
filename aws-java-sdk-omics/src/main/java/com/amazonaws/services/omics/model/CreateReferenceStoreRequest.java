...
public class CreateReferenceStoreRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateReferenceStoreRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateReferenceStoreRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateReferenceStoreRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateReferenceStoreRequest == false)
            return false;
        CreateReferenceStoreRequest other = (CreateReferenceStoreRequest) obj;
    ...
    @Override
    public CreateReferenceStoreRequest clone() {
        return (CreateReferenceStoreRequest) super.clone();
    }
