 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/ActivateReadSetJobItem" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ActivateReadSetJobItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public ActivateReadSetJobItem withCreationTime(java.util.Date creationTime) {
    ...
    public ActivateReadSetJobItem withCompletionTime(java.util.Date completionTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ActivateReadSetJobItem == false)
            return false;
    ...
    public ActivateReadSetJobItem clone() {
        try {
            return (ActivateReadSetJobItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.ActivateReadSetJobItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
