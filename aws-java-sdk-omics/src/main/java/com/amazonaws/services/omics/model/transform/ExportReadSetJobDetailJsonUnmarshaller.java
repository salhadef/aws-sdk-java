...
/**
 * ExportReadSetJobDetail JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExportReadSetJobDetailJsonUnmarshaller implements Unmarshaller<ExportReadSetJobDetail, JsonUnmarshallerContext> {

    public ExportReadSetJobDetail unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExportReadSetJobDetail exportReadSetJobDetail = new ExportReadSetJobDetail();
    ...
    private static ExportReadSetJobDetailJsonUnmarshaller instance;

    public static ExportReadSetJobDetailJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExportReadSetJobDetailJsonUnmarshaller();
        return instance;
    }
}
