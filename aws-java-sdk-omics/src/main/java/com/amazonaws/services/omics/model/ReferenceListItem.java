 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/ReferenceListItem" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReferenceListItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public ReferenceListItem withUpdateTime(java.util.Date updateTime) {
    ...
    public ReferenceListItem clone() {
        try {
            return (ReferenceListItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.ReferenceListItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
