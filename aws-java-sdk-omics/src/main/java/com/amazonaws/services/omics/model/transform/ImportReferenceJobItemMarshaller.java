...
/**
 * ImportReferenceJobItemMarshaller
 */
...
public class ImportReferenceJobItemMarshaller {
    ...
    public static ImportReferenceJobItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ImportReferenceJobItem importReferenceJobItem, ProtocolMarshaller protocolMarshaller) {

        if (importReferenceJobItem == null) {
