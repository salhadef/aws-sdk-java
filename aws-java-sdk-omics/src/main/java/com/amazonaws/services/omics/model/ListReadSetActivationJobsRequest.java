...
public class ListReadSetActivationJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The maximum number of read set activation jobs to return in one page of results.
     */
    ...
    public ListReadSetActivationJobsRequest withMaxResults(Integer maxResults) {
