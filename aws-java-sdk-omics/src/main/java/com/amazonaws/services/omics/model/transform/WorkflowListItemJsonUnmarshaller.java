...
/**
 * WorkflowListItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkflowListItemJsonUnmarshaller implements Unmarshaller<WorkflowListItem, JsonUnmarshallerContext> {

    public WorkflowListItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    workflowListItem.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    workflowListItem.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static WorkflowListItemJsonUnmarshaller instance;

    public static WorkflowListItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorkflowListItemJsonUnmarshaller();
        return instance;
    }
}
