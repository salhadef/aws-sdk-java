 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/ImportReferenceSourceItem" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportReferenceSourceItem implements Serializable, Cloneable, StructuredPojo {
     ...
     * @param status
     *        The source's status.
     * @see ReferenceImportJobItemStatus
     */
     ...
     *
     * @see ImportReferenceSourceItem#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ImportReferenceSourceItem addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public ImportReferenceSourceItem clone() {
        try {
            return (ImportReferenceSourceItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.ImportReferenceSourceItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
