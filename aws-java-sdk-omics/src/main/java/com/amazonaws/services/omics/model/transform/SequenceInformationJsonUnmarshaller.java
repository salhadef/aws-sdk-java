...
/**
 * SequenceInformation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SequenceInformationJsonUnmarshaller implements Unmarshaller<SequenceInformation, JsonUnmarshallerContext> {

    public SequenceInformation unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SequenceInformationJsonUnmarshaller instance;

    public static SequenceInformationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SequenceInformationJsonUnmarshaller();
        return instance;
    }
}
