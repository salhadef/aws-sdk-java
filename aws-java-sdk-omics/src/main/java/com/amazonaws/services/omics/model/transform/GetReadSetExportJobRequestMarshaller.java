...
/**
 * GetReadSetExportJobRequestMarshaller
 */
...
public class GetReadSetExportJobRequestMarshaller {
    ...
    public static GetReadSetExportJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetReadSetExportJobRequest getReadSetExportJobRequest, ProtocolMarshaller protocolMarshaller) {

        if (getReadSetExportJobRequest == null) {
