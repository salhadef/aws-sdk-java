...
/**
 * SequenceStoreDetail JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SequenceStoreDetailJsonUnmarshaller implements Unmarshaller<SequenceStoreDetail, JsonUnmarshallerContext> {

    public SequenceStoreDetail unmarshall(JsonUnmarshallerContext context) throws Exception {
        SequenceStoreDetail sequenceStoreDetail = new SequenceStoreDetail();
    ...
    private static SequenceStoreDetailJsonUnmarshaller instance;

    public static SequenceStoreDetailJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SequenceStoreDetailJsonUnmarshaller();
        return instance;
    }
}
