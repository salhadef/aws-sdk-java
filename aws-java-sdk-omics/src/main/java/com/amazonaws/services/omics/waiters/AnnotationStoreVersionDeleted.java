...
class AnnotationStoreVersionDeleted {
    ...
    static class IsDELETEDMatcher extends WaiterAcceptor<GetAnnotationStoreVersionResult> {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<GetAnnotationStoreVersionResult> {
        /**
    ...
    static class IsDELETINGMatcher extends WaiterAcceptor<GetAnnotationStoreVersionResult> {
        private static final JsonNode expectedResult;
