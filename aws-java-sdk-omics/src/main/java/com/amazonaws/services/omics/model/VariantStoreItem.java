 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/VariantStoreItem" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VariantStoreItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public VariantStoreItem withUpdateTime(java.util.Date updateTime) {
    ...
    public VariantStoreItem clone() {
        try {
            return (VariantStoreItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.VariantStoreItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
