...
public class UpdateVariantStoreRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public UpdateVariantStoreRequest clone() {
        return (UpdateVariantStoreRequest) super.clone();
    }
