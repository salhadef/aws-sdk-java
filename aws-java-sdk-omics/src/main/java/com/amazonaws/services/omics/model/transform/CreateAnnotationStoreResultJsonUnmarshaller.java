...
/**
 * CreateAnnotationStoreResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateAnnotationStoreResultJsonUnmarshaller implements Unmarshaller<CreateAnnotationStoreResult, JsonUnmarshallerContext> {

    public CreateAnnotationStoreResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateAnnotationStoreResult createAnnotationStoreResult = new CreateAnnotationStoreResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("storeFormat", targetDepth)) {
                    context.nextToken();
                    createAnnotationStoreResult.setStoreFormat(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static CreateAnnotationStoreResultJsonUnmarshaller instance;

    public static CreateAnnotationStoreResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateAnnotationStoreResultJsonUnmarshaller();
        return instance;
    }
}
