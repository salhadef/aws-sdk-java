...
public class StartReferenceImportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartReferenceImportJobResult withCreationTime(java.util.Date creationTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartReferenceImportJobResult == false)
            return false;
        StartReferenceImportJobResult other = (StartReferenceImportJobResult) obj;
    ...
    public StartReferenceImportJobResult clone() {
        try {
            return (StartReferenceImportJobResult) super.clone();
