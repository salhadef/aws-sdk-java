...
public class CreateVariantStoreResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateVariantStoreResult withReference(ReferenceItem reference) {
    ...
    public CreateVariantStoreResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public CreateVariantStoreResult withStatus(StoreStatus status) {
    ...
    @Override
    public CreateVariantStoreResult clone() {
        try {
            return (CreateVariantStoreResult) super.clone();
