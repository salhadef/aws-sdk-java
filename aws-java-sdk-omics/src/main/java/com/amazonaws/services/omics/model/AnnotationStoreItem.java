 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/AnnotationStoreItem" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AnnotationStoreItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public AnnotationStoreItem withUpdateTime(java.util.Date updateTime) {
    ...
    public AnnotationStoreItem clone() {
        try {
            return (AnnotationStoreItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.AnnotationStoreItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
