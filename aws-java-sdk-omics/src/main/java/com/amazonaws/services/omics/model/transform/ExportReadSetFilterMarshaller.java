...
public class ExportReadSetFilterMarshaller {
    ...
    public static ExportReadSetFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ExportReadSetFilter exportReadSetFilter, ProtocolMarshaller protocolMarshaller) {

        if (exportReadSetFilter == null) {
