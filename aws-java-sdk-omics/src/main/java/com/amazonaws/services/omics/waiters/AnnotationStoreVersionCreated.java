...
class AnnotationStoreVersionCreated {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<GetAnnotationStoreVersionResult> {
         ...
         */
        @Override
        public boolean matches(GetAnnotationStoreVersionResult result) {
    ...
    static class IsCREATINGMatcher extends WaiterAcceptor<GetAnnotationStoreVersionResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATINGMatcher extends WaiterAcceptor<GetAnnotationStoreVersionResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetAnnotationStoreVersionResult> {
        private static final JsonNode expectedResult;
