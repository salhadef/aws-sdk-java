 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/ExportReadSetFilter" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExportReadSetFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public ExportReadSetFilter withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public ExportReadSetFilter withStatus(ReadSetExportJobStatus status) {
    ...
    public ExportReadSetFilter withCreatedAfter(java.util.Date createdAfter) {
    ...
    public ExportReadSetFilter withCreatedBefore(java.util.Date createdBefore) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExportReadSetFilter == false)
            return false;
    ...
    @Override
    public ExportReadSetFilter clone() {
        try {
            return (ExportReadSetFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.ExportReadSetFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
