 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/ImportReadSetFilter" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportReadSetFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public ImportReadSetFilter withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public ImportReadSetFilter withStatus(ReadSetImportJobStatus status) {
    ...
    public ImportReadSetFilter withCreatedAfter(java.util.Date createdAfter) {
    ...
    public ImportReadSetFilter withCreatedBefore(java.util.Date createdBefore) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportReadSetFilter == false)
            return false;
        ImportReadSetFilter other = (ImportReadSetFilter) obj;
    ...
    @Override
    public ImportReadSetFilter clone() {
        try {
            return (ImportReadSetFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.ImportReadSetFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
