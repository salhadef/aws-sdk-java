...
public class ReferenceFilesMarshaller {
    ...
    public static ReferenceFilesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ReferenceFiles referenceFiles, ProtocolMarshaller protocolMarshaller) {
