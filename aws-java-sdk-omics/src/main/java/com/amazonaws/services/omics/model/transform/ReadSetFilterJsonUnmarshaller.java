...
/**
 * ReadSetFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReadSetFilterJsonUnmarshaller implements Unmarshaller<ReadSetFilter, JsonUnmarshallerContext> {

    public ReadSetFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
        ReadSetFilter readSetFilter = new ReadSetFilter();
        ...
        return readSetFilter;
    }

    private static ReadSetFilterJsonUnmarshaller instance;

    public static ReadSetFilterJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReadSetFilterJsonUnmarshaller();
        return instance;
    }
}
