...
public class ListRunGroupsRequestMarshaller {
    ...
    public static ListRunGroupsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListRunGroupsRequest listRunGroupsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listRunGroupsRequest == null) {
