...
/**
 * GetReadSetImportJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetReadSetImportJobResultJsonUnmarshaller implements Unmarshaller<GetReadSetImportJobResult, JsonUnmarshallerContext> {

    public GetReadSetImportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetReadSetImportJobResult getReadSetImportJobResult = new GetReadSetImportJobResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    getReadSetImportJobResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static GetReadSetImportJobResultJsonUnmarshaller instance;

    public static GetReadSetImportJobResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetReadSetImportJobResultJsonUnmarshaller();
        return instance;
    }
}
