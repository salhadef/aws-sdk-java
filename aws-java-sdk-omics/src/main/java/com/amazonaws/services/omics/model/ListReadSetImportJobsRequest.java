...
public class ListReadSetImportJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListReadSetImportJobsRequest withMaxResults(Integer maxResults) {
    ...
    @Override
    public ListReadSetImportJobsRequest clone() {
        return (ListReadSetImportJobsRequest) super.clone();
    }
