...
public class DeleteVariantStoreRequestMarshaller {
    ...
    public static DeleteVariantStoreRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteVariantStoreRequest deleteVariantStoreRequest, ProtocolMarshaller protocolMarshaller) {

        if (deleteVariantStoreRequest == null) {
