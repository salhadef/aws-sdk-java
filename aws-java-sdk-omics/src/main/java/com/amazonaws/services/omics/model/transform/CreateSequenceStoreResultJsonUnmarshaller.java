...
/**
 * CreateSequenceStoreResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateSequenceStoreResultJsonUnmarshaller implements Unmarshaller<CreateSequenceStoreResult, JsonUnmarshallerContext> {

    public CreateSequenceStoreResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateSequenceStoreResult createSequenceStoreResult = new CreateSequenceStoreResult();
    ...
    private static CreateSequenceStoreResultJsonUnmarshaller instance;

    public static CreateSequenceStoreResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateSequenceStoreResultJsonUnmarshaller();
        return instance;
    }
}
