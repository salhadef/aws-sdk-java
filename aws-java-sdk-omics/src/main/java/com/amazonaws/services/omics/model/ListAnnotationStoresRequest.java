...
public class ListAnnotationStoresRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAnnotationStoresRequest withIds(String... ids) {
        if (this.ids == null) {
    ...
    public ListAnnotationStoresRequest withIds(java.util.Collection<String> ids) {
        setIds(ids);
        return this;
    }
    ...
    public ListAnnotationStoresRequest withMaxResults(Integer maxResults) {
