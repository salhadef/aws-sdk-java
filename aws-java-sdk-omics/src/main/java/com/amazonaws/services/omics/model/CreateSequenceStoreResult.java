...
public class CreateSequenceStoreResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The store's SSE settings.
     */
    ...
    public CreateSequenceStoreResult withCreationTime(java.util.Date creationTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSequenceStoreResult == false)
            return false;
        CreateSequenceStoreResult other = (CreateSequenceStoreResult) obj;
    ...
    public CreateSequenceStoreResult clone() {
        try {
            return (CreateSequenceStoreResult) super.clone();
