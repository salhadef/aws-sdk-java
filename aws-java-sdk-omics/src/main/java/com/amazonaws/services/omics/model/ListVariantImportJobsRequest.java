...
public class ListVariantImportJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListVariantImportJobsRequest withMaxResults(Integer maxResults) {
    ...
    public ListVariantImportJobsRequest withIds(String... ids) {
        if (this.ids == null) {
    ...
    public ListVariantImportJobsRequest withIds(java.util.Collection<String> ids) {
        setIds(ids);
        return this;
    }
    ...
    public void setFilter(ListVariantImportJobsFilter filter) {
        this.filter = filter;
    }
    ...
    public ListVariantImportJobsFilter getFilter() {
        return this.filter;
    }
    ...
    public ListVariantImportJobsRequest withFilter(ListVariantImportJobsFilter filter) {
        setFilter(filter);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListVariantImportJobsRequest == false)
            return false;
    ...
    @Override
    public ListVariantImportJobsRequest clone() {
        return (ListVariantImportJobsRequest) super.clone();
    }
