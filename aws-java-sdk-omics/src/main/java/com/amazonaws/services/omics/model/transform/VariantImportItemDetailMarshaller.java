...
/**
 * VariantImportItemDetailMarshaller
 */
...
public class VariantImportItemDetailMarshaller {
    ...
    public static VariantImportItemDetailMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VariantImportItemDetail variantImportItemDetail, ProtocolMarshaller protocolMarshaller) {

        if (variantImportItemDetail == null) {
