...
public class ListSequenceStoresRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListSequenceStoresRequest withMaxResults(Integer maxResults) {
    ...
    @Override
    public ListSequenceStoresRequest clone() {
        return (ListSequenceStoresRequest) super.clone();
    }
