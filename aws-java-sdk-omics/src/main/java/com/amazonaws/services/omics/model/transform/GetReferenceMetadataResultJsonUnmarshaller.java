...
/**
 * GetReferenceMetadataResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetReferenceMetadataResultJsonUnmarshaller implements Unmarshaller<GetReferenceMetadataResult, JsonUnmarshallerContext> {

    public GetReferenceMetadataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetReferenceMetadataResult getReferenceMetadataResult = new GetReferenceMetadataResult();
    ...
    private static GetReferenceMetadataResultJsonUnmarshaller instance;

    public static GetReferenceMetadataResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetReferenceMetadataResultJsonUnmarshaller();
        return instance;
    }
}
