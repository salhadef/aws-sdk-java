...
/**
 * TsvVersionOptions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TsvVersionOptionsJsonUnmarshaller implements Unmarshaller<TsvVersionOptions, JsonUnmarshallerContext> {

    public TsvVersionOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
        TsvVersionOptions tsvVersionOptions = new TsvVersionOptions();
    ...
    private static TsvVersionOptionsJsonUnmarshaller instance;

    public static TsvVersionOptionsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TsvVersionOptionsJsonUnmarshaller();
        return instance;
    }
}
