...
public class GetAnnotationStoreVersionFunction implements SdkFunction<GetAnnotationStoreVersionRequest, GetAnnotationStoreVersionResult> {
    ...
    /**
     * Constructs a new GetAnnotationStoreVersionFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetAnnotationStoreVersionFunction(AmazonOmics client) {
        this.client = client;
    }
    ...
    public GetAnnotationStoreVersionResult apply(GetAnnotationStoreVersionRequest getAnnotationStoreVersionRequest) {
        return client.getAnnotationStoreVersion(getAnnotationStoreVersionRequest);
    }
}
