...
/**
 * ReferenceFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReferenceFilterJsonUnmarshaller implements Unmarshaller<ReferenceFilter, JsonUnmarshallerContext> {

    public ReferenceFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ReferenceFilterJsonUnmarshaller instance;

    public static ReferenceFilterJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReferenceFilterJsonUnmarshaller();
        return instance;
    }
}
