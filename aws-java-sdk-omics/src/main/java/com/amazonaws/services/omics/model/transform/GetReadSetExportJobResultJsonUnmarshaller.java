...
/**
 * GetReadSetExportJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetReadSetExportJobResultJsonUnmarshaller implements Unmarshaller<GetReadSetExportJobResult, JsonUnmarshallerContext> {

    public GetReadSetExportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetReadSetExportJobResult getReadSetExportJobResult = new GetReadSetExportJobResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    getReadSetExportJobResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static GetReadSetExportJobResultJsonUnmarshaller instance;

    public static GetReadSetExportJobResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetReadSetExportJobResultJsonUnmarshaller();
        return instance;
    }
}
