...
public class ListReadSetExportJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private ExportReadSetFilter filter;
    ...
    public ListReadSetExportJobsRequest withMaxResults(Integer maxResults) {
    ...
    public void setFilter(ExportReadSetFilter filter) {
        this.filter = filter;
    }
    ...
    public ExportReadSetFilter getFilter() {
        return this.filter;
    }
    ...
    public ListReadSetExportJobsRequest withFilter(ExportReadSetFilter filter) {
        setFilter(filter);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListReadSetExportJobsRequest == false)
            return false;
        ListReadSetExportJobsRequest other = (ListReadSetExportJobsRequest) obj;
    ...
    @Override
    public ListReadSetExportJobsRequest clone() {
        return (ListReadSetExportJobsRequest) super.clone();
    }
