 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/omics-2022-11-28/SequenceStoreFilter" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SequenceStoreFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public SequenceStoreFilter withName(String name) {
        setName(name);
        return this;
    }
    ...
    public SequenceStoreFilter withCreatedAfter(java.util.Date createdAfter) {
    ...
    public SequenceStoreFilter withCreatedBefore(java.util.Date createdBefore) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SequenceStoreFilter == false)
            return false;
    ...
    @Override
    public SequenceStoreFilter clone() {
        try {
            return (SequenceStoreFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.omics.model.transform.SequenceStoreFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
