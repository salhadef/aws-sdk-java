...
/**
 * ShareDetailsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ShareDetailsMarshaller {
    ...
    private static final ShareDetailsMarshaller instance = new ShareDetailsMarshaller();

    public static ShareDetailsMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(ShareDetails shareDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(shareDetails.getStatusMessage(), STATUSMESSAGE_BINDING);
            protocolMarshaller.marshall(shareDetails.getShareName(), SHARENAME_BINDING);
            protocolMarshaller.marshall(shareDetails.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(shareDetails.getUpdateTime(), UPDATETIME_BINDING);
        } catch (Exception e) {
