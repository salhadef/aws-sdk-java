...
class TenantDatabaseDeleted {
    ...
    static class IsTrueMatcher extends WaiterAcceptor<DescribeTenantDatabasesResult> {
        ...
        private static final JmesPathExpression ast = new OpEquals(new JmesPathLengthFunction(new JmesPathField("TenantDatabases")), new JmesPathLiteral("0"));
    ...
    static class IsDBInstanceNotFoundFaultMatcher extends WaiterAcceptor<DescribeTenantDatabasesResult> {
        /**
        ...
        public boolean matches(AmazonServiceException e) {
            return "DBInstanceNotFoundFault".equals(e.getErrorCode());
        }
