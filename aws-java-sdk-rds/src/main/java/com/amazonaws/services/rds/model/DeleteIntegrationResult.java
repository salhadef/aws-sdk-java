...
public class DeleteIntegrationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteIntegrationResult withAdditionalEncryptionContext(java.util.Map<String, String> additionalEncryptionContext) {
    ...
    public DeleteIntegrationResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public DeleteIntegrationResult withErrors(java.util.Collection<IntegrationError> errors) {
        setErrors(errors);
        return this;
    }
