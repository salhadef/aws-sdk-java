...
public class DeleteCustomDBEngineVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteCustomDBEngineVersionResult withSupportedCharacterSets(CharacterSet... supportedCharacterSets) {
    ...
    public DeleteCustomDBEngineVersionResult withSupportedCharacterSets(java.util.Collection<CharacterSet> supportedCharacterSets) {
    ...
    public DeleteCustomDBEngineVersionResult withSupportedNcharCharacterSets(CharacterSet... supportedNcharCharacterSets) {
    ...
    public DeleteCustomDBEngineVersionResult withSupportedNcharCharacterSets(java.util.Collection<CharacterSet> supportedNcharCharacterSets) {
    ...
    public DeleteCustomDBEngineVersionResult withValidUpgradeTarget(UpgradeTarget... validUpgradeTarget) {
    ...
    public DeleteCustomDBEngineVersionResult withValidUpgradeTarget(java.util.Collection<UpgradeTarget> validUpgradeTarget) {
    ...
    public DeleteCustomDBEngineVersionResult withSupportedTimezones(Timezone... supportedTimezones) {
    ...
    public DeleteCustomDBEngineVersionResult withSupportedTimezones(java.util.Collection<Timezone> supportedTimezones) {
    ...
    public DeleteCustomDBEngineVersionResult withExportableLogTypes(String... exportableLogTypes) {
    ...
    public DeleteCustomDBEngineVersionResult withExportableLogTypes(java.util.Collection<String> exportableLogTypes) {
    ...
    public DeleteCustomDBEngineVersionResult withSupportedEngineModes(String... supportedEngineModes) {
    ...
    public DeleteCustomDBEngineVersionResult withSupportedEngineModes(java.util.Collection<String> supportedEngineModes) {
    ...
    public DeleteCustomDBEngineVersionResult withSupportedFeatureNames(java.util.Collection<String> supportedFeatureNames) {
    ...
    public DeleteCustomDBEngineVersionResult withCreateTime(java.util.Date createTime) {
    ...
    public DeleteCustomDBEngineVersionResult withTagList(java.util.Collection<Tag> tagList) {
        setTagList(tagList);
        return this;
    }
    ...
    public DeleteCustomDBEngineVersionResult withSupportedCACertificateIdentifiers(java.util.Collection<String> supportedCACertificateIdentifiers) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteCustomDBEngineVersionResult == false)
            return false;
        DeleteCustomDBEngineVersionResult other = (DeleteCustomDBEngineVersionResult) obj;
    ...
    public DeleteCustomDBEngineVersionResult clone() {
        try {
            return (DeleteCustomDBEngineVersionResult) super.clone();
