...
public class DescribeIntegrationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * An optional pagination token provided by a previous <code>DescribeIntegrations</code> request. If this parameter
     ...
     * </p>
     * 
     * @return A filter that specifies one or more resources to return.
     */
    ...
    public DescribeIntegrationsRequest withFilters(Filter... filters) {
    ...
    public DescribeIntegrationsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
     ...
     * 
     * @param marker
     *        An optional pagination token provided by a previous <code>DescribeIntegrations</code> request. If this
     ...
     * </p>
     * 
     * @return An optional pagination token provided by a previous <code>DescribeIntegrations</code> request. If this
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeIntegrationsRequest == false)
            return false;
    ...
    public DescribeIntegrationsRequest clone() {
        return (DescribeIntegrationsRequest) super.clone();
    }
