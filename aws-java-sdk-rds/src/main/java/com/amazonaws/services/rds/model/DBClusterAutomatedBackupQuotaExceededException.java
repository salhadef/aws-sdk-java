...
public class DBClusterAutomatedBackupQuotaExceededException extends com.amazonaws.services.rds.model.AmazonRDSException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new DBClusterAutomatedBackupQuotaExceededException with the specified error message.
     *
     * @param message
