...
public class CreateCustomDBEngineVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateCustomDBEngineVersionResult withSupportedCharacterSets(java.util.Collection<CharacterSet> supportedCharacterSets) {
    ...
    public CreateCustomDBEngineVersionResult withSupportedNcharCharacterSets(java.util.Collection<CharacterSet> supportedNcharCharacterSets) {
    ...
    public CreateCustomDBEngineVersionResult withValidUpgradeTarget(UpgradeTarget... validUpgradeTarget) {
    ...
    public CreateCustomDBEngineVersionResult withValidUpgradeTarget(java.util.Collection<UpgradeTarget> validUpgradeTarget) {
    ...
    public CreateCustomDBEngineVersionResult withSupportedTimezones(java.util.Collection<Timezone> supportedTimezones) {
    ...
    public CreateCustomDBEngineVersionResult withExportableLogTypes(String... exportableLogTypes) {
    ...
    public CreateCustomDBEngineVersionResult withExportableLogTypes(java.util.Collection<String> exportableLogTypes) {
    ...
    public CreateCustomDBEngineVersionResult withSupportedEngineModes(String... supportedEngineModes) {
    ...
    public CreateCustomDBEngineVersionResult withSupportedEngineModes(java.util.Collection<String> supportedEngineModes) {
    ...
    public CreateCustomDBEngineVersionResult withSupportedFeatureNames(java.util.Collection<String> supportedFeatureNames) {
    ...
    public CreateCustomDBEngineVersionResult withCreateTime(java.util.Date createTime) {
    ...
    public CreateCustomDBEngineVersionResult withTagList(Tag... tagList) {
    ...
    public CreateCustomDBEngineVersionResult withTagList(java.util.Collection<Tag> tagList) {
        setTagList(tagList);
        return this;
    }
    ...
    public CreateCustomDBEngineVersionResult withSupportedCACertificateIdentifiers(java.util.Collection<String> supportedCACertificateIdentifiers) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCustomDBEngineVersionResult == false)
            return false;
        CreateCustomDBEngineVersionResult other = (CreateCustomDBEngineVersionResult) obj;
    ...
    @Override
    public CreateCustomDBEngineVersionResult clone() {
        try {
