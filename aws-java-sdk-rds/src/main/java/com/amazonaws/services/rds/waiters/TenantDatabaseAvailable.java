...
class TenantDatabaseAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeTenantDatabasesResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("TenantDatabases")), new JmesPathField(
                "Status"));
         ...
         */
        @Override
        public boolean matches(DescribeTenantDatabasesResult result) {
    ...
    static class IsDeletedMatcher extends WaiterAcceptor<DescribeTenantDatabasesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIncompatibleparametersMatcher extends WaiterAcceptor<DescribeTenantDatabasesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIncompatiblerestoreMatcher extends WaiterAcceptor<DescribeTenantDatabasesResult> {
        private static final JsonNode expectedResult;
