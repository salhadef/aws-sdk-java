...
public class PutLaunchActionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public PutLaunchActionRequest withParameters(java.util.Map<String, LaunchActionParameter> parameters) {
     ...
     *
     * @see PutLaunchActionRequest#withParameters
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutLaunchActionRequest == false)
            return false;
        PutLaunchActionRequest other = (PutLaunchActionRequest) obj;
    ...
    public PutLaunchActionRequest clone() {
        return (PutLaunchActionRequest) super.clone();
    }
