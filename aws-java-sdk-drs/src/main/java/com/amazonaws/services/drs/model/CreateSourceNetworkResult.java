...
public class CreateSourceNetworkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateSourceNetworkResult withSourceNetworkID(String sourceNetworkID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSourceNetworkResult == false)
            return false;
        CreateSourceNetworkResult other = (CreateSourceNetworkResult) obj;
    ...
    @Override
    public CreateSourceNetworkResult clone() {
        try {
            return (CreateSourceNetworkResult) super.clone();
