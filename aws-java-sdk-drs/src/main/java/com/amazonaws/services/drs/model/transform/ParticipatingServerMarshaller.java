...
public class ParticipatingServerMarshaller {
    ...
    private static final ParticipatingServerMarshaller instance = new ParticipatingServerMarshaller();

    public static ParticipatingServerMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ParticipatingServer participatingServer, ProtocolMarshaller protocolMarshaller) {

        if (participatingServer == null) {
