...
/**
 * DeleteSourceNetworkResult JSON Unmarshaller
 */
...
public class DeleteSourceNetworkResultJsonUnmarshaller implements Unmarshaller<DeleteSourceNetworkResult, JsonUnmarshallerContext> {
    ...
    public DeleteSourceNetworkResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSourceNetworkResult deleteSourceNetworkResult = new DeleteSourceNetworkResult();

        return deleteSourceNetworkResult;
    }
