...
public class DeleteSourceNetworkRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return ID of the Source Network to delete.
     */
    ...
    public DeleteSourceNetworkRequest withSourceNetworkID(String sourceNetworkID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteSourceNetworkRequest == false)
            return false;
        DeleteSourceNetworkRequest other = (DeleteSourceNetworkRequest) obj;
    ...
    @Override
    public DeleteSourceNetworkRequest clone() {
        return (DeleteSourceNetworkRequest) super.clone();
    }
