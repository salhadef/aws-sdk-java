...
/**
 * DeleteLaunchActionResult JSON Unmarshaller
 */
...
public class DeleteLaunchActionResultJsonUnmarshaller implements Unmarshaller<DeleteLaunchActionResult, JsonUnmarshallerContext> {
    ...
    public DeleteLaunchActionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLaunchActionResult deleteLaunchActionResult = new DeleteLaunchActionResult();

        return deleteLaunchActionResult;
    }
