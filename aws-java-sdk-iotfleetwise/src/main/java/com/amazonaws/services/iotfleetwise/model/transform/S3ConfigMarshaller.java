...
public class S3ConfigMarshaller {
    ...
    private static final MarshallingInfo<String> STORAGECOMPRESSIONFORMAT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("storageCompressionFormat").build();
    ...
    public void marshall(S3Config s3Config, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3Config.getBucketArn(), BUCKETARN_BINDING);
            protocolMarshaller.marshall(s3Config.getDataFormat(), DATAFORMAT_BINDING);
            protocolMarshaller.marshall(s3Config.getStorageCompressionFormat(), STORAGECOMPRESSIONFORMAT_BINDING);
            protocolMarshaller.marshall(s3Config.getPrefix(), PREFIX_BINDING);
        } catch (Exception e) {
