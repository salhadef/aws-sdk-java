...
public class SensorMarshaller {
    ...
    public static SensorMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Sensor sensor, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sensor.getFullyQualifiedName(), FULLYQUALIFIEDNAME_BINDING);
            protocolMarshaller.marshall(sensor.getDataType(), DATATYPE_BINDING);
            protocolMarshaller.marshall(sensor.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(sensor.getUnit(), UNIT_BINDING);
