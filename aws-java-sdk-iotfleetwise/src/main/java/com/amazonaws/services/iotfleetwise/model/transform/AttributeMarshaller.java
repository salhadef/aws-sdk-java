...
public class AttributeMarshaller {
    ...
    public void marshall(Attribute attribute, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(attribute.getFullyQualifiedName(), FULLYQUALIFIEDNAME_BINDING);
            protocolMarshaller.marshall(attribute.getDataType(), DATATYPE_BINDING);
            protocolMarshaller.marshall(attribute.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(attribute.getUnit(), UNIT_BINDING);
            protocolMarshaller.marshall(attribute.getAllowedValues(), ALLOWEDVALUES_BINDING);
            protocolMarshaller.marshall(attribute.getMin(), MIN_BINDING);
            protocolMarshaller.marshall(attribute.getMax(), MAX_BINDING);
            protocolMarshaller.marshall(attribute.getAssignedValue(), ASSIGNEDVALUE_BINDING);
            protocolMarshaller.marshall(attribute.getDefaultValue(), DEFAULTVALUE_BINDING);
            protocolMarshaller.marshall(attribute.getDeprecationMessage(), DEPRECATIONMESSAGE_BINDING);
            protocolMarshaller.marshall(attribute.getComment(), COMMENT_BINDING);
        } catch (Exception e) {
