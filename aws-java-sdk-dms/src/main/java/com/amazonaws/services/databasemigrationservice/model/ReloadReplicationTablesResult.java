...
public class ReloadReplicationTablesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReloadReplicationTablesResult == false)
            return false;
        ReloadReplicationTablesResult other = (ReloadReplicationTablesResult) obj;
    ...
    public ReloadReplicationTablesResult clone() {
        try {
            return (ReloadReplicationTablesResult) super.clone();
