...
public class DescribeMetadataModelImportsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Filters applied to the metadata model imports described in the form of key-value pairs.
     */
    ...
    public DescribeMetadataModelImportsRequest withFilters(Filter... filters) {
    ...
    public DescribeMetadataModelImportsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMetadataModelImportsRequest == false)
            return false;
        DescribeMetadataModelImportsRequest other = (DescribeMetadataModelImportsRequest) obj;
    ...
    public DescribeMetadataModelImportsRequest clone() {
        return (DescribeMetadataModelImportsRequest) super.clone();
    }
