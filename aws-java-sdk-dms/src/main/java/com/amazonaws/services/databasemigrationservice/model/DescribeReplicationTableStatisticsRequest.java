...
public class DescribeReplicationTableStatisticsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The replication config to describe.
     */
     ...
     * </p>
     * 
     * @return Filters applied to the replication table statistics.
     */
    ...
    public DescribeReplicationTableStatisticsRequest withFilters(Filter... filters) {
    ...
    public DescribeReplicationTableStatisticsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeReplicationTableStatisticsRequest == false)
            return false;
        DescribeReplicationTableStatisticsRequest other = (DescribeReplicationTableStatisticsRequest) obj;
    ...
    public DescribeReplicationTableStatisticsRequest clone() {
        return (DescribeReplicationTableStatisticsRequest) super.clone();
    }
