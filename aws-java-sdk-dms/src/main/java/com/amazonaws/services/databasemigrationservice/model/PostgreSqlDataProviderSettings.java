 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/PostgreSqlDataProviderSettings" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PostgreSqlDataProviderSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The SSL mode used to connect to the PostgreSQL data provider. The default value is <code>none</code>.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The port value for the PostgreSQL data provider.
     */
     ...
     * </p>
     * 
     * @return The database name on the PostgreSQL data provider.
     */
     ...
     * </p>
     * 
     * @return The SSL mode used to connect to the PostgreSQL data provider. The default value is <code>none</code>.
     * @see DmsSslModeValue
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PostgreSqlDataProviderSettings == false)
            return false;
        PostgreSqlDataProviderSettings other = (PostgreSqlDataProviderSettings) obj;
    ...
    public PostgreSqlDataProviderSettings clone() {
        try {
            return (PostgreSqlDataProviderSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.databasemigrationservice.model.transform.PostgreSqlDataProviderSettingsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
