...
public class DescribeMetadataModelExportsToTargetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeMetadataModelExportsToTargetRequest withMigrationProjectIdentifier(String migrationProjectIdentifier) {
     ...
     * </p>
     * 
     * @return Filters applied to the metadata model exports described in the form of key-value pairs.
     */
    ...
    public DescribeMetadataModelExportsToTargetRequest withFilters(Filter... filters) {
    ...
    public DescribeMetadataModelExportsToTargetRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeMetadataModelExportsToTargetRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public DescribeMetadataModelExportsToTargetRequest withMaxRecords(Integer maxRecords) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMetadataModelExportsToTargetRequest == false)
            return false;
        DescribeMetadataModelExportsToTargetRequest other = (DescribeMetadataModelExportsToTargetRequest) obj;
    ...
    @Override
    public DescribeMetadataModelExportsToTargetRequest clone() {
        return (DescribeMetadataModelExportsToTargetRequest) super.clone();
    }
