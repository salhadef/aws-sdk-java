...
public class StartReplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The replication that DMS started.
     */
    ...
    public String toString() {
        ...
        if (getReplication() != null)
            sb.append("Replication: ").append(getReplication());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getReplication() == null ^ this.getReplication() == null)
            return false;
        if (other.getReplication() != null && other.getReplication().equals(this.getReplication()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getReplication() == null) ? 0 : getReplication().hashCode());
        return hashCode;
    }
