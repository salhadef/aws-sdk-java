...
public class StartMetadataModelExportToTargetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartMetadataModelExportToTargetResult == false)
            return false;
        StartMetadataModelExportToTargetResult other = (StartMetadataModelExportToTargetResult) obj;
    ...
    @Override
    public StartMetadataModelExportToTargetResult clone() {
        try {
            return (StartMetadataModelExportToTargetResult) super.clone();
