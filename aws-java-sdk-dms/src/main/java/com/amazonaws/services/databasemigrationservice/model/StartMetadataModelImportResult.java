...
public class StartMetadataModelImportResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The identifier for the import operation.
     */
    ...
    public StartMetadataModelImportResult withRequestIdentifier(String requestIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartMetadataModelImportResult == false)
            return false;
        StartMetadataModelImportResult other = (StartMetadataModelImportResult) obj;
    ...
    @Override
    public StartMetadataModelImportResult clone() {
        try {
            return (StartMetadataModelImportResult) super.clone();
