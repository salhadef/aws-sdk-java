...
/**
 * TimestreamSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TimestreamSettingsJsonUnmarshaller implements Unmarshaller<TimestreamSettings, JsonUnmarshallerContext> {

    public TimestreamSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        TimestreamSettings timestreamSettings = new TimestreamSettings();
    ...
    private static TimestreamSettingsJsonUnmarshaller instance;

    public static TimestreamSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TimestreamSettingsJsonUnmarshaller();
        return instance;
    }
}
