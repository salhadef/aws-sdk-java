...
public class CreateEndpointRequestMarshaller {
    ...
    public void marshall(CreateEndpointRequest createEndpointRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createEndpointRequest.getKafkaSettings(), KAFKASETTINGS_BINDING);
            ...
            protocolMarshaller.marshall(createEndpointRequest.getResourceIdentifier(), RESOURCEIDENTIFIER_BINDING);
