...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/DescribeInstanceProfiles" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeInstanceProfilesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Filters applied to the instance profiles described in the form of key-value pairs.
     */
    ...
    public DescribeInstanceProfilesRequest withFilters(Filter... filters) {
    ...
    public DescribeInstanceProfilesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeInstanceProfilesRequest withMaxRecords(Integer maxRecords) {
    ...
    public DescribeInstanceProfilesRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeInstanceProfilesRequest == false)
            return false;
        DescribeInstanceProfilesRequest other = (DescribeInstanceProfilesRequest) obj;
    ...
    @Override
    public DescribeInstanceProfilesRequest clone() {
        return (DescribeInstanceProfilesRequest) super.clone();
    }
