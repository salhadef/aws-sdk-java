...
public class DeleteDataProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteDataProviderResult withDataProvider(DataProvider dataProvider) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDataProviderResult == false)
            return false;
        DeleteDataProviderResult other = (DeleteDataProviderResult) obj;
    ...
    @Override
    public DeleteDataProviderResult clone() {
        try {
            return (DeleteDataProviderResult) super.clone();
