...
public class DescribeMetadataModelExportsAsScriptResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeMetadataModelExportsAsScriptResult withMarker(String marker) {
        setMarker(marker);
        return this;
    }
     ...
     * </p>
     * 
     * @return A paginated list of metadata model exports.
     */
    ...
    public DescribeMetadataModelExportsAsScriptResult withRequests(SchemaConversionRequest... requests) {
    ...
    public DescribeMetadataModelExportsAsScriptResult withRequests(java.util.Collection<SchemaConversionRequest> requests) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMetadataModelExportsAsScriptResult == false)
            return false;
        DescribeMetadataModelExportsAsScriptResult other = (DescribeMetadataModelExportsAsScriptResult) obj;
    ...
    @Override
    public DescribeMetadataModelExportsAsScriptResult clone() {
        try {
            return (DescribeMetadataModelExportsAsScriptResult) super.clone();
