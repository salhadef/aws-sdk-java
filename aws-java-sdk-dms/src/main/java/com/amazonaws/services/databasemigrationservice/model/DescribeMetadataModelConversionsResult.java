...
public class DescribeMetadataModelConversionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeMetadataModelConversionsResult withMarker(String marker) {
        setMarker(marker);
        return this;
    }
     ...
     * </p>
     * 
     * @return A paginated list of metadata model conversions.
     */
    ...
    public DescribeMetadataModelConversionsResult withRequests(SchemaConversionRequest... requests) {
    ...
    public DescribeMetadataModelConversionsResult withRequests(java.util.Collection<SchemaConversionRequest> requests) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMetadataModelConversionsResult == false)
            return false;
        DescribeMetadataModelConversionsResult other = (DescribeMetadataModelConversionsResult) obj;
    ...
    @Override
    public DescribeMetadataModelConversionsResult clone() {
        try {
            return (DescribeMetadataModelConversionsResult) super.clone();
