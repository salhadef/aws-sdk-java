 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/SCApplicationAttributes" target="_top">AWS API
 *      Documentation</a>
 */
...
public class SCApplicationAttributes implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setS3BucketRoleArn(String s3BucketRoleArn) {
    ...
    public SCApplicationAttributes withS3BucketRoleArn(String s3BucketRoleArn) {
        setS3BucketRoleArn(s3BucketRoleArn);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SCApplicationAttributes == false)
            return false;
        SCApplicationAttributes other = (SCApplicationAttributes) obj;
        if (other.getS3BucketPath() == null ^ this.getS3BucketPath() == null)
            return false;
        if (other.getS3BucketPath() != null && other.getS3BucketPath().equals(this.getS3BucketPath()) == false)
            return false;
        if (other.getS3BucketRoleArn() == null ^ this.getS3BucketRoleArn() == null)
            return false;
        if (other.getS3BucketRoleArn() != null && other.getS3BucketRoleArn().equals(this.getS3BucketRoleArn()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getS3BucketPath() == null) ? 0 : getS3BucketPath().hashCode());
        hashCode = prime * hashCode + ((getS3BucketRoleArn() == null) ? 0 : getS3BucketRoleArn().hashCode());
        return hashCode;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.databasemigrationservice.model.transform.SCApplicationAttributesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
