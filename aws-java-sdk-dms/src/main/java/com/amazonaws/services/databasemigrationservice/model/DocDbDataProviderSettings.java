 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/DocDbDataProviderSettings" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DocDbDataProviderSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The SSL mode used to connect to the DocumentDB data provider. The default value is <code>none</code>.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The name of the source DocumentDB server.
     */
     ...
     * </p>
     * 
     * @return The port value for the DocumentDB data provider.
     */
     ...
     * </p>
     * 
     * @return The database name on the DocumentDB data provider.
     */
     ...
     * </p>
     * 
     * @return The SSL mode used to connect to the DocumentDB data provider. The default value is <code>none</code>.
     * @see DmsSslModeValue
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DocDbDataProviderSettings == false)
            return false;
        DocDbDataProviderSettings other = (DocDbDataProviderSettings) obj;
    ...
    public DocDbDataProviderSettings clone() {
        try {
            return (DocDbDataProviderSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.databasemigrationservice.model.transform.DocDbDataProviderSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
