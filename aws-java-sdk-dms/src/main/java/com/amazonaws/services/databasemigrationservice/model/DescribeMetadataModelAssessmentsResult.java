...
public class DescribeMetadataModelAssessmentsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeMetadataModelAssessmentsResult withMarker(String marker) {
        setMarker(marker);
        return this;
    }
     ...
     * </p>
     * 
     * @return A paginated list of metadata model assessments for the specified migration project.
     */
    ...
    public DescribeMetadataModelAssessmentsResult withRequests(SchemaConversionRequest... requests) {
    ...
    public DescribeMetadataModelAssessmentsResult withRequests(java.util.Collection<SchemaConversionRequest> requests) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMetadataModelAssessmentsResult == false)
            return false;
        DescribeMetadataModelAssessmentsResult other = (DescribeMetadataModelAssessmentsResult) obj;
    ...
    @Override
    public DescribeMetadataModelAssessmentsResult clone() {
        try {
            return (DescribeMetadataModelAssessmentsResult) super.clone();
