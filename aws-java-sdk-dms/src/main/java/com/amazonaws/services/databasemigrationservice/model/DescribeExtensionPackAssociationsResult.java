...
public class DescribeExtensionPackAssociationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return A paginated list of extension pack associations for the specified migration project.
     */
    ...
    public DescribeExtensionPackAssociationsResult withRequests(SchemaConversionRequest... requests) {
    ...
    public DescribeExtensionPackAssociationsResult withRequests(java.util.Collection<SchemaConversionRequest> requests) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeExtensionPackAssociationsResult == false)
            return false;
        DescribeExtensionPackAssociationsResult other = (DescribeExtensionPackAssociationsResult) obj;
    ...
    public DescribeExtensionPackAssociationsResult clone() {
        try {
            return (DescribeExtensionPackAssociationsResult) super.clone();
