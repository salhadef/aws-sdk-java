...
public class DescribeMigrationProjectsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Filters applied to the migration projects described in the form of key-value pairs.
     */
    ...
    public DescribeMigrationProjectsRequest withFilters(Filter... filters) {
    ...
    public DescribeMigrationProjectsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeMigrationProjectsRequest withMaxRecords(Integer maxRecords) {
    ...
    public DescribeMigrationProjectsRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMigrationProjectsRequest == false)
            return false;
        DescribeMigrationProjectsRequest other = (DescribeMigrationProjectsRequest) obj;
    ...
    @Override
    public DescribeMigrationProjectsRequest clone() {
        return (DescribeMigrationProjectsRequest) super.clone();
    }
