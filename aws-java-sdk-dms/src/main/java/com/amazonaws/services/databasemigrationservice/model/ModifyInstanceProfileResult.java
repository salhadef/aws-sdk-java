...
public class ModifyInstanceProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The instance profile that was modified.
     */
    ...
    public ModifyInstanceProfileResult withInstanceProfile(InstanceProfile instanceProfile) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyInstanceProfileResult == false)
            return false;
        ModifyInstanceProfileResult other = (ModifyInstanceProfileResult) obj;
    ...
    @Override
    public ModifyInstanceProfileResult clone() {
        try {
            return (ModifyInstanceProfileResult) super.clone();
