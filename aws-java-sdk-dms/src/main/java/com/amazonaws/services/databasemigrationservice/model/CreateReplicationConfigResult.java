...
public class CreateReplicationConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateReplicationConfigResult withReplicationConfig(ReplicationConfig replicationConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateReplicationConfigResult == false)
            return false;
        CreateReplicationConfigResult other = (CreateReplicationConfigResult) obj;
    ...
    @Override
    public CreateReplicationConfigResult clone() {
        try {
            return (CreateReplicationConfigResult) super.clone();
