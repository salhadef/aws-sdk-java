...
public class CreateDataProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDataProviderResult withDataProvider(DataProvider dataProvider) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDataProviderResult == false)
            return false;
        CreateDataProviderResult other = (CreateDataProviderResult) obj;
    ...
    @Override
    public CreateDataProviderResult clone() {
        try {
            return (CreateDataProviderResult) super.clone();
