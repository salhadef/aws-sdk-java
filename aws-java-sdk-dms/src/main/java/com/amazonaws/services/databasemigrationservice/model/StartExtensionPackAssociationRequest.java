...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/StartExtensionPackAssociation" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartExtensionPackAssociationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartExtensionPackAssociationRequest withMigrationProjectIdentifier(String migrationProjectIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartExtensionPackAssociationRequest == false)
            return false;
        StartExtensionPackAssociationRequest other = (StartExtensionPackAssociationRequest) obj;
    ...
    @Override
    public StartExtensionPackAssociationRequest clone() {
        return (StartExtensionPackAssociationRequest) super.clone();
    }
