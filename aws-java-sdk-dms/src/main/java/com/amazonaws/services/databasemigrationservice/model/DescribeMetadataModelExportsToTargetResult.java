...
public class DescribeMetadataModelExportsToTargetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeMetadataModelExportsToTargetResult withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public DescribeMetadataModelExportsToTargetResult withRequests(SchemaConversionRequest... requests) {
    ...
    public DescribeMetadataModelExportsToTargetResult withRequests(java.util.Collection<SchemaConversionRequest> requests) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMetadataModelExportsToTargetResult == false)
            return false;
        DescribeMetadataModelExportsToTargetResult other = (DescribeMetadataModelExportsToTargetResult) obj;
    ...
    @Override
    public DescribeMetadataModelExportsToTargetResult clone() {
        try {
            return (DescribeMetadataModelExportsToTargetResult) super.clone();
