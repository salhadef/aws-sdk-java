...
public class DescribeMetadataModelExportsAsScriptRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeMetadataModelExportsAsScriptRequest withMigrationProjectIdentifier(String migrationProjectIdentifier) {
    ...
    public DescribeMetadataModelExportsAsScriptRequest withFilters(Filter... filters) {
    ...
    public DescribeMetadataModelExportsAsScriptRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeMetadataModelExportsAsScriptRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public DescribeMetadataModelExportsAsScriptRequest withMaxRecords(Integer maxRecords) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMetadataModelExportsAsScriptRequest == false)
            return false;
        DescribeMetadataModelExportsAsScriptRequest other = (DescribeMetadataModelExportsAsScriptRequest) obj;
    ...
    @Override
    public DescribeMetadataModelExportsAsScriptRequest clone() {
        return (DescribeMetadataModelExportsAsScriptRequest) super.clone();
    }
