...
/**
 * EngineVersion JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EngineVersionJsonUnmarshaller implements Unmarshaller<EngineVersion, JsonUnmarshallerContext> {

    public EngineVersion unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static EngineVersionJsonUnmarshaller instance;

    public static EngineVersionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EngineVersionJsonUnmarshaller();
        return instance;
    }
}
