...
public class DescribeExtensionPackAssociationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name or Amazon Resource Name (ARN) for the migration project.
     */
    ...
    public DescribeExtensionPackAssociationsRequest withMigrationProjectIdentifier(String migrationProjectIdentifier) {
     ...
     * </p>
     * 
     * @return Filters applied to the extension pack associations described in the form of key-value pairs.
     */
    ...
    public DescribeExtensionPackAssociationsRequest withFilters(Filter... filters) {
    ...
    public DescribeExtensionPackAssociationsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeExtensionPackAssociationsRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public DescribeExtensionPackAssociationsRequest withMaxRecords(Integer maxRecords) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeExtensionPackAssociationsRequest == false)
            return false;
        DescribeExtensionPackAssociationsRequest other = (DescribeExtensionPackAssociationsRequest) obj;
    ...
    @Override
    public DescribeExtensionPackAssociationsRequest clone() {
        return (DescribeExtensionPackAssociationsRequest) super.clone();
    }
