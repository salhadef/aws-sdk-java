...
public class DescribeMetadataModelConversionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeMetadataModelConversionsRequest withMigrationProjectIdentifier(String migrationProjectIdentifier) {
     ...
     * </p>
     * 
     * @return Filters applied to the metadata model conversions described in the form of key-value pairs.
     */
    ...
    public DescribeMetadataModelConversionsRequest withFilters(Filter... filters) {
    ...
    public DescribeMetadataModelConversionsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeMetadataModelConversionsRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public DescribeMetadataModelConversionsRequest withMaxRecords(Integer maxRecords) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMetadataModelConversionsRequest == false)
            return false;
        DescribeMetadataModelConversionsRequest other = (DescribeMetadataModelConversionsRequest) obj;
    ...
    @Override
    public DescribeMetadataModelConversionsRequest clone() {
        return (DescribeMetadataModelConversionsRequest) super.clone();
    }
