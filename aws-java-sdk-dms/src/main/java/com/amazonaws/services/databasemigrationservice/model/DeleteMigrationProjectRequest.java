...
public class DeleteMigrationProjectRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name or Amazon Resource Name (ARN) of the migration project to delete.
     */
    ...
    public DeleteMigrationProjectRequest withMigrationProjectIdentifier(String migrationProjectIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteMigrationProjectRequest == false)
            return false;
        DeleteMigrationProjectRequest other = (DeleteMigrationProjectRequest) obj;
    ...
    @Override
    public DeleteMigrationProjectRequest clone() {
        return (DeleteMigrationProjectRequest) super.clone();
    }
