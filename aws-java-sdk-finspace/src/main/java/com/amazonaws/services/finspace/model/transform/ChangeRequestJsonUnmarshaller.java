...
/**
 * ChangeRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChangeRequestJsonUnmarshaller implements Unmarshaller<ChangeRequest, JsonUnmarshallerContext> {

    public ChangeRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ChangeRequestJsonUnmarshaller instance;

    public static ChangeRequestJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ChangeRequestJsonUnmarshaller();
        return instance;
    }
}
