...
public class ListEnvironmentsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * get the next set of pages, pass in the <code>nextToken</code>nextToken value from the response object of the
     * previous page call.
     * </p>
     */
     ...
     *        truncated. To get the next set of pages, pass in the <code>nextToken</code>nextToken value from the
     ...
     * </p>
     * 
     * @return A token generated by FinSpace that specifies where to continue pagination if a previous request was
     *         truncated. To get the next set of pages, pass in the <code>nextToken</code>nextToken value from the
     *         response object of the previous page call.
     */
