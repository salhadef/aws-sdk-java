...
/**
 * KxSavedownStorageConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class KxSavedownStorageConfigurationMarshaller {
    ...
    public static KxSavedownStorageConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(KxSavedownStorageConfiguration kxSavedownStorageConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (kxSavedownStorageConfiguration == null) {
