...
public class VpcConfigurationMarshaller {
    ...
    public void marshall(VpcConfiguration vpcConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(vpcConfiguration.getVpcId(), VPCID_BINDING);
            ...
            protocolMarshaller.marshall(vpcConfiguration.getIpAddressType(), IPADDRESSTYPE_BINDING);
        } catch (Exception e) {
