...
/**
 * DeleteKxDatabaseResult JSON Unmarshaller
 */
...
public class DeleteKxDatabaseResultJsonUnmarshaller implements Unmarshaller<DeleteKxDatabaseResult, JsonUnmarshallerContext> {
    ...
    public DeleteKxDatabaseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteKxDatabaseResult deleteKxDatabaseResult = new DeleteKxDatabaseResult();
