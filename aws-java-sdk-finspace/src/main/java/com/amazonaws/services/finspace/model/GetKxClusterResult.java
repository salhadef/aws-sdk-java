...
public class GetKxClusterResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetKxClusterResult withDatabases(KxDatabaseConfiguration... databases) {
    ...
    public GetKxClusterResult withDatabases(java.util.Collection<KxDatabaseConfiguration> databases) {
    ...
    public GetKxClusterResult withCacheStorageConfigurations(KxCacheStorageConfiguration... cacheStorageConfigurations) {
    ...
    public GetKxClusterResult withCacheStorageConfigurations(java.util.Collection<KxCacheStorageConfiguration> cacheStorageConfigurations) {
    ...
    public GetKxClusterResult withCommandLineArguments(KxCommandLineArgument... commandLineArguments) {
    ...
    public GetKxClusterResult withCommandLineArguments(java.util.Collection<KxCommandLineArgument> commandLineArguments) {
    ...
    public GetKxClusterResult withLastModifiedTimestamp(java.util.Date lastModifiedTimestamp) {
    ...
    public GetKxClusterResult withCreatedTimestamp(java.util.Date createdTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetKxClusterResult == false)
            return false;
        GetKxClusterResult other = (GetKxClusterResult) obj;
    ...
    public GetKxClusterResult clone() {
        try {
            return (GetKxClusterResult) super.clone();
