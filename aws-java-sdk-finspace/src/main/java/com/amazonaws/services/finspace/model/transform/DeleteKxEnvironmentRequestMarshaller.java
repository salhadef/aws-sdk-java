...
@SdkInternalApi
public class DeleteKxEnvironmentRequestMarshaller {
    ...
    public static DeleteKxEnvironmentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteKxEnvironmentRequest deleteKxEnvironmentRequest, ProtocolMarshaller protocolMarshaller) {
