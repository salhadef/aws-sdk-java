...
/**
 * DeleteKxClusterResult JSON Unmarshaller
 */
...
public class DeleteKxClusterResultJsonUnmarshaller implements Unmarshaller<DeleteKxClusterResult, JsonUnmarshallerContext> {
    ...
    public DeleteKxClusterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteKxClusterResult deleteKxClusterResult = new DeleteKxClusterResult();
