...
public class CodeConfigurationMarshaller {
    ...
    public void marshall(CodeConfiguration codeConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(codeConfiguration.getS3Bucket(), S3BUCKET_BINDING);
            protocolMarshaller.marshall(codeConfiguration.getS3Key(), S3KEY_BINDING);
            protocolMarshaller.marshall(codeConfiguration.getS3ObjectVersion(), S3OBJECTVERSION_BINDING);
        } catch (Exception e) {
