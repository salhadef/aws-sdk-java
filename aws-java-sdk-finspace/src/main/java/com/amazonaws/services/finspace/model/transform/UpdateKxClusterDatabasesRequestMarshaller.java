...
/**
 * UpdateKxClusterDatabasesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateKxClusterDatabasesRequestMarshaller {
    ...
    public static UpdateKxClusterDatabasesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateKxClusterDatabasesRequest updateKxClusterDatabasesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateKxClusterDatabasesRequest.getEnvironmentId(), ENVIRONMENTID_BINDING);
