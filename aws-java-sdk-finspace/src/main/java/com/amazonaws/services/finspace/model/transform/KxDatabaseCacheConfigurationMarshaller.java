...
/**
 * KxDatabaseCacheConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class KxDatabaseCacheConfigurationMarshaller {

    private static final MarshallingInfo<String> CACHETYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public static KxDatabaseCacheConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(KxDatabaseCacheConfiguration kxDatabaseCacheConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (kxDatabaseCacheConfiguration == null) {
