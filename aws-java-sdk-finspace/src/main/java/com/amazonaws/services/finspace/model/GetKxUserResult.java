...
public class GetKxUserResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetKxUserResult withUserName(String userName) {
    ...
    public GetKxUserResult withUserArn(String userArn) {
        setUserArn(userArn);
        return this;
    }
    ...
    public GetKxUserResult withEnvironmentId(String environmentId) {
    ...
    public GetKxUserResult withIamRole(String iamRole) {
        setIamRole(iamRole);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetKxUserResult == false)
            return false;
        GetKxUserResult other = (GetKxUserResult) obj;
