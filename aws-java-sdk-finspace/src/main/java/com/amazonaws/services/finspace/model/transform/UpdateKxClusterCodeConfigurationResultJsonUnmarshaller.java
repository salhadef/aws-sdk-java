...
/**
 * UpdateKxClusterCodeConfigurationResult JSON Unmarshaller
 */
...
public class UpdateKxClusterCodeConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateKxClusterCodeConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateKxClusterCodeConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateKxClusterCodeConfigurationResult updateKxClusterCodeConfigurationResult = new UpdateKxClusterCodeConfigurationResult();
