...
/**
 * DeleteKxEnvironmentResult JSON Unmarshaller
 */
...
public class DeleteKxEnvironmentResultJsonUnmarshaller implements Unmarshaller<DeleteKxEnvironmentResult, JsonUnmarshallerContext> {
    ...
    public DeleteKxEnvironmentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteKxEnvironmentResult deleteKxEnvironmentResult = new DeleteKxEnvironmentResult();
