...
public class KxUserMarshaller {
    ...
    private static final KxUserMarshaller instance = new KxUserMarshaller();

    public static KxUserMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(KxUser kxUser, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(kxUser.getUserArn(), USERARN_BINDING);
            protocolMarshaller.marshall(kxUser.getUserName(), USERNAME_BINDING);
            protocolMarshaller.marshall(kxUser.getIamRole(), IAMROLE_BINDING);
            protocolMarshaller.marshall(kxUser.getCreateTimestamp(), CREATETIMESTAMP_BINDING);
            protocolMarshaller.marshall(kxUser.getUpdateTimestamp(), UPDATETIMESTAMP_BINDING);
        } catch (Exception e) {
