...
/**
 * KxNode JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KxNodeJsonUnmarshaller implements Unmarshaller<KxNode, JsonUnmarshallerContext> {

    public KxNode unmarshall(JsonUnmarshallerContext context) throws Exception {
        KxNode kxNode = new KxNode();
    ...
    private static KxNodeJsonUnmarshaller instance;

    public static KxNodeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new KxNodeJsonUnmarshaller();
        return instance;
    }
}
