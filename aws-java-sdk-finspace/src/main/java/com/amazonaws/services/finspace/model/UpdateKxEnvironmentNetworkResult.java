...
public class UpdateKxEnvironmentNetworkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateKxEnvironmentNetworkResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public UpdateKxEnvironmentNetworkResult withEnvironmentId(String environmentId) {
    ...
    public UpdateKxEnvironmentNetworkResult withAwsAccountId(String awsAccountId) {
    ...
    public UpdateKxEnvironmentNetworkResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public UpdateKxEnvironmentNetworkResult withStatus(EnvironmentStatus status) {
    ...
    public UpdateKxEnvironmentNetworkResult withTgwStatus(String tgwStatus) {
    ...
    public UpdateKxEnvironmentNetworkResult withDnsStatus(String dnsStatus) {
    ...
    public UpdateKxEnvironmentNetworkResult withErrorMessage(String errorMessage) {
    ...
    public UpdateKxEnvironmentNetworkResult withDescription(String description) {
    ...
    public UpdateKxEnvironmentNetworkResult withEnvironmentArn(String environmentArn) {
    ...
    public UpdateKxEnvironmentNetworkResult withKmsKeyId(String kmsKeyId) {
    ...
    public UpdateKxEnvironmentNetworkResult withDedicatedServiceAccountId(String dedicatedServiceAccountId) {
    ...
    public UpdateKxEnvironmentNetworkResult withCustomDNSConfiguration(CustomDNSServer... customDNSConfiguration) {
    ...
    public UpdateKxEnvironmentNetworkResult withCustomDNSConfiguration(java.util.Collection<CustomDNSServer> customDNSConfiguration) {
    ...
    public UpdateKxEnvironmentNetworkResult withCreationTimestamp(java.util.Date creationTimestamp) {
    ...
    public UpdateKxEnvironmentNetworkResult withUpdateTimestamp(java.util.Date updateTimestamp) {
    ...
    public UpdateKxEnvironmentNetworkResult withAvailabilityZoneIds(String... availabilityZoneIds) {
    ...
    public UpdateKxEnvironmentNetworkResult withAvailabilityZoneIds(java.util.Collection<String> availabilityZoneIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateKxEnvironmentNetworkResult == false)
            return false;
        UpdateKxEnvironmentNetworkResult other = (UpdateKxEnvironmentNetworkResult) obj;
    ...
    @Override
    public UpdateKxEnvironmentNetworkResult clone() {
        try {
