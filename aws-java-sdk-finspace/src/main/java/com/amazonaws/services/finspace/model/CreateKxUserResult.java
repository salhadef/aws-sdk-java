...
public class CreateKxUserResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateKxUserResult == false)
            return false;
        CreateKxUserResult other = (CreateKxUserResult) obj;
    ...
    public CreateKxUserResult clone() {
        try {
            return (CreateKxUserResult) super.clone();
