...
/**
 * LastRecorderStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LastRecorderStatusJsonUnmarshaller implements Unmarshaller<LastRecorderStatus, JsonUnmarshallerContext> {

    public LastRecorderStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        LastRecorderStatus lastRecorderStatus = new LastRecorderStatus();
    ...
    private static LastRecorderStatusJsonUnmarshaller instance;

    public static LastRecorderStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LastRecorderStatusJsonUnmarshaller();
        return instance;
    }
}
