...
/**
 * CustomRoutingEndpointConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CustomRoutingEndpointConfigurationMarshaller {
    ...
    public static CustomRoutingEndpointConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CustomRoutingEndpointConfiguration customRoutingEndpointConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (customRoutingEndpointConfiguration == null) {
