...
/**
 * DeleteCrossAccountAttachmentResult JSON Unmarshaller
 */
...
public class DeleteCrossAccountAttachmentResultJsonUnmarshaller implements Unmarshaller<DeleteCrossAccountAttachmentResult, JsonUnmarshallerContext> {
    ...
    public DeleteCrossAccountAttachmentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCrossAccountAttachmentResult deleteCrossAccountAttachmentResult = new DeleteCrossAccountAttachmentResult();

        return deleteCrossAccountAttachmentResult;
    }
