...
public class DescribeCrossAccountAttachmentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) for the cross-account attachment to describe.
     */
    ...
    public DescribeCrossAccountAttachmentRequest withAttachmentArn(String attachmentArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeCrossAccountAttachmentRequest == false)
            return false;
        DescribeCrossAccountAttachmentRequest other = (DescribeCrossAccountAttachmentRequest) obj;
    ...
    @Override
    public DescribeCrossAccountAttachmentRequest clone() {
        return (DescribeCrossAccountAttachmentRequest) super.clone();
    }
