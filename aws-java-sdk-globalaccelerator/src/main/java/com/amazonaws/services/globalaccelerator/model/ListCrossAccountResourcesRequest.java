...
public class ListCrossAccountResourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of an accelerator in a cross-account attachment.
     */
    ...
    public void setResourceOwnerAwsAccountId(String resourceOwnerAwsAccountId) {
     ...
     * </p>
     * 
     * @return The account ID of a resource owner in a cross-account attachment.
     */

    public String getResourceOwnerAwsAccountId() {
    ...
    public ListCrossAccountResourcesRequest withResourceOwnerAwsAccountId(String resourceOwnerAwsAccountId) {
        setResourceOwnerAwsAccountId(resourceOwnerAwsAccountId);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getResourceOwnerAwsAccountId() != null)
            sb.append("ResourceOwnerAwsAccountId: ").append(getResourceOwnerAwsAccountId()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCrossAccountResourcesRequest == false)
            return false;
        ListCrossAccountResourcesRequest other = (ListCrossAccountResourcesRequest) obj;
        ...
        if (other.getAcceleratorArn() != null && other.getAcceleratorArn().equals(this.getAcceleratorArn()) == false)
            return false;
        if (other.getResourceOwnerAwsAccountId() == null ^ this.getResourceOwnerAwsAccountId() == null)
            return false;
        if (other.getResourceOwnerAwsAccountId() != null && other.getResourceOwnerAwsAccountId().equals(this.getResourceOwnerAwsAccountId()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getResourceOwnerAwsAccountId() == null) ? 0 : getResourceOwnerAwsAccountId().hashCode());
    ...
    public ListCrossAccountResourcesRequest clone() {
        return (ListCrossAccountResourcesRequest) super.clone();
    }
