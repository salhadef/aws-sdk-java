...
public class UpdateCrossAccountAttachmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the updated cross-account attachment.
     */
    ...
    public UpdateCrossAccountAttachmentResult withCrossAccountAttachment(Attachment crossAccountAttachment) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateCrossAccountAttachmentResult == false)
            return false;
        UpdateCrossAccountAttachmentResult other = (UpdateCrossAccountAttachmentResult) obj;
    ...
    @Override
    public UpdateCrossAccountAttachmentResult clone() {
        try {
            return (UpdateCrossAccountAttachmentResult) super.clone();
