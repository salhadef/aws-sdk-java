...
public class DescribeCrossAccountAttachmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeCrossAccountAttachmentResult withCrossAccountAttachment(Attachment crossAccountAttachment) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeCrossAccountAttachmentResult == false)
            return false;
        DescribeCrossAccountAttachmentResult other = (DescribeCrossAccountAttachmentResult) obj;
    ...
    @Override
    public DescribeCrossAccountAttachmentResult clone() {
        try {
            return (DescribeCrossAccountAttachmentResult) super.clone();
