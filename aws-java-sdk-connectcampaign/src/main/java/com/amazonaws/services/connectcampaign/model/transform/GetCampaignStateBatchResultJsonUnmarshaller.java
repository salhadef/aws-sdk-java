...
/**
 * GetCampaignStateBatchResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetCampaignStateBatchResultJsonUnmarshaller implements Unmarshaller<GetCampaignStateBatchResult, JsonUnmarshallerContext> {

    public GetCampaignStateBatchResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetCampaignStateBatchResult getCampaignStateBatchResult = new GetCampaignStateBatchResult();
    ...
    private static GetCampaignStateBatchResultJsonUnmarshaller instance;

    public static GetCampaignStateBatchResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetCampaignStateBatchResultJsonUnmarshaller();
        return instance;
    }
}
