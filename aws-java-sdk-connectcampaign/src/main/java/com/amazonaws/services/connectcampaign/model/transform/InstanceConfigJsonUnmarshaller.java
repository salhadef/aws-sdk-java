...
/**
 * InstanceConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceConfigJsonUnmarshaller implements Unmarshaller<InstanceConfig, JsonUnmarshallerContext> {

    public InstanceConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static InstanceConfigJsonUnmarshaller instance;

    public static InstanceConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstanceConfigJsonUnmarshaller();
        return instance;
    }
}
