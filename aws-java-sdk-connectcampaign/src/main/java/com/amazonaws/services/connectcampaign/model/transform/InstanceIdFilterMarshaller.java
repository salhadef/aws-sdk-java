...
public class InstanceIdFilterMarshaller {
    ...
    public static InstanceIdFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(InstanceIdFilter instanceIdFilter, ProtocolMarshaller protocolMarshaller) {
