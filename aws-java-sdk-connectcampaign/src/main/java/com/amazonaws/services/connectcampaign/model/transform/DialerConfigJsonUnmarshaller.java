...
/**
 * DialerConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DialerConfigJsonUnmarshaller implements Unmarshaller<DialerConfig, JsonUnmarshallerContext> {

    public DialerConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DialerConfigJsonUnmarshaller instance;

    public static DialerConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DialerConfigJsonUnmarshaller();
        return instance;
    }
}
