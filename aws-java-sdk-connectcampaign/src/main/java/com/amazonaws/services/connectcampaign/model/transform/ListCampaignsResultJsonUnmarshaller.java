    ...
    public ListCampaignsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("campaignSummaryList", targetDepth)) {
                    context.nextToken();
                    listCampaignsResult.setCampaignSummaryList(new ListUnmarshaller<CampaignSummary>(CampaignSummaryJsonUnmarshaller.getInstance())
