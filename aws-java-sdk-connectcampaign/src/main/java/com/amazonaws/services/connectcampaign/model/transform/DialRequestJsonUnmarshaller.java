...
/**
 * DialRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DialRequestJsonUnmarshaller implements Unmarshaller<DialRequest, JsonUnmarshallerContext> {

    public DialRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DialRequestJsonUnmarshaller instance;

    public static DialRequestJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DialRequestJsonUnmarshaller();
        return instance;
    }
}
