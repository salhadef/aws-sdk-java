...
public class GetIntegrationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetIntegrationResult withContentHandlingStrategy(String contentHandlingStrategy) {
    ...
    public GetIntegrationResult withIntegrationType(String integrationType) {
     ...
     *
     * @see GetIntegrationResult#withRequestParameters
     ...
     *
     * @see GetIntegrationResult#withRequestTemplates
     * @returns a reference to this object so that method calls can be chained together.
     */
     ...
     *
     * @see GetIntegrationResult#withResponseParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetIntegrationResult addResponseParametersEntry(String key, java.util.Map<String, String> value) {
    ...
    public GetIntegrationResult clearResponseParametersEntries() {
