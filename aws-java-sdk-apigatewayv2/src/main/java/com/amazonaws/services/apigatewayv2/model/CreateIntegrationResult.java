...
public class CreateIntegrationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateIntegrationResult withConnectionType(String connectionType) {
    ...
    public CreateIntegrationResult withConnectionType(ConnectionType connectionType) {
    ...
    public CreateIntegrationResult withContentHandlingStrategy(String contentHandlingStrategy) {
    ...
    public CreateIntegrationResult withContentHandlingStrategy(ContentHandlingStrategy contentHandlingStrategy) {
    ...
    public CreateIntegrationResult withIntegrationType(String integrationType) {
    ...
    public CreateIntegrationResult withIntegrationType(IntegrationType integrationType) {
    ...
    public CreateIntegrationResult withPassthroughBehavior(String passthroughBehavior) {
    ...
    public CreateIntegrationResult withPassthroughBehavior(PassthroughBehavior passthroughBehavior) {
    ...
    public CreateIntegrationResult clearRequestParametersEntries() {
    ...
    public CreateIntegrationResult clearRequestTemplatesEntries() {
