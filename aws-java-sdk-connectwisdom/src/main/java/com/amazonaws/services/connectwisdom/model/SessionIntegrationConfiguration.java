 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wisdom-2020-10-19/SessionIntegrationConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SessionIntegrationConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public SessionIntegrationConfiguration withTopicIntegrationArn(String topicIntegrationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SessionIntegrationConfiguration == false)
            return false;
        SessionIntegrationConfiguration other = (SessionIntegrationConfiguration) obj;
    ...
    @Override
    public SessionIntegrationConfiguration clone() {
        try {
            return (SessionIntegrationConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connectwisdom.model.transform.SessionIntegrationConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
