...
/**
 * SessionData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SessionDataJsonUnmarshaller implements Unmarshaller<SessionData, JsonUnmarshallerContext> {

    public SessionData unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("sessionArn", targetDepth)) {
                    context.nextToken();
                    sessionData.setSessionArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static SessionDataJsonUnmarshaller instance;

    public static SessionDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SessionDataJsonUnmarshaller();
        return instance;
    }
}
