...
public class DeleteAppVersionAppComponentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteAppVersionAppComponentResult withAppComponent(AppComponent appComponent) {
    ...
    public DeleteAppVersionAppComponentResult withAppVersion(String appVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAppVersionAppComponentResult == false)
            return false;
        DeleteAppVersionAppComponentResult other = (DeleteAppVersionAppComponentResult) obj;
    ...
    @Override
    public DeleteAppVersionAppComponentResult clone() {
        try {
            return (DeleteAppVersionAppComponentResult) super.clone();
