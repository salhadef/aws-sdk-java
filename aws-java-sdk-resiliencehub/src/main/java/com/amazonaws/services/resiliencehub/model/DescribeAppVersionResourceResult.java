...
public class DescribeAppVersionResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeAppVersionResourceResult withAppArn(String appArn) {
        setAppArn(appArn);
        return this;
    }
    ...
    public DescribeAppVersionResourceResult withAppVersion(String appVersion) {
    ...
    public DescribeAppVersionResourceResult withPhysicalResource(PhysicalResource physicalResource) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAppVersionResourceResult == false)
            return false;
        DescribeAppVersionResourceResult other = (DescribeAppVersionResourceResult) obj;
    ...
    @Override
    public DescribeAppVersionResourceResult clone() {
        try {
            return (DescribeAppVersionResourceResult) super.clone();
