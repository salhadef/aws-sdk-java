        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("eventType", targetDepth)) {
                    context.nextToken();
                    eventSubscription.setEventType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    eventSubscription.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
