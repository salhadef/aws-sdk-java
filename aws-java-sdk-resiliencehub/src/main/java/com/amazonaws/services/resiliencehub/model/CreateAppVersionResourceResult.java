...
public class CreateAppVersionResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateAppVersionResourceResult withAppArn(String appArn) {
        setAppArn(appArn);
        return this;
    }
    ...
    public CreateAppVersionResourceResult withAppVersion(String appVersion) {
    ...
    public CreateAppVersionResourceResult withPhysicalResource(PhysicalResource physicalResource) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAppVersionResourceResult == false)
            return false;
        CreateAppVersionResourceResult other = (CreateAppVersionResourceResult) obj;
    ...
    @Override
    public CreateAppVersionResourceResult clone() {
        try {
            return (CreateAppVersionResourceResult) super.clone();
