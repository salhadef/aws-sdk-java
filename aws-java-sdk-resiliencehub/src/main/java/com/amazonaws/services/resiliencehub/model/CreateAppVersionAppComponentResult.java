...
public class CreateAppVersionAppComponentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateAppVersionAppComponentResult withAppArn(String appArn) {
        setAppArn(appArn);
        return this;
    }
    ...
    public CreateAppVersionAppComponentResult withAppComponent(AppComponent appComponent) {
    ...
    public CreateAppVersionAppComponentResult withAppVersion(String appVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAppVersionAppComponentResult == false)
            return false;
        CreateAppVersionAppComponentResult other = (CreateAppVersionAppComponentResult) obj;
    ...
    @Override
    public CreateAppVersionAppComponentResult clone() {
        try {
            return (CreateAppVersionAppComponentResult) super.clone();
