...
/**
 * UpdateRecommendationStatusRequestEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateRecommendationStatusRequestEntryJsonUnmarshaller implements Unmarshaller<UpdateRecommendationStatusRequestEntry, JsonUnmarshallerContext> {

    public UpdateRecommendationStatusRequestEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateRecommendationStatusRequestEntry updateRecommendationStatusRequestEntry = new UpdateRecommendationStatusRequestEntry();
    ...
    private static UpdateRecommendationStatusRequestEntryJsonUnmarshaller instance;

    public static UpdateRecommendationStatusRequestEntryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateRecommendationStatusRequestEntryJsonUnmarshaller();
        return instance;
    }
}
