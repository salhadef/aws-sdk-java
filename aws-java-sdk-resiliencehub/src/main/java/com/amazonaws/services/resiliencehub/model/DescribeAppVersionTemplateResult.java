...
public class DescribeAppVersionTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeAppVersionTemplateResult withAppArn(String appArn) {
        setAppArn(appArn);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getAppTemplateBody() != null)
            sb.append("AppTemplateBody: ").append(getAppTemplateBody()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAppVersionTemplateResult == false)
            return false;
        DescribeAppVersionTemplateResult other = (DescribeAppVersionTemplateResult) obj;
    ...
    public DescribeAppVersionTemplateResult clone() {
        try {
            return (DescribeAppVersionTemplateResult) super.clone();
