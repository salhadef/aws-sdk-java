...
public class ListSuggestedResiliencyPoliciesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListSuggestedResiliencyPoliciesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSuggestedResiliencyPoliciesRequest == false)
            return false;
        ListSuggestedResiliencyPoliciesRequest other = (ListSuggestedResiliencyPoliciesRequest) obj;
    ...
    @Override
    public ListSuggestedResiliencyPoliciesRequest clone() {
        return (ListSuggestedResiliencyPoliciesRequest) super.clone();
    }
