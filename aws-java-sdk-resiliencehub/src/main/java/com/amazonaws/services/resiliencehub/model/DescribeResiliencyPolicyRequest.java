...
public class DescribeResiliencyPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeResiliencyPolicyRequest withPolicyArn(String policyArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeResiliencyPolicyRequest == false)
            return false;
        DescribeResiliencyPolicyRequest other = (DescribeResiliencyPolicyRequest) obj;
    ...
    @Override
    public DescribeResiliencyPolicyRequest clone() {
        return (DescribeResiliencyPolicyRequest) super.clone();
    }
