...
public class UpdateAppVersionAppComponentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAppVersionAppComponentResult withAppArn(String appArn) {
        setAppArn(appArn);
        return this;
    }
    ...
    public UpdateAppVersionAppComponentResult withAppComponent(AppComponent appComponent) {
    ...
    public UpdateAppVersionAppComponentResult withAppVersion(String appVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAppVersionAppComponentResult == false)
            return false;
        UpdateAppVersionAppComponentResult other = (UpdateAppVersionAppComponentResult) obj;
    ...
    @Override
    public UpdateAppVersionAppComponentResult clone() {
        try {
            return (UpdateAppVersionAppComponentResult) super.clone();
