...
/**
 * SopRecommendation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SopRecommendationJsonUnmarshaller implements Unmarshaller<SopRecommendation, JsonUnmarshallerContext> {

    public SopRecommendation unmarshall(JsonUnmarshallerContext context) throws Exception {
        SopRecommendation sopRecommendation = new SopRecommendation();
    ...
    private static SopRecommendationJsonUnmarshaller instance;

    public static SopRecommendationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SopRecommendationJsonUnmarshaller();
        return instance;
    }
}
