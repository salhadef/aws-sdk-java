...
public class ListAppComponentRecommendationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAppComponentRecommendationsRequest withAssessmentArn(String assessmentArn) {
    ...
    public ListAppComponentRecommendationsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAppComponentRecommendationsRequest == false)
            return false;
        ListAppComponentRecommendationsRequest other = (ListAppComponentRecommendationsRequest) obj;
    ...
    @Override
    public ListAppComponentRecommendationsRequest clone() {
        return (ListAppComponentRecommendationsRequest) super.clone();
    }
