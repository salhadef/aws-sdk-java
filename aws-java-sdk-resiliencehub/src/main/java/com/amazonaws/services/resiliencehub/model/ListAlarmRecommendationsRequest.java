...
public class ListAlarmRecommendationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAlarmRecommendationsRequest withAssessmentArn(String assessmentArn) {
    ...
    public ListAlarmRecommendationsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAlarmRecommendationsRequest == false)
            return false;
        ListAlarmRecommendationsRequest other = (ListAlarmRecommendationsRequest) obj;
    ...
    @Override
    public ListAlarmRecommendationsRequest clone() {
        return (ListAlarmRecommendationsRequest) super.clone();
    }
