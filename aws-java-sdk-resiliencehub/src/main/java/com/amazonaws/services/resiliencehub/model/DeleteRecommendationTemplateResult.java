...
public class DeleteRecommendationTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteRecommendationTemplateResult withRecommendationTemplateArn(String recommendationTemplateArn) {
    ...
    public DeleteRecommendationTemplateResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public DeleteRecommendationTemplateResult withStatus(RecommendationTemplateStatus status) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRecommendationTemplateResult == false)
            return false;
        DeleteRecommendationTemplateResult other = (DeleteRecommendationTemplateResult) obj;
    ...
    @Override
    public DeleteRecommendationTemplateResult clone() {
        try {
            return (DeleteRecommendationTemplateResult) super.clone();
