...
/**
 * LoggingConfigurationMetadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LoggingConfigurationMetadataJsonUnmarshaller implements Unmarshaller<LoggingConfigurationMetadata, JsonUnmarshallerContext> {

    public LoggingConfigurationMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        LoggingConfigurationMetadata loggingConfigurationMetadata = new LoggingConfigurationMetadata();
    ...
    private static LoggingConfigurationMetadataJsonUnmarshaller instance;

    public static LoggingConfigurationMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LoggingConfigurationMetadataJsonUnmarshaller();
        return instance;
    }
}
