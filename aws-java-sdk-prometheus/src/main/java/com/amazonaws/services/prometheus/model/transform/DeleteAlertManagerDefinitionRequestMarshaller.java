...
/**
 * DeleteAlertManagerDefinitionRequestMarshaller
 */
...
public class DeleteAlertManagerDefinitionRequestMarshaller {
    ...
    public static DeleteAlertManagerDefinitionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteAlertManagerDefinitionRequest deleteAlertManagerDefinitionRequest, ProtocolMarshaller protocolMarshaller) {

        if (deleteAlertManagerDefinitionRequest == null) {
