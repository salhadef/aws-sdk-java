...
/**
 * ListWorkspacesRequestMarshaller
 */
...
public class ListWorkspacesRequestMarshaller {
    ...
    public static ListWorkspacesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListWorkspacesRequest listWorkspacesRequest, ProtocolMarshaller protocolMarshaller) {

        if (listWorkspacesRequest == null) {
