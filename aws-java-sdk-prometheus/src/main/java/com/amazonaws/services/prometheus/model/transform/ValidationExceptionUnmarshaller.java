...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.prometheus.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.prometheus.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.prometheus.model.ValidationException validationException = new com.amazonaws.services.prometheus.model.ValidationException(null);
