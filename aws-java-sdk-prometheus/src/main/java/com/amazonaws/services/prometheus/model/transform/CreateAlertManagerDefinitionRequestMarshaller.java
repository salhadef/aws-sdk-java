...
public class CreateAlertManagerDefinitionRequestMarshaller {
    ...
    public static CreateAlertManagerDefinitionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateAlertManagerDefinitionRequest createAlertManagerDefinitionRequest, ProtocolMarshaller protocolMarshaller) {

        if (createAlertManagerDefinitionRequest == null) {
