...
/**
 * DeleteRuleGroupsNamespaceRequestMarshaller
 */
...
public class DeleteRuleGroupsNamespaceRequestMarshaller {
    ...
    public static DeleteRuleGroupsNamespaceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteRuleGroupsNamespaceRequest deleteRuleGroupsNamespaceRequest, ProtocolMarshaller protocolMarshaller) {

        if (deleteRuleGroupsNamespaceRequest == null) {
