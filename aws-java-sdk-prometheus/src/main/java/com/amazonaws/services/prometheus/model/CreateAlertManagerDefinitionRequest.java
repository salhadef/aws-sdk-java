...
public class CreateAlertManagerDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateAlertManagerDefinitionRequest withData(java.nio.ByteBuffer data) {
        setData(data);
        return this;
    }
    ...
    @Override
    public CreateAlertManagerDefinitionRequest clone() {
        return (CreateAlertManagerDefinitionRequest) super.clone();
    }
