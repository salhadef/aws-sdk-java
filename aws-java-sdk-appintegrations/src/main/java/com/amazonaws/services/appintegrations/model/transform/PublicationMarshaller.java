...
public class PublicationMarshaller {
    ...
    public void marshall(Publication publication, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(publication.getEvent(), EVENT_BINDING);
            protocolMarshaller.marshall(publication.getSchema(), SCHEMA_BINDING);
            protocolMarshaller.marshall(publication.getDescription(), DESCRIPTION_BINDING);
        } catch (Exception e) {
