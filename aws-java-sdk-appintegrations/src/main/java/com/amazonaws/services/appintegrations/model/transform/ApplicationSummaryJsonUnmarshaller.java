        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Namespace", targetDepth)) {
                    context.nextToken();
                    applicationSummary.setNamespace(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("LastModifiedTime", targetDepth)) {
                    context.nextToken();
                    applicationSummary.setLastModifiedTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
