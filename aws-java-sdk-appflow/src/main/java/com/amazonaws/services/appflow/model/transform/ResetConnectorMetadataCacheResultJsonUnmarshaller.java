...
/**
 * ResetConnectorMetadataCacheResult JSON Unmarshaller
 */
...
public class ResetConnectorMetadataCacheResultJsonUnmarshaller implements Unmarshaller<ResetConnectorMetadataCacheResult, JsonUnmarshallerContext> {
    ...
    public ResetConnectorMetadataCacheResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResetConnectorMetadataCacheResult resetConnectorMetadataCacheResult = new ResetConnectorMetadataCacheResult();

        return resetConnectorMetadataCacheResult;
    }
