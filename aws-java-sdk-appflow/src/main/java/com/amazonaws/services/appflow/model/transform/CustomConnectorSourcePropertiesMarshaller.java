...
/**
 * CustomConnectorSourcePropertiesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CustomConnectorSourcePropertiesMarshaller {
    ...
    public static CustomConnectorSourcePropertiesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CustomConnectorSourceProperties customConnectorSourceProperties, ProtocolMarshaller protocolMarshaller) {

        if (customConnectorSourceProperties == null) {
