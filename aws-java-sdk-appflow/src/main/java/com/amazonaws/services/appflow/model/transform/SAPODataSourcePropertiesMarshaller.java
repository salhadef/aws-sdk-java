...
/**
 * SAPODataSourcePropertiesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SAPODataSourcePropertiesMarshaller {
    ...
    public static SAPODataSourcePropertiesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SAPODataSourceProperties sAPODataSourceProperties, ProtocolMarshaller protocolMarshaller) {

        if (sAPODataSourceProperties == null) {
