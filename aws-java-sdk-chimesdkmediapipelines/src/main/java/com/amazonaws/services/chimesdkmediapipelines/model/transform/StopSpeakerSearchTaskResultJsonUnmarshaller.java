...
/**
 * StopSpeakerSearchTaskResult JSON Unmarshaller
 */
...
public class StopSpeakerSearchTaskResultJsonUnmarshaller implements Unmarshaller<StopSpeakerSearchTaskResult, JsonUnmarshallerContext> {
    ...
    public StopSpeakerSearchTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopSpeakerSearchTaskResult stopSpeakerSearchTaskResult = new StopSpeakerSearchTaskResult();

        return stopSpeakerSearchTaskResult;
    }
