...
public class UpdateMediaPipelineKinesisVideoStreamPoolResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public UpdateMediaPipelineKinesisVideoStreamPoolResult withKinesisVideoStreamPoolConfiguration(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMediaPipelineKinesisVideoStreamPoolResult == false)
            return false;
        UpdateMediaPipelineKinesisVideoStreamPoolResult other = (UpdateMediaPipelineKinesisVideoStreamPoolResult) obj;
    ...
    @Override
    public UpdateMediaPipelineKinesisVideoStreamPoolResult clone() {
        try {
            return (UpdateMediaPipelineKinesisVideoStreamPoolResult) super.clone();
