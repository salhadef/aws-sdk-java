...
public class MediaStreamSinkMarshaller {
    ...
    private static final MarshallingInfo<Integer> RESERVEDSTREAMCAPACITY_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ReservedStreamCapacity").build();
