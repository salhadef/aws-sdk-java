...
public class CreateMediaStreamPipelineRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The data sources for the media pipeline.
     */
    ...
    public CreateMediaStreamPipelineRequest withSources(MediaStreamSource... sources) {
    ...
    public CreateMediaStreamPipelineRequest withSources(java.util.Collection<MediaStreamSource> sources) {
        setSources(sources);
        return this;
    }
     ...
     * </p>
     * 
     * @return The data sink for the media pipeline.
     */
    ...
    public CreateMediaStreamPipelineRequest withSinks(MediaStreamSink... sinks) {
        if (this.sinks == null) {
    ...
    public CreateMediaStreamPipelineRequest withSinks(java.util.Collection<MediaStreamSink> sinks) {
        setSinks(sinks);
        return this;
    }
     ...
     * </p>
     * 
     * @return The tags assigned to the media pipeline.
     */
    ...
    public CreateMediaStreamPipelineRequest withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public CreateMediaStreamPipelineRequest withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMediaStreamPipelineRequest == false)
            return false;
        CreateMediaStreamPipelineRequest other = (CreateMediaStreamPipelineRequest) obj;
    ...
    public CreateMediaStreamPipelineRequest clone() {
        return (CreateMediaStreamPipelineRequest) super.clone();
    }
