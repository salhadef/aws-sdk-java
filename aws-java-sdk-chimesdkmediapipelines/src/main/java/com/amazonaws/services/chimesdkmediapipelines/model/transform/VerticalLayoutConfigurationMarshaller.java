...
/**
 * VerticalLayoutConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VerticalLayoutConfigurationMarshaller {
    ...
    private static final VerticalLayoutConfigurationMarshaller instance = new VerticalLayoutConfigurationMarshaller();

    public static VerticalLayoutConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VerticalLayoutConfiguration verticalLayoutConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(verticalLayoutConfiguration.getTileOrder(), TILEORDER_BINDING);
            protocolMarshaller.marshall(verticalLayoutConfiguration.getTilePosition(), TILEPOSITION_BINDING);
            protocolMarshaller.marshall(verticalLayoutConfiguration.getTileCount(), TILECOUNT_BINDING);
            protocolMarshaller.marshall(verticalLayoutConfiguration.getTileAspectRatio(), TILEASPECTRATIO_BINDING);
        } catch (Exception e) {
