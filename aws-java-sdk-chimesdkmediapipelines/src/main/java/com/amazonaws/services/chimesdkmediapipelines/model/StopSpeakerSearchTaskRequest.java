...
public class StopSpeakerSearchTaskRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StopSpeakerSearchTaskRequest withIdentifier(String identifier) {
    ...
    public StopSpeakerSearchTaskRequest withSpeakerSearchTaskId(String speakerSearchTaskId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopSpeakerSearchTaskRequest == false)
            return false;
        StopSpeakerSearchTaskRequest other = (StopSpeakerSearchTaskRequest) obj;
    ...
    @Override
    public StopSpeakerSearchTaskRequest clone() {
        return (StopSpeakerSearchTaskRequest) super.clone();
    }
