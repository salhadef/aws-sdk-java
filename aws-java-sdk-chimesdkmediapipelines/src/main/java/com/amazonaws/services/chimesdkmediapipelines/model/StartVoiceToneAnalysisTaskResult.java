...
public class StartVoiceToneAnalysisTaskResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartVoiceToneAnalysisTaskResult withVoiceToneAnalysisTask(VoiceToneAnalysisTask voiceToneAnalysisTask) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartVoiceToneAnalysisTaskResult == false)
            return false;
        StartVoiceToneAnalysisTaskResult other = (StartVoiceToneAnalysisTaskResult) obj;
    ...
    @Override
    public StartVoiceToneAnalysisTaskResult clone() {
        try {
            return (StartVoiceToneAnalysisTaskResult) super.clone();
