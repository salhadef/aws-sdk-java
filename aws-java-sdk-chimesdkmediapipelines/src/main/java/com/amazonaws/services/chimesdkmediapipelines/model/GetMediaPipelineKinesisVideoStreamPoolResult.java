...
public class GetMediaPipelineKinesisVideoStreamPoolResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetMediaPipelineKinesisVideoStreamPoolResult withKinesisVideoStreamPoolConfiguration(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMediaPipelineKinesisVideoStreamPoolResult == false)
            return false;
        GetMediaPipelineKinesisVideoStreamPoolResult other = (GetMediaPipelineKinesisVideoStreamPoolResult) obj;
    ...
    @Override
    public GetMediaPipelineKinesisVideoStreamPoolResult clone() {
        try {
            return (GetMediaPipelineKinesisVideoStreamPoolResult) super.clone();
