...
public class DisableUserResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableUserResult == false)
            return false;
        DisableUserResult other = (DisableUserResult) obj;
    ...
    public DisableUserResult clone() {
        try {
            return (DisableUserResult) super.clone();
