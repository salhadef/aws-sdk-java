...
public class EnableUserResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableUserResult == false)
            return false;
        EnableUserResult other = (EnableUserResult) obj;
    ...
    public EnableUserResult clone() {
        try {
            return (EnableUserResult) super.clone();
