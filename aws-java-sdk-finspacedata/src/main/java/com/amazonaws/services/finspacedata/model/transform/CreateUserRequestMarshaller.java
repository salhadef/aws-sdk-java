...
public class CreateUserRequestMarshaller {
    ...
    public void marshall(CreateUserRequest createUserRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createUserRequest.getType(), TYPE_BINDING);
            ...
            protocolMarshaller.marshall(createUserRequest.getApiAccess(), APIACCESS_BINDING);
            protocolMarshaller.marshall(createUserRequest.getApiAccessPrincipalArn(), APIACCESSPRINCIPALARN_BINDING);
