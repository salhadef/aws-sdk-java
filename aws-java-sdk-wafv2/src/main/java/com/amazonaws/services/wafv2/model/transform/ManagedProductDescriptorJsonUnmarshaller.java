...
/**
 * ManagedProductDescriptor JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ManagedProductDescriptorJsonUnmarshaller implements Unmarshaller<ManagedProductDescriptor, JsonUnmarshallerContext> {

    public ManagedProductDescriptor unmarshall(JsonUnmarshallerContext context) throws Exception {
        ManagedProductDescriptor managedProductDescriptor = new ManagedProductDescriptor();
    ...
    private static ManagedProductDescriptorJsonUnmarshaller instance;

    public static ManagedProductDescriptorJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ManagedProductDescriptorJsonUnmarshaller();
        return instance;
    }
}
