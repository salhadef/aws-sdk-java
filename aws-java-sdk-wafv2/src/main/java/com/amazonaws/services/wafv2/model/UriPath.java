...
public class UriPath implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UriPath == false)
            return false;
    ...
    @Override
    public UriPath clone() {
        try {
            return (UriPath) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.wafv2.model.transform.UriPathMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
