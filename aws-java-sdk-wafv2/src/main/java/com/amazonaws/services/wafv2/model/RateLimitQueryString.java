...
/**
 * <p>
 * Specifies the request's query string as an aggregate key for a rate-based rule. Each distinct string contributes to
 * the aggregation instance. If you use just the query string as your custom key, then each string fully defines an
 * aggregation instance.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wafv2-2019-07-29/RateLimitQueryString" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RateLimitQueryString implements Serializable, Cloneable, StructuredPojo {
    ...
    public RateLimitQueryString withTextTransformations(TextTransformation... textTransformations) {
    ...
    public RateLimitQueryString withTextTransformations(java.util.Collection<TextTransformation> textTransformations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RateLimitQueryString == false)
            return false;
        RateLimitQueryString other = (RateLimitQueryString) obj;
    ...
    @Override
    public RateLimitQueryString clone() {
        try {
            return (RateLimitQueryString) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.wafv2.model.transform.RateLimitQueryStringMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
