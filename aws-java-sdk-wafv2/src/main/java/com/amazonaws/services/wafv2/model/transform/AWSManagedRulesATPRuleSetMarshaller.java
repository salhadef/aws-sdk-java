...
@SdkInternalApi
public class AWSManagedRulesATPRuleSetMarshaller {
    ...
    public static AWSManagedRulesATPRuleSetMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AWSManagedRulesATPRuleSet aWSManagedRulesATPRuleSet, ProtocolMarshaller protocolMarshaller) {
