...
public class DescribeAllManagedProductsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeAllManagedProductsRequest withScope(String scope) {
        setScope(scope);
        return this;
    }
    ...
    public DescribeAllManagedProductsRequest withScope(Scope scope) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAllManagedProductsRequest == false)
            return false;
        DescribeAllManagedProductsRequest other = (DescribeAllManagedProductsRequest) obj;
    ...
    @Override
    public DescribeAllManagedProductsRequest clone() {
        return (DescribeAllManagedProductsRequest) super.clone();
    }
