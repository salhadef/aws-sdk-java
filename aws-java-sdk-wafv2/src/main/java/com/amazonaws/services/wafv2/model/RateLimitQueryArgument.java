...
/**
 * <p>
 * Specifies a query argument in the request as an aggregate key for a rate-based rule. Each distinct value for the
 * named query argument contributes to the aggregation instance. If you use a single query argument as your custom key,
 * then each value fully defines an aggregation instance.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wafv2-2019-07-29/RateLimitQueryArgument" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RateLimitQueryArgument implements Serializable, Cloneable, StructuredPojo {
    ...
    public RateLimitQueryArgument withName(String name) {
        setName(name);
        return this;
    }
    ...
    public RateLimitQueryArgument withTextTransformations(TextTransformation... textTransformations) {
    ...
    public RateLimitQueryArgument withTextTransformations(java.util.Collection<TextTransformation> textTransformations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RateLimitQueryArgument == false)
            return false;
        RateLimitQueryArgument other = (RateLimitQueryArgument) obj;
    ...
    @Override
    public RateLimitQueryArgument clone() {
        try {
            return (RateLimitQueryArgument) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.wafv2.model.transform.RateLimitQueryArgumentMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
