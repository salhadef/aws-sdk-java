...
public class QueryString implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof QueryString == false)
            return false;
    ...
    public QueryString clone() {
        try {
            return (QueryString) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.wafv2.model.transform.QueryStringMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
