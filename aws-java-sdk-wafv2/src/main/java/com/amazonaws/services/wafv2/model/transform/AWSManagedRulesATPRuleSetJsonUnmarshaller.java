...
/**
 * AWSManagedRulesATPRuleSet JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AWSManagedRulesATPRuleSetJsonUnmarshaller implements Unmarshaller<AWSManagedRulesATPRuleSet, JsonUnmarshallerContext> {

    public AWSManagedRulesATPRuleSet unmarshall(JsonUnmarshallerContext context) throws Exception {
        AWSManagedRulesATPRuleSet aWSManagedRulesATPRuleSet = new AWSManagedRulesATPRuleSet();
    ...
    private static AWSManagedRulesATPRuleSetJsonUnmarshaller instance;

    public static AWSManagedRulesATPRuleSetJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AWSManagedRulesATPRuleSetJsonUnmarshaller();
        return instance;
    }
}
