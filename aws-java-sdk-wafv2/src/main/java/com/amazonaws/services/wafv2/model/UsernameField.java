...
public class UsernameField implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UsernameField == false)
            return false;
        UsernameField other = (UsernameField) obj;
    ...
    public UsernameField clone() {
        try {
            return (UsernameField) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.wafv2.model.transform.UsernameFieldMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
