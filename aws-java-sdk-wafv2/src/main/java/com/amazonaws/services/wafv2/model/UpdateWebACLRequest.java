...
public class UpdateWebACLRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateWebACLRequest withCustomResponseBodies(java.util.Map<String, CustomResponseBody> customResponseBodies) {
     ...
     *
     * @see UpdateWebACLRequest#withCustomResponseBodies
    ...
    public UpdateWebACLRequest withTokenDomains(String... tokenDomains) {
    ...
    public UpdateWebACLRequest withTokenDomains(java.util.Collection<String> tokenDomains) {
