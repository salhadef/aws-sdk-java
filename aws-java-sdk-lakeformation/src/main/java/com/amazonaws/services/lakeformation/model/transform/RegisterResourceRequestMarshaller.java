...
/**
 * RegisterResourceRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RegisterResourceRequestMarshaller {

    private static final MarshallingInfo<String> RESOURCEARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ResourceArn").build();
    private static final MarshallingInfo<Boolean> USESERVICELINKEDROLE_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
    ...
    public static RegisterResourceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RegisterResourceRequest registerResourceRequest, ProtocolMarshaller protocolMarshaller) {
