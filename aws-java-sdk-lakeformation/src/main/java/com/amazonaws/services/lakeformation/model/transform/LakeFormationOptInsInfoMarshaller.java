...
/**
 * LakeFormationOptInsInfoMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LakeFormationOptInsInfoMarshaller {
    ...
    private static final LakeFormationOptInsInfoMarshaller instance = new LakeFormationOptInsInfoMarshaller();

    public static LakeFormationOptInsInfoMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LakeFormationOptInsInfo lakeFormationOptInsInfo, ProtocolMarshaller protocolMarshaller) {

        if (lakeFormationOptInsInfo == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(lakeFormationOptInsInfo.getResource(), RESOURCE_BINDING);
            protocolMarshaller.marshall(lakeFormationOptInsInfo.getPrincipal(), PRINCIPAL_BINDING);
            protocolMarshaller.marshall(lakeFormationOptInsInfo.getLastModified(), LASTMODIFIED_BINDING);
            protocolMarshaller.marshall(lakeFormationOptInsInfo.getLastUpdatedBy(), LASTUPDATEDBY_BINDING);
        } catch (Exception e) {
