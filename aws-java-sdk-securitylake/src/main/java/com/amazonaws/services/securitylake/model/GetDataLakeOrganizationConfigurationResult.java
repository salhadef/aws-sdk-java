...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securitylake-2018-05-10/GetDataLakeOrganizationConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetDataLakeOrganizationConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetDataLakeOrganizationConfigurationResult withAutoEnableNewAccount(DataLakeAutoEnableNewAccountConfiguration... autoEnableNewAccount) {
    ...
    public GetDataLakeOrganizationConfigurationResult withAutoEnableNewAccount(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDataLakeOrganizationConfigurationResult == false)
            return false;
        GetDataLakeOrganizationConfigurationResult other = (GetDataLakeOrganizationConfigurationResult) obj;
    ...
    @Override
    public GetDataLakeOrganizationConfigurationResult clone() {
        try {
            return (GetDataLakeOrganizationConfigurationResult) super.clone();
