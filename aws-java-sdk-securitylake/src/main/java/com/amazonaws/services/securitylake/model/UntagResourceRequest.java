...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A list of one or more tag keys. For each value in the list, specify the tag key for a tag to remove from the
     * Amazon Security Lake resource.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the Amazon Security Lake resource to remove one or more tags from.
     */
     ...
     * </p>
     * 
     * @return A list of one or more tag keys. For each value in the list, specify the tag key for a tag to remove from
     ...
     * 
     * @param tagKeys
     *        A list of one or more tag keys. For each value in the list, specify the tag key for a tag to remove from
     *        the Amazon Security Lake resource.
     */
