...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.securitylake.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.securitylake.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.securitylake.model.ConflictException conflictException = new com.amazonaws.services.securitylake.model.ConflictException(null);
