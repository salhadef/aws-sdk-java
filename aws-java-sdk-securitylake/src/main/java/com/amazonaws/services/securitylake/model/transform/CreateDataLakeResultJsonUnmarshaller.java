...
/**
 * CreateDataLakeResult JSON Unmarshaller
 */
...
public class CreateDataLakeResultJsonUnmarshaller implements Unmarshaller<CreateDataLakeResult, JsonUnmarshallerContext> {
    ...
    public CreateDataLakeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateDataLakeResult createDataLakeResult = new CreateDataLakeResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("dataLakes", targetDepth)) {
                    context.nextToken();
                    createDataLakeResult.setDataLakes(new ListUnmarshaller<DataLakeResource>(DataLakeResourceJsonUnmarshaller.getInstance())
