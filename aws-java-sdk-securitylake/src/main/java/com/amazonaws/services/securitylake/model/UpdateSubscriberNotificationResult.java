...
public class UpdateSubscriberNotificationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateSubscriberNotificationResult withSubscriberEndpoint(String subscriberEndpoint) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSubscriberNotificationResult == false)
            return false;
        UpdateSubscriberNotificationResult other = (UpdateSubscriberNotificationResult) obj;
    ...
    @Override
    public UpdateSubscriberNotificationResult clone() {
        try {
            return (UpdateSubscriberNotificationResult) super.clone();
