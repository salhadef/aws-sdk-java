...
public class UpdateDataLakeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateDataLakeResult withDataLakes(DataLakeResource... dataLakes) {
    ...
    public UpdateDataLakeResult withDataLakes(java.util.Collection<DataLakeResource> dataLakes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDataLakeResult == false)
            return false;
        UpdateDataLakeResult other = (UpdateDataLakeResult) obj;
    ...
    public UpdateDataLakeResult clone() {
        try {
            return (UpdateDataLakeResult) super.clone();
