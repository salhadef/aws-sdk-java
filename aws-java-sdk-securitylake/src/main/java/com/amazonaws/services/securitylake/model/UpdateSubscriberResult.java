...
public class UpdateSubscriberResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateSubscriberResult withSubscriber(SubscriberResource subscriber) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSubscriberResult == false)
            return false;
        UpdateSubscriberResult other = (UpdateSubscriberResult) obj;
    ...
    @Override
    public UpdateSubscriberResult clone() {
        try {
            return (UpdateSubscriberResult) super.clone();
