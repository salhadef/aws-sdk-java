...
/**
 * UpdateDataLakeResult JSON Unmarshaller
 */
...
public class UpdateDataLakeResultJsonUnmarshaller implements Unmarshaller<UpdateDataLakeResult, JsonUnmarshallerContext> {
    ...
    public UpdateDataLakeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDataLakeResult updateDataLakeResult = new UpdateDataLakeResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("dataLakes", targetDepth)) {
                    context.nextToken();
                    updateDataLakeResult.setDataLakes(new ListUnmarshaller<DataLakeResource>(DataLakeResourceJsonUnmarshaller.getInstance())
