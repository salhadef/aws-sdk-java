...
/**
 * DeleteDataLakeResult JSON Unmarshaller
 */
...
public class DeleteDataLakeResultJsonUnmarshaller implements Unmarshaller<DeleteDataLakeResult, JsonUnmarshallerContext> {
    ...
    public DeleteDataLakeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDataLakeResult deleteDataLakeResult = new DeleteDataLakeResult();
