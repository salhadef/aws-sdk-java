...
/**
 * DeleteSubscriberNotificationResult JSON Unmarshaller
 */
...
public class DeleteSubscriberNotificationResultJsonUnmarshaller implements Unmarshaller<DeleteSubscriberNotificationResult, JsonUnmarshallerContext> {
    ...
    public DeleteSubscriberNotificationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSubscriberNotificationResult deleteSubscriberNotificationResult = new DeleteSubscriberNotificationResult();
