...
/**
 * AwsLogSourceConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AwsLogSourceConfigurationMarshaller {
    ...
    private static final AwsLogSourceConfigurationMarshaller instance = new AwsLogSourceConfigurationMarshaller();

    public static AwsLogSourceConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AwsLogSourceConfiguration awsLogSourceConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (awsLogSourceConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(awsLogSourceConfiguration.getAccounts(), ACCOUNTS_BINDING);
            protocolMarshaller.marshall(awsLogSourceConfiguration.getRegions(), REGIONS_BINDING);
            protocolMarshaller.marshall(awsLogSourceConfiguration.getSourceName(), SOURCENAME_BINDING);
            protocolMarshaller.marshall(awsLogSourceConfiguration.getSourceVersion(), SOURCEVERSION_BINDING);
        } catch (Exception e) {
