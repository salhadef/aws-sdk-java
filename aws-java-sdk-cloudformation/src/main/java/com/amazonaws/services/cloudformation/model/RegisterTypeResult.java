...
public class RegisterTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public RegisterTypeResult clone() {
        try {
            return (RegisterTypeResult) super.clone();
