...
/**
 * Warnings StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WarningsStaxUnmarshaller implements Unmarshaller<Warnings, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("UnrecognizedResourceTypes/member", targetDepth)) {
                    warnings.withUnrecognizedResourceTypes(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
