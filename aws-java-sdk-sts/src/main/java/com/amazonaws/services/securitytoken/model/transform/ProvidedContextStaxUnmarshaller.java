...
/**
 * ProvidedContext StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProvidedContextStaxUnmarshaller implements Unmarshaller<ProvidedContext, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ProviderArn", targetDepth)) {
                    providedContext.setProviderArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ContextAssertion", targetDepth)) {
                    providedContext.setContextAssertion(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
