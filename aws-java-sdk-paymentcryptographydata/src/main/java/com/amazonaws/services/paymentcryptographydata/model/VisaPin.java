 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/VisaPin" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VisaPin implements Serializable, Cloneable, StructuredPojo {
    ...
    public VisaPin withPinVerificationKeyIndex(Integer pinVerificationKeyIndex) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VisaPin == false)
            return false;
    ...
    @Override
    public VisaPin clone() {
        try {
            return (VisaPin) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.paymentcryptographydata.model.transform.VisaPinMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
