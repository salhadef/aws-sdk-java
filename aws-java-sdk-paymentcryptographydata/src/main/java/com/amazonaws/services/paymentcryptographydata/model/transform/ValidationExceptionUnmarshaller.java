...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.paymentcryptographydata.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.paymentcryptographydata.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.paymentcryptographydata.model.ValidationException validationException = new com.amazonaws.services.paymentcryptographydata.model.ValidationException(
                null);
