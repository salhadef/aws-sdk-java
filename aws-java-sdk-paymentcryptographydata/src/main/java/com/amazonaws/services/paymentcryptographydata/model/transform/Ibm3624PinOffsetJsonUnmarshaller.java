...
/**
 * Ibm3624PinOffset JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Ibm3624PinOffsetJsonUnmarshaller implements Unmarshaller<Ibm3624PinOffset, JsonUnmarshallerContext> {

    public Ibm3624PinOffset unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static Ibm3624PinOffsetJsonUnmarshaller instance;

    public static Ibm3624PinOffsetJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new Ibm3624PinOffsetJsonUnmarshaller();
        return instance;
    }
}
