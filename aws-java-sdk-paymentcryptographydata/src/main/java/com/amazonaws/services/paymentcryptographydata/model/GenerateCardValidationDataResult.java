...
public class GenerateCardValidationDataResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GenerateCardValidationDataResult withKeyArn(String keyArn) {
        setKeyArn(keyArn);
        return this;
    }
     ...
     * </p>
     * 
     * @return The CVV or CSC value that Amazon Web Services Payment Cryptography generates for the card.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GenerateCardValidationDataResult == false)
            return false;
        GenerateCardValidationDataResult other = (GenerateCardValidationDataResult) obj;
    ...
    @Override
    public GenerateCardValidationDataResult clone() {
        try {
            return (GenerateCardValidationDataResult) super.clone();
