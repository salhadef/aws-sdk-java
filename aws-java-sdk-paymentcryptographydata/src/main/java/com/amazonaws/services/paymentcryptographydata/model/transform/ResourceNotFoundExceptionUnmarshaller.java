...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.paymentcryptographydata.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.paymentcryptographydata.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.paymentcryptographydata.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.paymentcryptographydata.model.ResourceNotFoundException(
                null);
