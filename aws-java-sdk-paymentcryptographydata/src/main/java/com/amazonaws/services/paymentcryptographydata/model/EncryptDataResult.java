...
public class EncryptDataResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public EncryptDataResult withKeyArn(String keyArn) {
        setKeyArn(keyArn);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EncryptDataResult == false)
            return false;
        EncryptDataResult other = (EncryptDataResult) obj;
    ...
    public EncryptDataResult clone() {
        try {
            return (EncryptDataResult) super.clone();
