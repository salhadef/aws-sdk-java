...
/**
 * DukptDerivationAttributesMarshaller
 */
...
public class DukptDerivationAttributesMarshaller {
    ...
    public static DukptDerivationAttributesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DukptDerivationAttributes dukptDerivationAttributes, ProtocolMarshaller protocolMarshaller) {

        if (dukptDerivationAttributes == null) {
