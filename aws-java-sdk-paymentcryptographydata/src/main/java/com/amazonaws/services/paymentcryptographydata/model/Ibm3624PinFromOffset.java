 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-data-2022-02-03/Ibm3624PinFromOffset"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Ibm3624PinFromOffset implements Serializable, Cloneable, StructuredPojo {
    ...
    public Ibm3624PinFromOffset withDecimalizationTable(String decimalizationTable) {
    ...
    public Ibm3624PinFromOffset withPinOffset(String pinOffset) {
    ...
    public Ibm3624PinFromOffset withPinValidationData(String pinValidationData) {
    ...
    public Ibm3624PinFromOffset withPinValidationDataPadCharacter(String pinValidationDataPadCharacter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Ibm3624PinFromOffset == false)
            return false;
        Ibm3624PinFromOffset other = (Ibm3624PinFromOffset) obj;
    ...
    @Override
    public Ibm3624PinFromOffset clone() {
        try {
            return (Ibm3624PinFromOffset) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.paymentcryptographydata.model.transform.Ibm3624PinFromOffsetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
