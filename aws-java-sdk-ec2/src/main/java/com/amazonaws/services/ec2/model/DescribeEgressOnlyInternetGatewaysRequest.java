...
public class DescribeEgressOnlyInternetGatewaysRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
    ...
    public DescribeEgressOnlyInternetGatewaysRequest withFilters(Filter... filters) {
    ...
    public DescribeEgressOnlyInternetGatewaysRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
