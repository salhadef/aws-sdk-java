...
/**
 * CreateVerifiedAccessGroupRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateVerifiedAccessGroupRequestMarshaller implements Marshaller<Request<CreateVerifiedAccessGroupRequest>, CreateVerifiedAccessGroupRequest> {
    ...
    public Request<CreateVerifiedAccessGroupRequest> marshall(CreateVerifiedAccessGroupRequest createVerifiedAccessGroupRequest) {
        ...
        Request<CreateVerifiedAccessGroupRequest> request = new DefaultRequest<CreateVerifiedAccessGroupRequest>(createVerifiedAccessGroupRequest, "AmazonEC2");
        ...
        com.amazonaws.internal.SdkInternalList<TagSpecification> createVerifiedAccessGroupRequestTagSpecificationsList = (com.amazonaws.internal.SdkInternalList<TagSpecification>) createVerifiedAccessGroupRequest
                .getTagSpecifications();
        if (!createVerifiedAccessGroupRequestTagSpecificationsList.isEmpty() || !createVerifiedAccessGroupRequestTagSpecificationsList.isAutoConstruct()) {
            ...
            for (TagSpecification createVerifiedAccessGroupRequestTagSpecificationsListValue : createVerifiedAccessGroupRequestTagSpecificationsList) {
                ...
                if (createVerifiedAccessGroupRequestTagSpecificationsListValue.getResourceType() != null) {
                    request.addParameter("TagSpecification." + tagSpecificationsListIndex + ".ResourceType",
                            StringUtils.fromString(createVerifiedAccessGroupRequestTagSpecificationsListValue.getResourceType()));
                }

                com.amazonaws.internal.SdkInternalList<Tag> tagSpecificationTagsList = (com.amazonaws.internal.SdkInternalList<Tag>) createVerifiedAccessGroupRequestTagSpecificationsListValue
                        .getTags();
