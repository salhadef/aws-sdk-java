...
public class EnableImageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public EnableImageResult withReturn(Boolean returnValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableImageResult == false)
            return false;
        EnableImageResult other = (EnableImageResult) obj;
    ...
    @Override
    public EnableImageResult clone() {
        try {
            return (EnableImageResult) super.clone();
