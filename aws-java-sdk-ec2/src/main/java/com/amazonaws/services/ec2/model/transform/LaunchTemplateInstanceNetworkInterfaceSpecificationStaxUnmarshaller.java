        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("interfaceType", targetDepth)) {
                    launchTemplateInstanceNetworkInterfaceSpecification.setInterfaceType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("primaryIpv6", targetDepth)) {
                    launchTemplateInstanceNetworkInterfaceSpecification.setPrimaryIpv6(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
