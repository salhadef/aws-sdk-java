...
public class VpnTunnelOptionsSpecification implements Serializable, Cloneable {
    ...
    public VpnTunnelOptionsSpecification withPhase1IntegrityAlgorithms(java.util.Collection<Phase1IntegrityAlgorithmsRequestListValue> phase1IntegrityAlgorithms) {
    ...
    public VpnTunnelOptionsSpecification withPhase2IntegrityAlgorithms(java.util.Collection<Phase2IntegrityAlgorithmsRequestListValue> phase2IntegrityAlgorithms) {
    ...
    public VpnTunnelOptionsSpecification withPhase1DHGroupNumbers(java.util.Collection<Phase1DHGroupNumbersRequestListValue> phase1DHGroupNumbers) {
    ...
    public VpnTunnelOptionsSpecification withPhase2DHGroupNumbers(java.util.Collection<Phase2DHGroupNumbersRequestListValue> phase2DHGroupNumbers) {
    ...
    public VpnTunnelOptionsSpecification withIKEVersions(java.util.Collection<IKEVersionsRequestListValue> iKEVersions) {
