...
class StoreImageTaskComplete {
    ...
    static class IsCompletedMatcher extends WaiterAcceptor<DescribeStoreImageTasksResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("StoreImageTaskResults")),
                new JmesPathField("StoreTaskState"));
         ...
         */
        @Override
        public boolean matches(DescribeStoreImageTasksResult result) {
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeStoreImageTasksResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsInProgressMatcher extends WaiterAcceptor<DescribeStoreImageTasksResult> {
        private static final JsonNode expectedResult;
