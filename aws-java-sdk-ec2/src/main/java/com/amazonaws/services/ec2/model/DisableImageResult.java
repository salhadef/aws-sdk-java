...
public class DisableImageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisableImageResult withReturn(Boolean returnValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableImageResult == false)
            return false;
        DisableImageResult other = (DisableImageResult) obj;
    ...
    @Override
    public DisableImageResult clone() {
        try {
            return (DisableImageResult) super.clone();
