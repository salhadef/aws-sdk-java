...
public class AssociateNatGatewayAddressResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateNatGatewayAddressResult withNatGatewayAddresses(NatGatewayAddress... natGatewayAddresses) {
    ...
    public AssociateNatGatewayAddressResult withNatGatewayAddresses(java.util.Collection<NatGatewayAddress> natGatewayAddresses) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateNatGatewayAddressResult == false)
            return false;
        AssociateNatGatewayAddressResult other = (AssociateNatGatewayAddressResult) obj;
    ...
    @Override
    public AssociateNatGatewayAddressResult clone() {
        try {
            return (AssociateNatGatewayAddressResult) super.clone();
