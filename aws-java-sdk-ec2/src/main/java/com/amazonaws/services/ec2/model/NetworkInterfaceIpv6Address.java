 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/NetworkInterfaceIpv6Address" target="_top">AWS
 *      API Documentation</a>
 */
...
public class NetworkInterfaceIpv6Address implements Serializable, Cloneable {
    ...
    public NetworkInterfaceIpv6Address clone() {
        try {
            return (NetworkInterfaceIpv6Address) super.clone();
