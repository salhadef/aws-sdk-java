...
/**
 * NetworkCardInfo StAX Unmarshaller
 */
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("networkCardIndex", targetDepth)) {
                    networkCardInfo.setNetworkCardIndex(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("networkPerformance", targetDepth)) {
                    networkCardInfo.setNetworkPerformance(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
