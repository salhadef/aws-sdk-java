 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CpuOptionsRequest" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CpuOptionsRequest implements Serializable, Cloneable {
    ...
    public CpuOptionsRequest withCoreCount(Integer coreCount) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CpuOptionsRequest == false)
            return false;
    ...
    @Override
    public CpuOptionsRequest clone() {
        try {
            return (CpuOptionsRequest) super.clone();
