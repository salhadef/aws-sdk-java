...
public class DeleteKeyPairResultStaxUnmarshaller implements Unmarshaller<DeleteKeyPairResult, StaxUnmarshallerContext> {

    public DeleteKeyPairResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        DeleteKeyPairResult deleteKeyPairResult = new DeleteKeyPairResult();
    ...
    public static DeleteKeyPairResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeleteKeyPairResultStaxUnmarshaller();
        return instance;
    }
}
