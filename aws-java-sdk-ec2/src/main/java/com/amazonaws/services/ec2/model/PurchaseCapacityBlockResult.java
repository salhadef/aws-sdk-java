...
public class PurchaseCapacityBlockResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PurchaseCapacityBlockResult withCapacityReservation(CapacityReservation capacityReservation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PurchaseCapacityBlockResult == false)
            return false;
        PurchaseCapacityBlockResult other = (PurchaseCapacityBlockResult) obj;
    ...
    @Override
    public PurchaseCapacityBlockResult clone() {
        try {
            return (PurchaseCapacityBlockResult) super.clone();
