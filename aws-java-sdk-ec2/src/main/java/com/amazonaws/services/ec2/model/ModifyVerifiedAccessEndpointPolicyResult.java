...
public class ModifyVerifiedAccessEndpointPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyVerifiedAccessEndpointPolicyResult == false)
            return false;
        ModifyVerifiedAccessEndpointPolicyResult other = (ModifyVerifiedAccessEndpointPolicyResult) obj;
    ...
    @Override
    public ModifyVerifiedAccessEndpointPolicyResult clone() {
        try {
            return (ModifyVerifiedAccessEndpointPolicyResult) super.clone();
