...
public class UnassignPrivateNatGatewayAddressResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UnassignPrivateNatGatewayAddressResult withNatGatewayAddresses(NatGatewayAddress... natGatewayAddresses) {
    ...
    public UnassignPrivateNatGatewayAddressResult withNatGatewayAddresses(java.util.Collection<NatGatewayAddress> natGatewayAddresses) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UnassignPrivateNatGatewayAddressResult == false)
            return false;
        UnassignPrivateNatGatewayAddressResult other = (UnassignPrivateNatGatewayAddressResult) obj;
