...
/**
 * ListRequestedServiceQuotaChangeHistoryRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListRequestedServiceQuotaChangeHistoryRequestMarshaller {
    ...
    public static ListRequestedServiceQuotaChangeHistoryRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListRequestedServiceQuotaChangeHistoryRequest listRequestedServiceQuotaChangeHistoryRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listRequestedServiceQuotaChangeHistoryRequest.getServiceCode(), SERVICECODE_BINDING);
