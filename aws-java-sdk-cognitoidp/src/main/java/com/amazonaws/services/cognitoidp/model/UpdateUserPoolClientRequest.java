...
public class UpdateUserPoolClientRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * Amazon Cognito requires HTTPS over HTTP except for <code>http://localhost</code> for testing purposes only.
     * </p>
     * <p>
     * App callback URLs such as <code>myapp://example</code> are also supported.
     * </p>
     ...
     * </p>
     * 
     * @return The time units you use when you set the duration of ID, access, and refresh tokens. The default unit for
     *         RefreshToken is days, and the default for ID and access tokens is hours.
     */
     ...
     *        </p>
     *        <p>
     *        Amazon Cognito requires HTTPS over HTTP except for <code>http://localhost</code> for testing purposes
     *        only.
     *        </p>
     *        <p>
     *        App callback URLs such as <code>myapp://example</code> are also supported.
     ...
     *        The Amazon Pinpoint analytics configuration necessary to collect metrics for this user pool.</p> <note>
     *        <p>
     ...
     * </note>
     * 
     * @return The Amazon Pinpoint analytics configuration necessary to collect metrics for this user pool.</p> <note>
     *         <p>
     *         In Amazon Web Services Regions where Amazon Pinpoint isn't available, user pools only support sending
