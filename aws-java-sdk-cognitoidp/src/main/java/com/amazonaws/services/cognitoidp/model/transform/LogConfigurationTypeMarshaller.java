...
/**
 * LogConfigurationTypeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LogConfigurationTypeMarshaller {
    ...
    private static final LogConfigurationTypeMarshaller instance = new LogConfigurationTypeMarshaller();

    public static LogConfigurationTypeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LogConfigurationType logConfigurationType, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(logConfigurationType.getLogLevel(), LOGLEVEL_BINDING);
            protocolMarshaller.marshall(logConfigurationType.getEventSource(), EVENTSOURCE_BINDING);
            protocolMarshaller.marshall(logConfigurationType.getCloudWatchLogsConfiguration(), CLOUDWATCHLOGSCONFIGURATION_BINDING);
        } catch (Exception e) {
