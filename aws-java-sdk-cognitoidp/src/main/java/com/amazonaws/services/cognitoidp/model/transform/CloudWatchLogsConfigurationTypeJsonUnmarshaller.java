...
/**
 * CloudWatchLogsConfigurationType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CloudWatchLogsConfigurationTypeJsonUnmarshaller implements Unmarshaller<CloudWatchLogsConfigurationType, JsonUnmarshallerContext> {

    public CloudWatchLogsConfigurationType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("LogGroupArn", targetDepth)) {
                    context.nextToken();
                    cloudWatchLogsConfigurationType.setLogGroupArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
