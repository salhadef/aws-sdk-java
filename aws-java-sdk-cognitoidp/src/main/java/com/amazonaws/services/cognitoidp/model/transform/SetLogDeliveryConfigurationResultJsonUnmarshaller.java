...
/**
 * SetLogDeliveryConfigurationResult JSON Unmarshaller
 */
...
public class SetLogDeliveryConfigurationResultJsonUnmarshaller implements Unmarshaller<SetLogDeliveryConfigurationResult, JsonUnmarshallerContext> {
    ...
    public SetLogDeliveryConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("LogDeliveryConfiguration", targetDepth)) {
                    context.nextToken();
                    setLogDeliveryConfigurationResult.setLogDeliveryConfiguration(LogDeliveryConfigurationTypeJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
