...
/**
 * GetLogDeliveryConfigurationResult JSON Unmarshaller
 */
...
public class GetLogDeliveryConfigurationResultJsonUnmarshaller implements Unmarshaller<GetLogDeliveryConfigurationResult, JsonUnmarshallerContext> {
    ...
    public GetLogDeliveryConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("LogDeliveryConfiguration", targetDepth)) {
                    context.nextToken();
                    getLogDeliveryConfigurationResult.setLogDeliveryConfiguration(LogDeliveryConfigurationTypeJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
