...
public class GetLogDeliveryConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLogDeliveryConfigurationResult == false)
            return false;
        GetLogDeliveryConfigurationResult other = (GetLogDeliveryConfigurationResult) obj;
    ...
    public GetLogDeliveryConfigurationResult clone() {
        try {
            return (GetLogDeliveryConfigurationResult) super.clone();
