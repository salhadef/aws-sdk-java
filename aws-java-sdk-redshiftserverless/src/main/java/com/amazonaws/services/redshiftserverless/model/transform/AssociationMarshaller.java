...
public class AssociationMarshaller {
    ...
    public void marshall(Association association, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(association.getCustomDomainCertificateArn(), CUSTOMDOMAINCERTIFICATEARN_BINDING);
            protocolMarshaller.marshall(association.getCustomDomainCertificateExpiryTime(), CUSTOMDOMAINCERTIFICATEEXPIRYTIME_BINDING);
            protocolMarshaller.marshall(association.getCustomDomainName(), CUSTOMDOMAINNAME_BINDING);
            protocolMarshaller.marshall(association.getWorkgroupName(), WORKGROUPNAME_BINDING);
        } catch (Exception e) {
