...
public class GetAdapterRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A string containing a unique ID for the adapter.
     */
    ...
    public GetAdapterRequest withAdapterId(String adapterId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAdapterRequest == false)
            return false;
        GetAdapterRequest other = (GetAdapterRequest) obj;
    ...
    @Override
    public GetAdapterRequest clone() {
        return (GetAdapterRequest) super.clone();
    }
