...
/**
 * DeleteAdapterVersionResult JSON Unmarshaller
 */
...
public class DeleteAdapterVersionResultJsonUnmarshaller implements Unmarshaller<DeleteAdapterVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteAdapterVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAdapterVersionResult deleteAdapterVersionResult = new DeleteAdapterVersionResult();
