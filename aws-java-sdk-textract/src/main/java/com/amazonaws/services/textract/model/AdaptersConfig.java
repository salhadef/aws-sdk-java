 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/AdaptersConfig" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AdaptersConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public AdaptersConfig withAdapters(Adapter... adapters) {
        if (this.adapters == null) {
            setAdapters(new java.util.ArrayList<Adapter>(adapters.length));
        }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getAdapters() != null)
            sb.append("Adapters: ").append(getAdapters());
        sb.append("}");
        return sb.toString();
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.textract.model.transform.AdaptersConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
