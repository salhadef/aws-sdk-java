...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/DeleteAdapterVersion" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteAdapterVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A string containing a unique ID for the adapter version that will be deleted.
     */
     ...
     * </p>
     * 
     * @return Specifies the adapter version to be deleted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAdapterVersionRequest == false)
            return false;
        DeleteAdapterVersionRequest other = (DeleteAdapterVersionRequest) obj;
    ...
    public DeleteAdapterVersionRequest clone() {
        return (DeleteAdapterVersionRequest) super.clone();
    }
