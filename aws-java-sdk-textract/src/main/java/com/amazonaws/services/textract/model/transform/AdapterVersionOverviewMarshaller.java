...
/**
 * AdapterVersionOverviewMarshaller
 */
...
public class AdapterVersionOverviewMarshaller {
    ...
    public void marshall(AdapterVersionOverview adapterVersionOverview, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(adapterVersionOverview.getAdapterId(), ADAPTERID_BINDING);
            protocolMarshaller.marshall(adapterVersionOverview.getAdapterVersion(), ADAPTERVERSION_BINDING);
            protocolMarshaller.marshall(adapterVersionOverview.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(adapterVersionOverview.getFeatureTypes(), FEATURETYPES_BINDING);
            protocolMarshaller.marshall(adapterVersionOverview.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(adapterVersionOverview.getStatusMessage(), STATUSMESSAGE_BINDING);
        } catch (Exception e) {
