...
public class DeleteViewVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The version number of the view.
     */
    ...
    public String toString() {
        ...
        if (getViewVersion() != null)
            sb.append("ViewVersion: ").append(getViewVersion());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getViewVersion() == null ^ this.getViewVersion() == null)
            return false;
        if (other.getViewVersion() != null && other.getViewVersion().equals(this.getViewVersion()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getViewVersion() == null) ? 0 : getViewVersion().hashCode());
        return hashCode;
    }

    @Override
    public DeleteViewVersionRequest clone() {
        return (DeleteViewVersionRequest) super.clone();
    }
