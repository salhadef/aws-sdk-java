...
public class HierarchyGroupSummaryMarshaller {
    ...
    public void marshall(HierarchyGroupSummary hierarchyGroupSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(hierarchyGroupSummary.getLastModifiedTime(), LASTMODIFIEDTIME_BINDING);
            protocolMarshaller.marshall(hierarchyGroupSummary.getLastModifiedRegion(), LASTMODIFIEDREGION_BINDING);
        } catch (Exception e) {
