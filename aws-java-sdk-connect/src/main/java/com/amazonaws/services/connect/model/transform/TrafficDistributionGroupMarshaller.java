...
/**
 * TrafficDistributionGroupMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TrafficDistributionGroupMarshaller {
    ...
    public static TrafficDistributionGroupMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TrafficDistributionGroup trafficDistributionGroup, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(trafficDistributionGroup.getId(), ID_BINDING);
            protocolMarshaller.marshall(trafficDistributionGroup.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(trafficDistributionGroup.getName(), NAME_BINDING);
            protocolMarshaller.marshall(trafficDistributionGroup.getDescription(), DESCRIPTION_BINDING);
