 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/QuickConnectSearchCriteria" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class QuickConnectSearchCriteria implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<QuickConnectSearchCriteria> orConditions;
    /**
     * <p>
     * A list of conditions which would be applied together with an AND condition.
     * </p>
     */
    private java.util.List<QuickConnectSearchCriteria> andConditions;
    /**
     * <p>
    ...
    public java.util.List<QuickConnectSearchCriteria> getOrConditions() {
        return orConditions;
    }
    ...
    public void setOrConditions(java.util.Collection<QuickConnectSearchCriteria> orConditions) {
        if (orConditions == null) {
            this.orConditions = null;
            return;
        }

        this.orConditions = new java.util.ArrayList<QuickConnectSearchCriteria>(orConditions);
    }
    ...
    public QuickConnectSearchCriteria withOrConditions(QuickConnectSearchCriteria... orConditions) {
        if (this.orConditions == null) {
            setOrConditions(new java.util.ArrayList<QuickConnectSearchCriteria>(orConditions.length));
        }
        for (QuickConnectSearchCriteria ele : orConditions) {
    ...
    public QuickConnectSearchCriteria withOrConditions(java.util.Collection<QuickConnectSearchCriteria> orConditions) {
    ...
    public java.util.List<QuickConnectSearchCriteria> getAndConditions() {
    ...
    public void setAndConditions(java.util.Collection<QuickConnectSearchCriteria> andConditions) {
        if (andConditions == null) {
            this.andConditions = null;
            return;
        }

        this.andConditions = new java.util.ArrayList<QuickConnectSearchCriteria>(andConditions);
    }
    ...
    public QuickConnectSearchCriteria withAndConditions(QuickConnectSearchCriteria... andConditions) {
        if (this.andConditions == null) {
            setAndConditions(new java.util.ArrayList<QuickConnectSearchCriteria>(andConditions.length));
        }
        for (QuickConnectSearchCriteria ele : andConditions) {
    ...
    public QuickConnectSearchCriteria withAndConditions(java.util.Collection<QuickConnectSearchCriteria> andConditions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof QuickConnectSearchCriteria == false)
            return false;
        QuickConnectSearchCriteria other = (QuickConnectSearchCriteria) obj;
    ...
    @Override
    public QuickConnectSearchCriteria clone() {
        try {
            return (QuickConnectSearchCriteria) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.QuickConnectSearchCriteriaMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
