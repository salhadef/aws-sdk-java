 ...
 * </note>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/RoutingProfileSearchCriteria"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RoutingProfileSearchCriteria implements Serializable, Cloneable, StructuredPojo {
    ...
    public RoutingProfileSearchCriteria withOrConditions(RoutingProfileSearchCriteria... orConditions) {
        if (this.orConditions == null) {
            setOrConditions(new java.util.ArrayList<RoutingProfileSearchCriteria>(orConditions.length));
        }
        for (RoutingProfileSearchCriteria ele : orConditions) {
    ...
    public RoutingProfileSearchCriteria withAndConditions(RoutingProfileSearchCriteria... andConditions) {
        if (this.andConditions == null) {
            setAndConditions(new java.util.ArrayList<RoutingProfileSearchCriteria>(andConditions.length));
        }
        for (RoutingProfileSearchCriteria ele : andConditions) {
    ...
    @Override
    public RoutingProfileSearchCriteria clone() {
        try {
            return (RoutingProfileSearchCriteria) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.RoutingProfileSearchCriteriaMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
