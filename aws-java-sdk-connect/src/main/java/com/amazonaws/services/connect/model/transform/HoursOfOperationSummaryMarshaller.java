...
/**
 * HoursOfOperationSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class HoursOfOperationSummaryMarshaller {
    ...
    public static HoursOfOperationSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HoursOfOperationSummary hoursOfOperationSummary, ProtocolMarshaller protocolMarshaller) {

        if (hoursOfOperationSummary == null) {
