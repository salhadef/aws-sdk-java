 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/AgentStatusSummary" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AgentStatusSummary implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The identifier for an agent status.
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) for the agent status.
     */
     ...
     * </p>
     * 
     * @return The type of the agent status.
     * @see AgentStatusType
     */
    ...
    public AgentStatusSummary clone() {
        try {
            return (AgentStatusSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.AgentStatusSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
