...
public class ApplicationMarshaller {
    ...
    public void marshall(Application application, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(application.getNamespace(), NAMESPACE_BINDING);
            protocolMarshaller.marshall(application.getApplicationPermissions(), APPLICATIONPERMISSIONS_BINDING);
        } catch (Exception e) {
