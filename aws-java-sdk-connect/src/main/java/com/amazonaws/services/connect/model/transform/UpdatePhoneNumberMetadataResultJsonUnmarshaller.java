...
/**
 * UpdatePhoneNumberMetadataResult JSON Unmarshaller
 */
...
public class UpdatePhoneNumberMetadataResultJsonUnmarshaller implements Unmarshaller<UpdatePhoneNumberMetadataResult, JsonUnmarshallerContext> {
    ...
    public UpdatePhoneNumberMetadataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePhoneNumberMetadataResult updatePhoneNumberMetadataResult = new UpdatePhoneNumberMetadataResult();

        return updatePhoneNumberMetadataResult;
    }
