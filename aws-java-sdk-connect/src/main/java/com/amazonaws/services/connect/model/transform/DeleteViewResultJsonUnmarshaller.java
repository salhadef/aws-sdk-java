...
/**
 * DeleteViewResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteViewResultJsonUnmarshaller implements Unmarshaller<DeleteViewResult, JsonUnmarshallerContext> {

    public DeleteViewResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteViewResult deleteViewResult = new DeleteViewResult();
