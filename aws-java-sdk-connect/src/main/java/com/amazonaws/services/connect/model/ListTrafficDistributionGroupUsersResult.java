...
public class ListTrafficDistributionGroupUsersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public void setTrafficDistributionGroupUserSummaryList(java.util.Collection<TrafficDistributionGroupUserSummary> trafficDistributionGroupUserSummaryList) {
        if (trafficDistributionGroupUserSummaryList == null) {
            this.trafficDistributionGroupUserSummaryList = null;
            return;
        }

        this.trafficDistributionGroupUserSummaryList = new java.util.ArrayList<TrafficDistributionGroupUserSummary>(trafficDistributionGroupUserSummaryList);
    }
     ...
     * {@link #setTrafficDistributionGroupUserSummaryList(java.util.Collection)} or
     * {@link #withTrafficDistributionGroupUserSummaryList(java.util.Collection)} if you want to override the existing
     * values.
     * </p>
     * 
     * @param trafficDistributionGroupUserSummaryList
    ...
    public ListTrafficDistributionGroupUsersResult withTrafficDistributionGroupUserSummaryList(
        ...
        if (this.trafficDistributionGroupUserSummaryList == null) {
            setTrafficDistributionGroupUserSummaryList(new java.util.ArrayList<TrafficDistributionGroupUserSummary>(
                    trafficDistributionGroupUserSummaryList.length));
        }
        for (TrafficDistributionGroupUserSummary ele : trafficDistributionGroupUserSummaryList) {
            this.trafficDistributionGroupUserSummaryList.add(ele);
        }
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getNextToken() != null && other.getNextToken().equals(this.getNextToken()) == false)
            return false;
        if (other.getTrafficDistributionGroupUserSummaryList() == null ^ this.getTrafficDistributionGroupUserSummaryList() == null)
            return false;
        if (other.getTrafficDistributionGroupUserSummaryList() != null
                && other.getTrafficDistributionGroupUserSummaryList().equals(this.getTrafficDistributionGroupUserSummaryList()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getTrafficDistributionGroupUserSummaryList() == null) ? 0 : getTrafficDistributionGroupUserSummaryList().hashCode());
        return hashCode;
    }

    @Override
    public ListTrafficDistributionGroupUsersResult clone() {
        try {
