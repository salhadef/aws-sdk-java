...
/**
 * SuccessfulRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SuccessfulRequestJsonUnmarshaller implements Unmarshaller<SuccessfulRequest, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestIdentifier", targetDepth)) {
                    context.nextToken();
                    successfulRequest.setRequestIdentifier(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ContactId", targetDepth)) {
                    context.nextToken();
                    successfulRequest.setContactId(context.getUnmarshaller(String.class).unmarshall(context));
                }
