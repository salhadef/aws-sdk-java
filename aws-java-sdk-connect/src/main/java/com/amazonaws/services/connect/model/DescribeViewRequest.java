...
public class DescribeViewRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeViewRequest withInstanceId(String instanceId) {
     ...
     * </p>
     * 
     * @return The ViewId of the view. This must be an ARN for Amazon Web Services managed views.
     */
    ...
    public DescribeViewRequest withViewId(String viewId) {
        setViewId(viewId);
        return this;
    }
