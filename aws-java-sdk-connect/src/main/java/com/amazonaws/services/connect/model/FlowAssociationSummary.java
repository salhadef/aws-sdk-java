 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/FlowAssociationSummary" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FlowAssociationSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public FlowAssociationSummary clone() {
        try {
            return (FlowAssociationSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.FlowAssociationSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
