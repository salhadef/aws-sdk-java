...
/**
 * HoursOfOperationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class HoursOfOperationMarshaller {
    ...
    private static final MarshallingInfo<String> HOURSOFOPERATIONARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("HoursOfOperationArn").build();
    ...
    public static HoursOfOperationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HoursOfOperation hoursOfOperation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(hoursOfOperation.getHoursOfOperationId(), HOURSOFOPERATIONID_BINDING);
            protocolMarshaller.marshall(hoursOfOperation.getHoursOfOperationArn(), HOURSOFOPERATIONARN_BINDING);
            protocolMarshaller.marshall(hoursOfOperation.getName(), NAME_BINDING);
            protocolMarshaller.marshall(hoursOfOperation.getDescription(), DESCRIPTION_BINDING);
