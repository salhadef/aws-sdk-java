...
public class AssociateTrafficDistributionGroupUserRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The identifier of the user account. This can be the ID or the ARN of the user.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateTrafficDistributionGroupUserRequest == false)
            return false;
        AssociateTrafficDistributionGroupUserRequest other = (AssociateTrafficDistributionGroupUserRequest) obj;
    ...
    public AssociateTrafficDistributionGroupUserRequest clone() {
        return (AssociateTrafficDistributionGroupUserRequest) super.clone();
    }
