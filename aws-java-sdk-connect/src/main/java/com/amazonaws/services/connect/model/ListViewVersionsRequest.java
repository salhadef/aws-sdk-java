...
public class ListViewVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListViewVersionsRequest clone() {
        return (ListViewVersionsRequest) super.clone();
    }
