        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Namespace", targetDepth)) {
                    context.nextToken();
                    application.setNamespace(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ApplicationPermissions", targetDepth)) {
                    context.nextToken();
                    application.setApplicationPermissions(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
