...
public class CreatePromptRequestMarshaller {
    ...
    public void marshall(CreatePromptRequest createPromptRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createPromptRequest.getInstanceId(), INSTANCEID_BINDING);
            ...
            protocolMarshaller.marshall(createPromptRequest.getS3Uri(), S3URI_BINDING);
