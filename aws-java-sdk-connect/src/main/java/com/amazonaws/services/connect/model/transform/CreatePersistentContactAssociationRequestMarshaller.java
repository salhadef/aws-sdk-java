...
/**
 * CreatePersistentContactAssociationRequestMarshaller
 */
...
public class CreatePersistentContactAssociationRequestMarshaller {
    ...
    private static final MarshallingInfo<String> REHYDRATIONTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RehydrationType").build();
    private static final MarshallingInfo<String> SOURCECONTACTID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SourceContactId").build();
