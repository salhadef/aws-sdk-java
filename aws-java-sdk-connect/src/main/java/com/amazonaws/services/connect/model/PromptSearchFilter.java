 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/PromptSearchFilter" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PromptSearchFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public PromptSearchFilter clone() {
        try {
            return (PromptSearchFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.PromptSearchFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
