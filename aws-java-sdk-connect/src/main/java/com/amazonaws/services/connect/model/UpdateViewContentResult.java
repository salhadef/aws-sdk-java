...
public class UpdateViewContentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateViewContentResult == false)
            return false;
        UpdateViewContentResult other = (UpdateViewContentResult) obj;
    ...
    @Override
    public UpdateViewContentResult clone() {
        try {
            return (UpdateViewContentResult) super.clone();
