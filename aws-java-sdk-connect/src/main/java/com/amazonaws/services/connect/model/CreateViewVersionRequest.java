...
public class CreateViewVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateViewVersionRequest clone() {
        return (CreateViewVersionRequest) super.clone();
    }
