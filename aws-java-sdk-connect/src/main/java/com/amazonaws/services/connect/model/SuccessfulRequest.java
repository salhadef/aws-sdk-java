 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/SuccessfulRequest" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SuccessfulRequest implements Serializable, Cloneable, StructuredPojo {
    ...
    public SuccessfulRequest clone() {
        try {
            return (SuccessfulRequest) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.SuccessfulRequestMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
