...
/**
 * DeleteViewVersionResult JSON Unmarshaller
 */
...
public class DeleteViewVersionResultJsonUnmarshaller implements Unmarshaller<DeleteViewVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteViewVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteViewVersionResult deleteViewVersionResult = new DeleteViewVersionResult();

        return deleteViewVersionResult;
    }
