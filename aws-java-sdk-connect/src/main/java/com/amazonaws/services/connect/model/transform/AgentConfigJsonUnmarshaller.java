...
/**
 * AgentConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AgentConfigJsonUnmarshaller implements Unmarshaller<AgentConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Distributions", targetDepth)) {
                    context.nextToken();
                    agentConfig.setDistributions(new ListUnmarshaller<Distribution>(DistributionJsonUnmarshaller.getInstance())
