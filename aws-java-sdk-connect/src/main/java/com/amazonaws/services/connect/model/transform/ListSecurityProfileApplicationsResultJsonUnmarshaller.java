...
/**
 * ListSecurityProfileApplicationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSecurityProfileApplicationsResultJsonUnmarshaller implements Unmarshaller<ListSecurityProfileApplicationsResult, JsonUnmarshallerContext> {

    public ListSecurityProfileApplicationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Applications", targetDepth)) {
                    context.nextToken();
                    listSecurityProfileApplicationsResult.setApplications(new ListUnmarshaller<Application>(ApplicationJsonUnmarshaller.getInstance())
