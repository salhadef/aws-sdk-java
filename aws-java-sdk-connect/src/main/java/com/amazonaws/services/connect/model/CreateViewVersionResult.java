...
public class CreateViewVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return All view data is contained within the View object.
     */
    ...
    @Override
    public CreateViewVersionResult clone() {
        try {
            return (CreateViewVersionResult) super.clone();
