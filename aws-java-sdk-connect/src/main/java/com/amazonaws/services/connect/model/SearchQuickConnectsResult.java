...
public class SearchQuickConnectsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * {@link #setQuickConnects(java.util.Collection)} or {@link #withQuickConnects(java.util.Collection)} if you want
    ...
    public SearchQuickConnectsResult withQuickConnects(QuickConnect... quickConnects) {
        if (this.quickConnects == null) {
            setQuickConnects(new java.util.ArrayList<QuickConnect>(quickConnects.length));
        }
        for (QuickConnect ele : quickConnects) {
            this.quickConnects.add(ele);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getQuickConnects() != null)
            sb.append("QuickConnects: ").append(getQuickConnects()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getQuickConnects() == null ^ this.getQuickConnects() == null)
            return false;
        if (other.getQuickConnects() != null && other.getQuickConnects().equals(this.getQuickConnects()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getQuickConnects() == null) ? 0 : getQuickConnects().hashCode());
    ...
    public SearchQuickConnectsResult clone() {
        try {
            return (SearchQuickConnectsResult) super.clone();
