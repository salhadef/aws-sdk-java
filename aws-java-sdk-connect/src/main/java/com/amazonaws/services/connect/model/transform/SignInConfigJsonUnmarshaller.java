...
/**
 * SignInConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SignInConfigJsonUnmarshaller implements Unmarshaller<SignInConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Distributions", targetDepth)) {
                    context.nextToken();
                    signInConfig.setDistributions(new ListUnmarshaller<SignInDistribution>(SignInDistributionJsonUnmarshaller.getInstance())
