...
/**
 * ListPhoneNumbersSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListPhoneNumbersSummaryMarshaller {
    ...
    public static ListPhoneNumbersSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListPhoneNumbersSummary listPhoneNumbersSummary, ProtocolMarshaller protocolMarshaller) {

        if (listPhoneNumbersSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listPhoneNumbersSummary.getPhoneNumberId(), PHONENUMBERID_BINDING);
            protocolMarshaller.marshall(listPhoneNumbersSummary.getPhoneNumberArn(), PHONENUMBERARN_BINDING);
            protocolMarshaller.marshall(listPhoneNumbersSummary.getPhoneNumber(), PHONENUMBER_BINDING);
