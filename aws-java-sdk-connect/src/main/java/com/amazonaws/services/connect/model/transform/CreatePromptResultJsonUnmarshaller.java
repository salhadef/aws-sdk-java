        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PromptARN", targetDepth)) {
                    context.nextToken();
                    createPromptResult.setPromptARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("PromptId", targetDepth)) {
                    context.nextToken();
                    createPromptResult.setPromptId(context.getUnmarshaller(String.class).unmarshall(context));
                }
