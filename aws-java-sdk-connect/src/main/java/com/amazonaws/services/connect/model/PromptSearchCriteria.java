 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/PromptSearchCriteria" target="_top">AWS API
 *      Documentation</a>
 */
...
public class PromptSearchCriteria implements Serializable, Cloneable, StructuredPojo {
    ...
    public PromptSearchCriteria withOrConditions(PromptSearchCriteria... orConditions) {
        if (this.orConditions == null) {
            setOrConditions(new java.util.ArrayList<PromptSearchCriteria>(orConditions.length));
        }
        for (PromptSearchCriteria ele : orConditions) {
    ...
    public PromptSearchCriteria withOrConditions(java.util.Collection<PromptSearchCriteria> orConditions) {
    ...
    public PromptSearchCriteria withAndConditions(PromptSearchCriteria... andConditions) {
        if (this.andConditions == null) {
            setAndConditions(new java.util.ArrayList<PromptSearchCriteria>(andConditions.length));
        }
        for (PromptSearchCriteria ele : andConditions) {
    ...
    public PromptSearchCriteria withAndConditions(java.util.Collection<PromptSearchCriteria> andConditions) {
    ...
    @Override
    public PromptSearchCriteria clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.PromptSearchCriteriaMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
