...
/**
 * DeleteRoutingProfileResult JSON Unmarshaller
 */
...
public class DeleteRoutingProfileResultJsonUnmarshaller implements Unmarshaller<DeleteRoutingProfileResult, JsonUnmarshallerContext> {
    ...
    public DeleteRoutingProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRoutingProfileResult deleteRoutingProfileResult = new DeleteRoutingProfileResult();

        return deleteRoutingProfileResult;
    }
