...
public class SecurityProfileSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public SecurityProfileSummary withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecurityProfileSummary == false)
            return false;
        SecurityProfileSummary other = (SecurityProfileSummary) obj;
    ...
    public SecurityProfileSummary clone() {
        try {
            return (SecurityProfileSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.SecurityProfileSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
