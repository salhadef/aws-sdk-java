...
public class MetricIntervalMarshaller {
    ...
    public void marshall(MetricInterval metricInterval, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(metricInterval.getInterval(), INTERVAL_BINDING);
            protocolMarshaller.marshall(metricInterval.getStartTime(), STARTTIME_BINDING);
            protocolMarshaller.marshall(metricInterval.getEndTime(), ENDTIME_BINDING);
        } catch (Exception e) {
