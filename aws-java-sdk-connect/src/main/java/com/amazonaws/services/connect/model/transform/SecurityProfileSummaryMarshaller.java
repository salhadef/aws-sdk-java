...
/**
 * SecurityProfileSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SecurityProfileSummaryMarshaller {
    ...
    private static final SecurityProfileSummaryMarshaller instance = new SecurityProfileSummaryMarshaller();

    public static SecurityProfileSummaryMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(SecurityProfileSummary securityProfileSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(securityProfileSummary.getLastModifiedTime(), LASTMODIFIEDTIME_BINDING);
            protocolMarshaller.marshall(securityProfileSummary.getLastModifiedRegion(), LASTMODIFIEDREGION_BINDING);
        } catch (Exception e) {
