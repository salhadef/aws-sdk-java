...
public class RoutingProfileSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public RoutingProfileSummary withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public RoutingProfileSummary withLastModifiedRegion(String lastModifiedRegion) {
