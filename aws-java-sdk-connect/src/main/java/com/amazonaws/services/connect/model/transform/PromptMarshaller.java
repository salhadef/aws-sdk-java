...
public class PromptMarshaller {
    ...
    private static final MarshallingInfo<String> PROMPTID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(Prompt prompt, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(prompt.getPromptARN(), PROMPTARN_BINDING);
            protocolMarshaller.marshall(prompt.getPromptId(), PROMPTID_BINDING);
            protocolMarshaller.marshall(prompt.getName(), NAME_BINDING);
            protocolMarshaller.marshall(prompt.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(prompt.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(prompt.getLastModifiedTime(), LASTMODIFIEDTIME_BINDING);
            protocolMarshaller.marshall(prompt.getLastModifiedRegion(), LASTMODIFIEDREGION_BINDING);
        } catch (Exception e) {
