...
/**
 * DisconnectReason JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisconnectReasonJsonUnmarshaller implements Unmarshaller<DisconnectReason, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Code", targetDepth)) {
                    context.nextToken();
                    disconnectReason.setCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
