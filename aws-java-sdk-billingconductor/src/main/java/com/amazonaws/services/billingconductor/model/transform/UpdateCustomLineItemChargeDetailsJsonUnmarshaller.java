...
/**
 * UpdateCustomLineItemChargeDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateCustomLineItemChargeDetailsJsonUnmarshaller implements Unmarshaller<UpdateCustomLineItemChargeDetails, JsonUnmarshallerContext> {

    public UpdateCustomLineItemChargeDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateCustomLineItemChargeDetails updateCustomLineItemChargeDetails = new UpdateCustomLineItemChargeDetails();
    ...
    private static UpdateCustomLineItemChargeDetailsJsonUnmarshaller instance;

    public static UpdateCustomLineItemChargeDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateCustomLineItemChargeDetailsJsonUnmarshaller();
        return instance;
    }
}
