...
/**
 * ConnectPeerSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConnectPeerSummaryJsonUnmarshaller implements Unmarshaller<ConnectPeerSummary, JsonUnmarshallerContext> {

    public ConnectPeerSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ConnectPeerSummary connectPeerSummary = new ConnectPeerSummary();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("SubnetArn", targetDepth)) {
                    context.nextToken();
                    connectPeerSummary.setSubnetArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ConnectPeerSummaryJsonUnmarshaller instance;

    public static ConnectPeerSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConnectPeerSummaryJsonUnmarshaller();
        return instance;
    }
}
