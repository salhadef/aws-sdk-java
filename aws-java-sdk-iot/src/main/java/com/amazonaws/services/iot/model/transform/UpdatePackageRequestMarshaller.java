...
public class UpdatePackageRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> UNSETDEFAULTVERSION_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("unsetDefaultVersion").build();
    ...
    public void marshall(UpdatePackageRequest updatePackageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updatePackageRequest.getPackageName(), PACKAGENAME_BINDING);
            protocolMarshaller.marshall(updatePackageRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updatePackageRequest.getDefaultVersionName(), DEFAULTVERSIONNAME_BINDING);
            protocolMarshaller.marshall(updatePackageRequest.getUnsetDefaultVersion(), UNSETDEFAULTVERSION_BINDING);
            protocolMarshaller.marshall(updatePackageRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
