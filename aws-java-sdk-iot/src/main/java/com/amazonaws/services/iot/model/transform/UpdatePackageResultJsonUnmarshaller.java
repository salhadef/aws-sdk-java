...
/**
 * UpdatePackageResult JSON Unmarshaller
 */
...
public class UpdatePackageResultJsonUnmarshaller implements Unmarshaller<UpdatePackageResult, JsonUnmarshallerContext> {
    ...
    public UpdatePackageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePackageResult updatePackageResult = new UpdatePackageResult();
