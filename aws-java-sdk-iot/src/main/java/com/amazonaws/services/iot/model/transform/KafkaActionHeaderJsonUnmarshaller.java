...
/**
 * KafkaActionHeader JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KafkaActionHeaderJsonUnmarshaller implements Unmarshaller<KafkaActionHeader, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("key", targetDepth)) {
                    context.nextToken();
                    kafkaActionHeader.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("value", targetDepth)) {
                    context.nextToken();
                    kafkaActionHeader.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
