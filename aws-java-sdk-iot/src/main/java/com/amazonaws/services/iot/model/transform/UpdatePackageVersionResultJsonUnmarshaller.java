...
/**
 * UpdatePackageVersionResult JSON Unmarshaller
 */
...
public class UpdatePackageVersionResultJsonUnmarshaller implements Unmarshaller<UpdatePackageVersionResult, JsonUnmarshallerContext> {
    ...
    public UpdatePackageVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePackageVersionResult updatePackageVersionResult = new UpdatePackageVersionResult();

        return updatePackageVersionResult;
    }
