...
public class CreatePackageRequestMarshaller {
    ...
    public void marshall(CreatePackageRequest createPackageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createPackageRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createPackageRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createPackageRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
