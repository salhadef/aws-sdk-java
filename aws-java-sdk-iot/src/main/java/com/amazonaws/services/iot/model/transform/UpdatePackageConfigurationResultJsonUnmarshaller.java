...
/**
 * UpdatePackageConfigurationResult JSON Unmarshaller
 */
...
public class UpdatePackageConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdatePackageConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdatePackageConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePackageConfigurationResult updatePackageConfigurationResult = new UpdatePackageConfigurationResult();

        return updatePackageConfigurationResult;
    }
