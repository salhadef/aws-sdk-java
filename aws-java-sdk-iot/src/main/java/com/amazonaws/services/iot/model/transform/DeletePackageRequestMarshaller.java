...
/**
 * DeletePackageRequestMarshaller
 */
...
public class DeletePackageRequestMarshaller {
    ...
    public static DeletePackageRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeletePackageRequest deletePackageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deletePackageRequest.getPackageName(), PACKAGENAME_BINDING);
            protocolMarshaller.marshall(deletePackageRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
