 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/opensearchserverless-2021-11-01/LifecyclePolicySummary"
...
public class LifecyclePolicySummary implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The Epoch time when the lifecycle policy was created.
     */
    ...
    public LifecyclePolicySummary withCreatedDate(Long createdDate) {
     ...
     * </p>
     * 
     * @return The date and time when the lifecycle policy was last modified.
     */
    ...
    public LifecyclePolicySummary withLastModifiedDate(Long lastModifiedDate) {
    ...
    public LifecyclePolicySummary withPolicyVersion(String policyVersion) {
    ...
    public LifecyclePolicySummary withType(String type) {
        setType(type);
        return this;
    }
    ...
    public LifecyclePolicySummary withType(LifecyclePolicyType type) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.opensearchserverless.model.transform.LifecyclePolicySummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
