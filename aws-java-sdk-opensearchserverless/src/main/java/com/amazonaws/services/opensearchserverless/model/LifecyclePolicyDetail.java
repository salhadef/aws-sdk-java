 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/opensearchserverless-2021-11-01/LifecyclePolicyDetail"
...
public class LifecyclePolicyDetail implements Serializable, Cloneable, StructuredPojo {
    ...
    public LifecyclePolicyDetail withCreatedDate(Long createdDate) {
    ...
    public LifecyclePolicyDetail withDescription(String description) {
     ...
     * </p>
     * 
     * @return The timestamp of when the lifecycle policy was last modified.
     */
    ...
    public LifecyclePolicyDetail withLastModifiedDate(Long lastModifiedDate) {
    ...
    public LifecyclePolicyDetail withName(String name) {
        setName(name);
        return this;
    }
     ...
     * </p>
     * 
     * @return The version of the lifecycle policy.
     */
    ...
    public LifecyclePolicyDetail withPolicyVersion(String policyVersion) {
    ...
    public LifecyclePolicyDetail withType(String type) {
        setType(type);
        return this;
    }
    ...
    public LifecyclePolicyDetail withType(LifecyclePolicyType type) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.opensearchserverless.model.transform.LifecyclePolicyDetailMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
