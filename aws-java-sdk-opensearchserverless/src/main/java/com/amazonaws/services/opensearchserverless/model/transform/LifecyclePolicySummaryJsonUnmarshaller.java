        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("createdDate", targetDepth)) {
                    context.nextToken();
                    lifecyclePolicySummary.setCreatedDate(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                ...
                if (context.testExpression("lastModifiedDate", targetDepth)) {
                    context.nextToken();
                    lifecyclePolicySummary.setLastModifiedDate(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                ...
                if (context.testExpression("policyVersion", targetDepth)) {
                    context.nextToken();
                    lifecyclePolicySummary.setPolicyVersion(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("type", targetDepth)) {
                    context.nextToken();
                    lifecyclePolicySummary.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
