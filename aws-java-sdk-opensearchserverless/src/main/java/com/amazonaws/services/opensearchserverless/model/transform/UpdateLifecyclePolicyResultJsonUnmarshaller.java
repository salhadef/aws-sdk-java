...
/**
 * UpdateLifecyclePolicyResult JSON Unmarshaller
 */
...
public class UpdateLifecyclePolicyResultJsonUnmarshaller implements Unmarshaller<UpdateLifecyclePolicyResult, JsonUnmarshallerContext> {
    ...
    public UpdateLifecyclePolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateLifecyclePolicyResult updateLifecyclePolicyResult = new UpdateLifecyclePolicyResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("lifecyclePolicyDetail", targetDepth)) {
                    context.nextToken();
                    updateLifecyclePolicyResult.setLifecyclePolicyDetail(LifecyclePolicyDetailJsonUnmarshaller.getInstance().unmarshall(context));
                }
