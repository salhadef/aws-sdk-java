...
public class ListCollectionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param nextToken
     *        If your initial <code>ListCollections</code> operation returns a <code>nextToken</code>, you can include
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getCollectionFilters() != null)
            sb.append("CollectionFilters: ").append(getCollectionFilters()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getCollectionFilters() == null ^ this.getCollectionFilters() == null)
            return false;
        if (other.getCollectionFilters() != null && other.getCollectionFilters().equals(this.getCollectionFilters()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getCollectionFilters() == null) ? 0 : getCollectionFilters().hashCode());
