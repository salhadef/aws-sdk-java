...
public class UpdateLifecyclePolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Details about the updated lifecycle policy.
     */
    ...
    public UpdateLifecyclePolicyResult withLifecyclePolicyDetail(LifecyclePolicyDetail lifecyclePolicyDetail) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateLifecyclePolicyResult == false)
            return false;
        UpdateLifecyclePolicyResult other = (UpdateLifecyclePolicyResult) obj;
    ...
    @Override
    public UpdateLifecyclePolicyResult clone() {
        try {
            return (UpdateLifecyclePolicyResult) super.clone();
