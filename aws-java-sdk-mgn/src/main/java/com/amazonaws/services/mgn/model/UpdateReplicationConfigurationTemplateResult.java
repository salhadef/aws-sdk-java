...
public class UpdateReplicationConfigurationTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateReplicationConfigurationTemplateResult withDefaultLargeStagingDiskType(
    ...
    public UpdateReplicationConfigurationTemplateResult withReplicationServersSecurityGroupsIDs(String... replicationServersSecurityGroupsIDs) {
    ...
    public UpdateReplicationConfigurationTemplateResult withReplicationServersSecurityGroupsIDs(java.util.Collection<String> replicationServersSecurityGroupsIDs) {
    ...
    public UpdateReplicationConfigurationTemplateResult withStagingAreaTags(java.util.Map<String, String> stagingAreaTags) {
     ...
     *
     * @see UpdateReplicationConfigurationTemplateResult#withStagingAreaTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateReplicationConfigurationTemplateResult addStagingAreaTagsEntry(String key, String value) {
    ...
    public UpdateReplicationConfigurationTemplateResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateReplicationConfigurationTemplateResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateReplicationConfigurationTemplateResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UpdateReplicationConfigurationTemplateResult withUseFipsEndpoint(Boolean useFipsEndpoint) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateReplicationConfigurationTemplateResult == false)
            return false;
        UpdateReplicationConfigurationTemplateResult other = (UpdateReplicationConfigurationTemplateResult) obj;
    ...
    public UpdateReplicationConfigurationTemplateResult clone() {
        try {
            return (UpdateReplicationConfigurationTemplateResult) super.clone();
