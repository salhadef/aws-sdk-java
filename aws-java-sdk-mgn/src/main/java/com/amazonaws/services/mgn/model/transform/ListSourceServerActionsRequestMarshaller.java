...
/**
 * ListSourceServerActionsRequestMarshaller
 */
...
public class ListSourceServerActionsRequestMarshaller {
    ...
    private static final ListSourceServerActionsRequestMarshaller instance = new ListSourceServerActionsRequestMarshaller();

    public static ListSourceServerActionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListSourceServerActionsRequest listSourceServerActionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(listSourceServerActionsRequest.getSourceServerID(), SOURCESERVERID_BINDING);
        } catch (Exception e) {
