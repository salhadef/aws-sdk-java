        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("isArchived", targetDepth)) {
                    context.nextToken();
                    sourceServer.setIsArchived(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("launchedInstance", targetDepth)) {
                    context.nextToken();
                    sourceServer.setLaunchedInstance(LaunchedInstanceJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("replicationType", targetDepth)) {
                    context.nextToken();
                    sourceServer.setReplicationType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("vcenterClientID", targetDepth)) {
                    context.nextToken();
                    sourceServer.setVcenterClientID(context.getUnmarshaller(String.class).unmarshall(context));
                }
