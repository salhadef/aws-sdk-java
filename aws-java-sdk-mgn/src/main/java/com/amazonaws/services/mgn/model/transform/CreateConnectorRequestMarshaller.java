...
public class CreateConnectorRequestMarshaller {
    ...
    public void marshall(CreateConnectorRequest createConnectorRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createConnectorRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createConnectorRequest.getSsmCommandConfig(), SSMCOMMANDCONFIG_BINDING);
            protocolMarshaller.marshall(createConnectorRequest.getSsmInstanceID(), SSMINSTANCEID_BINDING);
