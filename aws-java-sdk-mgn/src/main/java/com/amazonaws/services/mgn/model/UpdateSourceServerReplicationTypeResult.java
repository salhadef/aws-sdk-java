...
public class UpdateSourceServerReplicationTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
    ...
    public UpdateSourceServerReplicationTypeResult withFqdnForActionFramework(String fqdnForActionFramework) {
    ...
    public UpdateSourceServerReplicationTypeResult withIsArchived(Boolean isArchived) {
    ...
    public UpdateSourceServerReplicationTypeResult withReplicationType(String replicationType) {
    ...
    public UpdateSourceServerReplicationTypeResult withSourceServerID(String sourceServerID) {
    ...
    public UpdateSourceServerReplicationTypeResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateSourceServerReplicationTypeResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateSourceServerReplicationTypeResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UpdateSourceServerReplicationTypeResult withUserProvidedID(String userProvidedID) {
    ...
    public UpdateSourceServerReplicationTypeResult withVcenterClientID(String vcenterClientID) {
    ...
    @Override
    public UpdateSourceServerReplicationTypeResult clone() {
        try {
