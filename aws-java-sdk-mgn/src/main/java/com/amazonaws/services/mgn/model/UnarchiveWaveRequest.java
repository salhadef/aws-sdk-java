...
public class UnarchiveWaveRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UnarchiveWaveRequest withWaveID(String waveID) {
        setWaveID(waveID);
        return this;
    }
    ...
    @Override
    public UnarchiveWaveRequest clone() {
