...
public class PutSourceServerActionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public PutSourceServerActionRequest withCategory(String category) {
    ...
    public PutSourceServerActionRequest withCategory(ActionCategory category) {
    ...
    public PutSourceServerActionRequest withDescription(String description) {
    ...
    public PutSourceServerActionRequest withExternalParameters(java.util.Map<String, SsmExternalParameter> externalParameters) {
     ...
     *
     * @see PutSourceServerActionRequest#withExternalParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PutSourceServerActionRequest addExternalParametersEntry(String key, SsmExternalParameter value) {
    ...
    public PutSourceServerActionRequest clearExternalParametersEntries() {
