...
public class UpdateWaveRequestMarshaller {
    ...
    private static final UpdateWaveRequestMarshaller instance = new UpdateWaveRequestMarshaller();

    public static UpdateWaveRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateWaveRequest updateWaveRequest, ProtocolMarshaller protocolMarshaller) {
