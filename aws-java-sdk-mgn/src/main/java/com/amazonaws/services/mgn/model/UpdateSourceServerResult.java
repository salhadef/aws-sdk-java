...
public class UpdateSourceServerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateSourceServerResult withApplicationID(String applicationID) {
    ...
    public UpdateSourceServerResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public UpdateSourceServerResult withConnectorAction(SourceServerConnectorAction connectorAction) {
    ...
    public UpdateSourceServerResult withDataReplicationInfo(DataReplicationInfo dataReplicationInfo) {
    ...
    public UpdateSourceServerResult withFqdnForActionFramework(String fqdnForActionFramework) {
    ...
    public UpdateSourceServerResult withIsArchived(Boolean isArchived) {
    ...
    public UpdateSourceServerResult withLaunchedInstance(LaunchedInstance launchedInstance) {
    ...
    public UpdateSourceServerResult withLifeCycle(LifeCycle lifeCycle) {
    ...
    public UpdateSourceServerResult withReplicationType(String replicationType) {
    ...
    public UpdateSourceServerResult withReplicationType(ReplicationType replicationType) {
    ...
    public UpdateSourceServerResult withSourceProperties(SourceProperties sourceProperties) {
    ...
    public UpdateSourceServerResult withSourceServerID(String sourceServerID) {
    ...
    public UpdateSourceServerResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateSourceServerResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateSourceServerResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UpdateSourceServerResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public UpdateSourceServerResult withUserProvidedID(String userProvidedID) {
    ...
    public UpdateSourceServerResult withVcenterClientID(String vcenterClientID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSourceServerResult == false)
            return false;
        UpdateSourceServerResult other = (UpdateSourceServerResult) obj;
    ...
    @Override
    public UpdateSourceServerResult clone() {
        try {
            return (UpdateSourceServerResult) super.clone();
