...
public class StartCutoverRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Start Cutover by Source Server IDs.
     */
    ...
    public StartCutoverRequest withSourceServerIDs(java.util.Collection<String> sourceServerIDs) {
    ...
    public StartCutoverRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see StartCutoverRequest#withTags
