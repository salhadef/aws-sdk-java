...
public class DisconnectFromServiceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisconnectFromServiceResult withApplicationID(String applicationID) {
    ...
    public DisconnectFromServiceResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public DisconnectFromServiceResult withConnectorAction(SourceServerConnectorAction connectorAction) {
    ...
    public DisconnectFromServiceResult withDataReplicationInfo(DataReplicationInfo dataReplicationInfo) {
    ...
    public DisconnectFromServiceResult withFqdnForActionFramework(String fqdnForActionFramework) {
    ...
    public DisconnectFromServiceResult withIsArchived(Boolean isArchived) {
    ...
    public DisconnectFromServiceResult withLaunchedInstance(LaunchedInstance launchedInstance) {
    ...
    public DisconnectFromServiceResult withLifeCycle(LifeCycle lifeCycle) {
    ...
    public DisconnectFromServiceResult withReplicationType(String replicationType) {
    ...
    public DisconnectFromServiceResult withReplicationType(ReplicationType replicationType) {
    ...
    public DisconnectFromServiceResult withSourceProperties(SourceProperties sourceProperties) {
    ...
    public DisconnectFromServiceResult withSourceServerID(String sourceServerID) {
    ...
    public DisconnectFromServiceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see DisconnectFromServiceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DisconnectFromServiceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public DisconnectFromServiceResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public DisconnectFromServiceResult withUserProvidedID(String userProvidedID) {
    ...
    public DisconnectFromServiceResult withVcenterClientID(String vcenterClientID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisconnectFromServiceResult == false)
            return false;
        DisconnectFromServiceResult other = (DisconnectFromServiceResult) obj;
    ...
    @Override
    public DisconnectFromServiceResult clone() {
        try {
            return (DisconnectFromServiceResult) super.clone();
