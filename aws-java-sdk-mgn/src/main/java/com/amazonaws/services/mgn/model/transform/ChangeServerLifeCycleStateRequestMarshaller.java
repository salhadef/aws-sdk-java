...
/**
 * ChangeServerLifeCycleStateRequestMarshaller
 */
...
public class ChangeServerLifeCycleStateRequestMarshaller {
    ...
    private static final ChangeServerLifeCycleStateRequestMarshaller instance = new ChangeServerLifeCycleStateRequestMarshaller();

    public static ChangeServerLifeCycleStateRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ChangeServerLifeCycleStateRequest changeServerLifeCycleStateRequest, ProtocolMarshaller protocolMarshaller) {
