...
public class MarkAsArchivedResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public MarkAsArchivedResult withApplicationID(String applicationID) {
    ...
    public MarkAsArchivedResult withConnectorAction(SourceServerConnectorAction connectorAction) {
    ...
    public MarkAsArchivedResult withFqdnForActionFramework(String fqdnForActionFramework) {
    ...
    public MarkAsArchivedResult withReplicationType(String replicationType) {
    ...
    public MarkAsArchivedResult withReplicationType(ReplicationType replicationType) {
    ...
    public MarkAsArchivedResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see MarkAsArchivedResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public MarkAsArchivedResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public MarkAsArchivedResult withUserProvidedID(String userProvidedID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MarkAsArchivedResult == false)
            return false;
        MarkAsArchivedResult other = (MarkAsArchivedResult) obj;
    ...
    @Override
    public MarkAsArchivedResult clone() {
        try {
