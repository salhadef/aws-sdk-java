...
@SdkInternalApi
public class DeleteJobRequestMarshaller {
    ...
    public static DeleteJobRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DeleteJobRequest deleteJobRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteJobRequest.getAccountID(), ACCOUNTID_BINDING);
