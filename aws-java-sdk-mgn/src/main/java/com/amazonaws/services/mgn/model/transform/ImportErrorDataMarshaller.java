...
public class ImportErrorDataMarshaller {
    ...
    private static final MarshallingInfo<Long> ROWNUMBER_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("rowNumber").build();
    ...
    private static final ImportErrorDataMarshaller instance = new ImportErrorDataMarshaller();

    public static ImportErrorDataMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ImportErrorData importErrorData, ProtocolMarshaller protocolMarshaller) {

        if (importErrorData == null) {
        ...
        try {
            ...
            protocolMarshaller.marshall(importErrorData.getRowNumber(), ROWNUMBER_BINDING);
            protocolMarshaller.marshall(importErrorData.getSourceServerID(), SOURCESERVERID_BINDING);
            protocolMarshaller.marshall(importErrorData.getWaveID(), WAVEID_BINDING);
        } catch (Exception e) {
