...
/**
 * ImportErrorData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportErrorDataJsonUnmarshaller implements Unmarshaller<ImportErrorData, JsonUnmarshallerContext> {

    public ImportErrorData unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ImportErrorDataJsonUnmarshaller instance;

    public static ImportErrorDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImportErrorDataJsonUnmarshaller();
        return instance;
    }
}
