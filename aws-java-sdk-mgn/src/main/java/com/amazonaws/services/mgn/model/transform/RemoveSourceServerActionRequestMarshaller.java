...
/**
 * RemoveSourceServerActionRequestMarshaller
 */
...
public class RemoveSourceServerActionRequestMarshaller {
    ...
    private static final RemoveSourceServerActionRequestMarshaller instance = new RemoveSourceServerActionRequestMarshaller();

    public static RemoveSourceServerActionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RemoveSourceServerActionRequest removeSourceServerActionRequest, ProtocolMarshaller protocolMarshaller) {
