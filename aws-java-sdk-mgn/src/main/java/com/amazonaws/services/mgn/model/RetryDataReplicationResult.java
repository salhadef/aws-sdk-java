...
public class RetryDataReplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public RetryDataReplicationResult withConnectorAction(SourceServerConnectorAction connectorAction) {
    ...
    public RetryDataReplicationResult withIsArchived(Boolean isArchived) {
    ...
    public RetryDataReplicationResult withLaunchedInstance(LaunchedInstance launchedInstance) {
