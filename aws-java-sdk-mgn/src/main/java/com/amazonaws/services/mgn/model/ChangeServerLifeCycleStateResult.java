...
public class ChangeServerLifeCycleStateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ChangeServerLifeCycleStateResult withConnectorAction(SourceServerConnectorAction connectorAction) {
    ...
    public ChangeServerLifeCycleStateResult withFqdnForActionFramework(String fqdnForActionFramework) {
    ...
    public ChangeServerLifeCycleStateResult withUserProvidedID(String userProvidedID) {
