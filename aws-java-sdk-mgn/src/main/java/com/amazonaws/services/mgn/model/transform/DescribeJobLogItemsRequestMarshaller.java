...
/**
 * DescribeJobLogItemsRequestMarshaller
 */
...
public class DescribeJobLogItemsRequestMarshaller {
    ...
    private static final DescribeJobLogItemsRequestMarshaller instance = new DescribeJobLogItemsRequestMarshaller();

    public static DescribeJobLogItemsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeJobLogItemsRequest describeJobLogItemsRequest, ProtocolMarshaller protocolMarshaller) {
