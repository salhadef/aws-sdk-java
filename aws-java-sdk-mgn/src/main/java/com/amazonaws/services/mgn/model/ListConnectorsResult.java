...
public class ListConnectorsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<Connector> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return List connectors response items.
     */

    public java.util.List<Connector> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<Connector> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<Connector>(items);
    }
    ...
    public ListConnectorsResult withItems(Connector... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<Connector>(items.length));
        }
        for (Connector ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListConnectorsResult withItems(java.util.Collection<Connector> items) {
        setItems(items);
        return this;
    }
     ...
     * </p>
     * 
     * @return List connectors response next token.
     */
