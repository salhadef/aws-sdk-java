...
public class ResumeReplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ResumeReplicationResult withApplicationID(String applicationID) {
    ...
    public ResumeReplicationResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public ResumeReplicationResult withConnectorAction(SourceServerConnectorAction connectorAction) {
    ...
    public ResumeReplicationResult withDataReplicationInfo(DataReplicationInfo dataReplicationInfo) {
    ...
    public ResumeReplicationResult withFqdnForActionFramework(String fqdnForActionFramework) {
    ...
    public ResumeReplicationResult withIsArchived(Boolean isArchived) {
    ...
    public ResumeReplicationResult withLaunchedInstance(LaunchedInstance launchedInstance) {
    ...
    public ResumeReplicationResult withLifeCycle(LifeCycle lifeCycle) {
    ...
    public ResumeReplicationResult withReplicationType(String replicationType) {
    ...
    public ResumeReplicationResult withReplicationType(ReplicationType replicationType) {
    ...
    public ResumeReplicationResult withSourceProperties(SourceProperties sourceProperties) {
    ...
    public ResumeReplicationResult withSourceServerID(String sourceServerID) {
    ...
    public ResumeReplicationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ResumeReplicationResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ResumeReplicationResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public ResumeReplicationResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public ResumeReplicationResult withUserProvidedID(String userProvidedID) {
    ...
    public ResumeReplicationResult withVcenterClientID(String vcenterClientID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResumeReplicationResult == false)
            return false;
        ResumeReplicationResult other = (ResumeReplicationResult) obj;
    ...
    @Override
    public ResumeReplicationResult clone() {
        try {
            return (ResumeReplicationResult) super.clone();
