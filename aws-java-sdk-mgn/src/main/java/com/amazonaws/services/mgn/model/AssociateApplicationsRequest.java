...
public class AssociateApplicationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AssociateApplicationsRequest withAccountID(String accountID) {
    ...
    public AssociateApplicationsRequest withApplicationIDs(String... applicationIDs) {
    ...
    public AssociateApplicationsRequest withApplicationIDs(java.util.Collection<String> applicationIDs) {
    ...
    public AssociateApplicationsRequest withWaveID(String waveID) {
        setWaveID(waveID);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateApplicationsRequest == false)
            return false;
    ...
    @Override
    public AssociateApplicationsRequest clone() {
        return (AssociateApplicationsRequest) super.clone();
    }
