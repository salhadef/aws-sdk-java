...
public class PauseReplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PauseReplicationResult withApplicationID(String applicationID) {
    ...
    public PauseReplicationResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public PauseReplicationResult withConnectorAction(SourceServerConnectorAction connectorAction) {
    ...
    public PauseReplicationResult withDataReplicationInfo(DataReplicationInfo dataReplicationInfo) {
    ...
    public PauseReplicationResult withFqdnForActionFramework(String fqdnForActionFramework) {
    ...
    public PauseReplicationResult withIsArchived(Boolean isArchived) {
    ...
    public PauseReplicationResult withLaunchedInstance(LaunchedInstance launchedInstance) {
    ...
    public PauseReplicationResult withLifeCycle(LifeCycle lifeCycle) {
    ...
    public PauseReplicationResult withReplicationType(String replicationType) {
    ...
    public PauseReplicationResult withReplicationType(ReplicationType replicationType) {
    ...
    public PauseReplicationResult withSourceProperties(SourceProperties sourceProperties) {
    ...
    public PauseReplicationResult withSourceServerID(String sourceServerID) {
    ...
    public PauseReplicationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see PauseReplicationResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PauseReplicationResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public PauseReplicationResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public PauseReplicationResult withUserProvidedID(String userProvidedID) {
    ...
    public PauseReplicationResult withVcenterClientID(String vcenterClientID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PauseReplicationResult == false)
            return false;
        PauseReplicationResult other = (PauseReplicationResult) obj;
    ...
    @Override
    public PauseReplicationResult clone() {
        try {
            return (PauseReplicationResult) super.clone();
