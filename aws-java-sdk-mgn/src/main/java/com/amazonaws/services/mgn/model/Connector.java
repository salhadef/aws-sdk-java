...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/Connector" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Connector implements Serializable, Cloneable, StructuredPojo {
    ...
    public Connector withSsmCommandConfig(ConnectorSsmCommandConfig ssmCommandConfig) {
    ...
    public Connector withSsmInstanceID(String ssmInstanceID) {
    ...
    public Connector withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see Connector#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public Connector addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public Connector clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mgn.model.transform.ConnectorMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
