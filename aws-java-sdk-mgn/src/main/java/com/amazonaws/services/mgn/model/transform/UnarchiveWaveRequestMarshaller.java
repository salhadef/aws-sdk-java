...
/**
 * UnarchiveWaveRequestMarshaller
 */
...
public class UnarchiveWaveRequestMarshaller {
    ...
    private static final UnarchiveWaveRequestMarshaller instance = new UnarchiveWaveRequestMarshaller();

    public static UnarchiveWaveRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UnarchiveWaveRequest unarchiveWaveRequest, ProtocolMarshaller protocolMarshaller) {

        if (unarchiveWaveRequest == null) {
