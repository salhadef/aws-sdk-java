...
public class AssociateSourceServersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AssociateSourceServersRequest withAccountID(String accountID) {
    ...
    public AssociateSourceServersRequest withApplicationID(String applicationID) {
    ...
    public AssociateSourceServersRequest withSourceServerIDs(String... sourceServerIDs) {
    ...
    public AssociateSourceServersRequest withSourceServerIDs(java.util.Collection<String> sourceServerIDs) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateSourceServersRequest == false)
            return false;
    ...
    @Override
    public AssociateSourceServersRequest clone() {
