...
public class StartTestRequestMarshaller {
    ...
    private static final StartTestRequestMarshaller instance = new StartTestRequestMarshaller();

    public static StartTestRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartTestRequest startTestRequest, ProtocolMarshaller protocolMarshaller) {
