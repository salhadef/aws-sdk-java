...
public class DeleteWaveRequestMarshaller {
    ...
    private static final DeleteWaveRequestMarshaller instance = new DeleteWaveRequestMarshaller();

    public static DeleteWaveRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteWaveRequest deleteWaveRequest, ProtocolMarshaller protocolMarshaller) {

        if (deleteWaveRequest == null) {
