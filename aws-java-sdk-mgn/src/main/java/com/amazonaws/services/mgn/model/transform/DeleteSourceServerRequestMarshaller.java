...
/**
 * DeleteSourceServerRequestMarshaller
 */
...
public class DeleteSourceServerRequestMarshaller {
    ...
    private static final DeleteSourceServerRequestMarshaller instance = new DeleteSourceServerRequestMarshaller();

    public static DeleteSourceServerRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteSourceServerRequest deleteSourceServerRequest, ProtocolMarshaller protocolMarshaller) {
