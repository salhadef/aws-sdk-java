...
public class StartTestRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Start Test for Source Server IDs.
     */
    ...
    public StartTestRequest withSourceServerIDs(String... sourceServerIDs) {
    ...
    public StartTestRequest withSourceServerIDs(java.util.Collection<String> sourceServerIDs) {
    ...
    public StartTestRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see StartTestRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public StartTestRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public StartTestRequest clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public StartTestRequest clone() {
        return (StartTestRequest) super.clone();
    }
