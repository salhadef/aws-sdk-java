...
public class DescribeSourceServersRequestMarshaller {
    ...
    private static final DescribeSourceServersRequestMarshaller instance = new DescribeSourceServersRequestMarshaller();

    public static DescribeSourceServersRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeSourceServersRequest describeSourceServersRequest, ProtocolMarshaller protocolMarshaller) {
