...
public class FinalizeCutoverResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public FinalizeCutoverResult withApplicationID(String applicationID) {
    ...
    public FinalizeCutoverResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public FinalizeCutoverResult withConnectorAction(SourceServerConnectorAction connectorAction) {
    ...
    public FinalizeCutoverResult withDataReplicationInfo(DataReplicationInfo dataReplicationInfo) {
    ...
    public FinalizeCutoverResult withFqdnForActionFramework(String fqdnForActionFramework) {
    ...
    public FinalizeCutoverResult withIsArchived(Boolean isArchived) {
    ...
    public FinalizeCutoverResult withLaunchedInstance(LaunchedInstance launchedInstance) {
    ...
    public FinalizeCutoverResult withLifeCycle(LifeCycle lifeCycle) {
    ...
    public FinalizeCutoverResult withReplicationType(String replicationType) {
    ...
    public FinalizeCutoverResult withReplicationType(ReplicationType replicationType) {
    ...
    public FinalizeCutoverResult withSourceProperties(SourceProperties sourceProperties) {
    ...
    public FinalizeCutoverResult withSourceServerID(String sourceServerID) {
    ...
    public FinalizeCutoverResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see FinalizeCutoverResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public FinalizeCutoverResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public FinalizeCutoverResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public FinalizeCutoverResult withUserProvidedID(String userProvidedID) {
    ...
    public FinalizeCutoverResult withVcenterClientID(String vcenterClientID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FinalizeCutoverResult == false)
            return false;
        FinalizeCutoverResult other = (FinalizeCutoverResult) obj;
    ...
    @Override
    public FinalizeCutoverResult clone() {
        try {
            return (FinalizeCutoverResult) super.clone();
