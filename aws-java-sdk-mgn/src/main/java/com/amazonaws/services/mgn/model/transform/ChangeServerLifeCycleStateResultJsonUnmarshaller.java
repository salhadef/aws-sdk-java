...
/**
 * ChangeServerLifeCycleStateResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChangeServerLifeCycleStateResultJsonUnmarshaller implements Unmarshaller<ChangeServerLifeCycleStateResult, JsonUnmarshallerContext> {

    public ChangeServerLifeCycleStateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ChangeServerLifeCycleStateResult changeServerLifeCycleStateResult = new ChangeServerLifeCycleStateResult();
    ...
    private static ChangeServerLifeCycleStateResultJsonUnmarshaller instance;

    public static ChangeServerLifeCycleStateResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ChangeServerLifeCycleStateResultJsonUnmarshaller();
        return instance;
    }
}
