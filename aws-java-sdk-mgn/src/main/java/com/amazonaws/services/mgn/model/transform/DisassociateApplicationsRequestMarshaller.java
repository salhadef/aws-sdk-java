...
/**
 * DisassociateApplicationsRequestMarshaller
 */
...
public class DisassociateApplicationsRequestMarshaller {
    ...
    private static final DisassociateApplicationsRequestMarshaller instance = new DisassociateApplicationsRequestMarshaller();

    public static DisassociateApplicationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DisassociateApplicationsRequest disassociateApplicationsRequest, ProtocolMarshaller protocolMarshaller) {
