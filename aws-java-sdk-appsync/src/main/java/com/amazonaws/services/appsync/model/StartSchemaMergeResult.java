...
public class StartSchemaMergeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartSchemaMergeResult withSourceApiAssociationStatus(String sourceApiAssociationStatus) {
    ...
    public StartSchemaMergeResult withSourceApiAssociationStatus(SourceApiAssociationStatus sourceApiAssociationStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartSchemaMergeResult == false)
            return false;
        StartSchemaMergeResult other = (StartSchemaMergeResult) obj;
    ...
    @Override
    public StartSchemaMergeResult clone() {
        try {
            return (StartSchemaMergeResult) super.clone();
