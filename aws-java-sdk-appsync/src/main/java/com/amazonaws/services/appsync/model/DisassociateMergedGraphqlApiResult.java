...
public class DisassociateMergedGraphqlApiResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateMergedGraphqlApiResult == false)
            return false;
        DisassociateMergedGraphqlApiResult other = (DisassociateMergedGraphqlApiResult) obj;
    ...
    public DisassociateMergedGraphqlApiResult clone() {
        try {
            return (DisassociateMergedGraphqlApiResult) super.clone();
