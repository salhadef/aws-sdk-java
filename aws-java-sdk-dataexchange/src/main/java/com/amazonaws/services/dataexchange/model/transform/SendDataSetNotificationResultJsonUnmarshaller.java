...
/**
 * SendDataSetNotificationResult JSON Unmarshaller
 */
...
public class SendDataSetNotificationResultJsonUnmarshaller implements Unmarshaller<SendDataSetNotificationResult, JsonUnmarshallerContext> {
    ...
    public SendDataSetNotificationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SendDataSetNotificationResult sendDataSetNotificationResult = new SendDataSetNotificationResult();

        return sendDataSetNotificationResult;
    }
