 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/events-2015-10-07/CreateConnectionApiKeyAuthRequestParameters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateConnectionApiKeyAuthRequestParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateConnectionApiKeyAuthRequestParameters == false)
            return false;
    ...
    @Override
    public CreateConnectionApiKeyAuthRequestParameters clone() {
        try {
            return (CreateConnectionApiKeyAuthRequestParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cloudwatchevents.model.transform.CreateConnectionApiKeyAuthRequestParametersMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
