...
/**
 * KmsKey JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KmsKeyJsonUnmarshaller implements Unmarshaller<KmsKey, JsonUnmarshallerContext> {

    public KmsKey unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static KmsKeyJsonUnmarshaller instance;

    public static KmsKeyJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new KmsKeyJsonUnmarshaller();
        return instance;
    }
}
