...
public class PutNotificationSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutNotificationSettingsResult == false)
            return false;
        PutNotificationSettingsResult other = (PutNotificationSettingsResult) obj;
    ...
    @Override
    public PutNotificationSettingsResult clone() {
        try {
            return (PutNotificationSettingsResult) super.clone();
