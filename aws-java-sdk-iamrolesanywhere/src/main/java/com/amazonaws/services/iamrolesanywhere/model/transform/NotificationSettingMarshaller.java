...
/**
 * NotificationSettingMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class NotificationSettingMarshaller {
    ...
    private static final NotificationSettingMarshaller instance = new NotificationSettingMarshaller();

    public static NotificationSettingMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(NotificationSetting notificationSetting, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(notificationSetting.getChannel(), CHANNEL_BINDING);
            protocolMarshaller.marshall(notificationSetting.getEnabled(), ENABLED_BINDING);
            protocolMarshaller.marshall(notificationSetting.getEvent(), EVENT_BINDING);
            protocolMarshaller.marshall(notificationSetting.getThreshold(), THRESHOLD_BINDING);
        } catch (Exception e) {
