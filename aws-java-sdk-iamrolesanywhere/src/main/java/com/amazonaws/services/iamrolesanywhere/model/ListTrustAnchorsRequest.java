...
public class ListTrustAnchorsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListTrustAnchorsRequest withPageSize(Integer pageSize) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTrustAnchorsRequest == false)
            return false;
        ListTrustAnchorsRequest other = (ListTrustAnchorsRequest) obj;
    ...
    @Override
    public ListTrustAnchorsRequest clone() {
        return (ListTrustAnchorsRequest) super.clone();
    }
