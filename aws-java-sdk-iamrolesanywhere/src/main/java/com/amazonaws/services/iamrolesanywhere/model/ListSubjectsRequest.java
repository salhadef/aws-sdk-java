...
public class ListSubjectsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListSubjectsRequest withPageSize(Integer pageSize) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSubjectsRequest == false)
            return false;
        ListSubjectsRequest other = (ListSubjectsRequest) obj;
    ...
    @Override
    public ListSubjectsRequest clone() {
        return (ListSubjectsRequest) super.clone();
    }
