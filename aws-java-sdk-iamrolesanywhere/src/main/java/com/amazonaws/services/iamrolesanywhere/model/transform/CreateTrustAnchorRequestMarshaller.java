...
public class CreateTrustAnchorRequestMarshaller {
    ...
    private static final CreateTrustAnchorRequestMarshaller instance = new CreateTrustAnchorRequestMarshaller();

    public static CreateTrustAnchorRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateTrustAnchorRequest createTrustAnchorRequest, ProtocolMarshaller protocolMarshaller) {

        if (createTrustAnchorRequest == null) {
