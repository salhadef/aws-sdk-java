...
public class ListCrlsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListCrlsRequest withPageSize(Integer pageSize) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCrlsRequest == false)
            return false;
        ListCrlsRequest other = (ListCrlsRequest) obj;
    ...
    @Override
    public ListCrlsRequest clone() {
        return (ListCrlsRequest) super.clone();
    }
