...
/**
 * TrustAnchorDetail JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TrustAnchorDetailJsonUnmarshaller implements Unmarshaller<TrustAnchorDetail, JsonUnmarshallerContext> {

    public TrustAnchorDetail unmarshall(JsonUnmarshallerContext context) throws Exception {
        TrustAnchorDetail trustAnchorDetail = new TrustAnchorDetail();
    ...
    private static TrustAnchorDetailJsonUnmarshaller instance;

    public static TrustAnchorDetailJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TrustAnchorDetailJsonUnmarshaller();
        return instance;
    }
}
