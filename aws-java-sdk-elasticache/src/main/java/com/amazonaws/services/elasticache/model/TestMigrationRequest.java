...
public class TestMigrationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the replication group to which data is to be migrated.
     */
     ...
     * </p>
     * 
     * @return List of endpoints from which data should be migrated. List should have only one element.
     */
    ...
    public TestMigrationRequest withCustomerNodeEndpointList(CustomerNodeEndpoint... customerNodeEndpointList) {
    ...
    public TestMigrationRequest withCustomerNodeEndpointList(java.util.Collection<CustomerNodeEndpoint> customerNodeEndpointList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TestMigrationRequest == false)
            return false;
        TestMigrationRequest other = (TestMigrationRequest) obj;
    ...
    public TestMigrationRequest clone() {
        return (TestMigrationRequest) super.clone();
    }
