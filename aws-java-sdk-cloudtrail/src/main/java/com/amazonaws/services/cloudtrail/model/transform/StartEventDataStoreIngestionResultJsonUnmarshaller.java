...
/**
 * StartEventDataStoreIngestionResult JSON Unmarshaller
 */
...
public class StartEventDataStoreIngestionResultJsonUnmarshaller implements Unmarshaller<StartEventDataStoreIngestionResult, JsonUnmarshallerContext> {
    ...
    public StartEventDataStoreIngestionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartEventDataStoreIngestionResult startEventDataStoreIngestionResult = new StartEventDataStoreIngestionResult();

        return startEventDataStoreIngestionResult;
    }
