...
public class StartEventDataStoreIngestionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN (or ID suffix of the ARN) of the event data store for which you want to start ingestion.
     */
    ...
    public StartEventDataStoreIngestionRequest withEventDataStore(String eventDataStore) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartEventDataStoreIngestionRequest == false)
            return false;
        StartEventDataStoreIngestionRequest other = (StartEventDataStoreIngestionRequest) obj;
    ...
    @Override
    public StartEventDataStoreIngestionRequest clone() {
        return (StartEventDataStoreIngestionRequest) super.clone();
    }
