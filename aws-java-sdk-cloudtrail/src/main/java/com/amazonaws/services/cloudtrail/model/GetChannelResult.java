...
public class GetChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The destinations for the channel. For channels created for integrations, the destinations are the event data
     * stores that log events arriving through the channel. For service-linked channels, the destination is the Amazon
     * Web Services service that created the service-linked channel to receive events.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The source for the CloudTrail channel.
     */
     ...
     * </p>
     * 
     * @return The destinations for the channel. For channels created for integrations, the destinations are the event
     *         data stores that log events arriving through the channel. For service-linked channels, the destination is
     *         the Amazon Web Services service that created the service-linked channel to receive events.
     */
     ...
     * </p>
     * 
     * @return A table showing information about the most recent successful and failed attempts to ingest events.
     */
