...
public class StopEventDataStoreIngestionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN (or ID suffix of the ARN) of the event data store for which you want to stop ingestion.
     */
    ...
    public StopEventDataStoreIngestionRequest withEventDataStore(String eventDataStore) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopEventDataStoreIngestionRequest == false)
            return false;
        StopEventDataStoreIngestionRequest other = (StopEventDataStoreIngestionRequest) obj;
    ...
    @Override
    public StopEventDataStoreIngestionRequest clone() {
        return (StopEventDataStoreIngestionRequest) super.clone();
    }
