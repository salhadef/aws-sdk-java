...
public class RestoreEventDataStoreResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The event data store ARN.
     */
     ...
     * </p>
     * 
     * @return The status of the event data store.
     * @see EventDataStoreStatus
     */
     ...
     * </p>
     * 
     * @return The advanced event selectors that were used to select events.
     */
    ...
    public RestoreEventDataStoreResult withAdvancedEventSelectors(AdvancedEventSelector... advancedEventSelectors) {
    ...
    public RestoreEventDataStoreResult withAdvancedEventSelectors(java.util.Collection<AdvancedEventSelector> advancedEventSelectors) {
     ...
     * </p>
     * 
     * @return The timestamp of an event data store's creation.
     */
    ...
    public RestoreEventDataStoreResult withCreatedTimestamp(java.util.Date createdTimestamp) {
    ...
    public RestoreEventDataStoreResult withUpdatedTimestamp(java.util.Date updatedTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RestoreEventDataStoreResult == false)
            return false;
        RestoreEventDataStoreResult other = (RestoreEventDataStoreResult) obj;
