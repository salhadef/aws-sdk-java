...
public class UpdateConfigurationProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateConfigurationProfileResult withValidators(Validator... validators) {
    ...
    public UpdateConfigurationProfileResult withValidators(java.util.Collection<Validator> validators) {
    ...
    public UpdateConfigurationProfileResult withKmsKeyArn(String kmsKeyArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConfigurationProfileResult == false)
            return false;
        UpdateConfigurationProfileResult other = (UpdateConfigurationProfileResult) obj;
    ...
    public UpdateConfigurationProfileResult clone() {
        try {
            return (UpdateConfigurationProfileResult) super.clone();
