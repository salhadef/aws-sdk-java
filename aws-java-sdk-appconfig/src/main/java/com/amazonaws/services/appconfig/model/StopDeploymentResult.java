...
public class StopDeploymentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopDeploymentResult withAppliedExtensions(AppliedExtension... appliedExtensions) {
    ...
    public StopDeploymentResult withAppliedExtensions(java.util.Collection<AppliedExtension> appliedExtensions) {
    ...
    public StopDeploymentResult withKmsKeyArn(String kmsKeyArn) {
