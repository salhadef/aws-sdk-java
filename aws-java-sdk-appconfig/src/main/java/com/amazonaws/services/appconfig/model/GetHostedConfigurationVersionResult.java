...
public class GetHostedConfigurationVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetHostedConfigurationVersionResult withApplicationId(String applicationId) {
    ...
    public GetHostedConfigurationVersionResult withConfigurationProfileId(String configurationProfileId) {
    ...
    public GetHostedConfigurationVersionResult withVersionNumber(Integer versionNumber) {
    ...
    public GetHostedConfigurationVersionResult withDescription(String description) {
    ...
    public GetHostedConfigurationVersionResult withContent(java.nio.ByteBuffer content) {
        setContent(content);
        return this;
    }
    ...
    public GetHostedConfigurationVersionResult withContentType(String contentType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetHostedConfigurationVersionResult == false)
            return false;
        GetHostedConfigurationVersionResult other = (GetHostedConfigurationVersionResult) obj;
    ...
    @Override
    public GetHostedConfigurationVersionResult clone() {
        try {
            return (GetHostedConfigurationVersionResult) super.clone();
