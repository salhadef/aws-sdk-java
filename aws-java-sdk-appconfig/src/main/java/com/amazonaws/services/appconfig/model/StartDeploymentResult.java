...
public class StartDeploymentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartDeploymentResult withEventLog(DeploymentEvent... eventLog) {
    ...
    public StartDeploymentResult withEventLog(java.util.Collection<DeploymentEvent> eventLog) {
    ...
    public StartDeploymentResult withStartedAt(java.util.Date startedAt) {
    ...
    public StartDeploymentResult withCompletedAt(java.util.Date completedAt) {
    ...
    public StartDeploymentResult withAppliedExtensions(AppliedExtension... appliedExtensions) {
    ...
    public StartDeploymentResult withAppliedExtensions(java.util.Collection<AppliedExtension> appliedExtensions) {
