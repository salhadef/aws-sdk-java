...
public class MaxNumberOfOrganizationConformancePacksExceededException extends com.amazonaws.services.config.model.AmazonConfigException {
     ...
     */
    public MaxNumberOfOrganizationConformancePacksExceededException(String message) {
        super(message);
    }
