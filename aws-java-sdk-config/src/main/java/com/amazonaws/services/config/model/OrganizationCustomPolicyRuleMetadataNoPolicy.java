...
public class OrganizationCustomPolicyRuleMetadataNoPolicy implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The type of notification that triggers Config to run an evaluation for a rule. For Config Custom Policy rules,
     ...
     * </ul>
     * 
     * @return The type of notification that triggers Config to run an evaluation for a rule. For Config Custom Policy
     *         rules, Config supports change triggered notification types:</p>
     *         <ul>
     *         <li>
     *         <p>
    ...
    public OrganizationCustomPolicyRuleMetadataNoPolicy withOrganizationConfigRuleTriggerTypes(java.util.Collection<String> organizationConfigRuleTriggerTypes) {
    ...
    public OrganizationCustomPolicyRuleMetadataNoPolicy withOrganizationConfigRuleTriggerTypes(
    ...
    public OrganizationCustomPolicyRuleMetadataNoPolicy withResourceTypesScope(java.util.Collection<String> resourceTypesScope) {
    ...
    public OrganizationCustomPolicyRuleMetadataNoPolicy withDebugLogDeliveryAccounts(java.util.Collection<String> debugLogDeliveryAccounts) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OrganizationCustomPolicyRuleMetadataNoPolicy == false)
            return false;
        OrganizationCustomPolicyRuleMetadataNoPolicy other = (OrganizationCustomPolicyRuleMetadataNoPolicy) obj;
    ...
    public OrganizationCustomPolicyRuleMetadataNoPolicy clone() {
        try {
            return (OrganizationCustomPolicyRuleMetadataNoPolicy) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.config.model.transform.OrganizationCustomPolicyRuleMetadataNoPolicyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
