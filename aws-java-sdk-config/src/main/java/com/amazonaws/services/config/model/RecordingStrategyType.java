...
public enum RecordingStrategyType {
     ...
     * @param value
     *        real value
     * @return RecordingStrategyType corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static RecordingStrategyType fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (RecordingStrategyType enumEntry : RecordingStrategyType.values()) {
