...
public class MaxNumberOfConformancePacksExceededException extends com.amazonaws.services.config.model.AmazonConfigException {
     ...
     */
    public MaxNumberOfConformancePacksExceededException(String message) {
        super(message);
    }
