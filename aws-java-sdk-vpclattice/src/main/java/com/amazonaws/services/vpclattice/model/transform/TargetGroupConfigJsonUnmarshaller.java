...
/**
 * TargetGroupConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TargetGroupConfigJsonUnmarshaller implements Unmarshaller<TargetGroupConfig, JsonUnmarshallerContext> {

    public TargetGroupConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static TargetGroupConfigJsonUnmarshaller instance;

    public static TargetGroupConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TargetGroupConfigJsonUnmarshaller();
        return instance;
    }
}
