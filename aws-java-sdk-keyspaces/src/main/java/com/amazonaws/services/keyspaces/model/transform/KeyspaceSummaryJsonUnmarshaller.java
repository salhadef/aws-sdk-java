...
/**
 * KeyspaceSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KeyspaceSummaryJsonUnmarshaller implements Unmarshaller<KeyspaceSummary, JsonUnmarshallerContext> {

    public KeyspaceSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        KeyspaceSummary keyspaceSummary = new KeyspaceSummary();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("keyspaceName", targetDepth)) {
                    context.nextToken();
                    keyspaceSummary.setKeyspaceName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static KeyspaceSummaryJsonUnmarshaller instance;

    public static KeyspaceSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new KeyspaceSummaryJsonUnmarshaller();
        return instance;
    }
}
