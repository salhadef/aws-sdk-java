...
/**
 * AwsDmsEndpointDetailsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AwsDmsEndpointDetailsMarshaller {
    ...
    private static final AwsDmsEndpointDetailsMarshaller instance = new AwsDmsEndpointDetailsMarshaller();

    public static AwsDmsEndpointDetailsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AwsDmsEndpointDetails awsDmsEndpointDetails, ProtocolMarshaller protocolMarshaller) {

        if (awsDmsEndpointDetails == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(awsDmsEndpointDetails.getCertificateArn(), CERTIFICATEARN_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getDatabaseName(), DATABASENAME_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getEndpointArn(), ENDPOINTARN_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getEndpointIdentifier(), ENDPOINTIDENTIFIER_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getEndpointType(), ENDPOINTTYPE_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getEngineName(), ENGINENAME_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getExternalId(), EXTERNALID_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getExtraConnectionAttributes(), EXTRACONNECTIONATTRIBUTES_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getKmsKeyId(), KMSKEYID_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getPort(), PORT_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getServerName(), SERVERNAME_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getSslMode(), SSLMODE_BINDING);
            protocolMarshaller.marshall(awsDmsEndpointDetails.getUsername(), USERNAME_BINDING);
        } catch (Exception e) {
