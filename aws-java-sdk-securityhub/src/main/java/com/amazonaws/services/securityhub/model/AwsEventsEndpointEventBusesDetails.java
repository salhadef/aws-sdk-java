 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEventsEndpointEventBusesDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEventsEndpointEventBusesDetails implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the event bus that the endpoint is associated with.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEventsEndpointEventBusesDetails == false)
            return false;
        AwsEventsEndpointEventBusesDetails other = (AwsEventsEndpointEventBusesDetails) obj;
    ...
    public AwsEventsEndpointEventBusesDetails clone() {
        try {
            return (AwsEventsEndpointEventBusesDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEventsEndpointEventBusesDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
