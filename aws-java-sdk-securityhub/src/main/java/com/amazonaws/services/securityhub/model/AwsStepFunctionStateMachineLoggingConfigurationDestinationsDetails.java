 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public AwsStepFunctionStateMachineLoggingConfigurationDestinationsCloudWatchLogsLogGroupDetails getCloudWatchLogsLogGroup() {
    ...
    public AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails withCloudWatchLogsLogGroup(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails == false)
            return false;
    ...
    public AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails clone() {
        try {
            return (AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsStepFunctionStateMachineLoggingConfigurationDestinationsDetailsMarshaller.getInstance().marshall(
