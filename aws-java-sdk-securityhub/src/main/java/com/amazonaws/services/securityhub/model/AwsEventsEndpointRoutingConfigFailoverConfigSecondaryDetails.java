 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEventsEndpointRoutingConfigFailoverConfigSecondaryDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEventsEndpointRoutingConfigFailoverConfigSecondaryDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEventsEndpointRoutingConfigFailoverConfigSecondaryDetails == false)
            return false;
    ...
    public AwsEventsEndpointRoutingConfigFailoverConfigSecondaryDetails clone() {
        try {
            return (AwsEventsEndpointRoutingConfigFailoverConfigSecondaryDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEventsEndpointRoutingConfigFailoverConfigSecondaryDetailsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
