 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsDmsReplicationInstanceVpcSecurityGroupsDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsDmsReplicationInstanceVpcSecurityGroupsDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getVpcSecurityGroupId() != null)
            sb.append("VpcSecurityGroupId: ").append(getVpcSecurityGroupId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsDmsReplicationInstanceVpcSecurityGroupsDetails == false)
            return false;
    ...
    public AwsDmsReplicationInstanceVpcSecurityGroupsDetails clone() {
        try {
            return (AwsDmsReplicationInstanceVpcSecurityGroupsDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsDmsReplicationInstanceVpcSecurityGroupsDetailsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
