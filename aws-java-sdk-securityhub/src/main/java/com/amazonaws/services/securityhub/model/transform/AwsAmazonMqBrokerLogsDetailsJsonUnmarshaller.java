...
/**
 * AwsAmazonMqBrokerLogsDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsAmazonMqBrokerLogsDetailsJsonUnmarshaller implements Unmarshaller<AwsAmazonMqBrokerLogsDetails, JsonUnmarshallerContext> {

    public AwsAmazonMqBrokerLogsDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsAmazonMqBrokerLogsDetails awsAmazonMqBrokerLogsDetails = new AwsAmazonMqBrokerLogsDetails();
    ...
    private static AwsAmazonMqBrokerLogsDetailsJsonUnmarshaller instance;

    public static AwsAmazonMqBrokerLogsDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsAmazonMqBrokerLogsDetailsJsonUnmarshaller();
        return instance;
    }
}
