...
/**
 * CodeVulnerabilitiesFilePath JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CodeVulnerabilitiesFilePathJsonUnmarshaller implements Unmarshaller<CodeVulnerabilitiesFilePath, JsonUnmarshallerContext> {

    public CodeVulnerabilitiesFilePath unmarshall(JsonUnmarshallerContext context) throws Exception {
        CodeVulnerabilitiesFilePath codeVulnerabilitiesFilePath = new CodeVulnerabilitiesFilePath();
    ...
    private static CodeVulnerabilitiesFilePathJsonUnmarshaller instance;

    public static CodeVulnerabilitiesFilePathJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CodeVulnerabilitiesFilePathJsonUnmarshaller();
        return instance;
    }
}
