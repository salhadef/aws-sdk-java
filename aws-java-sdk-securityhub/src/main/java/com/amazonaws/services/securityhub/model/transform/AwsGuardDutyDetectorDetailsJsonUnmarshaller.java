...
/**
 * AwsGuardDutyDetectorDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsGuardDutyDetectorDetailsJsonUnmarshaller implements Unmarshaller<AwsGuardDutyDetectorDetails, JsonUnmarshallerContext> {

    public AwsGuardDutyDetectorDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsGuardDutyDetectorDetails awsGuardDutyDetectorDetails = new AwsGuardDutyDetectorDetails();
    ...
    private static AwsGuardDutyDetectorDetailsJsonUnmarshaller instance;

    public static AwsGuardDutyDetectorDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsGuardDutyDetectorDetailsJsonUnmarshaller();
        return instance;
    }
}
