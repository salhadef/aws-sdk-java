...
/**
 * UpdateAutomationRulesRequestItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateAutomationRulesRequestItemJsonUnmarshaller implements Unmarshaller<UpdateAutomationRulesRequestItem, JsonUnmarshallerContext> {

    public UpdateAutomationRulesRequestItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateAutomationRulesRequestItem updateAutomationRulesRequestItem = new UpdateAutomationRulesRequestItem();
        ...
        return updateAutomationRulesRequestItem;
    }

    private static UpdateAutomationRulesRequestItemJsonUnmarshaller instance;

    public static UpdateAutomationRulesRequestItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateAutomationRulesRequestItemJsonUnmarshaller();
        return instance;
    }
}
