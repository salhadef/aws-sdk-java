...
public class DecisionTaskCompletedEventAttributesJsonUnmarshaller implements Unmarshaller<DecisionTaskCompletedEventAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("executionContext", targetDepth)) {
                    context.nextToken();
                    decisionTaskCompletedEventAttributes.setExecutionContext(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("scheduledEventId", targetDepth)) {
                    context.nextToken();
                    decisionTaskCompletedEventAttributes.setScheduledEventId(context.getUnmarshaller(Long.class).unmarshall(context));
                }
    ...
    public static DecisionTaskCompletedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DecisionTaskCompletedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
