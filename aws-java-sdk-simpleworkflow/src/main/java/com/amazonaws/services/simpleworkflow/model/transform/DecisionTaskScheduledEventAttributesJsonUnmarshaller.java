...
public class DecisionTaskScheduledEventAttributesJsonUnmarshaller implements Unmarshaller<DecisionTaskScheduledEventAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("taskPriority", targetDepth)) {
                    context.nextToken();
                    decisionTaskScheduledEventAttributes.setTaskPriority(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static DecisionTaskScheduledEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DecisionTaskScheduledEventAttributesJsonUnmarshaller();
        return instance;
    }
}
