...
/**
 * <p>
 * Indicates the method for setting up document ID. The supported methods are Kinesis Data Firehose generated document
 * ID and OpenSearch Service generated document ID.
 * </p>
 * <p/>
 * 
...
public class DocumentIdOptions implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * When the <code>FIREHOSE_DEFAULT</code> option is chosen, Kinesis Data Firehose generates a unique document ID for
     ...
     * </p>
     * <p>
     * When the <code>NO_DOCUMENT_ID</code> option is chosen, Kinesis Data Firehose does not include any document IDs in
     ...
     *        When the <code>FIREHOSE_DEFAULT</code> option is chosen, Kinesis Data Firehose generates a unique document
     *        ID for each record based on a unique internal identifier. The generated document ID is stable across
     *        multiple delivery attempts, which helps prevent the same record from being indexed multiple times with
     *        different document IDs.</p>
     *        <p>
     *        When the <code>NO_DOCUMENT_ID</code> option is chosen, Kinesis Data Firehose does not include any document
     *        IDs in the requests it sends to the Amazon OpenSearch Service. This causes the Amazon OpenSearch Service
     *        domain to generate document IDs. In case of multiple delivery attempts, this may cause the same record to
     *        be indexed more than once with different document IDs. This option enables write-heavy operations, such as
     ...
     * </p>
     * 
     * @return When the <code>FIREHOSE_DEFAULT</code> option is chosen, Kinesis Data Firehose generates a unique
     ...
     *         with different document IDs.</p>
     *         <p>
     *         When the <code>NO_DOCUMENT_ID</code> option is chosen, Kinesis Data Firehose does not include any
