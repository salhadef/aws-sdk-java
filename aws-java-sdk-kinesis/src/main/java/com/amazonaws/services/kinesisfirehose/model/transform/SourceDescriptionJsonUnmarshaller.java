...
/**
 * SourceDescription JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SourceDescriptionJsonUnmarshaller implements Unmarshaller<SourceDescription, JsonUnmarshallerContext> {
    ...
    private static SourceDescriptionJsonUnmarshaller instance;

    public static SourceDescriptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SourceDescriptionJsonUnmarshaller();
        return instance;
    }
}
