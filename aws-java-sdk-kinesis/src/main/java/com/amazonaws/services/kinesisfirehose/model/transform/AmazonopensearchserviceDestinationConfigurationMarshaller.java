...
/**
 * AmazonopensearchserviceDestinationConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AmazonopensearchserviceDestinationConfigurationMarshaller {
    ...
    public static AmazonopensearchserviceDestinationConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AmazonopensearchserviceDestinationConfiguration amazonopensearchserviceDestinationConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getRoleARN(), ROLEARN_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getDomainARN(), DOMAINARN_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getClusterEndpoint(), CLUSTERENDPOINT_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getIndexName(), INDEXNAME_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getTypeName(), TYPENAME_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getIndexRotationPeriod(), INDEXROTATIONPERIOD_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getBufferingHints(), BUFFERINGHINTS_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getRetryOptions(), RETRYOPTIONS_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getS3BackupMode(), S3BACKUPMODE_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationConfiguration.getS3Configuration(), S3CONFIGURATION_BINDING);
