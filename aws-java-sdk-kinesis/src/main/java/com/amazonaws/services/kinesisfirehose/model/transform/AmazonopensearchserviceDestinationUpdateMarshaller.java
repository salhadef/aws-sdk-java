...
/**
 * AmazonopensearchserviceDestinationUpdateMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AmazonopensearchserviceDestinationUpdateMarshaller {
    ...
    public static AmazonopensearchserviceDestinationUpdateMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AmazonopensearchserviceDestinationUpdate amazonopensearchserviceDestinationUpdate, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(amazonopensearchserviceDestinationUpdate.getRoleARN(), ROLEARN_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationUpdate.getDomainARN(), DOMAINARN_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationUpdate.getClusterEndpoint(), CLUSTERENDPOINT_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationUpdate.getIndexName(), INDEXNAME_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationUpdate.getTypeName(), TYPENAME_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationUpdate.getIndexRotationPeriod(), INDEXROTATIONPERIOD_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationUpdate.getBufferingHints(), BUFFERINGHINTS_BINDING);
            protocolMarshaller.marshall(amazonopensearchserviceDestinationUpdate.getRetryOptions(), RETRYOPTIONS_BINDING);
