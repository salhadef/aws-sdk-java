...
public class ConnectorSummaryMarshaller {
    ...
    private static final MarshallingInfo<String> CERTIFICATEENROLLMENTPOLICYSERVERENDPOINT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CertificateEnrollmentPolicyServerEndpoint").build();
    ...
    private static final MarshallingInfo<StructuredPojo> VPCINFORMATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("VpcInformation").build();
    ...
    public void marshall(ConnectorSummary connectorSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(connectorSummary.getCertificateEnrollmentPolicyServerEndpoint(), CERTIFICATEENROLLMENTPOLICYSERVERENDPOINT_BINDING);
            protocolMarshaller.marshall(connectorSummary.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(connectorSummary.getDirectoryId(), DIRECTORYID_BINDING);
            ...
            protocolMarshaller.marshall(connectorSummary.getVpcInformation(), VPCINFORMATION_BINDING);
        } catch (Exception e) {
