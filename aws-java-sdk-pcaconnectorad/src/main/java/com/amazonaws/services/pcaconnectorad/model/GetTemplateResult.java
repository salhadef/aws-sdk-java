...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-ad-2018-05-10/GetTemplate" target="_top">AWS API
 *      Documentation</a>
 */
...
public class GetTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A certificate template that the connector uses to issue certificates from a private CA.
     */
    ...
    public GetTemplateResult withTemplate(Template template) {
