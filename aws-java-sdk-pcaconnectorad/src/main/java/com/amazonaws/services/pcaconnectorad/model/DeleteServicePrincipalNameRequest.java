...
public class DeleteServicePrincipalNameRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteServicePrincipalNameRequest withConnectorArn(String connectorArn) {
    ...
    public DeleteServicePrincipalNameRequest withDirectoryRegistrationArn(String directoryRegistrationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteServicePrincipalNameRequest == false)
            return false;
        DeleteServicePrincipalNameRequest other = (DeleteServicePrincipalNameRequest) obj;
    ...
    @Override
    public DeleteServicePrincipalNameRequest clone() {
        return (DeleteServicePrincipalNameRequest) super.clone();
    }
