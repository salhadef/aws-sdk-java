 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-ad-2018-05-10/SubjectNameFlagsV3"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SubjectNameFlagsV3 implements Serializable, Cloneable, StructuredPojo {
    ...
    public SubjectNameFlagsV3 withRequireCommonName(Boolean requireCommonName) {
    ...
    public SubjectNameFlagsV3 withRequireDirectoryPath(Boolean requireDirectoryPath) {
    ...
    public SubjectNameFlagsV3 withRequireDnsAsCn(Boolean requireDnsAsCn) {
    ...
    public SubjectNameFlagsV3 withRequireEmail(Boolean requireEmail) {
    ...
    public SubjectNameFlagsV3 withSanRequireDirectoryGuid(Boolean sanRequireDirectoryGuid) {
    ...
    public SubjectNameFlagsV3 withSanRequireDns(Boolean sanRequireDns) {
    ...
    public SubjectNameFlagsV3 withSanRequireDomainDns(Boolean sanRequireDomainDns) {
    ...
    public SubjectNameFlagsV3 withSanRequireEmail(Boolean sanRequireEmail) {
    ...
    public SubjectNameFlagsV3 withSanRequireSpn(Boolean sanRequireSpn) {
    ...
    public SubjectNameFlagsV3 withSanRequireUpn(Boolean sanRequireUpn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SubjectNameFlagsV3 == false)
            return false;
        SubjectNameFlagsV3 other = (SubjectNameFlagsV3) obj;
    ...
    @Override
    public SubjectNameFlagsV3 clone() {
        try {
            return (SubjectNameFlagsV3) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pcaconnectorad.model.transform.SubjectNameFlagsV3Marshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
