...
public class CreateConnectorRequestMarshaller {
    ...
    public void marshall(CreateConnectorRequest createConnectorRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createConnectorRequest.getCertificateAuthorityArn(), CERTIFICATEAUTHORITYARN_BINDING);
            protocolMarshaller.marshall(createConnectorRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createConnectorRequest.getDirectoryId(), DIRECTORYID_BINDING);
            protocolMarshaller.marshall(createConnectorRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createConnectorRequest.getVpcInformation(), VPCINFORMATION_BINDING);
        } catch (Exception e) {
