...
/**
 * EnrollmentFlagsV3 JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EnrollmentFlagsV3JsonUnmarshaller implements Unmarshaller<EnrollmentFlagsV3, JsonUnmarshallerContext> {

    public EnrollmentFlagsV3 unmarshall(JsonUnmarshallerContext context) throws Exception {
        EnrollmentFlagsV3 enrollmentFlagsV3 = new EnrollmentFlagsV3();
    ...
    private static EnrollmentFlagsV3JsonUnmarshaller instance;

    public static EnrollmentFlagsV3JsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EnrollmentFlagsV3JsonUnmarshaller();
        return instance;
    }
}
