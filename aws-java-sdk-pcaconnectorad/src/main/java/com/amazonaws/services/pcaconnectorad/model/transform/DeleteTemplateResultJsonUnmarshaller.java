...
/**
 * DeleteTemplateResult JSON Unmarshaller
 */
...
public class DeleteTemplateResultJsonUnmarshaller implements Unmarshaller<DeleteTemplateResult, JsonUnmarshallerContext> {
    ...
    public DeleteTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTemplateResult deleteTemplateResult = new DeleteTemplateResult();
