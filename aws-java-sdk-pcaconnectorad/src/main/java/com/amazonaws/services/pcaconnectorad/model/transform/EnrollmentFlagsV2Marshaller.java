...
/**
 * EnrollmentFlagsV2Marshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EnrollmentFlagsV2Marshaller {
    ...
    private static final EnrollmentFlagsV2Marshaller instance = new EnrollmentFlagsV2Marshaller();

    public static EnrollmentFlagsV2Marshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EnrollmentFlagsV2 enrollmentFlagsV2, ProtocolMarshaller protocolMarshaller) {

        if (enrollmentFlagsV2 == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(enrollmentFlagsV2.getEnableKeyReuseOnNtTokenKeysetStorageFull(), ENABLEKEYREUSEONNTTOKENKEYSETSTORAGEFULL_BINDING);
            protocolMarshaller.marshall(enrollmentFlagsV2.getIncludeSymmetricAlgorithms(), INCLUDESYMMETRICALGORITHMS_BINDING);
            protocolMarshaller.marshall(enrollmentFlagsV2.getNoSecurityExtension(), NOSECURITYEXTENSION_BINDING);
            protocolMarshaller.marshall(enrollmentFlagsV2.getRemoveInvalidCertificateFromPersonalStore(), REMOVEINVALIDCERTIFICATEFROMPERSONALSTORE_BINDING);
            protocolMarshaller.marshall(enrollmentFlagsV2.getUserInteractionRequired(), USERINTERACTIONREQUIRED_BINDING);
        } catch (Exception e) {
