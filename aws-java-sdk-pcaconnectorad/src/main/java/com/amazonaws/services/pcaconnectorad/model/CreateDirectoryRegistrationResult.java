...
public class CreateDirectoryRegistrationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDirectoryRegistrationResult withDirectoryRegistrationArn(String directoryRegistrationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDirectoryRegistrationResult == false)
            return false;
        CreateDirectoryRegistrationResult other = (CreateDirectoryRegistrationResult) obj;
    ...
    @Override
    public CreateDirectoryRegistrationResult clone() {
        try {
