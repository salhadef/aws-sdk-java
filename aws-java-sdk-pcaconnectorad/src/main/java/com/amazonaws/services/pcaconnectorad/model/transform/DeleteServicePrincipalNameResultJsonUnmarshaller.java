...
/**
 * DeleteServicePrincipalNameResult JSON Unmarshaller
 */
...
public class DeleteServicePrincipalNameResultJsonUnmarshaller implements Unmarshaller<DeleteServicePrincipalNameResult, JsonUnmarshallerContext> {
    ...
    public DeleteServicePrincipalNameResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteServicePrincipalNameResult deleteServicePrincipalNameResult = new DeleteServicePrincipalNameResult();
