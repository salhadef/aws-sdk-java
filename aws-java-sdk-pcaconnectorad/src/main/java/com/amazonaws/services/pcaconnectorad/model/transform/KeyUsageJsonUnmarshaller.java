        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Critical", targetDepth)) {
                    context.nextToken();
                    keyUsage.setCritical(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("UsageFlags", targetDepth)) {
                    context.nextToken();
                    keyUsage.setUsageFlags(KeyUsageFlagsJsonUnmarshaller.getInstance().unmarshall(context));
                }
