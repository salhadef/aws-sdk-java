...
public class ListDirectoryRegistrationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDirectoryRegistrationsRequest withMaxResults(Integer maxResults) {
    ...
    public ListDirectoryRegistrationsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDirectoryRegistrationsRequest == false)
            return false;
        ListDirectoryRegistrationsRequest other = (ListDirectoryRegistrationsRequest) obj;
    ...
    @Override
    public ListDirectoryRegistrationsRequest clone() {
        return (ListDirectoryRegistrationsRequest) super.clone();
    }
