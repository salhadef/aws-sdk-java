...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.pcaconnectorad.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.pcaconnectorad.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pcaconnectorad.model.ValidationException validationException = new com.amazonaws.services.pcaconnectorad.model.ValidationException(
                null);
