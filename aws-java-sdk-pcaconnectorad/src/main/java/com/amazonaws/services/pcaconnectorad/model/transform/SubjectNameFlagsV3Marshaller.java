...
/**
 * SubjectNameFlagsV3Marshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SubjectNameFlagsV3Marshaller {
    ...
    private static final SubjectNameFlagsV3Marshaller instance = new SubjectNameFlagsV3Marshaller();

    public static SubjectNameFlagsV3Marshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SubjectNameFlagsV3 subjectNameFlagsV3, ProtocolMarshaller protocolMarshaller) {

        if (subjectNameFlagsV3 == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(subjectNameFlagsV3.getRequireCommonName(), REQUIRECOMMONNAME_BINDING);
            protocolMarshaller.marshall(subjectNameFlagsV3.getRequireDirectoryPath(), REQUIREDIRECTORYPATH_BINDING);
            protocolMarshaller.marshall(subjectNameFlagsV3.getRequireDnsAsCn(), REQUIREDNSASCN_BINDING);
            protocolMarshaller.marshall(subjectNameFlagsV3.getRequireEmail(), REQUIREEMAIL_BINDING);
            protocolMarshaller.marshall(subjectNameFlagsV3.getSanRequireDirectoryGuid(), SANREQUIREDIRECTORYGUID_BINDING);
            protocolMarshaller.marshall(subjectNameFlagsV3.getSanRequireDns(), SANREQUIREDNS_BINDING);
            protocolMarshaller.marshall(subjectNameFlagsV3.getSanRequireDomainDns(), SANREQUIREDOMAINDNS_BINDING);
            protocolMarshaller.marshall(subjectNameFlagsV3.getSanRequireEmail(), SANREQUIREEMAIL_BINDING);
            protocolMarshaller.marshall(subjectNameFlagsV3.getSanRequireSpn(), SANREQUIRESPN_BINDING);
            protocolMarshaller.marshall(subjectNameFlagsV3.getSanRequireUpn(), SANREQUIREUPN_BINDING);
        } catch (Exception e) {
