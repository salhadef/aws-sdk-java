...
public class ListTemplatesRequestMarshaller {
    ...
    private static final MarshallingInfo<String> CONNECTORARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("ConnectorArn").build();
    ...
    public void marshall(ListTemplatesRequest listTemplatesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listTemplatesRequest.getConnectorArn(), CONNECTORARN_BINDING);
            protocolMarshaller.marshall(listTemplatesRequest.getMaxResults(), MAXRESULTS_BINDING);
