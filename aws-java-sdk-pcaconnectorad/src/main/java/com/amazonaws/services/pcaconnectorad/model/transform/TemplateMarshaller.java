...
public class TemplateMarshaller {
    ...
    public void marshall(Template template, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(template.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(template.getConnectorArn(), CONNECTORARN_BINDING);
            protocolMarshaller.marshall(template.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(template.getDefinition(), DEFINITION_BINDING);
            protocolMarshaller.marshall(template.getName(), NAME_BINDING);
            protocolMarshaller.marshall(template.getObjectIdentifier(), OBJECTIDENTIFIER_BINDING);
            protocolMarshaller.marshall(template.getPolicySchema(), POLICYSCHEMA_BINDING);
            protocolMarshaller.marshall(template.getRevision(), REVISION_BINDING);
            protocolMarshaller.marshall(template.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(template.getUpdatedAt(), UPDATEDAT_BINDING);
        } catch (Exception e) {
