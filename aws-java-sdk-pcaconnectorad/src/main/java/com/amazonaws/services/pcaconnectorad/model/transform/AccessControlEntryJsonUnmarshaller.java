...
/**
 * AccessControlEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AccessControlEntryJsonUnmarshaller implements Unmarshaller<AccessControlEntry, JsonUnmarshallerContext> {

    public AccessControlEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static AccessControlEntryJsonUnmarshaller instance;

    public static AccessControlEntryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AccessControlEntryJsonUnmarshaller();
        return instance;
    }
}
