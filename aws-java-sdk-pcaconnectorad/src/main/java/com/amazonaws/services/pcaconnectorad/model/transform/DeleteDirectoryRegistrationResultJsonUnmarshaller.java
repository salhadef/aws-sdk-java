...
/**
 * DeleteDirectoryRegistrationResult JSON Unmarshaller
 */
...
public class DeleteDirectoryRegistrationResultJsonUnmarshaller implements Unmarshaller<DeleteDirectoryRegistrationResult, JsonUnmarshallerContext> {
    ...
    public DeleteDirectoryRegistrationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDirectoryRegistrationResult deleteDirectoryRegistrationResult = new DeleteDirectoryRegistrationResult();
