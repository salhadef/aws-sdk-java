...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.pcaconnectorad.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.pcaconnectorad.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pcaconnectorad.model.ConflictException conflictException = new com.amazonaws.services.pcaconnectorad.model.ConflictException(
                null);
