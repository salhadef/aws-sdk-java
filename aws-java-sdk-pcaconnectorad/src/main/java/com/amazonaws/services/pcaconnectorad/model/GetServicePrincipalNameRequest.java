...
public class GetServicePrincipalNameRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetServicePrincipalNameRequest withConnectorArn(String connectorArn) {
    ...
    public GetServicePrincipalNameRequest withDirectoryRegistrationArn(String directoryRegistrationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetServicePrincipalNameRequest == false)
            return false;
        GetServicePrincipalNameRequest other = (GetServicePrincipalNameRequest) obj;
    ...
    @Override
    public GetServicePrincipalNameRequest clone() {
        return (GetServicePrincipalNameRequest) super.clone();
    }
