...
public class KeyUsageMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> USAGEFLAGS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UsageFlags").build();
    ...
    public void marshall(KeyUsage keyUsage, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(keyUsage.getCritical(), CRITICAL_BINDING);
            protocolMarshaller.marshall(keyUsage.getUsageFlags(), USAGEFLAGS_BINDING);
        } catch (Exception e) {
