...
public enum ServicePrincipalNameStatusReason {
     ...
     * @param value
     *        real value
     * @return ServicePrincipalNameStatusReason corresponding to the value
     *
    ...
    public static ServicePrincipalNameStatusReason fromValue(String value) {
        ...
        for (ServicePrincipalNameStatusReason enumEntry : ServicePrincipalNameStatusReason.values()) {
