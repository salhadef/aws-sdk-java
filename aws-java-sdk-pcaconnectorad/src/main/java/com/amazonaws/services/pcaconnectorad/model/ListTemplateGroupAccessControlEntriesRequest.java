...
public class ListTemplateGroupAccessControlEntriesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListTemplateGroupAccessControlEntriesRequest withMaxResults(Integer maxResults) {
    ...
    public ListTemplateGroupAccessControlEntriesRequest withNextToken(String nextToken) {
    ...
    public ListTemplateGroupAccessControlEntriesRequest withTemplateArn(String templateArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTemplateGroupAccessControlEntriesRequest == false)
            return false;
        ListTemplateGroupAccessControlEntriesRequest other = (ListTemplateGroupAccessControlEntriesRequest) obj;
    ...
    @Override
    public ListTemplateGroupAccessControlEntriesRequest clone() {
        return (ListTemplateGroupAccessControlEntriesRequest) super.clone();
    }
