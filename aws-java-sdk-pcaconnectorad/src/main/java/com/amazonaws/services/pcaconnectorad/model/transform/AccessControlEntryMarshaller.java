...
/**
 * AccessControlEntryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AccessControlEntryMarshaller {
    ...
    private static final AccessControlEntryMarshaller instance = new AccessControlEntryMarshaller();

    public static AccessControlEntryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AccessControlEntry accessControlEntry, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(accessControlEntry.getAccessRights(), ACCESSRIGHTS_BINDING);
            protocolMarshaller.marshall(accessControlEntry.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(accessControlEntry.getGroupDisplayName(), GROUPDISPLAYNAME_BINDING);
            protocolMarshaller.marshall(accessControlEntry.getGroupSecurityIdentifier(), GROUPSECURITYIDENTIFIER_BINDING);
            protocolMarshaller.marshall(accessControlEntry.getTemplateArn(), TEMPLATEARN_BINDING);
            protocolMarshaller.marshall(accessControlEntry.getUpdatedAt(), UPDATEDAT_BINDING);
        } catch (Exception e) {
