...
public class PutIntegrationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PutIntegrationResult withConnectionType(String connectionType) {
    ...
    public PutIntegrationResult withConnectionType(ConnectionType connectionType) {
    ...
    public PutIntegrationResult withConnectionId(String connectionId) {
    ...
    public PutIntegrationResult withTimeoutInMillis(Integer timeoutInMillis) {
    ...
    public PutIntegrationResult withTlsConfig(TlsConfig tlsConfig) {
