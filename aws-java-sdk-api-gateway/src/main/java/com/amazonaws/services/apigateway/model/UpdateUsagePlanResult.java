...
public class UpdateUsagePlanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateUsagePlanResult withApiStages(java.util.Collection<ApiStage> apiStages) {
    ...
    public UpdateUsagePlanResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
    ...
    public UpdateUsagePlanResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
