...
public class GetUsagePlanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetUsagePlanResult withApiStages(ApiStage... apiStages) {
    ...
    public GetUsagePlanResult withApiStages(java.util.Collection<ApiStage> apiStages) {
     ...
     *
     * @see GetUsagePlanResult#withTags
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetUsagePlanResult == false)
            return false;
        GetUsagePlanResult other = (GetUsagePlanResult) obj;
