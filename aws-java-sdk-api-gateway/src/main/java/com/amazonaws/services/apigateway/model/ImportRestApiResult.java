...
public class ImportRestApiResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ImportRestApiResult withVersion(String version) {
        setVersion(version);
        return this;
    }
    ...
    public ImportRestApiResult withWarnings(java.util.Collection<String> warnings) {
    ...
    public ImportRestApiResult withBinaryMediaTypes(String... binaryMediaTypes) {
    ...
    public ImportRestApiResult withBinaryMediaTypes(java.util.Collection<String> binaryMediaTypes) {
    ...
    public ImportRestApiResult withMinimumCompressionSize(Integer minimumCompressionSize) {
    ...
    public ImportRestApiResult withApiKeySource(String apiKeySource) {
    ...
    public ImportRestApiResult withApiKeySource(ApiKeySourceType apiKeySource) {
    ...
    public ImportRestApiResult withEndpointConfiguration(EndpointConfiguration endpointConfiguration) {
    ...
    public ImportRestApiResult withPolicy(String policy) {
        setPolicy(policy);
        return this;
    }
    ...
    public ImportRestApiResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ImportRestApiResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ImportRestApiResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public ImportRestApiResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public ImportRestApiResult withDisableExecuteApiEndpoint(Boolean disableExecuteApiEndpoint) {
    ...
    public ImportRestApiResult withRootResourceId(String rootResourceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportRestApiResult == false)
            return false;
        ImportRestApiResult other = (ImportRestApiResult) obj;
    ...
    public ImportRestApiResult clone() {
        try {
            return (ImportRestApiResult) super.clone();
