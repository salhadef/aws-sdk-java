...
public class CreateApiKeyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateApiKeyResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateApiKeyResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateApiKeyResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateApiKeyResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
