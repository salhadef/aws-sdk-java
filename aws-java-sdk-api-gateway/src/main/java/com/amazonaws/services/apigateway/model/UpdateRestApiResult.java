...
public class UpdateRestApiResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateRestApiResult withVersion(String version) {
        setVersion(version);
        return this;
    }
    ...
    public UpdateRestApiResult withWarnings(java.util.Collection<String> warnings) {
    ...
    public UpdateRestApiResult withBinaryMediaTypes(String... binaryMediaTypes) {
    ...
    public UpdateRestApiResult withBinaryMediaTypes(java.util.Collection<String> binaryMediaTypes) {
    ...
    public UpdateRestApiResult withMinimumCompressionSize(Integer minimumCompressionSize) {
    ...
    public UpdateRestApiResult withApiKeySource(String apiKeySource) {
    ...
    public UpdateRestApiResult withApiKeySource(ApiKeySourceType apiKeySource) {
    ...
    public UpdateRestApiResult withEndpointConfiguration(EndpointConfiguration endpointConfiguration) {
    ...
    public UpdateRestApiResult withPolicy(String policy) {
        setPolicy(policy);
        return this;
    }
    ...
    public UpdateRestApiResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateRestApiResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateRestApiResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UpdateRestApiResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public UpdateRestApiResult withDisableExecuteApiEndpoint(Boolean disableExecuteApiEndpoint) {
    ...
    public UpdateRestApiResult withRootResourceId(String rootResourceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateRestApiResult == false)
            return false;
        UpdateRestApiResult other = (UpdateRestApiResult) obj;
    ...
    public UpdateRestApiResult clone() {
        try {
            return (UpdateRestApiResult) super.clone();
