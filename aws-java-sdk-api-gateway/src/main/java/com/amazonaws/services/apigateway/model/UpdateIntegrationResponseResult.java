...
public class UpdateIntegrationResponseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateIntegrationResponseResult withStatusCode(String statusCode) {
    ...
    public UpdateIntegrationResponseResult withResponseParameters(java.util.Map<String, String> responseParameters) {
    ...
    public UpdateIntegrationResponseResult withResponseTemplates(java.util.Map<String, String> responseTemplates) {
    ...
    public UpdateIntegrationResponseResult withContentHandling(String contentHandling) {
    ...
    public UpdateIntegrationResponseResult withContentHandling(ContentHandlingStrategy contentHandling) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateIntegrationResponseResult == false)
            return false;
        UpdateIntegrationResponseResult other = (UpdateIntegrationResponseResult) obj;
    ...
    @Override
    public UpdateIntegrationResponseResult clone() {
        try {
