...
public class VpcLink implements Serializable, Cloneable, StructuredPojo {
    ...
    public VpcLink withId(String id) {
        setId(id);
        return this;
    }
    ...
    public VpcLink withTargetArns(String... targetArns) {
    ...
    public VpcLink withTargetArns(java.util.Collection<String> targetArns) {
    ...
    public VpcLink withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public VpcLink withStatus(VpcLinkStatus status) {
    ...
    public VpcLink withStatusMessage(String statusMessage) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VpcLink == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.apigateway.model.transform.VpcLinkMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
