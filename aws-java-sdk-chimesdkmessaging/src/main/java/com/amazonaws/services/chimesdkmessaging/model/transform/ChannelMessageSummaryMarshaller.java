...
public class ChannelMessageSummaryMarshaller {
    ...
    public void marshall(ChannelMessageSummary channelMessageSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(channelMessageSummary.getContentType(), CONTENTTYPE_BINDING);
            protocolMarshaller.marshall(channelMessageSummary.getTarget(), TARGET_BINDING);
        } catch (Exception e) {
