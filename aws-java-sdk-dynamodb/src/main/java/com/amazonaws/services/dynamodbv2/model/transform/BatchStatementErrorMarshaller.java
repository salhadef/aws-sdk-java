...
/**
 * BatchStatementErrorMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BatchStatementErrorMarshaller {
    ...
    public static BatchStatementErrorMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchStatementError batchStatementError, ProtocolMarshaller protocolMarshaller) {

        if (batchStatementError == null) {
