...
public class CreateUserRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateUserRequest withEmails(java.util.Collection<Email> emails) {
        setEmails(emails);
        return this;
    }
    ...
    public CreateUserRequest withAddresses(java.util.Collection<Address> addresses) {
    ...
    public CreateUserRequest withPhoneNumbers(java.util.Collection<PhoneNumber> phoneNumbers) {
    ...
    public String toString() {
        ...
        if (getTimezone() != null)
            sb.append("Timezone: ").append("***Sensitive Data Redacted***");
        sb.append("}");
        return sb.toString();
    }
