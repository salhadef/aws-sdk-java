...
/**
 * TranslationSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TranslationSettingsJsonUnmarshaller implements Unmarshaller<TranslationSettings, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Brevity", targetDepth)) {
                    context.nextToken();
                    translationSettings.setBrevity(context.getUnmarshaller(String.class).unmarshall(context));
                }
