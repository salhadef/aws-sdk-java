...
/**
 * <p>
 * The user-specified message system attribute value. For string data types, the <code>Value</code> attribute has the
 * same restrictions on the content as the message body. For more information, see <code> <a>SendMessage</a>.</code>
 * </p>
 * <p>
 * <code>Name</code>, <code>type</code>, <code>value</code> and the message body must not be empty or null.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/MessageSystemAttributeValue" target="_top">AWS
 *      API Documentation</a>
 */
...
public class MessageSystemAttributeValue implements Serializable, Cloneable, StructuredPojo {
    ...
    public MessageSystemAttributeValue withBinaryValue(java.nio.ByteBuffer binaryValue) {
    ...
    public MessageSystemAttributeValue withStringListValues(java.util.Collection<String> stringListValues) {
    ...
    public MessageSystemAttributeValue withBinaryListValues(java.nio.ByteBuffer... binaryListValues) {
    ...
    public MessageSystemAttributeValue withBinaryListValues(java.util.Collection<java.nio.ByteBuffer> binaryListValues) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MessageSystemAttributeValue == false)
            return false;
