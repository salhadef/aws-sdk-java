...
public class KmsNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private KmsNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.sqs.model.KmsNotFoundException.class, "KmsNotFound");
    }

    @Override
    public com.amazonaws.services.sqs.model.KmsNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.sqs.model.KmsNotFoundException kmsNotFoundException = new com.amazonaws.services.sqs.model.KmsNotFoundException(null);
