...
public class KmsDisabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private KmsDisabledExceptionUnmarshaller() {
        super(com.amazonaws.services.sqs.model.KmsDisabledException.class, "KmsDisabled");
    }

    @Override
    public com.amazonaws.services.sqs.model.KmsDisabledException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.sqs.model.KmsDisabledException kmsDisabledException = new com.amazonaws.services.sqs.model.KmsDisabledException(null);
