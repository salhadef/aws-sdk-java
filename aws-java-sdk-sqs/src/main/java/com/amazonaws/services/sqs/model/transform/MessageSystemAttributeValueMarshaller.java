...
/**
 * MessageSystemAttributeValueMarshaller
 */
...
public class MessageSystemAttributeValueMarshaller {
    ...
    public void marshall(MessageSystemAttributeValue messageSystemAttributeValue, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(messageSystemAttributeValue.getStringValue(), STRINGVALUE_BINDING);
            protocolMarshaller.marshall(messageSystemAttributeValue.getBinaryValue(), BINARYVALUE_BINDING);
            ...
            protocolMarshaller.marshall(messageSystemAttributeValue.getDataType(), DATATYPE_BINDING);
        } catch (Exception e) {
