...
public class CancelMessageMoveTaskResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CancelMessageMoveTaskResult withApproximateNumberOfMessagesMoved(Long approximateNumberOfMessagesMoved) {
    ...
    public String toString() {
        ...
        if (getApproximateNumberOfMessagesMoved() != null)
            sb.append("ApproximateNumberOfMessagesMoved: ").append(getApproximateNumberOfMessagesMoved());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelMessageMoveTaskResult == false)
            return false;
        CancelMessageMoveTaskResult other = (CancelMessageMoveTaskResult) obj;
    ...
    @Override
    public CancelMessageMoveTaskResult clone() {
        try {
            return (CancelMessageMoveTaskResult) super.clone();
