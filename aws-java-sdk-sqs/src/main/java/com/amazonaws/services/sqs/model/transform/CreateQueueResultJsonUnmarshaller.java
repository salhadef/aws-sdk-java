...
/**
 * CreateQueueResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateQueueResultJsonUnmarshaller implements Unmarshaller<CreateQueueResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("QueueUrl", targetDepth)) {
                    context.nextToken();
                    createQueueResult.setQueueUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
