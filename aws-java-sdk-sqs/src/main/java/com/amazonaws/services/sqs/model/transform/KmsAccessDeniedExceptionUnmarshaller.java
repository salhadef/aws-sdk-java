...
public class KmsAccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private KmsAccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.sqs.model.KmsAccessDeniedException.class, "KmsAccessDenied");
    }

    @Override
    public com.amazonaws.services.sqs.model.KmsAccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.sqs.model.KmsAccessDeniedException kmsAccessDeniedException = new com.amazonaws.services.sqs.model.KmsAccessDeniedException(null);
