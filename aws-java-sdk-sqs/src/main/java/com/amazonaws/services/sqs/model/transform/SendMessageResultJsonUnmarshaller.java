        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MD5OfMessageBody", targetDepth)) {
                    context.nextToken();
                    sendMessageResult.setMD5OfMessageBody(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MD5OfMessageAttributes", targetDepth)) {
                    context.nextToken();
                    sendMessageResult.setMD5OfMessageAttributes(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MD5OfMessageSystemAttributes", targetDepth)) {
                    context.nextToken();
                    sendMessageResult.setMD5OfMessageSystemAttributes(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MessageId", targetDepth)) {
                    context.nextToken();
                    sendMessageResult.setMessageId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("SequenceNumber", targetDepth)) {
                    context.nextToken();
                    sendMessageResult.setSequenceNumber(context.getUnmarshaller(String.class).unmarshall(context));
                }
