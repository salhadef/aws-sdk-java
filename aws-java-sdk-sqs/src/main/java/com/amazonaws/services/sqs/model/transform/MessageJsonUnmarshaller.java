        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ReceiptHandle", targetDepth)) {
                    context.nextToken();
                    message.setReceiptHandle(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MD5OfBody", targetDepth)) {
                    context.nextToken();
                    message.setMD5OfBody(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Attributes", targetDepth)) {
                    context.nextToken();
                    message.setAttributes(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context.getUnmarshaller(String.class))
                            .unmarshall(context));
                }
                if (context.testExpression("MD5OfMessageAttributes", targetDepth)) {
                    context.nextToken();
                    message.setMD5OfMessageAttributes(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MessageAttributes", targetDepth)) {
                    context.nextToken();
                    message.setMessageAttributes(new MapUnmarshaller<String, MessageAttributeValue>(context.getUnmarshaller(String.class),
