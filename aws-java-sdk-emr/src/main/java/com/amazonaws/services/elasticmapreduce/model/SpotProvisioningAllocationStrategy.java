...
public enum SpotProvisioningAllocationStrategy {
     ...
     * @param value
     *        real value
     * @return SpotProvisioningAllocationStrategy corresponding to the value
     *
    ...
    public static SpotProvisioningAllocationStrategy fromValue(String value) {
        ...
        for (SpotProvisioningAllocationStrategy enumEntry : SpotProvisioningAllocationStrategy.values()) {
