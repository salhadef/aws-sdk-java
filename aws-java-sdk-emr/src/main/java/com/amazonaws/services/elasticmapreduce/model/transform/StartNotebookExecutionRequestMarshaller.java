...
public class StartNotebookExecutionRequestMarshaller {
    ...
    public void marshall(StartNotebookExecutionRequest startNotebookExecutionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(startNotebookExecutionRequest.getNotebookS3Location(), NOTEBOOKS3LOCATION_BINDING);
            protocolMarshaller.marshall(startNotebookExecutionRequest.getOutputNotebookS3Location(), OUTPUTNOTEBOOKS3LOCATION_BINDING);
            protocolMarshaller.marshall(startNotebookExecutionRequest.getOutputNotebookFormat(), OUTPUTNOTEBOOKFORMAT_BINDING);
            protocolMarshaller.marshall(startNotebookExecutionRequest.getEnvironmentVariables(), ENVIRONMENTVARIABLES_BINDING);
        } catch (Exception e) {
