...
public interface AmazonIVSAsync extends AmazonIVS {
     ...
     * @sample AmazonIVSAsync.GetStreamSession
     * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-2020-07-14/GetStreamSession" target="_top">AWS API
     *      Documentation</a>
     */
    java.util.concurrent.Future<GetStreamSessionResult> getStreamSessionAsync(GetStreamSessionRequest getStreamSessionRequest);
     ...
     *        unsuccessful completion of the operation.
     * @return A Java Future containing the result of the GetStreamSession operation returned by the service.
     * @sample AmazonIVSAsyncHandler.GetStreamSession
     * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-2020-07-14/GetStreamSession" target="_top">AWS API
     *      Documentation</a>
     */
    java.util.concurrent.Future<GetStreamSessionResult> getStreamSessionAsync(GetStreamSessionRequest getStreamSessionRequest,
     ...
     * @sample AmazonIVSAsync.ListStreamSessions
     * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-2020-07-14/ListStreamSessions" target="_top">AWS API
     *      Documentation</a>
     */
    java.util.concurrent.Future<ListStreamSessionsResult> listStreamSessionsAsync(ListStreamSessionsRequest listStreamSessionsRequest);
     ...
     *        unsuccessful completion of the operation.
     * @return A Java Future containing the result of the ListStreamSessions operation returned by the service.
     * @sample AmazonIVSAsyncHandler.ListStreamSessions
     * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-2020-07-14/ListStreamSessions" target="_top">AWS API
     *      Documentation</a>
     */
    java.util.concurrent.Future<ListStreamSessionsResult> listStreamSessionsAsync(ListStreamSessionsRequest listStreamSessionsRequest,
