...
public enum ThumbnailConfigurationResolution {
     ...
     * @param value
     *        real value
     * @return ThumbnailConfigurationResolution corresponding to the value
     *
    ...
    public static ThumbnailConfigurationResolution fromValue(String value) {
        ...
        for (ThumbnailConfigurationResolution enumEntry : ThumbnailConfigurationResolution.values()) {
