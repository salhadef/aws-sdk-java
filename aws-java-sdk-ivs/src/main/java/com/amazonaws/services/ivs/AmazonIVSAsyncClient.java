...
public class AmazonIVSAsyncClient extends AmazonIVSClient implements AmazonIVSAsync {
    ...
    @Override
    public java.util.concurrent.Future<GetStreamSessionResult> getStreamSessionAsync(final GetStreamSessionRequest request,
            final com.amazonaws.handlers.AsyncHandler<GetStreamSessionRequest, GetStreamSessionResult> asyncHandler) {
        final GetStreamSessionRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<GetStreamSessionResult>() {
            @Override
    ...
    @Override
    public java.util.concurrent.Future<ListStreamSessionsResult> listStreamSessionsAsync(final ListStreamSessionsRequest request,
            final com.amazonaws.handlers.AsyncHandler<ListStreamSessionsRequest, ListStreamSessionsResult> asyncHandler) {
        final ListStreamSessionsRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<ListStreamSessionsResult>() {
            @Override
