...
/**
 * StartViewerSessionRevocationResult JSON Unmarshaller
 */
...
public class StartViewerSessionRevocationResultJsonUnmarshaller implements Unmarshaller<StartViewerSessionRevocationResult, JsonUnmarshallerContext> {
    ...
    public StartViewerSessionRevocationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartViewerSessionRevocationResult startViewerSessionRevocationResult = new StartViewerSessionRevocationResult();
