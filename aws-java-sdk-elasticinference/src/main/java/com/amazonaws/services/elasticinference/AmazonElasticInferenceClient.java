...
import com.amazonaws.services.elasticinference.AmazonElasticInferenceClientBuilder;
...
public class AmazonElasticInferenceClient extends AmazonWebServiceClient implements AmazonElasticInference {

    /** Provider for AWS credentials. */
    private final AWSCredentialsProvider awsCredentialsProvider;

    private static final Log log = LogFactory.getLog(AmazonElasticInference.class);

    /** Default signing name for the service. */
    private static final String DEFAULT_SIGNING_NAME = "elastic-inference";
            ...
            new JsonClientMetadata()
                    ...
                    .addErrorMetadata(
                            new JsonErrorShapeMetadata().withErrorCode("InternalServerException").withExceptionUnmarshaller(
                                    com.amazonaws.services.elasticinference.model.transform.InternalServerExceptionUnmarshaller.getInstance()))
                    .addErrorMetadata(
                            new JsonErrorShapeMetadata().withErrorCode("BadRequestException").withExceptionUnmarshaller(
                                    com.amazonaws.services.elasticinference.model.transform.BadRequestExceptionUnmarshaller.getInstance()))
                    .addErrorMetadata(
                            new JsonErrorShapeMetadata().withErrorCode("ResourceNotFoundException").withExceptionUnmarshaller(
                                    com.amazonaws.services.elasticinference.model.transform.ResourceNotFoundExceptionUnmarshaller.getInstance()))
                    .withBaseServiceExceptionClass(com.amazonaws.services.elasticinference.model.AmazonElasticInferenceException.class));

    public static AmazonElasticInferenceClientBuilder builder() {
        return AmazonElasticInferenceClientBuilder.standard();
    }

    /**
     * Constructs a new client to invoke service methods on Amazon Elastic Inference using the specified parameters.
     *
     * <p>
     ...
     */
    AmazonElasticInferenceClient(AwsSyncClientParams clientParams) {
     ...
     *        Object providing client parameters.
     */
    AmazonElasticInferenceClient(AwsSyncClientParams clientParams, boolean endpointDiscoveryEnabled) {
        super(clientParams);
    ...
    private void init() {
        ...
        setEndpoint("api.elastic-inference.us-east-1.amazonaws.com");
        HandlerChainFactory chainFactory = new HandlerChainFactory();
        requestHandler2s.addAll(chainFactory.newRequestHandlerChain("/com/amazonaws/services/elasticinference/request.handlers"));
        requestHandler2s.addAll(chainFactory.newRequestHandler2Chain("/com/amazonaws/services/elasticinference/request.handler2s"));
