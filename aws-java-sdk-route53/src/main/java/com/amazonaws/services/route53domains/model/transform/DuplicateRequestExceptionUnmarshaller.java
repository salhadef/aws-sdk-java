...
public class DuplicateRequestExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("requestId", targetDepth)) {
                    context.nextToken();
                    duplicateRequestException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static DuplicateRequestExceptionUnmarshaller instance;

    public static DuplicateRequestExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateRequestExceptionUnmarshaller();
        return instance;
    }
}
