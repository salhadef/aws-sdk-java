...
public class ScanConditionPair implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScanConditionPair == false)
            return false;
        ScanConditionPair other = (ScanConditionPair) obj;
    ...
    public ScanConditionPair clone() {
        try {
            return (ScanConditionPair) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.guardduty.model.transform.ScanConditionPairMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
