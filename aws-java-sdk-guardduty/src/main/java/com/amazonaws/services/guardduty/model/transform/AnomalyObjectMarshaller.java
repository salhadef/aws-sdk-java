...
public class AnomalyObjectMarshaller {
    ...
    private static final MarshallingInfo<String> PROFILESUBTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("profileSubtype").build();
    private static final MarshallingInfo<StructuredPojo> OBSERVATIONS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("observations").build();
