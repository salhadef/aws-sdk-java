        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("profiles", targetDepth)) {
                    context.nextToken();
                    anomaly.setProfiles(new MapUnmarshaller<String, java.util.Map<String, java.util.List<AnomalyObject>>>(
                            context.getUnmarshaller(String.class), new MapUnmarshaller<String, java.util.List<AnomalyObject>>(context
                                    .getUnmarshaller(String.class), new ListUnmarshaller<AnomalyObject>(AnomalyObjectJsonUnmarshaller.getInstance())

                            )).unmarshall(context));
                }
                if (context.testExpression("unusual", targetDepth)) {
                    context.nextToken();
                    anomaly.setUnusual(AnomalyUnusualJsonUnmarshaller.getInstance().unmarshall(context));
                }
