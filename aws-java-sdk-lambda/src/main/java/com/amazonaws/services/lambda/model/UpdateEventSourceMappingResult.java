...
public class UpdateEventSourceMappingResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateEventSourceMappingResult withStartingPosition(String startingPosition) {
    ...
    public UpdateEventSourceMappingResult withStartingPosition(EventSourcePosition startingPosition) {
    ...
    public UpdateEventSourceMappingResult withStartingPositionTimestamp(java.util.Date startingPositionTimestamp) {
    ...
    public UpdateEventSourceMappingResult withFilterCriteria(FilterCriteria filterCriteria) {
    ...
    public UpdateEventSourceMappingResult withTopics(String... topics) {
        if (this.topics == null) {
    ...
    public UpdateEventSourceMappingResult withTopics(java.util.Collection<String> topics) {
        setTopics(topics);
        return this;
    }
    ...
    public UpdateEventSourceMappingResult withQueues(String... queues) {
        if (this.queues == null) {
    ...
    public UpdateEventSourceMappingResult withQueues(java.util.Collection<String> queues) {
        setQueues(queues);
        return this;
    }
    ...
    public UpdateEventSourceMappingResult withSourceAccessConfigurations(java.util.Collection<SourceAccessConfiguration> sourceAccessConfigurations) {
    ...
    public UpdateEventSourceMappingResult withSelfManagedEventSource(SelfManagedEventSource selfManagedEventSource) {
    ...
    public UpdateEventSourceMappingResult withTumblingWindowInSeconds(Integer tumblingWindowInSeconds) {
    ...
    public UpdateEventSourceMappingResult withFunctionResponseTypes(String... functionResponseTypes) {
    ...
    public UpdateEventSourceMappingResult withFunctionResponseTypes(java.util.Collection<String> functionResponseTypes) {
    ...
    public UpdateEventSourceMappingResult withFunctionResponseTypes(FunctionResponseType... functionResponseTypes) {
    ...
    public UpdateEventSourceMappingResult withScalingConfig(ScalingConfig scalingConfig) {
    ...
    public UpdateEventSourceMappingResult withDocumentDBEventSourceConfig(DocumentDBEventSourceConfig documentDBEventSourceConfig) {
