...
public class GetLayerVersionByArnResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetLayerVersionByArnResult withContent(LayerVersionContentOutput content) {
        setContent(content);
        return this;
    }
    ...
    public GetLayerVersionByArnResult withLayerArn(String layerArn) {
    ...
    public GetLayerVersionByArnResult withLayerVersionArn(String layerVersionArn) {
    ...
    public GetLayerVersionByArnResult withDescription(String description) {
    ...
    public GetLayerVersionByArnResult withCreatedDate(String createdDate) {
    ...
    public GetLayerVersionByArnResult withVersion(Long version) {
        setVersion(version);
        return this;
    }
    ...
    public GetLayerVersionByArnResult withCompatibleRuntimes(String... compatibleRuntimes) {
    ...
    public GetLayerVersionByArnResult withCompatibleRuntimes(java.util.Collection<String> compatibleRuntimes) {
    ...
    public GetLayerVersionByArnResult withCompatibleRuntimes(Runtime... compatibleRuntimes) {
    ...
    public GetLayerVersionByArnResult withLicenseInfo(String licenseInfo) {
    ...
    public GetLayerVersionByArnResult withCompatibleArchitectures(String... compatibleArchitectures) {
    ...
    public GetLayerVersionByArnResult withCompatibleArchitectures(java.util.Collection<String> compatibleArchitectures) {
    ...
    public GetLayerVersionByArnResult withCompatibleArchitectures(Architecture... compatibleArchitectures) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLayerVersionByArnResult == false)
            return false;
        GetLayerVersionByArnResult other = (GetLayerVersionByArnResult) obj;
    ...
    @Override
    public GetLayerVersionByArnResult clone() {
        try {
            return (GetLayerVersionByArnResult) super.clone();
