...
public class UpdateFunctionCodeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateFunctionCodeResult withFileSystemConfigs(FileSystemConfig... fileSystemConfigs) {
    ...
    public UpdateFunctionCodeResult withFileSystemConfigs(java.util.Collection<FileSystemConfig> fileSystemConfigs) {
    ...
    public UpdateFunctionCodeResult withPackageType(String packageType) {
    ...
    public UpdateFunctionCodeResult withPackageType(PackageType packageType) {
    ...
    public UpdateFunctionCodeResult withImageConfigResponse(ImageConfigResponse imageConfigResponse) {
    ...
    public UpdateFunctionCodeResult withArchitectures(String... architectures) {
    ...
    public UpdateFunctionCodeResult withArchitectures(java.util.Collection<String> architectures) {
    ...
    public UpdateFunctionCodeResult withArchitectures(Architecture... architectures) {
    ...
    public UpdateFunctionCodeResult withEphemeralStorage(EphemeralStorage ephemeralStorage) {
    ...
    public UpdateFunctionCodeResult withSnapStart(SnapStartResponse snapStart) {
    ...
    public UpdateFunctionCodeResult withRuntimeVersionConfig(RuntimeVersionConfig runtimeVersionConfig) {
