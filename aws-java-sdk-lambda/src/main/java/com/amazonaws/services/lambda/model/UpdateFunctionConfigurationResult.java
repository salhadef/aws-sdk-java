...
public class UpdateFunctionConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateFunctionConfigurationResult withState(String state) {
        setState(state);
        return this;
    }
    ...
    public UpdateFunctionConfigurationResult withState(State state) {
    ...
    public UpdateFunctionConfigurationResult withStateReason(String stateReason) {
    ...
    public UpdateFunctionConfigurationResult withStateReasonCode(String stateReasonCode) {
    ...
    public UpdateFunctionConfigurationResult withStateReasonCode(StateReasonCode stateReasonCode) {
    ...
    public UpdateFunctionConfigurationResult withLastUpdateStatus(String lastUpdateStatus) {
    ...
    public UpdateFunctionConfigurationResult withLastUpdateStatus(LastUpdateStatus lastUpdateStatus) {
    ...
    public UpdateFunctionConfigurationResult withLastUpdateStatusReason(String lastUpdateStatusReason) {
    ...
    public UpdateFunctionConfigurationResult withLastUpdateStatusReasonCode(String lastUpdateStatusReasonCode) {
    ...
    public UpdateFunctionConfigurationResult withLastUpdateStatusReasonCode(LastUpdateStatusReasonCode lastUpdateStatusReasonCode) {
    ...
    public UpdateFunctionConfigurationResult withArchitectures(String... architectures) {
    ...
    public UpdateFunctionConfigurationResult withArchitectures(java.util.Collection<String> architectures) {
    ...
    public UpdateFunctionConfigurationResult withArchitectures(Architecture... architectures) {
    ...
    public UpdateFunctionConfigurationResult withEphemeralStorage(EphemeralStorage ephemeralStorage) {
    ...
    public UpdateFunctionConfigurationResult withSnapStart(SnapStartResponse snapStart) {
    ...
    public UpdateFunctionConfigurationResult withRuntimeVersionConfig(RuntimeVersionConfig runtimeVersionConfig) {
