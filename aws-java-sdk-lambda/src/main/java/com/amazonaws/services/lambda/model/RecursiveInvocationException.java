...
public class RecursiveInvocationException extends com.amazonaws.services.lambda.model.AWSLambdaException {
    ...
    public RecursiveInvocationException withType(String type) {
        setType(type);
        return this;
    }
