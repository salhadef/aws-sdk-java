...
public class CreateFunctionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateFunctionResult withEnvironment(EnvironmentResponse environment) {
    ...
    public CreateFunctionResult withLayers(Layer... layers) {
        if (this.layers == null) {
    ...
    public CreateFunctionResult withLayers(java.util.Collection<Layer> layers) {
        setLayers(layers);
        return this;
    }
    ...
    public CreateFunctionResult withFileSystemConfigs(FileSystemConfig... fileSystemConfigs) {
    ...
    public CreateFunctionResult withFileSystemConfigs(java.util.Collection<FileSystemConfig> fileSystemConfigs) {
    ...
    public CreateFunctionResult withArchitectures(java.util.Collection<String> architectures) {
    ...
    public CreateFunctionResult withSnapStart(SnapStartResponse snapStart) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateFunctionResult == false)
            return false;
        CreateFunctionResult other = (CreateFunctionResult) obj;
