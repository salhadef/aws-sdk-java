...
public class GetFunctionConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetFunctionConfigurationResult withLayers(Layer... layers) {
        if (this.layers == null) {
    ...
    public GetFunctionConfigurationResult withLayers(java.util.Collection<Layer> layers) {
        setLayers(layers);
        return this;
    }
    ...
    public GetFunctionConfigurationResult withFileSystemConfigs(FileSystemConfig... fileSystemConfigs) {
    ...
    public GetFunctionConfigurationResult withFileSystemConfigs(java.util.Collection<FileSystemConfig> fileSystemConfigs) {
    ...
    public GetFunctionConfigurationResult withPackageType(String packageType) {
    ...
    public GetFunctionConfigurationResult withPackageType(PackageType packageType) {
    ...
    public GetFunctionConfigurationResult withImageConfigResponse(ImageConfigResponse imageConfigResponse) {
    ...
    public GetFunctionConfigurationResult withSigningProfileVersionArn(String signingProfileVersionArn) {
    ...
    public GetFunctionConfigurationResult withSigningJobArn(String signingJobArn) {
    ...
    public GetFunctionConfigurationResult withEphemeralStorage(EphemeralStorage ephemeralStorage) {
    ...
    public GetFunctionConfigurationResult withSnapStart(SnapStartResponse snapStart) {
