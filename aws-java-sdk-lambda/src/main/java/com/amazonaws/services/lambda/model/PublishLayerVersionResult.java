...
public class PublishLayerVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PublishLayerVersionResult withCompatibleArchitectures(String... compatibleArchitectures) {
    ...
    public PublishLayerVersionResult withCompatibleArchitectures(java.util.Collection<String> compatibleArchitectures) {
    ...
    public PublishLayerVersionResult withCompatibleArchitectures(Architecture... compatibleArchitectures) {
