...
/**
 * GitPushFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GitPushFilterMarshaller {
    ...
    public static GitPushFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GitPushFilter gitPushFilter, ProtocolMarshaller protocolMarshaller) {

        if (gitPushFilter == null) {
