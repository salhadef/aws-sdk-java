...
/**
 * StopInputDeviceResult JSON Unmarshaller
 */
...
public class StopInputDeviceResultJsonUnmarshaller implements Unmarshaller<StopInputDeviceResult, JsonUnmarshallerContext> {
    ...
    public StopInputDeviceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopInputDeviceResult stopInputDeviceResult = new StopInputDeviceResult();

        return stopInputDeviceResult;
    }
