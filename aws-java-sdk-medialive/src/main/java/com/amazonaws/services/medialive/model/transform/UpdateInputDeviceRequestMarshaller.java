...
public class UpdateInputDeviceRequestMarshaller {
    ...
    public static UpdateInputDeviceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateInputDeviceRequest updateInputDeviceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateInputDeviceRequest.getAvailabilityZone(), AVAILABILITYZONE_BINDING);
        } catch (Exception e) {
