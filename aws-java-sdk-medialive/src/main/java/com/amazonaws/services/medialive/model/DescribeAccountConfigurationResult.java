...
public class DescribeAccountConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeAccountConfigurationResult withAccountConfiguration(AccountConfiguration accountConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAccountConfigurationResult == false)
            return false;
        DescribeAccountConfigurationResult other = (DescribeAccountConfigurationResult) obj;
    ...
    @Override
    public DescribeAccountConfigurationResult clone() {
        try {
            return (DescribeAccountConfigurationResult) super.clone();
