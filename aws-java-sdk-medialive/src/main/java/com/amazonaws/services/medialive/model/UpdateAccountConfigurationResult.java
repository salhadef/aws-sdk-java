...
public class UpdateAccountConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAccountConfigurationResult withAccountConfiguration(AccountConfiguration accountConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAccountConfigurationResult == false)
            return false;
        UpdateAccountConfigurationResult other = (UpdateAccountConfigurationResult) obj;
    ...
    public UpdateAccountConfigurationResult clone() {
        try {
            return (UpdateAccountConfigurationResult) super.clone();
