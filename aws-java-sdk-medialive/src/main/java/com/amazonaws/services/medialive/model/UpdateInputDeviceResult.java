...
public class UpdateInputDeviceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateInputDeviceResult withUhdDeviceSettings(InputDeviceUhdSettings uhdDeviceSettings) {
    ...
    public UpdateInputDeviceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateInputDeviceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateInputDeviceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UpdateInputDeviceResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public UpdateInputDeviceResult withAvailabilityZone(String availabilityZone) {
    ...
    @Override
    public UpdateInputDeviceResult clone() {
        try {
