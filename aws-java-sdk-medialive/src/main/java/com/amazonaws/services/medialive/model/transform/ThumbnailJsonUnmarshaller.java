...
/**
 * Thumbnail JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ThumbnailJsonUnmarshaller implements Unmarshaller<Thumbnail, JsonUnmarshallerContext> {

    public Thumbnail unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ThumbnailJsonUnmarshaller instance;

    public static ThumbnailJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ThumbnailJsonUnmarshaller();
        return instance;
    }
}
