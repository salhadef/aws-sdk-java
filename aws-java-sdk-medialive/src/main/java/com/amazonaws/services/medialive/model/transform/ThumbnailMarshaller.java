...
public class ThumbnailMarshaller {
    ...
    private static final MarshallingInfo<String> THUMBNAILTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("thumbnailType").build();
    ...
    public void marshall(Thumbnail thumbnail, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(thumbnail.getBody(), BODY_BINDING);
            protocolMarshaller.marshall(thumbnail.getContentType(), CONTENTTYPE_BINDING);
            protocolMarshaller.marshall(thumbnail.getThumbnailType(), THUMBNAILTYPE_BINDING);
            protocolMarshaller.marshall(thumbnail.getTimeStamp(), TIMESTAMP_BINDING);
        } catch (Exception e) {
