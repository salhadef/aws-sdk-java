...
public class StartInputDeviceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartInputDeviceRequest withInputDeviceId(String inputDeviceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartInputDeviceRequest == false)
            return false;
        StartInputDeviceRequest other = (StartInputDeviceRequest) obj;
    ...
    @Override
    public StartInputDeviceRequest clone() {
        return (StartInputDeviceRequest) super.clone();
    }
