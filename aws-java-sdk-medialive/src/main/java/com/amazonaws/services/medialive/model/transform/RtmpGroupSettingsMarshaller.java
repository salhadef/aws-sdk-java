...
public class RtmpGroupSettingsMarshaller {
    ...
    private static final MarshallingInfo<String> CACHEFULLBEHAVIOR_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("cacheFullBehavior").build();
    private static final MarshallingInfo<Integer> CACHELENGTH_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
