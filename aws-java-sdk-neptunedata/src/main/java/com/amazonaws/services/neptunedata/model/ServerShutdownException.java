...
public class ServerShutdownException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public ServerShutdownException withDetailedMessage(String detailedMessage) {
    ...
    public ServerShutdownException withRequestId(String requestId) {
    ...
    public ServerShutdownException withCode(String code) {
        setCode(code);
        return this;
    }
