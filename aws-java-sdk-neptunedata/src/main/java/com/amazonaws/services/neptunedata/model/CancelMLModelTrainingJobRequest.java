...
public class CancelMLModelTrainingJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * If set to <code>TRUE</code>, this flag specifies that all Amazon S3 artifacts should be deleted when the job is
     ...
     * </p>
     * 
     * @return The unique identifier of the model-training job to be canceled.
     */
     ...
     * 
     * @param clean
     *        If set to <code>TRUE</code>, this flag specifies that all Amazon S3 artifacts should be deleted when the
     ...
     * </p>
     * 
     * @return If set to <code>TRUE</code>, this flag specifies that all Amazon S3 artifacts should be deleted when the
     *         job is stopped. The default is <code>FALSE</code>.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelMLModelTrainingJobRequest == false)
            return false;
        CancelMLModelTrainingJobRequest other = (CancelMLModelTrainingJobRequest) obj;
    ...
    public CancelMLModelTrainingJobRequest clone() {
        return (CancelMLModelTrainingJobRequest) super.clone();
    }
