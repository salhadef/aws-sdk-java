...
public class ParsingException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public ParsingException withDetailedMessage(String detailedMessage) {
    ...
    public ParsingException withRequestId(String requestId) {
    ...
    public ParsingException withCode(String code) {
        setCode(code);
        return this;
    }
