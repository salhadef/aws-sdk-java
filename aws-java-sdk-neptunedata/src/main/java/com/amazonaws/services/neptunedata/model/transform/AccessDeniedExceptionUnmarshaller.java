...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.neptunedata.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.neptunedata.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.neptunedata.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.neptunedata.model.AccessDeniedException(
                null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("detailedMessage", targetDepth)) {
                    context.nextToken();
                    accessDeniedException.setDetailedMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
