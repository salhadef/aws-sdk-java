...
public class ListMLDataProcessingJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListMLDataProcessingJobsRequest withMaxItems(Integer maxItems) {
    ...
    public ListMLDataProcessingJobsRequest withNeptuneIamRoleArn(String neptuneIamRoleArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListMLDataProcessingJobsRequest == false)
            return false;
        ListMLDataProcessingJobsRequest other = (ListMLDataProcessingJobsRequest) obj;
    ...
    @Override
    public ListMLDataProcessingJobsRequest clone() {
        return (ListMLDataProcessingJobsRequest) super.clone();
    }
