...
/**
 * NodeStructure JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NodeStructureJsonUnmarshaller implements Unmarshaller<NodeStructure, JsonUnmarshallerContext> {

    public NodeStructure unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static NodeStructureJsonUnmarshaller instance;

    public static NodeStructureJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new NodeStructureJsonUnmarshaller();
        return instance;
    }
}
