...
public class GetMLEndpointRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetMLEndpointRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetMLEndpointRequest withNeptuneIamRoleArn(String neptuneIamRoleArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMLEndpointRequest == false)
            return false;
        GetMLEndpointRequest other = (GetMLEndpointRequest) obj;
    ...
    @Override
    public GetMLEndpointRequest clone() {
        return (GetMLEndpointRequest) super.clone();
    }
