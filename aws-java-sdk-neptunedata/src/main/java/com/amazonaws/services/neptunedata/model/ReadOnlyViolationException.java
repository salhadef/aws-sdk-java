...
public class ReadOnlyViolationException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public ReadOnlyViolationException withDetailedMessage(String detailedMessage) {
     ...
     * </p>
     * 
     * @return The ID of the request in which the parameter is missing.
     */
    ...
    public ReadOnlyViolationException withRequestId(String requestId) {
    ...
    public ReadOnlyViolationException withCode(String code) {
        setCode(code);
        return this;
    }
