...
public class InvalidParameterException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
     ...
     * </p>
     * 
     * @return The ID of the request that includes an invalid parameter.
     */
    ...
    public InvalidParameterException withRequestId(String requestId) {
