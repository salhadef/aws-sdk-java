...
public class ExpiredStreamException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
     ...
     */
    public ExpiredStreamException(String message) {
        super(message);
    }
    ...
    public ExpiredStreamException withDetailedMessage(String detailedMessage) {
    ...
    public ExpiredStreamException withRequestId(String requestId) {
    ...
    public ExpiredStreamException withCode(String code) {
        setCode(code);
        return this;
    }
