...
public class CancelledByUserException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public CancelledByUserException withDetailedMessage(String detailedMessage) {
    ...
    public CancelledByUserException withRequestId(String requestId) {
    ...
    public CancelledByUserException withCode(String code) {
        setCode(code);
        return this;
    }
