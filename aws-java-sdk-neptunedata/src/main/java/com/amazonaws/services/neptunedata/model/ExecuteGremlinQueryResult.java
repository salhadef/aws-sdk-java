...
public class ExecuteGremlinQueryResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setStatus(GremlinQueryStatusAttributes status) {
        this.status = status;
    }
    ...
    public GremlinQueryStatusAttributes getStatus() {
        return this.status;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExecuteGremlinQueryResult == false)
            return false;
        ExecuteGremlinQueryResult other = (ExecuteGremlinQueryResult) obj;
    ...
    public ExecuteGremlinQueryResult clone() {
        try {
            return (ExecuteGremlinQueryResult) super.clone();
