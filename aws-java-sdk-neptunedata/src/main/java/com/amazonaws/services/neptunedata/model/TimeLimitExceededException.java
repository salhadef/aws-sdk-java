...
public class TimeLimitExceededException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public TimeLimitExceededException withDetailedMessage(String detailedMessage) {
    ...
    public TimeLimitExceededException withRequestId(String requestId) {
    ...
    public TimeLimitExceededException withCode(String code) {
        setCode(code);
        return this;
    }
