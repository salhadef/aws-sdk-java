...
/**
 * ExecuteGremlinQueryResult JSON Unmarshaller
 */
...
public class ExecuteGremlinQueryResultJsonUnmarshaller implements Unmarshaller<ExecuteGremlinQueryResult, JsonUnmarshallerContext> {
    ...
    public ExecuteGremlinQueryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("requestId", targetDepth)) {
                    context.nextToken();
                    executeGremlinQueryResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    executeGremlinQueryResult.setStatus(GremlinQueryStatusAttributesJsonUnmarshaller.getInstance().unmarshall(context));
                }
