...
public class GetMLDataProcessingJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier of the data-processing job to be retrieved.
     */
    ...
    public GetMLDataProcessingJobRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetMLDataProcessingJobRequest withNeptuneIamRoleArn(String neptuneIamRoleArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMLDataProcessingJobRequest == false)
            return false;
        GetMLDataProcessingJobRequest other = (GetMLDataProcessingJobRequest) obj;
    ...
    @Override
    public GetMLDataProcessingJobRequest clone() {
        return (GetMLDataProcessingJobRequest) super.clone();
    }
