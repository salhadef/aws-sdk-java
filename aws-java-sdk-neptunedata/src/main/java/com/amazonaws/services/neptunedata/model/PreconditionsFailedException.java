...
public class PreconditionsFailedException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public PreconditionsFailedException withDetailedMessage(String detailedMessage) {
    ...
    public PreconditionsFailedException withRequestId(String requestId) {
    ...
    public PreconditionsFailedException withCode(String code) {
        setCode(code);
        return this;
    }
