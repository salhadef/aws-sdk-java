...
public class UnsupportedOperationException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public UnsupportedOperationException withDetailedMessage(String detailedMessage) {
    ...
    public UnsupportedOperationException withCode(String code) {
        setCode(code);
        return this;
    }
