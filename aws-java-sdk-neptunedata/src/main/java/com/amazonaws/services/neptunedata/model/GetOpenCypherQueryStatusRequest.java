...
public class GetOpenCypherQueryStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique ID of the openCypher query for which to retrieve the query status.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOpenCypherQueryStatusRequest == false)
            return false;
        GetOpenCypherQueryStatusRequest other = (GetOpenCypherQueryStatusRequest) obj;
    ...
    public GetOpenCypherQueryStatusRequest clone() {
        return (GetOpenCypherQueryStatusRequest) super.clone();
    }
