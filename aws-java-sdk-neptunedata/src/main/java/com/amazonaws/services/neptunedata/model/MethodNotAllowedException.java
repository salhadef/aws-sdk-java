...
public class MethodNotAllowedException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public MethodNotAllowedException withDetailedMessage(String detailedMessage) {
    ...
    public MethodNotAllowedException withCode(String code) {
        setCode(code);
        return this;
    }
