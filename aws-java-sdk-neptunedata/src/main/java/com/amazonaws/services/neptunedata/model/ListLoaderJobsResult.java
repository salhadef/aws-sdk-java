...
public class ListLoaderJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setPayload(LoaderIdResult payload) {
    ...
    public LoaderIdResult getPayload() {
        return this.payload;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLoaderJobsResult == false)
            return false;
        ListLoaderJobsResult other = (ListLoaderJobsResult) obj;
    ...
    public ListLoaderJobsResult clone() {
        try {
            return (ListLoaderJobsResult) super.clone();
