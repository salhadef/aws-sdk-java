...
/**
 * <p>
 * Raised when the number of active queries exceeds what the server can process. The query in question can be retried
 * when the system is less busy.
 * </p>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class QueryLimitExceededException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
     ...
     * </p>
     * 
     * @return The ID of the request which exceeded the limit.
     */
