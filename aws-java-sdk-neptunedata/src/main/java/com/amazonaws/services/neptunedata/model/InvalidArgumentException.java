...
public class InvalidArgumentException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public InvalidArgumentException withDetailedMessage(String detailedMessage) {
    ...
    public InvalidArgumentException withRequestId(String requestId) {
    ...
    public InvalidArgumentException withCode(String code) {
        setCode(code);
        return this;
    }
