...
public class IllegalArgumentException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public IllegalArgumentException withDetailedMessage(String detailedMessage) {
    ...
    public IllegalArgumentException withRequestId(String requestId) {
    ...
    public IllegalArgumentException withCode(String code) {
        setCode(code);
        return this;
    }
