...
public class StatisticsNotAvailableException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
     ...
     */
    public StatisticsNotAvailableException(String message) {
        super(message);
    }
    ...
    public StatisticsNotAvailableException withDetailedMessage(String detailedMessage) {
    ...
    public StatisticsNotAvailableException withRequestId(String requestId) {
    ...
    public StatisticsNotAvailableException withCode(String code) {
        setCode(code);
        return this;
    }
