...
public class StreamRecordsNotFoundException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
     ...
     */
    public StreamRecordsNotFoundException(String message) {
        super(message);
    }
    ...
    public StreamRecordsNotFoundException withDetailedMessage(String detailedMessage) {
    ...
    public StreamRecordsNotFoundException withRequestId(String requestId) {
    ...
    public StreamRecordsNotFoundException withCode(String code) {
        setCode(code);
        return this;
    }
