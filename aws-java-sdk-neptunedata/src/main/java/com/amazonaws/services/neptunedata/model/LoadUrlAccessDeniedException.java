...
public class LoadUrlAccessDeniedException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
     ...
     */
    public LoadUrlAccessDeniedException(String message) {
        super(message);
    }
    ...
    public LoadUrlAccessDeniedException withDetailedMessage(String detailedMessage) {
    ...
    public LoadUrlAccessDeniedException withRequestId(String requestId) {
    ...
    public LoadUrlAccessDeniedException withCode(String code) {
        setCode(code);
        return this;
    }
