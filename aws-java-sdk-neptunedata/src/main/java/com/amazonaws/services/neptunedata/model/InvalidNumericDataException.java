...
public class InvalidNumericDataException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
     ...
     */
    public InvalidNumericDataException(String message) {
        super(message);
    }
    ...
    public InvalidNumericDataException withDetailedMessage(String detailedMessage) {
    ...
    public InvalidNumericDataException withRequestId(String requestId) {
    ...
    public InvalidNumericDataException withCode(String code) {
        setCode(code);
        return this;
    }
