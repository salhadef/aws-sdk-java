...
public class TooManyRequestsException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public TooManyRequestsException withDetailedMessage(String detailedMessage) {
    ...
    public TooManyRequestsException withCode(String code) {
        setCode(code);
        return this;
    }
