...
public class InternalFailureException extends com.amazonaws.services.neptunedata.model.AmazonNeptunedataException {
    ...
    public InternalFailureException withDetailedMessage(String detailedMessage) {
    ...
    public InternalFailureException withRequestId(String requestId) {
