...
public class ListMLModelTrainingJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A page of the list of model training job IDs.
     */
    ...
    public ListMLModelTrainingJobsResult withIds(String... ids) {
        if (this.ids == null) {
    ...
    public ListMLModelTrainingJobsResult withIds(java.util.Collection<String> ids) {
        setIds(ids);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListMLModelTrainingJobsResult == false)
            return false;
        ListMLModelTrainingJobsResult other = (ListMLModelTrainingJobsResult) obj;
    ...
    @Override
    public ListMLModelTrainingJobsResult clone() {
        try {
            return (ListMLModelTrainingJobsResult) super.clone();
