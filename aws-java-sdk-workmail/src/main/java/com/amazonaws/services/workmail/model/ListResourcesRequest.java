...
public class ListResourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private ListResourcesFilters filters;
     ...
     * </p>
     * 
     * @return The identifier for the organization under which the resources exist.
     */
    ...
    public void setFilters(ListResourcesFilters filters) {
     ...
     * </p>
     * 
     * @return Limit the resource search results based on the filter criteria. You can only use one filter per request.
     */

    public ListResourcesFilters getFilters() {
        return this.filters;
    }
    ...
    public ListResourcesRequest withFilters(ListResourcesFilters filters) {
        setFilters(filters);
        return this;
    }
