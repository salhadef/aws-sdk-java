...
public class ListResourcesRequestMarshaller {
    ...
    public void marshall(ListResourcesRequest listResourcesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listResourcesRequest.getOrganizationId(), ORGANIZATIONID_BINDING);
            ...
            protocolMarshaller.marshall(listResourcesRequest.getFilters(), FILTERS_BINDING);
        } catch (Exception e) {
