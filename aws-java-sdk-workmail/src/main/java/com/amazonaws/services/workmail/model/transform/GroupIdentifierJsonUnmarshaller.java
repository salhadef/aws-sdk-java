...
/**
 * GroupIdentifier JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GroupId", targetDepth)) {
                    context.nextToken();
                    groupIdentifier.setGroupId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("GroupName", targetDepth)) {
                    context.nextToken();
                    groupIdentifier.setGroupName(context.getUnmarshaller(String.class).unmarshall(context));
                }
