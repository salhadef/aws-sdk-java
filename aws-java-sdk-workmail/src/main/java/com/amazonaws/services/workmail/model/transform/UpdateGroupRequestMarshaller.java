...
public class UpdateGroupRequestMarshaller {
    ...
    public void marshall(UpdateGroupRequest updateGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateGroupRequest.getOrganizationId(), ORGANIZATIONID_BINDING);
            protocolMarshaller.marshall(updateGroupRequest.getGroupId(), GROUPID_BINDING);
            protocolMarshaller.marshall(updateGroupRequest.getHiddenFromGlobalAddressList(), HIDDENFROMGLOBALADDRESSLIST_BINDING);
        } catch (Exception e) {
