...
/**
 * ListUsersFilters JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListUsersFiltersJsonUnmarshaller implements Unmarshaller<ListUsersFilters, JsonUnmarshallerContext> {

    public ListUsersFilters unmarshall(JsonUnmarshallerContext context) throws Exception {
        ListUsersFilters listUsersFilters = new ListUsersFilters();
    ...
    private static ListUsersFiltersJsonUnmarshaller instance;

    public static ListUsersFiltersJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListUsersFiltersJsonUnmarshaller();
        return instance;
    }
}
