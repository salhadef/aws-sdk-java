...
/**
 * TraceContentMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TraceContentMarshaller {

    private static final MarshallingInfo<String> WIRELESSDEVICEFRAMEINFO_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public static TraceContentMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TraceContent traceContent, ProtocolMarshaller protocolMarshaller) {
