...
/**
 * GetNetworkAnalyzerConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetNetworkAnalyzerConfigurationResultJsonUnmarshaller implements Unmarshaller<GetNetworkAnalyzerConfigurationResult, JsonUnmarshallerContext> {

    public GetNetworkAnalyzerConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetNetworkAnalyzerConfigurationResult getNetworkAnalyzerConfigurationResult = new GetNetworkAnalyzerConfigurationResult();
    ...
    private static GetNetworkAnalyzerConfigurationResultJsonUnmarshaller instance;

    public static GetNetworkAnalyzerConfigurationResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetNetworkAnalyzerConfigurationResultJsonUnmarshaller();
        return instance;
    }
}
