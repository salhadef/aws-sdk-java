    ...
    public Data unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PerformanceInsightsMetric", targetDepth)) {
                    context.nextToken();
                    data.setPerformanceInsightsMetric(PerformanceInsightsMetricJsonUnmarshaller.getInstance().unmarshall(context));
                }
