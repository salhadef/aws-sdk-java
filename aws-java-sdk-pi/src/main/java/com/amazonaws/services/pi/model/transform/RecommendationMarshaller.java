...
public class RecommendationMarshaller {
    ...
    private static final MarshallingInfo<String> RECOMMENDATIONDESCRIPTION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RecommendationDescription").build();
    ...
    public void marshall(Recommendation recommendation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(recommendation.getRecommendationDescription(), RECOMMENDATIONDESCRIPTION_BINDING);
        } catch (Exception e) {
