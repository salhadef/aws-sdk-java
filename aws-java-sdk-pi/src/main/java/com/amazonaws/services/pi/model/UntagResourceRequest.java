...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The Amazon RDS Performance Insights resource that the tags are added to. This value is an Amazon Resource Name
    ...
    public UntagResourceRequest withServiceType(String serviceType) {
    ...
    public UntagResourceRequest withServiceType(ServiceType serviceType) {
     ...
     * 
     * @param resourceARN
     *        The Amazon RDS Performance Insights resource that the tags are added to. This value is an Amazon Resource
     ...
     * </p>
     * 
     * @return The Amazon RDS Performance Insights resource that the tags are added to. This value is an Amazon Resource
     *         Name (ARN). For information about creating an ARN, see <a href=
     *         "https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Tagging.ARN.html#USER_Tagging.ARN.Constructing"
     *         > Constructing an RDS Amazon Resource Name (ARN)</a>.
     */
     ...
     * </p>
     * 
     * @return The metadata assigned to an Amazon RDS Performance Insights resource consisting of a key-value pair.
     */
