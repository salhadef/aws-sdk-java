...
public class StartEntitiesDetectionV2JobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The language of the input documents. All documents must be in the same language. Amazon Comprehend Medical
     ...
     * </p>
     * 
     * @return The language of the input documents. All documents must be in the same language. Amazon Comprehend
    ...
    public StartEntitiesDetectionV2JobRequest withLanguageCode(String languageCode) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartEntitiesDetectionV2JobRequest == false)
            return false;
        StartEntitiesDetectionV2JobRequest other = (StartEntitiesDetectionV2JobRequest) obj;
    ...
    @Override
    public StartEntitiesDetectionV2JobRequest clone() {
