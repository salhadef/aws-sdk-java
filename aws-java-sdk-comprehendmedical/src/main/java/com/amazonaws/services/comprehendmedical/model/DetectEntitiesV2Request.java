...
public class DetectEntitiesV2Request extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A UTF-8 string containing the clinical content being examined for entities.
     */
    ...
    @Override
    public DetectEntitiesV2Request clone() {
        return (DetectEntitiesV2Request) super.clone();
    }
