...
public class StartICD10CMInferenceJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartICD10CMInferenceJobRequest withLanguageCode(String languageCode) {
    ...
    public StartICD10CMInferenceJobRequest withLanguageCode(LanguageCode languageCode) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartICD10CMInferenceJobRequest == false)
            return false;
        StartICD10CMInferenceJobRequest other = (StartICD10CMInferenceJobRequest) obj;
    ...
    @Override
    public StartICD10CMInferenceJobRequest clone() {
        return (StartICD10CMInferenceJobRequest) super.clone();
    }
