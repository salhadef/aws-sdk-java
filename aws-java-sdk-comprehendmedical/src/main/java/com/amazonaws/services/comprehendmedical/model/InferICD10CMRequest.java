...
public class InferICD10CMRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public InferICD10CMRequest clone() {
        return (InferICD10CMRequest) super.clone();
    }
