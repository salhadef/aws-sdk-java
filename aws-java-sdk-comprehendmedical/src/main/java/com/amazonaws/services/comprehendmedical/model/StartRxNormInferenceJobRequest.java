...
public class StartRxNormInferenceJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartRxNormInferenceJobRequest withLanguageCode(String languageCode) {
    ...
    public StartRxNormInferenceJobRequest withLanguageCode(LanguageCode languageCode) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartRxNormInferenceJobRequest == false)
            return false;
        StartRxNormInferenceJobRequest other = (StartRxNormInferenceJobRequest) obj;
    ...
    @Override
    public StartRxNormInferenceJobRequest clone() {
        return (StartRxNormInferenceJobRequest) super.clone();
    }
