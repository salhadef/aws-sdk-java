 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/amplifybackend-2020-08-11/CreateBackendAuthVerificationMessageConfig"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateBackendAuthVerificationMessageConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public CreateBackendAuthVerificationMessageConfig withDeliveryMethod(String deliveryMethod) {
    ...
    public CreateBackendAuthVerificationMessageConfig withDeliveryMethod(DeliveryMethod deliveryMethod) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBackendAuthVerificationMessageConfig == false)
            return false;
    ...
    @Override
    public CreateBackendAuthVerificationMessageConfig clone() {
        try {
            return (CreateBackendAuthVerificationMessageConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.amplifybackend.model.transform.CreateBackendAuthVerificationMessageConfigMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
