...
public class ListDeploymentsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<DeploymentSummary> deployments;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return An array of deployment with summary data.
     */

    public java.util.List<DeploymentSummary> getDeployments() {
        return deployments;
    }
    ...
    public void setDeployments(java.util.Collection<DeploymentSummary> deployments) {
        if (deployments == null) {
            this.deployments = null;
            return;
        }

        this.deployments = new java.util.ArrayList<DeploymentSummary>(deployments);
    }
    ...
    public ListDeploymentsResult withDeployments(DeploymentSummary... deployments) {
        if (this.deployments == null) {
            setDeployments(new java.util.ArrayList<DeploymentSummary>(deployments.length));
        }
    ...
    public ListDeploymentsResult withDeployments(java.util.Collection<DeploymentSummary> deployments) {
     ...
     * </p>
     * 
     * @return A token that indicates the location of the next deployment in the array of deployment, after the current
     *         requested list of deployment.
     */
