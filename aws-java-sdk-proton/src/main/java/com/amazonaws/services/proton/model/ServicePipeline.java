 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/proton-2020-07-20/ServicePipeline" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServicePipeline implements Serializable, Cloneable, StructuredPojo {
    ...
    public ServicePipeline withCreatedAt(java.util.Date createdAt) {
    ...
    public ServicePipeline withLastDeploymentAttemptedAt(java.util.Date lastDeploymentAttemptedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ServicePipeline == false)
            return false;
    ...
    public ServicePipeline clone() {
        try {
            return (ServicePipeline) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.proton.model.transform.ServicePipelineMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
