...
@SdkInternalApi
public class ServicePipelineMarshaller {
    ...
    private static final ServicePipelineMarshaller instance = new ServicePipelineMarshaller();

    public static ServicePipelineMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ServicePipeline servicePipeline, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(servicePipeline.getArn(), ARN_BINDING);
            ...
            protocolMarshaller.marshall(servicePipeline.getTemplateName(), TEMPLATENAME_BINDING);
        } catch (Exception e) {
