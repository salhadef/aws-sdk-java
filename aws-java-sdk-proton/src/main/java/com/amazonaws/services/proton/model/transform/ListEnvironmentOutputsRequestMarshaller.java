...
/**
 * ListEnvironmentOutputsRequestMarshaller
 */
...
public class ListEnvironmentOutputsRequestMarshaller {
    ...
    private static final ListEnvironmentOutputsRequestMarshaller instance = new ListEnvironmentOutputsRequestMarshaller();

    public static ListEnvironmentOutputsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListEnvironmentOutputsRequest listEnvironmentOutputsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listEnvironmentOutputsRequest == null) {
