...
/**
 * ListServiceInstanceOutputsRequestMarshaller
 */
...
public class ListServiceInstanceOutputsRequestMarshaller {
    ...
    private static final ListServiceInstanceOutputsRequestMarshaller instance = new ListServiceInstanceOutputsRequestMarshaller();

    public static ListServiceInstanceOutputsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListServiceInstanceOutputsRequest listServiceInstanceOutputsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listServiceInstanceOutputsRequest == null) {
