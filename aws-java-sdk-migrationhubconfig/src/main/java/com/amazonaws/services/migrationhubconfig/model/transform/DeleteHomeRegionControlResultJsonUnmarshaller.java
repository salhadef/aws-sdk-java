...
/**
 * DeleteHomeRegionControlResult JSON Unmarshaller
 */
...
public class DeleteHomeRegionControlResultJsonUnmarshaller implements Unmarshaller<DeleteHomeRegionControlResult, JsonUnmarshallerContext> {
    ...
    public DeleteHomeRegionControlResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteHomeRegionControlResult deleteHomeRegionControlResult = new DeleteHomeRegionControlResult();
