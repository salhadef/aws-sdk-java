...
public class GetCustomVerificationEmailTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetCustomVerificationEmailTemplateRequest clone() {
        return (GetCustomVerificationEmailTemplateRequest) super.clone();
    }
