...
public class UpdateCustomVerificationEmailTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the custom verification email template to update.
     */
    ...
    public UpdateCustomVerificationEmailTemplateRequest clone() {
        return (UpdateCustomVerificationEmailTemplateRequest) super.clone();
    }
