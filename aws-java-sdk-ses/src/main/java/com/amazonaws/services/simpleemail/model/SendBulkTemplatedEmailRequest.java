 ...
 * the <a href="https://docs.aws.amazon.com/ses/latest/dg/send-personalized-email-api.html">Amazon SES Developer
 * Guide</a>.
 * </p>
 * 
...
public class SendBulkTemplatedEmailRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <a href="https://docs.aws.amazon.com/ses/latest/dg/creating-identities.html">Amazon SES Developer Guide</a>.
     * </p>
     * <p>
     ...
     * authorization, see the <a href="https://docs.aws.amazon.com/ses/latest/dg/sending-authorization.html">Amazon SES
     * Developer Guide</a>.
     * </p>
     * <note>
     * <p>
     ...
     * message is forwarded to the email address specified by the <code>ReturnPath</code> parameter. The
    ...
    /**
     * <p>
     * One or more <code>Destination</code> objects. All of the recipients in a <code>Destination</code> receive the
     * same version of the email. You can specify up to 50 <code>Destination</code> objects within a
     ...
     *        identities, see the <a href="https://docs.aws.amazon.com/ses/latest/dg/creating-identities.html">Amazon
     ...
     *        this message is forwarded to the email address specified by the <code>ReturnPath</code> parameter. The
     *        <code>ReturnPath</code> parameter is never overwritten. This email address must be either individually
     ...
     *         ISP; this message is forwarded to the email address specified by the <code>ReturnPath</code> parameter.
     *         The <code>ReturnPath</code> parameter is never overwritten. This email address must be either
     ...
     * </p>
     * 
     * @return One or more <code>Destination</code> objects. All of the recipients in a <code>Destination</code> receive
     ...
     * 
     * @param destinations
     *        One or more <code>Destination</code> objects. All of the recipients in a <code>Destination</code> receive
     *        the same version of the email. You can specify up to 50 <code>Destination</code> objects within a
     *        <code>Destinations</code> array.
     */
