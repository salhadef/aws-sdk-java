...
public enum H264ScanTypeConversionMode {
    ...
    private H264ScanTypeConversionMode(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return H264ScanTypeConversionMode corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static H264ScanTypeConversionMode fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (H264ScanTypeConversionMode enumEntry : H264ScanTypeConversionMode.values()) {
