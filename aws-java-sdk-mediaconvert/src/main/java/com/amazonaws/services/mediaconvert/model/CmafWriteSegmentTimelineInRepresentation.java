...
public enum CmafWriteSegmentTimelineInRepresentation {
    ...
    private CmafWriteSegmentTimelineInRepresentation(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return CmafWriteSegmentTimelineInRepresentation corresponding to the value
     *
    ...
    public static CmafWriteSegmentTimelineInRepresentation fromValue(String value) {
        ...
        for (CmafWriteSegmentTimelineInRepresentation enumEntry : CmafWriteSegmentTimelineInRepresentation.values()) {
