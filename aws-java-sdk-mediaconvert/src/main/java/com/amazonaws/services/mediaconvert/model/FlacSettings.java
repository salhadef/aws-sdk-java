 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/FlacSettings" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FlacSettings implements Serializable, Cloneable, StructuredPojo {
     ...
     * channel; choosing Stereo gives you 2. In the API, valid values are between 1 and 8.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FlacSettings == false)
            return false;
    ...
    @Override
    public FlacSettings clone() {
        try {
            return (FlacSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconvert.model.transform.FlacSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
