...
public enum CmafSegmentLengthControl {
    ...
    private CmafSegmentLengthControl(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return CmafSegmentLengthControl corresponding to the value
     *
    ...
    public static CmafSegmentLengthControl fromValue(String value) {
        ...
        for (CmafSegmentLengthControl enumEntry : CmafSegmentLengthControl.values()) {
