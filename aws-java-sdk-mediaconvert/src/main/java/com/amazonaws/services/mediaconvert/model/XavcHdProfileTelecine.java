...
public enum XavcHdProfileTelecine {
    ...
    private XavcHdProfileTelecine(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return XavcHdProfileTelecine corresponding to the value
     *
    ...
    public static XavcHdProfileTelecine fromValue(String value) {
        ...
        for (XavcHdProfileTelecine enumEntry : XavcHdProfileTelecine.values()) {
