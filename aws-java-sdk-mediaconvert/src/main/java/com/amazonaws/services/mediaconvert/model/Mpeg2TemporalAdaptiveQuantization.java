...
public enum Mpeg2TemporalAdaptiveQuantization {
    ...
    private Mpeg2TemporalAdaptiveQuantization(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Mpeg2TemporalAdaptiveQuantization corresponding to the value
     *
    ...
    public static Mpeg2TemporalAdaptiveQuantization fromValue(String value) {
        ...
        for (Mpeg2TemporalAdaptiveQuantization enumEntry : Mpeg2TemporalAdaptiveQuantization.values()) {
