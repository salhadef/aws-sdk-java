...
public enum Vc3ScanTypeConversionMode {
    ...
    private Vc3ScanTypeConversionMode(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Vc3ScanTypeConversionMode corresponding to the value
     *
    ...
    public static Vc3ScanTypeConversionMode fromValue(String value) {
        ...
        for (Vc3ScanTypeConversionMode enumEntry : Vc3ScanTypeConversionMode.values()) {
