...
/**
 * FlacSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FlacSettingsMarshaller {
    ...
    private static final FlacSettingsMarshaller instance = new FlacSettingsMarshaller();

    public static FlacSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FlacSettings flacSettings, ProtocolMarshaller protocolMarshaller) {

        if (flacSettings == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(flacSettings.getBitDepth(), BITDEPTH_BINDING);
            protocolMarshaller.marshall(flacSettings.getChannels(), CHANNELS_BINDING);
            protocolMarshaller.marshall(flacSettings.getSampleRate(), SAMPLERATE_BINDING);
        } catch (Exception e) {
