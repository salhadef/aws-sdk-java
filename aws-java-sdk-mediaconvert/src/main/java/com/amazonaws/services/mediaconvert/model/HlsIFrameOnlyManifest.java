...
public enum HlsIFrameOnlyManifest {
    ...
    private HlsIFrameOnlyManifest(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return HlsIFrameOnlyManifest corresponding to the value
     *
    ...
    public static HlsIFrameOnlyManifest fromValue(String value) {
        ...
        for (HlsIFrameOnlyManifest enumEntry : HlsIFrameOnlyManifest.values()) {
