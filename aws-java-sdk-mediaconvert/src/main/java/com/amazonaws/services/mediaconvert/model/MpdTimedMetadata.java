...
public enum MpdTimedMetadata {
    ...
    private MpdTimedMetadata(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return MpdTimedMetadata corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static MpdTimedMetadata fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (MpdTimedMetadata enumEntry : MpdTimedMetadata.values()) {
