...
public enum DvbSubtitleShadowColor {
    ...
    private DvbSubtitleShadowColor(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return DvbSubtitleShadowColor corresponding to the value
     *
    ...
    public static DvbSubtitleShadowColor fromValue(String value) {
        ...
        for (DvbSubtitleShadowColor enumEntry : DvbSubtitleShadowColor.values()) {
