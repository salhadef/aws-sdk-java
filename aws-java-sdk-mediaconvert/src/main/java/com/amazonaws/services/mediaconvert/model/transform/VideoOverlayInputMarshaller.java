...
/**
 * VideoOverlayInputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VideoOverlayInputMarshaller {
    ...
    private static final VideoOverlayInputMarshaller instance = new VideoOverlayInputMarshaller();

    public static VideoOverlayInputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VideoOverlayInput videoOverlayInput, ProtocolMarshaller protocolMarshaller) {

        if (videoOverlayInput == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(videoOverlayInput.getFileInput(), FILEINPUT_BINDING);
            protocolMarshaller.marshall(videoOverlayInput.getInputClippings(), INPUTCLIPPINGS_BINDING);
            protocolMarshaller.marshall(videoOverlayInput.getTimecodeSource(), TIMECODESOURCE_BINDING);
            protocolMarshaller.marshall(videoOverlayInput.getTimecodeStart(), TIMECODESTART_BINDING);
        } catch (Exception e) {
