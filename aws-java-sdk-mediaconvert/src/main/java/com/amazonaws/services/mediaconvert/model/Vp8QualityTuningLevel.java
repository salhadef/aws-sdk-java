...
public enum Vp8QualityTuningLevel {
    ...
    private Vp8QualityTuningLevel(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Vp8QualityTuningLevel corresponding to the value
     *
    ...
    public static Vp8QualityTuningLevel fromValue(String value) {
        ...
        for (Vp8QualityTuningLevel enumEntry : Vp8QualityTuningLevel.values()) {
