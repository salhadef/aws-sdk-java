...
public enum Av1FramerateControl {
    ...
    private Av1FramerateControl(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Av1FramerateControl corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static Av1FramerateControl fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (Av1FramerateControl enumEntry : Av1FramerateControl.values()) {
