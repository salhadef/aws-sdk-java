...
public enum Vp8FramerateControl {
    ...
    private Vp8FramerateControl(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Vp8FramerateControl corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static Vp8FramerateControl fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (Vp8FramerateControl enumEntry : Vp8FramerateControl.values()) {
