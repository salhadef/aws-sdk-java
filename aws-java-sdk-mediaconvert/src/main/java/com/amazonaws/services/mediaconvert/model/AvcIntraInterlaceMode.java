...
public enum AvcIntraInterlaceMode {
    ...
    private AvcIntraInterlaceMode(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return AvcIntraInterlaceMode corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static AvcIntraInterlaceMode fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (AvcIntraInterlaceMode enumEntry : AvcIntraInterlaceMode.values()) {
