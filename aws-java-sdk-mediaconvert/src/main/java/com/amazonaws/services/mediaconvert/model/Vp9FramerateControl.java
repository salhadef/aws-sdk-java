...
public enum Vp9FramerateControl {
    ...
    private Vp9FramerateControl(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Vp9FramerateControl corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static Vp9FramerateControl fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (Vp9FramerateControl enumEntry : Vp9FramerateControl.values()) {
