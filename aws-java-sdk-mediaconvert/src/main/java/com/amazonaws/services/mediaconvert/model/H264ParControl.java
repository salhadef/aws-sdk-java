...
public enum H264ParControl {
    ...
    private H264ParControl(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return H264ParControl corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static H264ParControl fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (H264ParControl enumEntry : H264ParControl.values()) {
