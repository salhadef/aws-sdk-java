...
public enum XavcSpatialAdaptiveQuantization {
    ...
    private XavcSpatialAdaptiveQuantization(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return XavcSpatialAdaptiveQuantization corresponding to the value
     *
    ...
    public static XavcSpatialAdaptiveQuantization fromValue(String value) {
        ...
        for (XavcSpatialAdaptiveQuantization enumEntry : XavcSpatialAdaptiveQuantization.values()) {
