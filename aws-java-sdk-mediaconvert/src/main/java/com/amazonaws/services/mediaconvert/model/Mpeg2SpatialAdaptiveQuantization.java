...
public enum Mpeg2SpatialAdaptiveQuantization {
    ...
    private Mpeg2SpatialAdaptiveQuantization(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Mpeg2SpatialAdaptiveQuantization corresponding to the value
     *
    ...
    public static Mpeg2SpatialAdaptiveQuantization fromValue(String value) {
        ...
        for (Mpeg2SpatialAdaptiveQuantization enumEntry : Mpeg2SpatialAdaptiveQuantization.values()) {
