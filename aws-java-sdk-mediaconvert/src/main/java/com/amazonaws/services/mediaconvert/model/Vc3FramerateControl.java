...
public enum Vc3FramerateControl {
    ...
    private Vc3FramerateControl(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Vc3FramerateControl corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static Vc3FramerateControl fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (Vc3FramerateControl enumEntry : Vc3FramerateControl.values()) {
