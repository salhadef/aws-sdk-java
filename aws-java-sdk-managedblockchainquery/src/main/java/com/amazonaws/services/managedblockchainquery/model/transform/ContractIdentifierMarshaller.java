...
/**
 * ContractIdentifierMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ContractIdentifierMarshaller {
    ...
    private static final ContractIdentifierMarshaller instance = new ContractIdentifierMarshaller();

    public static ContractIdentifierMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ContractIdentifier contractIdentifier, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(contractIdentifier.getNetwork(), NETWORK_BINDING);
            protocolMarshaller.marshall(contractIdentifier.getContractAddress(), CONTRACTADDRESS_BINDING);
        } catch (Exception e) {
