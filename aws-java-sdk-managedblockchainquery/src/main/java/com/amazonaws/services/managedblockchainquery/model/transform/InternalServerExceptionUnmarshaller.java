...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.managedblockchainquery.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.managedblockchainquery.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.managedblockchainquery.model.InternalServerException internalServerException = new com.amazonaws.services.managedblockchainquery.model.InternalServerException(
                null);
