...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.managedblockchainquery.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.managedblockchainquery.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.managedblockchainquery.model.ThrottlingException throttlingException = new com.amazonaws.services.managedblockchainquery.model.ThrottlingException(
                null);
