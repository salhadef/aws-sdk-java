...
/**
 * ValidationExceptionField JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ValidationExceptionFieldJsonUnmarshaller implements Unmarshaller<ValidationExceptionField, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    validationExceptionField.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
