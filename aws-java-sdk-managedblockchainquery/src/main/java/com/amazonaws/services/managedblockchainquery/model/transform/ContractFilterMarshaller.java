...
/**
 * ContractFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ContractFilterMarshaller {
    ...
    private static final ContractFilterMarshaller instance = new ContractFilterMarshaller();

    public static ContractFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ContractFilter contractFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(contractFilter.getNetwork(), NETWORK_BINDING);
            protocolMarshaller.marshall(contractFilter.getTokenStandard(), TOKENSTANDARD_BINDING);
            protocolMarshaller.marshall(contractFilter.getDeployerAddress(), DEPLOYERADDRESS_BINDING);
        } catch (Exception e) {
