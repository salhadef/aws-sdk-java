...
public class GetTokenBalanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetTokenBalanceResult withOwnerIdentifier(OwnerIdentifier ownerIdentifier) {
    ...
    public GetTokenBalanceResult withTokenIdentifier(TokenIdentifier tokenIdentifier) {
    ...
    public GetTokenBalanceResult withBalance(String balance) {
        setBalance(balance);
        return this;
    }
    ...
    public GetTokenBalanceResult withAtBlockchainInstant(BlockchainInstant atBlockchainInstant) {
    ...
    public GetTokenBalanceResult withLastUpdatedTime(BlockchainInstant lastUpdatedTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTokenBalanceResult == false)
            return false;
        GetTokenBalanceResult other = (GetTokenBalanceResult) obj;
    ...
    @Override
    public GetTokenBalanceResult clone() {
        try {
            return (GetTokenBalanceResult) super.clone();
