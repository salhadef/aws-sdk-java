...
/**
 * TokenBalance JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TokenBalanceJsonUnmarshaller implements Unmarshaller<TokenBalance, JsonUnmarshallerContext> {

    public TokenBalance unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static TokenBalanceJsonUnmarshaller instance;

    public static TokenBalanceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TokenBalanceJsonUnmarshaller();
        return instance;
    }
}
