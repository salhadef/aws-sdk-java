...
/**
 * BatchGetTokenBalanceInputItemMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BatchGetTokenBalanceInputItemMarshaller {
    ...
    private static final BatchGetTokenBalanceInputItemMarshaller instance = new BatchGetTokenBalanceInputItemMarshaller();

    public static BatchGetTokenBalanceInputItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchGetTokenBalanceInputItem batchGetTokenBalanceInputItem, ProtocolMarshaller protocolMarshaller) {

        if (batchGetTokenBalanceInputItem == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(batchGetTokenBalanceInputItem.getTokenIdentifier(), TOKENIDENTIFIER_BINDING);
            protocolMarshaller.marshall(batchGetTokenBalanceInputItem.getOwnerIdentifier(), OWNERIDENTIFIER_BINDING);
            protocolMarshaller.marshall(batchGetTokenBalanceInputItem.getAtBlockchainInstant(), ATBLOCKCHAININSTANT_BINDING);
        } catch (Exception e) {
