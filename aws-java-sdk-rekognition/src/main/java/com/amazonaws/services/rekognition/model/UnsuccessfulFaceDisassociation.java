...
public class UnsuccessfulFaceDisassociation implements Serializable, Cloneable, StructuredPojo {
    ...
    public UnsuccessfulFaceDisassociation withFaceId(String faceId) {
        setFaceId(faceId);
        return this;
    }
    ...
    public UnsuccessfulFaceDisassociation withUserId(String userId) {
        setUserId(userId);
        return this;
    }
     ...
     * @see UnsuccessfulFaceDisassociationReason
     */
    ...
    public UnsuccessfulFaceDisassociation withReasons(String... reasons) {
    ...
    public UnsuccessfulFaceDisassociation withReasons(java.util.Collection<String> reasons) {
        setReasons(reasons);
        return this;
    }
    ...
    public UnsuccessfulFaceDisassociation withReasons(UnsuccessfulFaceDisassociationReason... reasons) {
        java.util.ArrayList<String> reasonsCopy = new java.util.ArrayList<String>(reasons.length);
        for (UnsuccessfulFaceDisassociationReason value : reasons) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UnsuccessfulFaceDisassociation == false)
            return false;
    ...
    @Override
    public UnsuccessfulFaceDisassociation clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.UnsuccessfulFaceDisassociationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
