...
@SdkInternalApi
public class UserMatchMarshaller {
    ...
    private static final UserMatchMarshaller instance = new UserMatchMarshaller();

    public static UserMatchMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UserMatch userMatch, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(userMatch.getSimilarity(), SIMILARITY_BINDING);
            protocolMarshaller.marshall(userMatch.getUser(), USER_BINDING);
        } catch (Exception e) {
