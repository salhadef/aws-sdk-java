...
public class AssociatedFace implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public AssociatedFace clone() {
        try {
            return (AssociatedFace) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.AssociatedFaceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
