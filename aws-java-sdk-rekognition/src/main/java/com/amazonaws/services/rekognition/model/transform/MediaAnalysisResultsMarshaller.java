...
/**
 * MediaAnalysisResultsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MediaAnalysisResultsMarshaller {
    ...
    public static MediaAnalysisResultsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MediaAnalysisResults mediaAnalysisResults, ProtocolMarshaller protocolMarshaller) {

        if (mediaAnalysisResults == null) {
