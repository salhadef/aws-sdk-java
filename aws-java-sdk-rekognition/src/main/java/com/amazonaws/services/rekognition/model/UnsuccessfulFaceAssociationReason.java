...
public enum UnsuccessfulFaceAssociationReason {
     ...
     * @param value
     *        real value
     * @return UnsuccessfulFaceAssociationReason corresponding to the value
     *
    ...
    public static UnsuccessfulFaceAssociationReason fromValue(String value) {
        ...
        for (UnsuccessfulFaceAssociationReason enumEntry : UnsuccessfulFaceAssociationReason.values()) {
