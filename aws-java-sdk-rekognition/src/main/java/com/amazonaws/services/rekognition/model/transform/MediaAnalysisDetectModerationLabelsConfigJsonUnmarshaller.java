...
/**
 * MediaAnalysisDetectModerationLabelsConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MediaAnalysisDetectModerationLabelsConfigJsonUnmarshaller implements
        Unmarshaller<MediaAnalysisDetectModerationLabelsConfig, JsonUnmarshallerContext> {

    public MediaAnalysisDetectModerationLabelsConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MinConfidence", targetDepth)) {
                    context.nextToken();
                    mediaAnalysisDetectModerationLabelsConfig.setMinConfidence(context.getUnmarshaller(Float.class).unmarshall(context));
                }
                if (context.testExpression("ProjectVersion", targetDepth)) {
                    context.nextToken();
                    mediaAnalysisDetectModerationLabelsConfig.setProjectVersion(context.getUnmarshaller(String.class).unmarshall(context));
                }
