...
/**
 * UnsearchedFace JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UnsearchedFaceJsonUnmarshaller implements Unmarshaller<UnsearchedFace, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FaceDetails", targetDepth)) {
                    context.nextToken();
                    unsearchedFace.setFaceDetails(FaceDetailJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Reasons", targetDepth)) {
                    context.nextToken();
                    unsearchedFace.setReasons(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
