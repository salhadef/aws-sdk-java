...
/**
 * DetectModerationLabelsResult JSON Unmarshaller
 */
...
public class DetectModerationLabelsResultJsonUnmarshaller implements Unmarshaller<DetectModerationLabelsResult, JsonUnmarshallerContext> {
    ...
    public DetectModerationLabelsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ModerationModelVersion", targetDepth)) {
                    context.nextToken();
                    detectModerationLabelsResult.setModerationModelVersion(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("HumanLoopActivationOutput", targetDepth)) {
                    context.nextToken();
                    detectModerationLabelsResult.setHumanLoopActivationOutput(HumanLoopActivationOutputJsonUnmarshaller.getInstance().unmarshall(context));
                }
