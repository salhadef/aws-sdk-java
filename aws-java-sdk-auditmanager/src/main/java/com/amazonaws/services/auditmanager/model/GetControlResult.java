...
public class GetControlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetControlResult withControl(Control control) {
        setControl(control);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetControlResult == false)
            return false;
        GetControlResult other = (GetControlResult) obj;
    ...
    public GetControlResult clone() {
        try {
            return (GetControlResult) super.clone();
