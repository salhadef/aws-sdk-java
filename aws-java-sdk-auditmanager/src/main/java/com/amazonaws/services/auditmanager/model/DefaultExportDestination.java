 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/auditmanager-2017-07-25/DefaultExportDestination"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DefaultExportDestination implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The destination bucket where Audit Manager stores exported files.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DefaultExportDestination == false)
            return false;
        DefaultExportDestination other = (DefaultExportDestination) obj;
    ...
    public DefaultExportDestination clone() {
        try {
            return (DefaultExportDestination) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.auditmanager.model.transform.DefaultExportDestinationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
