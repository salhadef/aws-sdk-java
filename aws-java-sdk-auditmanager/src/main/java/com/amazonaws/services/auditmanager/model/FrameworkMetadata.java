...
public class FrameworkMetadata implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FrameworkMetadata == false)
            return false;
    ...
    public FrameworkMetadata clone() {
        try {
            return (FrameworkMetadata) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.auditmanager.model.transform.FrameworkMetadataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
