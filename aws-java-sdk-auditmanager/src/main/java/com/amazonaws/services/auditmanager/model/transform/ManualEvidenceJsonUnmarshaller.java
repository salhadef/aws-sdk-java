...
/**
 * ManualEvidence JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ManualEvidenceJsonUnmarshaller implements Unmarshaller<ManualEvidence, JsonUnmarshallerContext> {

    public ManualEvidence unmarshall(JsonUnmarshallerContext context) throws Exception {
        ManualEvidence manualEvidence = new ManualEvidence();
    ...
    private static ManualEvidenceJsonUnmarshaller instance;

    public static ManualEvidenceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ManualEvidenceJsonUnmarshaller();
        return instance;
    }
}
