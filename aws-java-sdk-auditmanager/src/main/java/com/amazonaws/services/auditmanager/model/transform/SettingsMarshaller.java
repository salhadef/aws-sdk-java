...
public class SettingsMarshaller {
    ...
    private static final MarshallingInfo<Boolean> ISAWSORGENABLED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("isAwsOrgEnabled").build();
    ...
    public void marshall(Settings settings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(settings.getIsAwsOrgEnabled(), ISAWSORGENABLED_BINDING);
            protocolMarshaller.marshall(settings.getSnsTopic(), SNSTOPIC_BINDING);
            protocolMarshaller.marshall(settings.getDefaultAssessmentReportsDestination(), DEFAULTASSESSMENTREPORTSDESTINATION_BINDING);
            ...
            protocolMarshaller.marshall(settings.getDefaultExportDestination(), DEFAULTEXPORTDESTINATION_BINDING);
        } catch (Exception e) {
