...
/**
 * CreateRule JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateRuleJsonUnmarshaller implements Unmarshaller<CreateRule, JsonUnmarshallerContext> {

    public CreateRule unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("IntervalUnit", targetDepth)) {
                    context.nextToken();
                    createRule.setIntervalUnit(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static CreateRuleJsonUnmarshaller instance;

    public static CreateRuleJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateRuleJsonUnmarshaller();
        return instance;
    }
}
