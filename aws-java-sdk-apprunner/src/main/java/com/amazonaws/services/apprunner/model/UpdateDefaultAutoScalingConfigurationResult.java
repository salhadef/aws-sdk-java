...
public class UpdateDefaultAutoScalingConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return A description of the App Runner auto scaling configuration that was set as default.
     */
    ...
    public UpdateDefaultAutoScalingConfigurationResult withAutoScalingConfiguration(AutoScalingConfiguration autoScalingConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDefaultAutoScalingConfigurationResult == false)
            return false;
        UpdateDefaultAutoScalingConfigurationResult other = (UpdateDefaultAutoScalingConfigurationResult) obj;
    ...
    @Override
    public UpdateDefaultAutoScalingConfigurationResult clone() {
        try {
            return (UpdateDefaultAutoScalingConfigurationResult) super.clone();
