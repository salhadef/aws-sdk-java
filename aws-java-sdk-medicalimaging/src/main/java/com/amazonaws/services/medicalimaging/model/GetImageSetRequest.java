...
public class GetImageSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetImageSetRequest withDatastoreId(String datastoreId) {
    ...
    public GetImageSetRequest withImageSetId(String imageSetId) {
    ...
    public GetImageSetRequest withVersionId(String versionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetImageSetRequest == false)
            return false;
    ...
    @Override
    public GetImageSetRequest clone() {
        return (GetImageSetRequest) super.clone();
    }
