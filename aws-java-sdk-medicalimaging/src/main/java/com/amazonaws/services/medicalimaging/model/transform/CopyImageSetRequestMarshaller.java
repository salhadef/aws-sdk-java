...
public class CopyImageSetRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SOURCEIMAGESETID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public static CopyImageSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CopyImageSetRequest copyImageSetRequest, ProtocolMarshaller protocolMarshaller) {
