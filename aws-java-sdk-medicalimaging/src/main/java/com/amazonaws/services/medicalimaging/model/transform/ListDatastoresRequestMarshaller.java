...
/**
 * ListDatastoresRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListDatastoresRequestMarshaller {

    private static final MarshallingInfo<String> DATASTORESTATUS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("datastoreStatus").build();
    private static final MarshallingInfo<String> NEXTTOKEN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("nextToken").build();
    private static final MarshallingInfo<Integer> MAXRESULTS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("maxResults").build();

    private static final ListDatastoresRequestMarshaller instance = new ListDatastoresRequestMarshaller();

    public static ListDatastoresRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(ListDatastoresRequest listDatastoresRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listDatastoresRequest.getDatastoreStatus(), DATASTORESTATUS_BINDING);
