...
/**
 * DatastorePropertiesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DatastorePropertiesMarshaller {
    ...
    public static DatastorePropertiesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DatastoreProperties datastoreProperties, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(datastoreProperties.getDatastoreId(), DATASTOREID_BINDING);
            protocolMarshaller.marshall(datastoreProperties.getDatastoreName(), DATASTORENAME_BINDING);
            protocolMarshaller.marshall(datastoreProperties.getDatastoreStatus(), DATASTORESTATUS_BINDING);
            protocolMarshaller.marshall(datastoreProperties.getKmsKeyArn(), KMSKEYARN_BINDING);
            protocolMarshaller.marshall(datastoreProperties.getDatastoreArn(), DATASTOREARN_BINDING);
            protocolMarshaller.marshall(datastoreProperties.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(datastoreProperties.getUpdatedAt(), UPDATEDAT_BINDING);
        } catch (Exception e) {
