...
/**
 * GetImageFrameResult JSON Unmarshaller
 */
...
public class GetImageFrameResultJsonUnmarshaller implements Unmarshaller<GetImageFrameResult, JsonUnmarshallerContext> {
    ...
    public GetImageFrameResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetImageFrameResult getImageFrameResult = new GetImageFrameResult();

        if (context.isStartOfDocument()) {
            if (context.getHeader("Content-Type") != null) {
                context.setCurrentHeader("Content-Type");
                getImageFrameResult.setContentType(context.getUnmarshaller(String.class).unmarshall(context));
            }
        }

        getImageFrameResult.setImageFrameBlob(context.getHttpResponse().getContent());
