...
public class ListDICOMImportJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<DICOMImportJobSummary> jobSummaries;
    /**
     * <p>
    ...
    public java.util.List<DICOMImportJobSummary> getJobSummaries() {
        return jobSummaries;
    }
    ...
    public void setJobSummaries(java.util.Collection<DICOMImportJobSummary> jobSummaries) {
        if (jobSummaries == null) {
            this.jobSummaries = null;
            return;
        }

        this.jobSummaries = new java.util.ArrayList<DICOMImportJobSummary>(jobSummaries);
    }
    ...
    public ListDICOMImportJobsResult withJobSummaries(DICOMImportJobSummary... jobSummaries) {
        if (this.jobSummaries == null) {
            setJobSummaries(new java.util.ArrayList<DICOMImportJobSummary>(jobSummaries.length));
        }
        for (DICOMImportJobSummary ele : jobSummaries) {
    ...
    public ListDICOMImportJobsResult withJobSummaries(java.util.Collection<DICOMImportJobSummary> jobSummaries) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDICOMImportJobsResult == false)
            return false;
        ListDICOMImportJobsResult other = (ListDICOMImportJobsResult) obj;
    ...
    public ListDICOMImportJobsResult clone() {
        try {
            return (ListDICOMImportJobsResult) super.clone();
