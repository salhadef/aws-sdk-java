...
/**
 * CopySourceImageSetInformationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CopySourceImageSetInformationMarshaller {
    ...
    public static CopySourceImageSetInformationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CopySourceImageSetInformation copySourceImageSetInformation, ProtocolMarshaller protocolMarshaller) {

        if (copySourceImageSetInformation == null) {
