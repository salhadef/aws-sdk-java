...
public class GetDatastoreResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetDatastoreResult withDatastoreProperties(DatastoreProperties datastoreProperties) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDatastoreResult == false)
            return false;
        GetDatastoreResult other = (GetDatastoreResult) obj;
    ...
    @Override
    public GetDatastoreResult clone() {
        try {
            return (GetDatastoreResult) super.clone();
