...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medical-imaging-2023-07-19/DeleteDatastore" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteDatastoreResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteDatastoreResult withDatastoreId(String datastoreId) {
    ...
    public DeleteDatastoreResult withDatastoreStatus(String datastoreStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDatastoreResult == false)
            return false;
        DeleteDatastoreResult other = (DeleteDatastoreResult) obj;
    ...
    @Override
    public DeleteDatastoreResult clone() {
        try {
