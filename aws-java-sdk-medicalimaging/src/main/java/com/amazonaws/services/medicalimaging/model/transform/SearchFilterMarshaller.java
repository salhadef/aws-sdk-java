...
/**
 * SearchFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SearchFilterMarshaller {
    ...
    private static final SearchFilterMarshaller instance = new SearchFilterMarshaller();

    public static SearchFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SearchFilter searchFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(searchFilter.getValues(), VALUES_BINDING);
            protocolMarshaller.marshall(searchFilter.getOperator(), OPERATOR_BINDING);
        } catch (Exception e) {
