 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medical-imaging-2023-07-19/CopySourceImageSetInformation"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CopySourceImageSetInformation implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CopySourceImageSetInformation == false)
            return false;
    ...
    @Override
    public CopySourceImageSetInformation clone() {
        try {
            return (CopySourceImageSetInformation) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medicalimaging.model.transform.CopySourceImageSetInformationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
