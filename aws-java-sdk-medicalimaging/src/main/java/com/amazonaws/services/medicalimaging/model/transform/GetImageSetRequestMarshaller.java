...
public class GetImageSetRequestMarshaller {
    ...
    private static final GetImageSetRequestMarshaller instance = new GetImageSetRequestMarshaller();

    public static GetImageSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetImageSetRequest getImageSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getImageSetRequest.getDatastoreId(), DATASTOREID_BINDING);
            protocolMarshaller.marshall(getImageSetRequest.getImageSetId(), IMAGESETID_BINDING);
            protocolMarshaller.marshall(getImageSetRequest.getVersionId(), VERSIONID_BINDING);
        } catch (Exception e) {
