...
public class UpdateOutpostResolverResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The response to an <code>UpdateOutpostResolver</code> request.
     */
    ...
    public UpdateOutpostResolverResult withOutpostResolver(OutpostResolver outpostResolver) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateOutpostResolverResult == false)
            return false;
        UpdateOutpostResolverResult other = (UpdateOutpostResolverResult) obj;
    ...
    @Override
    public UpdateOutpostResolverResult clone() {
        try {
            return (UpdateOutpostResolverResult) super.clone();
