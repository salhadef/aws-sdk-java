...
public class DeleteOutpostResolverResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * Information about the <code>DeleteOutpostResolver</code> request, including the status of the request.
     * </p>
     */
     ...
     * </p>
     * 
     * @return Information about the <code>DeleteOutpostResolver</code> request, including the status of the request.
     */
    ...
    public DeleteOutpostResolverResult withOutpostResolver(OutpostResolver outpostResolver) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteOutpostResolverResult == false)
            return false;
        DeleteOutpostResolverResult other = (DeleteOutpostResolverResult) obj;
    ...
    public DeleteOutpostResolverResult clone() {
        try {
            return (DeleteOutpostResolverResult) super.clone();
