...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/GetOutpostResolver" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetOutpostResolverResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetOutpostResolverResult withOutpostResolver(OutpostResolver outpostResolver) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOutpostResolverResult == false)
            return false;
        GetOutpostResolverResult other = (GetOutpostResolverResult) obj;
    ...
    @Override
    public GetOutpostResolverResult clone() {
        try {
            return (GetOutpostResolverResult) super.clone();
