...
public class DescribeEventTypesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public void setFilter(EventTypeFilter filter) {
        this.filter = filter;
    }
    ...
    public EventTypeFilter getFilter() {
        return this.filter;
    }
    ...
    public DescribeEventTypesRequest withFilter(EventTypeFilter filter) {
        setFilter(filter);
        return this;
    }
    ...
    public DescribeEventTypesRequest withLocale(String locale) {
        setLocale(locale);
        return this;
    }
    ...
    public DescribeEventTypesRequest withNextToken(String nextToken) {
    ...
    public DescribeEventTypesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEventTypesRequest == false)
            return false;
    ...
    @Override
    public DescribeEventTypesRequest clone() {
        return (DescribeEventTypesRequest) super.clone();
    }
