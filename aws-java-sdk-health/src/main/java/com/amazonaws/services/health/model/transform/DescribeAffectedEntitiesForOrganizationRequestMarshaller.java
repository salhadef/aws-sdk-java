...
/**
 * DescribeAffectedEntitiesForOrganizationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeAffectedEntitiesForOrganizationRequestMarshaller {

    private static final MarshallingInfo<List> ORGANIZATIONENTITYFILTERS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("organizationEntityFilters").build();
    ...
    public static DescribeAffectedEntitiesForOrganizationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeAffectedEntitiesForOrganizationRequest describeAffectedEntitiesForOrganizationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeAffectedEntitiesForOrganizationRequest.getOrganizationEntityFilters(), ORGANIZATIONENTITYFILTERS_BINDING);
