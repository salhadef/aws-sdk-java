...
public class DescribeEntityAggregatesForOrganizationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeEntityAggregatesForOrganizationRequest withEventArns(String... eventArns) {
    ...
    public DescribeEntityAggregatesForOrganizationRequest withEventArns(java.util.Collection<String> eventArns) {
    ...
    public DescribeEntityAggregatesForOrganizationRequest withAwsAccountIds(String... awsAccountIds) {
    ...
    public DescribeEntityAggregatesForOrganizationRequest withAwsAccountIds(java.util.Collection<String> awsAccountIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEntityAggregatesForOrganizationRequest == false)
            return false;
        DescribeEntityAggregatesForOrganizationRequest other = (DescribeEntityAggregatesForOrganizationRequest) obj;
    ...
    @Override
    public DescribeEntityAggregatesForOrganizationRequest clone() {
        return (DescribeEntityAggregatesForOrganizationRequest) super.clone();
    }
