...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.paymentcryptography.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.paymentcryptography.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.paymentcryptography.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.paymentcryptography.model.ResourceNotFoundException(
                null);
