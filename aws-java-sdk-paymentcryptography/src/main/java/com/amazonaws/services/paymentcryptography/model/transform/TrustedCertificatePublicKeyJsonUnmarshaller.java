...
/**
 * TrustedCertificatePublicKey JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TrustedCertificatePublicKeyJsonUnmarshaller implements Unmarshaller<TrustedCertificatePublicKey, JsonUnmarshallerContext> {

    public TrustedCertificatePublicKey unmarshall(JsonUnmarshallerContext context) throws Exception {
        TrustedCertificatePublicKey trustedCertificatePublicKey = new TrustedCertificatePublicKey();
    ...
    private static TrustedCertificatePublicKeyJsonUnmarshaller instance;

    public static TrustedCertificatePublicKeyJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TrustedCertificatePublicKeyJsonUnmarshaller();
        return instance;
    }
}
