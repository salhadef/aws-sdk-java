...
public class ListTagsForResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The list of tags associated with a <code>ResourceArn</code>. Each tag will list the key-value pair
     ...
     * 
     * @param tags
     *        The list of tags associated with a <code>ResourceArn</code>. Each tag will list the key-value pair
     *        contained within that tag.
     */
