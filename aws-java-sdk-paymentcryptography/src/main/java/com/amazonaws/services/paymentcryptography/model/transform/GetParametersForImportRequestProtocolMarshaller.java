...
public class GetParametersForImportRequestProtocolMarshaller implements Marshaller<Request<GetParametersForImportRequest>, GetParametersForImportRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.AWS_JSON).requestUri("/")
            ...
            .operationIdentifier("PaymentCryptographyControlPlane.GetParametersForImport").serviceName("AWSPaymentCryptography").build();

    private final com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory;

    public GetParametersForImportRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
