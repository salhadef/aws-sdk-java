...
public class ListAliasesRequestProtocolMarshaller implements Marshaller<Request<ListAliasesRequest>, ListAliasesRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.AWS_JSON).requestUri("/")
            ...
            .operationIdentifier("PaymentCryptographyControlPlane.ListAliases").serviceName("AWSPaymentCryptography").build();

    private final com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory;

    public ListAliasesRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
