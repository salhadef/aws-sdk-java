...
/**
 * DeleteKeyResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteKeyResultJsonUnmarshaller implements Unmarshaller<DeleteKeyResult, JsonUnmarshallerContext> {

    public DeleteKeyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteKeyResult deleteKeyResult = new DeleteKeyResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    deleteKeyResult.setKey(KeyJsonUnmarshaller.getInstance().unmarshall(context));
                }
