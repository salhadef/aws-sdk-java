...
/**
 * ExportTr34KeyBlock JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExportTr34KeyBlockJsonUnmarshaller implements Unmarshaller<ExportTr34KeyBlock, JsonUnmarshallerContext> {

    public ExportTr34KeyBlock unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExportTr34KeyBlock exportTr34KeyBlock = new ExportTr34KeyBlock();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("KeyBlockFormat", targetDepth)) {
                    context.nextToken();
                    exportTr34KeyBlock.setKeyBlockFormat(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ExportTr34KeyBlockJsonUnmarshaller instance;

    public static ExportTr34KeyBlockJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExportTr34KeyBlockJsonUnmarshaller();
        return instance;
    }
}
