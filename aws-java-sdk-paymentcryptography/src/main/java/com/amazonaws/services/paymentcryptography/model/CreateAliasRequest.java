...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/payment-cryptography-2021-09-14/CreateAlias" target="_top">AWS
 *      API Documentation</a>
 */
...
public class CreateAliasRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The <code>KeyARN</code> of the key to associate with the alias.
     */
    ...
    public CreateAliasRequest withKeyArn(String keyArn) {
        setKeyArn(keyArn);
        return this;
    }
