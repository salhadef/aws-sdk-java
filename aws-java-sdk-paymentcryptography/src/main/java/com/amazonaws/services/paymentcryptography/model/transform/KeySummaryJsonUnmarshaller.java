...
/**
 * KeySummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KeySummaryJsonUnmarshaller implements Unmarshaller<KeySummary, JsonUnmarshallerContext> {

    public KeySummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        KeySummary keySummary = new KeySummary();
    ...
    private static KeySummaryJsonUnmarshaller instance;

    public static KeySummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new KeySummaryJsonUnmarshaller();
        return instance;
    }
}
