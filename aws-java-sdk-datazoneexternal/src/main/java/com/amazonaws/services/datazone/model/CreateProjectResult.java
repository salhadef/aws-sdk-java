...
public class CreateProjectResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateProjectResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateProjectResult withGlossaryTerms(java.util.Collection<String> glossaryTerms) {
    ...
    public CreateProjectResult withLastUpdatedAt(java.util.Date lastUpdatedAt) {
