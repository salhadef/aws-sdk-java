...
public class ListSubscriptionGrantsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<SubscriptionGrantSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>ListSubscriptionGrants</code> action.
     */

    public java.util.List<SubscriptionGrantSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<SubscriptionGrantSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<SubscriptionGrantSummary>(items);
    }
    ...
    public ListSubscriptionGrantsResult withItems(SubscriptionGrantSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<SubscriptionGrantSummary>(items.length));
        }
        for (SubscriptionGrantSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListSubscriptionGrantsResult withItems(java.util.Collection<SubscriptionGrantSummary> items) {
        setItems(items);
        return this;
    }
    ...
    public ListSubscriptionGrantsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSubscriptionGrantsResult == false)
            return false;
        ListSubscriptionGrantsResult other = (ListSubscriptionGrantsResult) obj;
    ...
    @Override
    public ListSubscriptionGrantsResult clone() {
        try {
            return (ListSubscriptionGrantsResult) super.clone();
