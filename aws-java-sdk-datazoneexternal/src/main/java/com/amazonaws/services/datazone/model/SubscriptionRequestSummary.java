 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/SubscriptionRequestSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SubscriptionRequestSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public SubscriptionRequestSummary withCreatedAt(java.util.Date createdAt) {
    ...
    public SubscriptionRequestSummary withSubscribedListings(SubscribedListing... subscribedListings) {
    ...
    public SubscriptionRequestSummary withSubscribedListings(java.util.Collection<SubscribedListing> subscribedListings) {
    ...
    public SubscriptionRequestSummary withSubscribedPrincipals(SubscribedPrincipal... subscribedPrincipals) {
    ...
    public SubscriptionRequestSummary withSubscribedPrincipals(java.util.Collection<SubscribedPrincipal> subscribedPrincipals) {
    ...
    public SubscriptionRequestSummary withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SubscriptionRequestSummary == false)
            return false;
    ...
    public SubscriptionRequestSummary clone() {
        try {
            return (SubscriptionRequestSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.datazone.model.transform.SubscriptionRequestSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
