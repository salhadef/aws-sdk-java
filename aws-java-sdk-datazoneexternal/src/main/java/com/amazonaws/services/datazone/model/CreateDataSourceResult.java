...
public class CreateDataSourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDataSourceResult withAssetFormsOutput(FormOutput... assetFormsOutput) {
    ...
    public CreateDataSourceResult withAssetFormsOutput(java.util.Collection<FormOutput> assetFormsOutput) {
    ...
    public CreateDataSourceResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateDataSourceResult withLastRunAt(java.util.Date lastRunAt) {
    ...
    public CreateDataSourceResult withUpdatedAt(java.util.Date updatedAt) {
