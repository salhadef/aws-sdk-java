...
public class ListDomainsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The results of the <code>ListDomains</code> action.
     */
    ...
    public void setItems(java.util.Collection<DomainSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<DomainSummary>(items);
    }
    ...
    public ListDomainsResult withItems(DomainSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<DomainSummary>(items.length));
        }
        for (DomainSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListDomainsResult withItems(java.util.Collection<DomainSummary> items) {
        setItems(items);
        return this;
    }
