...
/**
 * FormEntryInputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FormEntryInputMarshaller {
    ...
    private static final FormEntryInputMarshaller instance = new FormEntryInputMarshaller();

    public static FormEntryInputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FormEntryInput formEntryInput, ProtocolMarshaller protocolMarshaller) {

        if (formEntryInput == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(formEntryInput.getRequired(), REQUIRED_BINDING);
            protocolMarshaller.marshall(formEntryInput.getTypeIdentifier(), TYPEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(formEntryInput.getTypeRevision(), TYPEREVISION_BINDING);
        } catch (Exception e) {
