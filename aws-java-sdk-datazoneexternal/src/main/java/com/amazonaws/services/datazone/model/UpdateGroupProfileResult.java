...
public class UpdateGroupProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateGroupProfileResult == false)
            return false;
        UpdateGroupProfileResult other = (UpdateGroupProfileResult) obj;
    ...
    public UpdateGroupProfileResult clone() {
        try {
            return (UpdateGroupProfileResult) super.clone();
