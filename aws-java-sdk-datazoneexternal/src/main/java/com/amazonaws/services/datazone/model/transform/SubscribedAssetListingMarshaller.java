...
/**
 * SubscribedAssetListingMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SubscribedAssetListingMarshaller {
    ...
    private static final SubscribedAssetListingMarshaller instance = new SubscribedAssetListingMarshaller();

    public static SubscribedAssetListingMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SubscribedAssetListing subscribedAssetListing, ProtocolMarshaller protocolMarshaller) {

        if (subscribedAssetListing == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(subscribedAssetListing.getEntityId(), ENTITYID_BINDING);
            protocolMarshaller.marshall(subscribedAssetListing.getEntityRevision(), ENTITYREVISION_BINDING);
            protocolMarshaller.marshall(subscribedAssetListing.getEntityType(), ENTITYTYPE_BINDING);
            protocolMarshaller.marshall(subscribedAssetListing.getForms(), FORMS_BINDING);
            protocolMarshaller.marshall(subscribedAssetListing.getGlossaryTerms(), GLOSSARYTERMS_BINDING);
        } catch (Exception e) {
