...
public class ListProjectsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> GROUPIDENTIFIER_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("groupIdentifier").build();
    ...
    private static final MarshallingInfo<String> USERIDENTIFIER_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("userIdentifier").build();
    ...
    public void marshall(ListProjectsRequest listProjectsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listProjectsRequest.getDomainIdentifier(), DOMAINIDENTIFIER_BINDING);
            protocolMarshaller.marshall(listProjectsRequest.getGroupIdentifier(), GROUPIDENTIFIER_BINDING);
            protocolMarshaller.marshall(listProjectsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listProjectsRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(listProjectsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listProjectsRequest.getUserIdentifier(), USERIDENTIFIER_BINDING);
        } catch (Exception e) {
