...
public class ListDataSourceRunsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<DataSourceRunSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>ListDataSourceRuns</code> action.
     */

    public java.util.List<DataSourceRunSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<DataSourceRunSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<DataSourceRunSummary>(items);
    }
    ...
    public ListDataSourceRunsResult withItems(DataSourceRunSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<DataSourceRunSummary>(items.length));
        }
        for (DataSourceRunSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListDataSourceRunsResult withItems(java.util.Collection<DataSourceRunSummary> items) {
        setItems(items);
        return this;
    }
    ...
    public ListDataSourceRunsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDataSourceRunsResult == false)
            return false;
        ListDataSourceRunsResult other = (ListDataSourceRunsResult) obj;
    ...
    public ListDataSourceRunsResult clone() {
        try {
            return (ListDataSourceRunsResult) super.clone();
