...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/GetEnvironmentProfile" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetEnvironmentProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon Web Services account where this environment profile exists.
     */
     ...
     * </p>
     * 
     * @return The Amazon Web Services region where this environment profile exists.
     */
    ...
    public GetEnvironmentProfileResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone domain in which this environment profile exists.
     */
     ...
     * </p>
     * 
     * @return The ID of the environment profile.
     */
     ...
     * </p>
     * 
     * @return The timestamp of when this environment profile was upated.
     */
    ...
    public GetEnvironmentProfileResult withUpdatedAt(java.util.Date updatedAt) {
     ...
     * </p>
     * 
     * @return The user parameters of the environment profile.
     */
    ...
    public GetEnvironmentProfileResult withUserParameters(CustomParameter... userParameters) {
    ...
    public GetEnvironmentProfileResult withUserParameters(java.util.Collection<CustomParameter> userParameters) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetEnvironmentProfileResult == false)
            return false;
        GetEnvironmentProfileResult other = (GetEnvironmentProfileResult) obj;
    ...
    public GetEnvironmentProfileResult clone() {
        try {
            return (GetEnvironmentProfileResult) super.clone();
