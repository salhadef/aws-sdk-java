        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("iam", targetDepth)) {
                    context.nextToken();
                    userProfileDetails.setIam(IamUserProfileDetailsJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("sso", targetDepth)) {
                    context.nextToken();
                    userProfileDetails.setSso(SsoUserProfileDetailsJsonUnmarshaller.getInstance().unmarshall(context));
                }
