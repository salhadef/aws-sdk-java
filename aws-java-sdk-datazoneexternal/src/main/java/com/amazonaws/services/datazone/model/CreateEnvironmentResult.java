...
public class CreateEnvironmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Web Services region in which the Amazon DataZone environment is created.
     */
    ...
    public CreateEnvironmentResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The Amazon DataZone user who created this environment.
     */
     ...
     * </p>
     * 
     * @return The deployment properties of this Amazon DataZone environment.
     */
     ...
     * </p>
     * 
     * @return The description of this Amazon DataZone environment.
     */
     ...
     * </p>
     * 
     * @return The configurable actions of this Amazon DataZone environment.
     */
    ...
    public CreateEnvironmentResult withEnvironmentActions(ConfigurableEnvironmentAction... environmentActions) {
    ...
    public CreateEnvironmentResult withEnvironmentActions(java.util.Collection<ConfigurableEnvironmentAction> environmentActions) {
     ...
     * </p>
     * 
     * @return The ID of the blueprint with which this Amazon DataZone environment was created.
     */
     ...
     * </p>
     * 
     * @return The ID of the environment profile with which this Amazon DataZone environment was created.
     */
    ...
    public CreateEnvironmentResult withGlossaryTerms(java.util.Collection<String> glossaryTerms) {
     ...
     * </p>
     * 
     * @return The ID of this Amazon DataZone environment.
     */
     ...
     * </p>
     * 
     * @return The details of the last deployment of this Amazon DataZone environment.
     */
    ...
    public CreateEnvironmentResult withProvisionedResources(Resource... provisionedResources) {
    ...
    public CreateEnvironmentResult withProvisionedResources(java.util.Collection<Resource> provisionedResources) {
    ...
    public CreateEnvironmentResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public CreateEnvironmentResult withUserParameters(CustomParameter... userParameters) {
    ...
    public CreateEnvironmentResult withUserParameters(java.util.Collection<CustomParameter> userParameters) {
