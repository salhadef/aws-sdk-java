...
public class TopicMarshaller {
    ...
    private static final TopicMarshaller instance = new TopicMarshaller();

    public static TopicMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Topic topic, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(topic.getResource(), RESOURCE_BINDING);
            protocolMarshaller.marshall(topic.getRole(), ROLE_BINDING);
            protocolMarshaller.marshall(topic.getSubject(), SUBJECT_BINDING);
        } catch (Exception e) {
