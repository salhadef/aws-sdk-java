 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/DataSourceConfigurationOutput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataSourceConfigurationOutput implements Serializable, Cloneable, StructuredPojo {
    ...
    public GlueRunConfigurationOutput getGlueRunConfiguration() {
    ...
    public void setRedshiftRunConfiguration(RedshiftRunConfigurationOutput redshiftRunConfiguration) {
    ...
    public RedshiftRunConfigurationOutput getRedshiftRunConfiguration() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DataSourceConfigurationOutput == false)
            return false;
    ...
    @Override
    public DataSourceConfigurationOutput clone() {
        try {
            return (DataSourceConfigurationOutput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.datazone.model.transform.DataSourceConfigurationOutputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
