...
public class RevokeSubscriptionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getRetainPermissions() != null)
            sb.append("RetainPermissions: ").append(getRetainPermissions());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RevokeSubscriptionRequest == false)
            return false;
        RevokeSubscriptionRequest other = (RevokeSubscriptionRequest) obj;
