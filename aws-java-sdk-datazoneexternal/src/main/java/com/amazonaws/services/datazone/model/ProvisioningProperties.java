 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/ProvisioningProperties" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProvisioningProperties implements Serializable, Cloneable, StructuredPojo {
    ...
    public CloudFormationProperties getCloudFormation() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ProvisioningProperties == false)
            return false;
    ...
    public ProvisioningProperties clone() {
        try {
            return (ProvisioningProperties) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.datazone.model.transform.ProvisioningPropertiesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
