...
public class ListSubscriptionTargetsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<SubscriptionTargetSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>ListSubscriptionTargets</code> action.
     */

    public java.util.List<SubscriptionTargetSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<SubscriptionTargetSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<SubscriptionTargetSummary>(items);
    }
    ...
    public ListSubscriptionTargetsResult withItems(SubscriptionTargetSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<SubscriptionTargetSummary>(items.length));
        }
        for (SubscriptionTargetSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListSubscriptionTargetsResult withItems(java.util.Collection<SubscriptionTargetSummary> items) {
        setItems(items);
        return this;
    }
    ...
    public ListSubscriptionTargetsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSubscriptionTargetsResult == false)
            return false;
        ListSubscriptionTargetsResult other = (ListSubscriptionTargetsResult) obj;
    ...
    @Override
    public ListSubscriptionTargetsResult clone() {
        try {
            return (ListSubscriptionTargetsResult) super.clone();
