...
/**
 * DeleteAssetResult JSON Unmarshaller
 */
...
public class DeleteAssetResultJsonUnmarshaller implements Unmarshaller<DeleteAssetResult, JsonUnmarshallerContext> {
    ...
    public DeleteAssetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAssetResult deleteAssetResult = new DeleteAssetResult();
