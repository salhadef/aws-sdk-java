 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/GrantedEntityInput" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GrantedEntityInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public ListingRevisionInput getListing() {
        return this.listing;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GrantedEntityInput == false)
            return false;
    ...
    public GrantedEntityInput clone() {
        try {
            return (GrantedEntityInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.datazone.model.transform.GrantedEntityInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
