        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("items", targetDepth)) {
                    context.nextToken();
                    searchResult.setItems(new ListUnmarshaller<SearchInventoryResultItem>(SearchInventoryResultItemJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    searchResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("totalMatchCount", targetDepth)) {
                    context.nextToken();
                    searchResult.setTotalMatchCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
