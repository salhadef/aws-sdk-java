...
public class SearchUserProfilesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<UserProfileSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>SearchUserProfiles</code> action.
     */

    public java.util.List<UserProfileSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<UserProfileSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<UserProfileSummary>(items);
    }
    ...
    public SearchUserProfilesResult withItems(UserProfileSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<UserProfileSummary>(items.length));
        }
        for (UserProfileSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public SearchUserProfilesResult withItems(java.util.Collection<UserProfileSummary> items) {
        setItems(items);
        return this;
    }
    ...
    public SearchUserProfilesResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchUserProfilesResult == false)
            return false;
        SearchUserProfilesResult other = (SearchUserProfilesResult) obj;
    ...
    @Override
    public SearchUserProfilesResult clone() {
        try {
            return (SearchUserProfilesResult) super.clone();
