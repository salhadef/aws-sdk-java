...
/**
 * GlueRunConfigurationInputMarshaller
 */
...
public class GlueRunConfigurationInputMarshaller {
    ...
    private static final GlueRunConfigurationInputMarshaller instance = new GlueRunConfigurationInputMarshaller();

    public static GlueRunConfigurationInputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GlueRunConfigurationInput glueRunConfigurationInput, ProtocolMarshaller protocolMarshaller) {

        if (glueRunConfigurationInput == null) {
