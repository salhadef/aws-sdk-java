...
/**
 * DeleteSubscriptionTargetResult JSON Unmarshaller
 */
...
public class DeleteSubscriptionTargetResultJsonUnmarshaller implements Unmarshaller<DeleteSubscriptionTargetResult, JsonUnmarshallerContext> {
    ...
    public DeleteSubscriptionTargetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSubscriptionTargetResult deleteSubscriptionTargetResult = new DeleteSubscriptionTargetResult();
