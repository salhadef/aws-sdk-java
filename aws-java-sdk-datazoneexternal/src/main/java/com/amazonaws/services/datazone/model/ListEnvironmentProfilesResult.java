...
public class ListEnvironmentProfilesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<EnvironmentProfileSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>ListEnvironmentProfiles</code> action.
     */

    public java.util.List<EnvironmentProfileSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<EnvironmentProfileSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<EnvironmentProfileSummary>(items);
    }
    ...
    public ListEnvironmentProfilesResult withItems(EnvironmentProfileSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<EnvironmentProfileSummary>(items.length));
        }
        for (EnvironmentProfileSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListEnvironmentProfilesResult withItems(java.util.Collection<EnvironmentProfileSummary> items) {
        setItems(items);
        return this;
    }
    ...
    public ListEnvironmentProfilesResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEnvironmentProfilesResult == false)
            return false;
        ListEnvironmentProfilesResult other = (ListEnvironmentProfilesResult) obj;
    ...
    @Override
    public ListEnvironmentProfilesResult clone() {
        try {
            return (ListEnvironmentProfilesResult) super.clone();
