...
/**
 * FormEntryOutputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FormEntryOutputMarshaller {
    ...
    private static final FormEntryOutputMarshaller instance = new FormEntryOutputMarshaller();

    public static FormEntryOutputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FormEntryOutput formEntryOutput, ProtocolMarshaller protocolMarshaller) {

        if (formEntryOutput == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(formEntryOutput.getRequired(), REQUIRED_BINDING);
            protocolMarshaller.marshall(formEntryOutput.getTypeName(), TYPENAME_BINDING);
            protocolMarshaller.marshall(formEntryOutput.getTypeRevision(), TYPEREVISION_BINDING);
        } catch (Exception e) {
