...
public class DataProductItemMarshaller {
    ...
    public void marshall(DataProductItem dataProductItem, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dataProductItem.getDomainId(), DOMAINID_BINDING);
            protocolMarshaller.marshall(dataProductItem.getItemId(), ITEMID_BINDING);
        } catch (Exception e) {
