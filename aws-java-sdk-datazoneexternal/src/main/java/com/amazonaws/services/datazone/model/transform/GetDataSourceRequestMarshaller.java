...
public class GetDataSourceRequestMarshaller {
    ...
    public void marshall(GetDataSourceRequest getDataSourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getDataSourceRequest.getDomainIdentifier(), DOMAINIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getDataSourceRequest.getIdentifier(), IDENTIFIER_BINDING);
        } catch (Exception e) {
