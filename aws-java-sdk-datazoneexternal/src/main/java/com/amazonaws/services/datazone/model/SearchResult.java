...
public class SearchResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<SearchInventoryResultItem> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>Search</code> action.
     */

    public java.util.List<SearchInventoryResultItem> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<SearchInventoryResultItem> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<SearchInventoryResultItem>(items);
    }
    ...
    public SearchResult withItems(SearchInventoryResultItem... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<SearchInventoryResultItem>(items.length));
        }
        for (SearchInventoryResultItem ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public SearchResult withItems(java.util.Collection<SearchInventoryResultItem> items) {
        setItems(items);
        return this;
    }
    ...
    public SearchResult withTotalMatchCount(Integer totalMatchCount) {
