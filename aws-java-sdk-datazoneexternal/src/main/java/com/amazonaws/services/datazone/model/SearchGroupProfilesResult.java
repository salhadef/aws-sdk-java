...
public class SearchGroupProfilesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<GroupProfileSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>SearchGroupProfiles</code> action.
     */

    public java.util.List<GroupProfileSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<GroupProfileSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<GroupProfileSummary>(items);
    }
    ...
    public SearchGroupProfilesResult withItems(GroupProfileSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<GroupProfileSummary>(items.length));
        }
        for (GroupProfileSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public SearchGroupProfilesResult withItems(java.util.Collection<GroupProfileSummary> items) {
        setItems(items);
        return this;
    }
    ...
    public SearchGroupProfilesResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchGroupProfilesResult == false)
            return false;
        SearchGroupProfilesResult other = (SearchGroupProfilesResult) obj;
    ...
    @Override
    public SearchGroupProfilesResult clone() {
        try {
            return (SearchGroupProfilesResult) super.clone();
