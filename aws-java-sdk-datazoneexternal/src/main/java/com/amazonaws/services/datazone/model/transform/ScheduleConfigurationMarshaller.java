...
/**
 * ScheduleConfigurationMarshaller
 */
...
public class ScheduleConfigurationMarshaller {
    ...
    private static final ScheduleConfigurationMarshaller instance = new ScheduleConfigurationMarshaller();
     ...
     */
    public void marshall(ScheduleConfiguration scheduleConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(scheduleConfiguration.getSchedule(), SCHEDULE_BINDING);
            protocolMarshaller.marshall(scheduleConfiguration.getTimezone(), TIMEZONE_BINDING);
        } catch (Exception e) {
