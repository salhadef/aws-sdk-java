...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/GetSubscriptionTarget" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetSubscriptionTargetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The asset types associated with the subscription target.
     */
    ...
    public GetSubscriptionTargetResult withApplicableAssetTypes(String... applicableAssetTypes) {
    ...
    public GetSubscriptionTargetResult withApplicableAssetTypes(java.util.Collection<String> applicableAssetTypes) {
    ...
    public GetSubscriptionTargetResult withAuthorizedPrincipals(String... authorizedPrincipals) {
    ...
    public GetSubscriptionTargetResult withAuthorizedPrincipals(java.util.Collection<String> authorizedPrincipals) {
    ...
    public GetSubscriptionTargetResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone domain in which the subscription target exists.
     */
     ...
     * </p>
     * 
     * @return The ID of the environment associated with the subscription target.
     */
     ...
     * </p>
     * 
     * @return The ID of the project associated with the subscription target.
     */
     ...
     * </p>
     * 
     * @return The configuration of teh subscription target.
     */
    ...
    public GetSubscriptionTargetResult withSubscriptionTargetConfig(SubscriptionTargetForm... subscriptionTargetConfig) {
    ...
    public GetSubscriptionTargetResult withSubscriptionTargetConfig(java.util.Collection<SubscriptionTargetForm> subscriptionTargetConfig) {
    ...
    public GetSubscriptionTargetResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSubscriptionTargetResult == false)
            return false;
        GetSubscriptionTargetResult other = (GetSubscriptionTargetResult) obj;
    ...
    public GetSubscriptionTargetResult clone() {
        try {
            return (GetSubscriptionTargetResult) super.clone();
