...
public class UpdateSubscriptionRequestResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The timestamp of when the subscription request was created.
     */
    ...
    public UpdateSubscriptionRequestResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The decision comment of the <code>UpdateSubscriptionRequest</code> action.
     */
    ...
    public UpdateSubscriptionRequestResult withDecisionComment(String decisionComment) {
    ...
    public UpdateSubscriptionRequestResult withRequestReason(String requestReason) {
     ...
     * </p>
     * 
     * @return The identifier of the Amazon DataZone user who reviews the subscription request.
     */
     ...
     * </p>
     * 
     * @return The subscribed listings of the subscription request.
     */
    ...
    public UpdateSubscriptionRequestResult withSubscribedListings(SubscribedListing... subscribedListings) {
    ...
    public UpdateSubscriptionRequestResult withSubscribedListings(java.util.Collection<SubscribedListing> subscribedListings) {
    ...
    public UpdateSubscriptionRequestResult withSubscribedPrincipals(SubscribedPrincipal... subscribedPrincipals) {
    ...
    public UpdateSubscriptionRequestResult withSubscribedPrincipals(java.util.Collection<SubscribedPrincipal> subscribedPrincipals) {
    ...
    public UpdateSubscriptionRequestResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSubscriptionRequestResult == false)
            return false;
        UpdateSubscriptionRequestResult other = (UpdateSubscriptionRequestResult) obj;
