...
public class SearchListingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setItems(java.util.Collection<SearchResultItem> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<SearchResultItem>(items);
    }
    ...
    public SearchListingsResult withItems(SearchResultItem... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<SearchResultItem>(items.length));
        }
    ...
    public SearchListingsResult withItems(java.util.Collection<SearchResultItem> items) {
        setItems(items);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchListingsResult == false)
            return false;
