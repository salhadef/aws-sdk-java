        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("failureReason", targetDepth)) {
                    context.nextToken();
                    deployment.setFailureReason(EnvironmentErrorJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("isDeploymentComplete", targetDepth)) {
                    context.nextToken();
                    deployment.setIsDeploymentComplete(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("messages", targetDepth)) {
                    context.nextToken();
                    deployment.setMessages(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
