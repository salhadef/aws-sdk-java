...
public class ListSubscriptionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The results of the <code>ListSubscriptions</code> action.
     */
    ...
    public void setItems(java.util.Collection<SubscriptionSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<SubscriptionSummary>(items);
    }
    ...
    public ListSubscriptionsResult withItems(SubscriptionSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<SubscriptionSummary>(items.length));
        }
        for (SubscriptionSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListSubscriptionsResult withItems(java.util.Collection<SubscriptionSummary> items) {
        setItems(items);
        return this;
    }
