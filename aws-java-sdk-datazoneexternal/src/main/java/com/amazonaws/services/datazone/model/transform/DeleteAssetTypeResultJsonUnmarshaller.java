...
/**
 * DeleteAssetTypeResult JSON Unmarshaller
 */
...
public class DeleteAssetTypeResultJsonUnmarshaller implements Unmarshaller<DeleteAssetTypeResult, JsonUnmarshallerContext> {
    ...
    public DeleteAssetTypeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAssetTypeResult deleteAssetTypeResult = new DeleteAssetTypeResult();
