...
public class GetAssetTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetAssetTypeResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The metadata forms attached to the asset type.
     */
    ...
    public GetAssetTypeResult withFormsOutput(java.util.Map<String, FormEntryOutput> formsOutput) {
     ...
     *
     * @see GetAssetTypeResult#withFormsOutput
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetAssetTypeResult addFormsOutputEntry(String key, FormEntryOutput value) {
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone domain in which the asset type was originally created.
     */
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone project in which the asset type was originally created.
     */
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone project that owns the asset type.
     */
    ...
    public GetAssetTypeResult withUpdatedAt(java.util.Date updatedAt) {
     ...
     * </p>
     * 
     * @return The Amazon DataZone user that updated the asset type.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAssetTypeResult == false)
            return false;
        GetAssetTypeResult other = (GetAssetTypeResult) obj;
