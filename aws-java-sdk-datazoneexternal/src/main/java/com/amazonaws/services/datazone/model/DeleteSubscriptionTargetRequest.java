...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/DeleteSubscriptionTarget" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteSubscriptionTargetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone domain in which the subscription target is deleted.
     */
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone environment in which the subscription target is deleted.
     */
     ...
     * </p>
     * 
     * @return The ID of the subscription target that is deleted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteSubscriptionTargetRequest == false)
            return false;
        DeleteSubscriptionTargetRequest other = (DeleteSubscriptionTargetRequest) obj;
    ...
    public DeleteSubscriptionTargetRequest clone() {
        return (DeleteSubscriptionTargetRequest) super.clone();
    }
