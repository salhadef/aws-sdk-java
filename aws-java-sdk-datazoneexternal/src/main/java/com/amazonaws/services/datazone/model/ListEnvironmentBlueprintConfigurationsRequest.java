...
public class ListEnvironmentBlueprintConfigurationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <code>ListEnvironmentBlueprintConfigurations</code>. When the number of configurations to be listed is greater
     * than the value of <code>MaxResults</code>, the response contains a <code>NextToken</code> value that you can use
     * in a subsequent call to <code>ListEnvironmentBlueprintConfigurations</code> to list the next set of
     * configurations.
     * </p>
     */
     ...
     * @param maxResults
     *        The maximum number of blueprint configurations to return in a single call to
     *        <code>ListEnvironmentBlueprintConfigurations</code>. When the number of configurations to be listed is
     *        greater than the value of <code>MaxResults</code>, the response contains a <code>NextToken</code> value
     *        that you can use in a subsequent call to <code>ListEnvironmentBlueprintConfigurations</code> to list the
     ...
     * </p>
     * 
     * @return The maximum number of blueprint configurations to return in a single call to
     *         <code>ListEnvironmentBlueprintConfigurations</code>. When the number of configurations to be listed is
     *         greater than the value of <code>MaxResults</code>, the response contains a <code>NextToken</code> value
     *         that you can use in a subsequent call to <code>ListEnvironmentBlueprintConfigurations</code> to list the
     *         next set of configurations.
    ...
    public ListEnvironmentBlueprintConfigurationsRequest withMaxResults(Integer maxResults) {
    ...
    public ListEnvironmentBlueprintConfigurationsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEnvironmentBlueprintConfigurationsRequest == false)
            return false;
        ListEnvironmentBlueprintConfigurationsRequest other = (ListEnvironmentBlueprintConfigurationsRequest) obj;
    ...
    @Override
    public ListEnvironmentBlueprintConfigurationsRequest clone() {
        return (ListEnvironmentBlueprintConfigurationsRequest) super.clone();
    }
