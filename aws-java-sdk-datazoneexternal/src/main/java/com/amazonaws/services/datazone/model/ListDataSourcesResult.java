...
public class ListDataSourcesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<DataSourceSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>ListDataSources</code> action.
     */

    public java.util.List<DataSourceSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<DataSourceSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<DataSourceSummary>(items);
    }
    ...
    public ListDataSourcesResult withItems(DataSourceSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<DataSourceSummary>(items.length));
        }
        for (DataSourceSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListDataSourcesResult withItems(java.util.Collection<DataSourceSummary> items) {
        setItems(items);
        return this;
    }
