...
public class ListProjectsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ProjectSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>ListProjects</code> action.
     */

    public java.util.List<ProjectSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<ProjectSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<ProjectSummary>(items);
    }
    ...
    public ListProjectsResult withItems(ProjectSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<ProjectSummary>(items.length));
        }
        for (ProjectSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListProjectsResult withItems(java.util.Collection<ProjectSummary> items) {
        setItems(items);
        return this;
    }
