...
public class GetAssetRequestMarshaller {
    ...
    public void marshall(GetAssetRequest getAssetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getAssetRequest.getDomainIdentifier(), DOMAINIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getAssetRequest.getIdentifier(), IDENTIFIER_BINDING);
            protocolMarshaller.marshall(getAssetRequest.getRevision(), REVISION_BINDING);
        } catch (Exception e) {
