...
public class RejectSubscriptionRequestResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The timestamp of when the subscription request was rejected.
     */
    ...
    public RejectSubscriptionRequestResult withCreatedAt(java.util.Date createdAt) {
    ...
    public RejectSubscriptionRequestResult withSubscribedListings(SubscribedListing... subscribedListings) {
    ...
    public RejectSubscriptionRequestResult withSubscribedListings(java.util.Collection<SubscribedListing> subscribedListings) {
    ...
    public RejectSubscriptionRequestResult withSubscribedPrincipals(SubscribedPrincipal... subscribedPrincipals) {
    ...
    public RejectSubscriptionRequestResult withSubscribedPrincipals(java.util.Collection<SubscribedPrincipal> subscribedPrincipals) {
    ...
    public RejectSubscriptionRequestResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectSubscriptionRequestResult == false)
            return false;
        RejectSubscriptionRequestResult other = (RejectSubscriptionRequestResult) obj;
    ...
    public RejectSubscriptionRequestResult clone() {
        try {
            return (RejectSubscriptionRequestResult) super.clone();
