...
public class DeleteEnvironmentRequestMarshaller {
    ...
    public void marshall(DeleteEnvironmentRequest deleteEnvironmentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteEnvironmentRequest.getDomainIdentifier(), DOMAINIDENTIFIER_BINDING);
            protocolMarshaller.marshall(deleteEnvironmentRequest.getIdentifier(), IDENTIFIER_BINDING);
        } catch (Exception e) {
