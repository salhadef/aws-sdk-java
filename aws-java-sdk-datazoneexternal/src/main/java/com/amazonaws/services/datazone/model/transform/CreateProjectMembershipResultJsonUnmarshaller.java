...
/**
 * CreateProjectMembershipResult JSON Unmarshaller
 */
...
public class CreateProjectMembershipResultJsonUnmarshaller implements Unmarshaller<CreateProjectMembershipResult, JsonUnmarshallerContext> {
    ...
    public CreateProjectMembershipResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateProjectMembershipResult createProjectMembershipResult = new CreateProjectMembershipResult();
