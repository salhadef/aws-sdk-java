        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    domainSummary.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("lastUpdatedAt", targetDepth)) {
                    context.nextToken();
                    domainSummary.setLastUpdatedAt(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                if (context.testExpression("managedAccountId", targetDepth)) {
                    context.nextToken();
                    domainSummary.setManagedAccountId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("portalUrl", targetDepth)) {
                    context.nextToken();
                    domainSummary.setPortalUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
