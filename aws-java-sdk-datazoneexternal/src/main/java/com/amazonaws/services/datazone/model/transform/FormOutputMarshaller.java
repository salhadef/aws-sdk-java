...
/**
 * FormOutputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FormOutputMarshaller {
    ...
    private static final FormOutputMarshaller instance = new FormOutputMarshaller();

    public static FormOutputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FormOutput formOutput, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(formOutput.getContent(), CONTENT_BINDING);
            protocolMarshaller.marshall(formOutput.getFormName(), FORMNAME_BINDING);
            protocolMarshaller.marshall(formOutput.getTypeName(), TYPENAME_BINDING);
            protocolMarshaller.marshall(formOutput.getTypeRevision(), TYPEREVISION_BINDING);
        } catch (Exception e) {
