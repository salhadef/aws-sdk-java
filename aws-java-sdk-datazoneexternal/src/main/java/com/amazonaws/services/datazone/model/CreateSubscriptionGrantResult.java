...
public class CreateSubscriptionGrantResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateSubscriptionGrantResult withAssets(SubscribedAsset... assets) {
        if (this.assets == null) {
    ...
    public CreateSubscriptionGrantResult withAssets(java.util.Collection<SubscribedAsset> assets) {
        setAssets(assets);
        return this;
    }
    ...
    public CreateSubscriptionGrantResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateSubscriptionGrantResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSubscriptionGrantResult == false)
            return false;
        CreateSubscriptionGrantResult other = (CreateSubscriptionGrantResult) obj;
    ...
    public CreateSubscriptionGrantResult clone() {
        try {
            return (CreateSubscriptionGrantResult) super.clone();
