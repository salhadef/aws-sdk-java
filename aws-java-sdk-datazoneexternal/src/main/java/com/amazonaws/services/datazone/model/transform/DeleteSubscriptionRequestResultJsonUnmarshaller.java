...
/**
 * DeleteSubscriptionRequestResult JSON Unmarshaller
 */
...
public class DeleteSubscriptionRequestResultJsonUnmarshaller implements Unmarshaller<DeleteSubscriptionRequestResult, JsonUnmarshallerContext> {
    ...
    public DeleteSubscriptionRequestResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSubscriptionRequestResult deleteSubscriptionRequestResult = new DeleteSubscriptionRequestResult();
