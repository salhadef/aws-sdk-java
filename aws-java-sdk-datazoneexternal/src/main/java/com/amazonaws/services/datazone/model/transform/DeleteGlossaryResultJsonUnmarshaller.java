...
/**
 * DeleteGlossaryResult JSON Unmarshaller
 */
...
public class DeleteGlossaryResultJsonUnmarshaller implements Unmarshaller<DeleteGlossaryResult, JsonUnmarshallerContext> {
    ...
    public DeleteGlossaryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteGlossaryResult deleteGlossaryResult = new DeleteGlossaryResult();
