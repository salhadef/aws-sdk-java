    ...
    public Member unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("groupIdentifier", targetDepth)) {
                    context.nextToken();
                    member.setGroupIdentifier(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("userIdentifier", targetDepth)) {
                    context.nextToken();
                    member.setUserIdentifier(context.getUnmarshaller(String.class).unmarshall(context));
                }
