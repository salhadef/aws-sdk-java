...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appstream-2016-12-01/StopAppBlockBuilder" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopAppBlockBuilderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopAppBlockBuilderResult withAppBlockBuilder(AppBlockBuilder appBlockBuilder) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopAppBlockBuilderResult == false)
            return false;
        StopAppBlockBuilderResult other = (StopAppBlockBuilderResult) obj;
    ...
    @Override
    public StopAppBlockBuilderResult clone() {
        try {
            return (StopAppBlockBuilderResult) super.clone();
