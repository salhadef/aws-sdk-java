...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appstream-2016-12-01/StartAppBlockBuilder" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartAppBlockBuilderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartAppBlockBuilderResult withAppBlockBuilder(AppBlockBuilder appBlockBuilder) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartAppBlockBuilderResult == false)
            return false;
        StartAppBlockBuilderResult other = (StartAppBlockBuilderResult) obj;
    ...
    @Override
    public StartAppBlockBuilderResult clone() {
        try {
            return (StartAppBlockBuilderResult) super.clone();
