...
/**
 * DeleteAppBlockBuilderResult JSON Unmarshaller
 */
...
public class DeleteAppBlockBuilderResultJsonUnmarshaller implements Unmarshaller<DeleteAppBlockBuilderResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppBlockBuilderResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppBlockBuilderResult deleteAppBlockBuilderResult = new DeleteAppBlockBuilderResult();
