...
public class CreateAppBlockBuilderStreamingURLResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The URL to start the streaming session.
     */
    ...
    public CreateAppBlockBuilderStreamingURLResult withExpires(java.util.Date expires) {
        setExpires(expires);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAppBlockBuilderStreamingURLResult == false)
            return false;
        CreateAppBlockBuilderStreamingURLResult other = (CreateAppBlockBuilderStreamingURLResult) obj;
    ...
    public CreateAppBlockBuilderStreamingURLResult clone() {
        try {
            return (CreateAppBlockBuilderStreamingURLResult) super.clone();
