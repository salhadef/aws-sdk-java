...
public class FleetMarshaller {
    ...
    public void marshall(Fleet fleet, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(fleet.getSessionScriptS3Location(), SESSIONSCRIPTS3LOCATION_BINDING);
            protocolMarshaller.marshall(fleet.getMaxSessionsPerInstance(), MAXSESSIONSPERINSTANCE_BINDING);
        } catch (Exception e) {
