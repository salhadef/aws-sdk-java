...
public class UpdateAppBlockBuilderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAppBlockBuilderResult withAppBlockBuilder(AppBlockBuilder appBlockBuilder) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAppBlockBuilderResult == false)
            return false;
        UpdateAppBlockBuilderResult other = (UpdateAppBlockBuilderResult) obj;
    ...
    @Override
    public UpdateAppBlockBuilderResult clone() {
        try {
            return (UpdateAppBlockBuilderResult) super.clone();
