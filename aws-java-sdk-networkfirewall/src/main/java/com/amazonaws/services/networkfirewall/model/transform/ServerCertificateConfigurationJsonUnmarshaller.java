...
/**
 * ServerCertificateConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServerCertificateConfigurationJsonUnmarshaller implements Unmarshaller<ServerCertificateConfiguration, JsonUnmarshallerContext> {

    public ServerCertificateConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ServerCertificateConfiguration serverCertificateConfiguration = new ServerCertificateConfiguration();
    ...
    private static ServerCertificateConfigurationJsonUnmarshaller instance;

    public static ServerCertificateConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServerCertificateConfigurationJsonUnmarshaller();
        return instance;
    }
}
