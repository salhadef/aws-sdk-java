...
/**
 * ServerCertificateConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ServerCertificateConfigurationMarshaller {

    private static final MarshallingInfo<List> SERVERCERTIFICATES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
    ...
    public static ServerCertificateConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ServerCertificateConfiguration serverCertificateConfiguration, ProtocolMarshaller protocolMarshaller) {
