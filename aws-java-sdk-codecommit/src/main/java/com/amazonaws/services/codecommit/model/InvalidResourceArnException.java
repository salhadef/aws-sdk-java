...
/**
 * <p>
 * The value for the resource ARN is not valid. For more information about resources in CodeCommit, see <a href=
...
public class InvalidResourceArnException extends com.amazonaws.services.codecommit.model.AWSCodeCommitException {
     ...
     */
    public InvalidResourceArnException(String message) {
        super(message);
    }
