...
/**
 * FileVersion JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FileVersionJsonUnmarshaller implements Unmarshaller<FileVersion, JsonUnmarshallerContext> {

    public FileVersion unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static FileVersionJsonUnmarshaller instance;

    public static FileVersionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileVersionJsonUnmarshaller();
        return instance;
    }
}
