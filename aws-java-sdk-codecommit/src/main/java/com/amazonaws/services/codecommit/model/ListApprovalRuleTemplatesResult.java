...
public class ListApprovalRuleTemplatesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListApprovalRuleTemplatesResult withApprovalRuleTemplateNames(String... approvalRuleTemplateNames) {
    ...
    public ListApprovalRuleTemplatesResult withApprovalRuleTemplateNames(java.util.Collection<String> approvalRuleTemplateNames) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListApprovalRuleTemplatesResult == false)
            return false;
        ListApprovalRuleTemplatesResult other = (ListApprovalRuleTemplatesResult) obj;
    ...
    public ListApprovalRuleTemplatesResult clone() {
        try {
            return (ListApprovalRuleTemplatesResult) super.clone();
