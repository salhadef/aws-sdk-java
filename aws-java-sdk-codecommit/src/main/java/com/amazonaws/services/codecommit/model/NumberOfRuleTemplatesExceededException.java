...
public class NumberOfRuleTemplatesExceededException extends com.amazonaws.services.codecommit.model.AWSCodeCommitException {
     ...
     */
    public NumberOfRuleTemplatesExceededException(String message) {
        super(message);
    }
