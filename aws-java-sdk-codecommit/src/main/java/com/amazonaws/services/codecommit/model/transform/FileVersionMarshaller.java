...
/**
 * FileVersionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FileVersionMarshaller {

    private static final MarshallingInfo<StructuredPojo> COMMIT_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("commit").build();
    ...
    private static final MarshallingInfo<List> REVISIONCHILDREN_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("revisionChildren").build();
    ...
    public void marshall(FileVersion fileVersion, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(fileVersion.getCommit(), COMMIT_BINDING);
            protocolMarshaller.marshall(fileVersion.getBlobId(), BLOBID_BINDING);
            protocolMarshaller.marshall(fileVersion.getPath(), PATH_BINDING);
