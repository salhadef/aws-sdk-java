...
/**
 * Fluent builder for {@link com.amazonaws.services.entityresolution.AWSEntityResolution}. Use of the builder is
...
public final class AWSEntityResolutionClientBuilder extends AwsSyncClientBuilder<AWSEntityResolutionClientBuilder, AWSEntityResolution> {
    ...
    /**
     * Construct a synchronous implementation of AWSEntityResolution using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSEntityResolution.
     */
    @Override
    protected AWSEntityResolution build(AwsSyncClientParams params) {
        return new AWSEntityResolutionClient(params);
    }
