...
public class OutputAttribute implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * A name of a column to be written to the output. This must be an <code>InputField</code> name in the schema
     * mapping.
     * </p>
     */
    private String name;
     ...
     * </p>
     * 
     * @return Enables the ability to hash the column values in the output.
     */
     ...
     * </p>
     * 
     * @return A name of a column to be written to the output. This must be an <code>InputField</code> name in the
     *         schema mapping.
     */
