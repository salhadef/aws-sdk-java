...
public class UpdateMatchingWorkflowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateMatchingWorkflowRequest withIncrementalRunConfig(IncrementalRunConfig incrementalRunConfig) {
    ...
    public UpdateMatchingWorkflowRequest withInputSourceConfig(java.util.Collection<InputSource> inputSourceConfig) {
    ...
    public UpdateMatchingWorkflowRequest withOutputSourceConfig(java.util.Collection<OutputSource> outputSourceConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMatchingWorkflowRequest == false)
            return false;
        UpdateMatchingWorkflowRequest other = (UpdateMatchingWorkflowRequest) obj;
    ...
    public UpdateMatchingWorkflowRequest clone() {
        return (UpdateMatchingWorkflowRequest) super.clone();
    }
