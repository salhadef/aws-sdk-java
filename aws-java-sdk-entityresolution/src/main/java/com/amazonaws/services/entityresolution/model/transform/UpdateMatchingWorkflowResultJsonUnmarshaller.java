...
/**
 * UpdateMatchingWorkflowResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateMatchingWorkflowResultJsonUnmarshaller implements Unmarshaller<UpdateMatchingWorkflowResult, JsonUnmarshallerContext> {

    public UpdateMatchingWorkflowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateMatchingWorkflowResult updateMatchingWorkflowResult = new UpdateMatchingWorkflowResult();
    ...
    private static UpdateMatchingWorkflowResultJsonUnmarshaller instance;

    public static UpdateMatchingWorkflowResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateMatchingWorkflowResultJsonUnmarshaller();
        return instance;
    }
}
