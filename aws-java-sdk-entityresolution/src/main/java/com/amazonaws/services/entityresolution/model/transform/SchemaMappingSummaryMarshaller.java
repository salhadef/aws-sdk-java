...
/**
 * SchemaMappingSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SchemaMappingSummaryMarshaller {
    ...
    private static final SchemaMappingSummaryMarshaller instance = new SchemaMappingSummaryMarshaller();

    public static SchemaMappingSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SchemaMappingSummary schemaMappingSummary, ProtocolMarshaller protocolMarshaller) {

        if (schemaMappingSummary == null) {
