        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("applyNormalization", targetDepth)) {
                    context.nextToken();
                    inputSource.setApplyNormalization(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("inputSourceARN", targetDepth)) {
                    context.nextToken();
                    inputSource.setInputSourceARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("schemaName", targetDepth)) {
                    context.nextToken();
                    inputSource.setSchemaName(context.getUnmarshaller(String.class).unmarshall(context));
                }
