...
public class CreateMatchingWorkflowResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateMatchingWorkflowResult withDescription(String description) {
    ...
    public CreateMatchingWorkflowResult withIncrementalRunConfig(IncrementalRunConfig incrementalRunConfig) {
    ...
    public CreateMatchingWorkflowResult withInputSourceConfig(InputSource... inputSourceConfig) {
    ...
    public CreateMatchingWorkflowResult withInputSourceConfig(java.util.Collection<InputSource> inputSourceConfig) {
    ...
    public CreateMatchingWorkflowResult withOutputSourceConfig(OutputSource... outputSourceConfig) {
    ...
    public CreateMatchingWorkflowResult withOutputSourceConfig(java.util.Collection<OutputSource> outputSourceConfig) {
    ...
    public CreateMatchingWorkflowResult withResolutionTechniques(ResolutionTechniques resolutionTechniques) {
    ...
    public CreateMatchingWorkflowResult withRoleArn(String roleArn) {
        setRoleArn(roleArn);
        return this;
    }
    ...
    public CreateMatchingWorkflowResult withWorkflowArn(String workflowArn) {
    ...
    public CreateMatchingWorkflowResult withWorkflowName(String workflowName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMatchingWorkflowResult == false)
            return false;
        CreateMatchingWorkflowResult other = (CreateMatchingWorkflowResult) obj;
    ...
    @Override
    public CreateMatchingWorkflowResult clone() {
        try {
            return (CreateMatchingWorkflowResult) super.clone();
