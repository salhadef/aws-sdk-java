...
public class ListIdMappingJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListIdMappingJobsResult withJobs(JobSummary... jobs) {
        if (this.jobs == null) {
    ...
    public ListIdMappingJobsResult withJobs(java.util.Collection<JobSummary> jobs) {
        setJobs(jobs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListIdMappingJobsResult == false)
            return false;
        ListIdMappingJobsResult other = (ListIdMappingJobsResult) obj;
    ...
    @Override
    public ListIdMappingJobsResult clone() {
        try {
            return (ListIdMappingJobsResult) super.clone();
