...
public class CreateMatchingWorkflowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateMatchingWorkflowRequest withIncrementalRunConfig(IncrementalRunConfig incrementalRunConfig) {
    ...
    public CreateMatchingWorkflowRequest withInputSourceConfig(InputSource... inputSourceConfig) {
    ...
    public CreateMatchingWorkflowRequest withInputSourceConfig(java.util.Collection<InputSource> inputSourceConfig) {
    ...
    public CreateMatchingWorkflowRequest withOutputSourceConfig(OutputSource... outputSourceConfig) {
    ...
    public CreateMatchingWorkflowRequest withOutputSourceConfig(java.util.Collection<OutputSource> outputSourceConfig) {
    ...
    public CreateMatchingWorkflowRequest withResolutionTechniques(ResolutionTechniques resolutionTechniques) {
    ...
    public CreateMatchingWorkflowRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateMatchingWorkflowRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateMatchingWorkflowRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateMatchingWorkflowRequest withWorkflowName(String workflowName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMatchingWorkflowRequest == false)
            return false;
        CreateMatchingWorkflowRequest other = (CreateMatchingWorkflowRequest) obj;
    ...
    @Override
    public CreateMatchingWorkflowRequest clone() {
        return (CreateMatchingWorkflowRequest) super.clone();
    }
