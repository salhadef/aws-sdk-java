...
/**
 * Fluent builder for {@link com.amazonaws.services.entityresolution.AWSEntityResolutionAsync}. Use of the builder is
...
public final class AWSEntityResolutionAsyncClientBuilder extends AwsAsyncClientBuilder<AWSEntityResolutionAsyncClientBuilder, AWSEntityResolutionAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSEntityResolutionAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSEntityResolutionAsync.
     */
    @Override
    protected AWSEntityResolutionAsync build(AwsAsyncClientParams params) {
        return new AWSEntityResolutionAsyncClient(params);
    }
