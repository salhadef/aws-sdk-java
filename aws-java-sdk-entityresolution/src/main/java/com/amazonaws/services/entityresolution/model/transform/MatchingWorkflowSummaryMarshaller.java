...
/**
 * MatchingWorkflowSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MatchingWorkflowSummaryMarshaller {
    ...
    private static final MatchingWorkflowSummaryMarshaller instance = new MatchingWorkflowSummaryMarshaller();

    public static MatchingWorkflowSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MatchingWorkflowSummary matchingWorkflowSummary, ProtocolMarshaller protocolMarshaller) {

        if (matchingWorkflowSummary == null) {
