...
public class CreateIdMappingWorkflowResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateIdMappingWorkflowResult withInputSourceConfig(java.util.Collection<IdMappingWorkflowInputSource> inputSourceConfig) {
    ...
    public CreateIdMappingWorkflowResult withOutputSourceConfig(java.util.Collection<IdMappingWorkflowOutputSource> outputSourceConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateIdMappingWorkflowResult == false)
            return false;
        CreateIdMappingWorkflowResult other = (CreateIdMappingWorkflowResult) obj;
    ...
    public CreateIdMappingWorkflowResult clone() {
        try {
            return (CreateIdMappingWorkflowResult) super.clone();
