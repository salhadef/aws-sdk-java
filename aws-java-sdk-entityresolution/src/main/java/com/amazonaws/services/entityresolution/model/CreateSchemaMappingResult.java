...
public class CreateSchemaMappingResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateSchemaMappingResult withDescription(String description) {
    ...
    public CreateSchemaMappingResult withMappedInputFields(java.util.Collection<SchemaInputAttribute> mappedInputFields) {
    ...
    public CreateSchemaMappingResult withSchemaName(String schemaName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSchemaMappingResult == false)
            return false;
        CreateSchemaMappingResult other = (CreateSchemaMappingResult) obj;
    ...
    @Override
    public CreateSchemaMappingResult clone() {
        try {
            return (CreateSchemaMappingResult) super.clone();
