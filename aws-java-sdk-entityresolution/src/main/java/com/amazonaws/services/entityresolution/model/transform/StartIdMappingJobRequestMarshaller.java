...
public class StartIdMappingJobRequestMarshaller {
    ...
    private static final StartIdMappingJobRequestMarshaller instance = new StartIdMappingJobRequestMarshaller();

    public static StartIdMappingJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartIdMappingJobRequest startIdMappingJobRequest, ProtocolMarshaller protocolMarshaller) {
