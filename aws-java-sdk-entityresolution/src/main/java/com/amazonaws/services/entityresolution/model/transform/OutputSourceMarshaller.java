...
public class OutputSourceMarshaller {
    ...
    private static final MarshallingInfo<List> OUTPUT_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(OutputSource outputSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(outputSource.getKMSArn(), KMSARN_BINDING);
            protocolMarshaller.marshall(outputSource.getApplyNormalization(), APPLYNORMALIZATION_BINDING);
            protocolMarshaller.marshall(outputSource.getOutput(), OUTPUT_BINDING);
            protocolMarshaller.marshall(outputSource.getOutputS3Path(), OUTPUTS3PATH_BINDING);
        } catch (Exception e) {
