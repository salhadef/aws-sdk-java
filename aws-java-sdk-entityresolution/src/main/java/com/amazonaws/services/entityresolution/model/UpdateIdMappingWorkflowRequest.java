...
public class UpdateIdMappingWorkflowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateIdMappingWorkflowRequest withInputSourceConfig(java.util.Collection<IdMappingWorkflowInputSource> inputSourceConfig) {
    ...
    public UpdateIdMappingWorkflowRequest withOutputSourceConfig(java.util.Collection<IdMappingWorkflowOutputSource> outputSourceConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateIdMappingWorkflowRequest == false)
            return false;
        UpdateIdMappingWorkflowRequest other = (UpdateIdMappingWorkflowRequest) obj;
    ...
    public UpdateIdMappingWorkflowRequest clone() {
        return (UpdateIdMappingWorkflowRequest) super.clone();
    }
