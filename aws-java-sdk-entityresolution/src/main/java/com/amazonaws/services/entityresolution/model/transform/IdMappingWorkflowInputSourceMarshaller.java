...
/**
 * IdMappingWorkflowInputSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class IdMappingWorkflowInputSourceMarshaller {
    ...
    public static IdMappingWorkflowInputSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(IdMappingWorkflowInputSource idMappingWorkflowInputSource, ProtocolMarshaller protocolMarshaller) {

        if (idMappingWorkflowInputSource == null) {
