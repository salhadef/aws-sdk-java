    ...
    public Rule unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("matchingKeys", targetDepth)) {
                    context.nextToken();
                    rule.setMatchingKeys(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("ruleName", targetDepth)) {
                    context.nextToken();
                    rule.setRuleName(context.getUnmarshaller(String.class).unmarshall(context));
                }
