...
public class RuleMarshaller {
    ...
    private static final MarshallingInfo<List> MATCHINGKEYS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("matchingKeys").build();
    ...
    public void marshall(Rule rule, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(rule.getMatchingKeys(), MATCHINGKEYS_BINDING);
            protocolMarshaller.marshall(rule.getRuleName(), RULENAME_BINDING);
        } catch (Exception e) {
