...
public class GetStageSessionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return ARN of the stage for which the information is to be retrieved.
     */
    ...
    public GetStageSessionRequest clone() {
        return (GetStageSessionRequest) super.clone();
    }
