...
public class GetParticipantRequestMarshaller {
    ...
    public static GetParticipantRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetParticipantRequest getParticipantRequest, ProtocolMarshaller protocolMarshaller) {
