...
public class StageSessionSummaryMarshaller {
    ...
    public static StageSessionSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StageSessionSummary stageSessionSummary, ProtocolMarshaller protocolMarshaller) {

        if (stageSessionSummary == null) {
