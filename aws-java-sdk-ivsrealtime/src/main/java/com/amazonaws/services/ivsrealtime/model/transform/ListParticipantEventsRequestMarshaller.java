...
public class ListParticipantEventsRequestMarshaller {
    ...
    public static ListParticipantEventsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListParticipantEventsRequest listParticipantEventsRequest, ProtocolMarshaller protocolMarshaller) {
