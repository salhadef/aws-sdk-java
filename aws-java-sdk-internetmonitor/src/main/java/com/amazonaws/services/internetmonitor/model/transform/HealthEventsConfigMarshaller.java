...
/**
 * HealthEventsConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class HealthEventsConfigMarshaller {

    private static final MarshallingInfo<Double> AVAILABILITYSCORETHRESHOLD_BINDING = MarshallingInfo.builder(MarshallingType.DOUBLE)
    ...
    public static HealthEventsConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HealthEventsConfig healthEventsConfig, ProtocolMarshaller protocolMarshaller) {
