...
public class BatchGetCodeSnippetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of finding ARNs for the findings you want to retrieve code snippets from.
     */
    ...
    public BatchGetCodeSnippetRequest withFindingArns(String... findingArns) {
    ...
    public BatchGetCodeSnippetRequest withFindingArns(java.util.Collection<String> findingArns) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetCodeSnippetRequest == false)
            return false;
        BatchGetCodeSnippetRequest other = (BatchGetCodeSnippetRequest) obj;
    ...
    public BatchGetCodeSnippetRequest clone() {
        return (BatchGetCodeSnippetRequest) super.clone();
    }
