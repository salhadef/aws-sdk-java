...
public class Cvss3Marshaller {
    ...
    private static final Cvss3Marshaller instance = new Cvss3Marshaller();

    public static Cvss3Marshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Cvss3 cvss3, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(cvss3.getBaseScore(), BASESCORE_BINDING);
            protocolMarshaller.marshall(cvss3.getScoringVector(), SCORINGVECTOR_BINDING);
        } catch (Exception e) {
