...
/**
 * ResourceFilterCriteriaMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ResourceFilterCriteriaMarshaller {
    ...
    private static final ResourceFilterCriteriaMarshaller instance = new ResourceFilterCriteriaMarshaller();

    public static ResourceFilterCriteriaMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ResourceFilterCriteria resourceFilterCriteria, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourceFilterCriteria.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(resourceFilterCriteria.getEc2InstanceTags(), EC2INSTANCETAGS_BINDING);
            protocolMarshaller.marshall(resourceFilterCriteria.getEcrImageTags(), ECRIMAGETAGS_BINDING);
            protocolMarshaller.marshall(resourceFilterCriteria.getEcrRepositoryName(), ECRREPOSITORYNAME_BINDING);
            protocolMarshaller.marshall(resourceFilterCriteria.getLambdaFunctionName(), LAMBDAFUNCTIONNAME_BINDING);
            protocolMarshaller.marshall(resourceFilterCriteria.getLambdaFunctionTags(), LAMBDAFUNCTIONTAGS_BINDING);
            protocolMarshaller.marshall(resourceFilterCriteria.getResourceId(), RESOURCEID_BINDING);
            protocolMarshaller.marshall(resourceFilterCriteria.getResourceType(), RESOURCETYPE_BINDING);
        } catch (Exception e) {
