...
public class CodeFilePathMarshaller {
    ...
    public void marshall(CodeFilePath codeFilePath, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(codeFilePath.getEndLine(), ENDLINE_BINDING);
            protocolMarshaller.marshall(codeFilePath.getFileName(), FILENAME_BINDING);
            protocolMarshaller.marshall(codeFilePath.getFilePath(), FILEPATH_BINDING);
            protocolMarshaller.marshall(codeFilePath.getStartLine(), STARTLINE_BINDING);
        } catch (Exception e) {
