...
/**
 * AutoEnableMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AutoEnableMarshaller {

    private static final MarshallingInfo<Boolean> EC2_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("ec2").build();
    private static final MarshallingInfo<Boolean> ECR_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public static AutoEnableMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AutoEnable autoEnable, ProtocolMarshaller protocolMarshaller) {
