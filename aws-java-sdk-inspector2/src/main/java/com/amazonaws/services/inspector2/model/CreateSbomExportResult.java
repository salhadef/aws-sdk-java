...
public class CreateSbomExportResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The report ID for the software bill of materials (SBOM) report.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSbomExportResult == false)
            return false;
        CreateSbomExportResult other = (CreateSbomExportResult) obj;
    ...
    public CreateSbomExportResult clone() {
        try {
            return (CreateSbomExportResult) super.clone();
