...
public class ListDelegatedAdminAccountsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDelegatedAdminAccountsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDelegatedAdminAccountsRequest == false)
            return false;
        ListDelegatedAdminAccountsRequest other = (ListDelegatedAdminAccountsRequest) obj;
    ...
    @Override
    public ListDelegatedAdminAccountsRequest clone() {
        return (ListDelegatedAdminAccountsRequest) super.clone();
    }
