...
/**
 * ResetEncryptionKeyResult JSON Unmarshaller
 */
...
public class ResetEncryptionKeyResultJsonUnmarshaller implements Unmarshaller<ResetEncryptionKeyResult, JsonUnmarshallerContext> {
    ...
    public ResetEncryptionKeyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResetEncryptionKeyResult resetEncryptionKeyResult = new ResetEncryptionKeyResult();

        return resetEncryptionKeyResult;
    }
