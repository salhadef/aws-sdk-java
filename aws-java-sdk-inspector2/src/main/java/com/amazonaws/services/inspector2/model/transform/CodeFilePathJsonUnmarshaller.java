...
/**
 * CodeFilePath JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CodeFilePathJsonUnmarshaller implements Unmarshaller<CodeFilePath, JsonUnmarshallerContext> {

    public CodeFilePath unmarshall(JsonUnmarshallerContext context) throws Exception {
        CodeFilePath codeFilePath = new CodeFilePath();
    ...
    private static CodeFilePathJsonUnmarshaller instance;

    public static CodeFilePathJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CodeFilePathJsonUnmarshaller();
        return instance;
    }
}
