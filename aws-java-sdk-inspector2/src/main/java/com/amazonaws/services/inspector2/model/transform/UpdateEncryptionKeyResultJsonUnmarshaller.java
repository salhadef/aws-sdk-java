...
/**
 * UpdateEncryptionKeyResult JSON Unmarshaller
 */
...
public class UpdateEncryptionKeyResultJsonUnmarshaller implements Unmarshaller<UpdateEncryptionKeyResult, JsonUnmarshallerContext> {
    ...
    public UpdateEncryptionKeyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateEncryptionKeyResult updateEncryptionKeyResult = new UpdateEncryptionKeyResult();

        return updateEncryptionKeyResult;
    }
