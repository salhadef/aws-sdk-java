...
public class UpdateOrgEc2DeepInspectionConfigurationRequestMarshaller {
    ...
    private static final MarshallingInfo<List> ORGPACKAGEPATHS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("orgPackagePaths").build();
