...
/**
 * ResourceStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResourceStatusJsonUnmarshaller implements Unmarshaller<ResourceStatus, JsonUnmarshallerContext> {

    public ResourceStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ResourceStatusJsonUnmarshaller instance;

    public static ResourceStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceStatusJsonUnmarshaller();
        return instance;
    }
}
