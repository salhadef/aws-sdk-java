...
public class TrainingDataConfigMarshaller {
    ...
    private static final MarshallingInfo<Map> EXCLUDEDDATASETCOLUMNS_BINDING = MarshallingInfo.builder(MarshallingType.MAP)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("excludedDatasetColumns").build();
    ...
    public void marshall(TrainingDataConfig trainingDataConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(trainingDataConfig.getExcludedDatasetColumns(), EXCLUDEDDATASETCOLUMNS_BINDING);
        } catch (Exception e) {
