...
public class ExportLicenseRecommendationsRequestMarshaller {
    ...
    private static final ExportLicenseRecommendationsRequestMarshaller instance = new ExportLicenseRecommendationsRequestMarshaller();

    public static ExportLicenseRecommendationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ExportLicenseRecommendationsRequest exportLicenseRecommendationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (exportLicenseRecommendationsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(exportLicenseRecommendationsRequest.getAccountIds(), ACCOUNTIDS_BINDING);
            protocolMarshaller.marshall(exportLicenseRecommendationsRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(exportLicenseRecommendationsRequest.getFieldsToExport(), FIELDSTOEXPORT_BINDING);
            protocolMarshaller.marshall(exportLicenseRecommendationsRequest.getS3DestinationConfig(), S3DESTINATIONCONFIG_BINDING);
            protocolMarshaller.marshall(exportLicenseRecommendationsRequest.getFileFormat(), FILEFORMAT_BINDING);
            protocolMarshaller.marshall(exportLicenseRecommendationsRequest.getIncludeMemberAccounts(), INCLUDEMEMBERACCOUNTS_BINDING);
        } catch (Exception e) {
