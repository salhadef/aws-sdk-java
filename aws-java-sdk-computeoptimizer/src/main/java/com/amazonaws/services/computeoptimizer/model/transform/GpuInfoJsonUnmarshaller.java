...
/**
 * GpuInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GpuInfoJsonUnmarshaller implements Unmarshaller<GpuInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("gpus", targetDepth)) {
                    context.nextToken();
                    gpuInfo.setGpus(new ListUnmarshaller<Gpu>(GpuJsonUnmarshaller.getInstance())
