...
/**
 * InstanceRecommendationOption JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceRecommendationOptionJsonUnmarshaller implements Unmarshaller<InstanceRecommendationOption, JsonUnmarshallerContext> {
    ...
    public static InstanceRecommendationOptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstanceRecommendationOptionJsonUnmarshaller();
        return instance;
    }
}
