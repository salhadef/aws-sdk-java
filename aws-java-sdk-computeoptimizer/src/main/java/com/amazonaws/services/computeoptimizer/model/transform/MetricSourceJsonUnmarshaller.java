        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("provider", targetDepth)) {
                    context.nextToken();
                    metricSource.setProvider(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("providerArn", targetDepth)) {
                    context.nextToken();
                    metricSource.setProviderArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
