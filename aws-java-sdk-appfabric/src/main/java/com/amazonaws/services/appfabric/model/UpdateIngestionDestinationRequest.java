...
public class UpdateIngestionDestinationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getIngestionDestinationIdentifier() != null)
            sb.append("IngestionDestinationIdentifier: ").append(getIngestionDestinationIdentifier()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateIngestionDestinationRequest == false)
            return false;
    ...
    public UpdateIngestionDestinationRequest clone() {
        return (UpdateIngestionDestinationRequest) super.clone();
    }
