...
public class CreateAppAuthorizationRequestMarshaller {
    ...
    private static final CreateAppAuthorizationRequestMarshaller instance = new CreateAppAuthorizationRequestMarshaller();

    public static CreateAppAuthorizationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateAppAuthorizationRequest createAppAuthorizationRequest, ProtocolMarshaller protocolMarshaller) {

        if (createAppAuthorizationRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createAppAuthorizationRequest.getAppBundleIdentifier(), APPBUNDLEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(createAppAuthorizationRequest.getApp(), APP_BINDING);
            protocolMarshaller.marshall(createAppAuthorizationRequest.getCredential(), CREDENTIAL_BINDING);
            protocolMarshaller.marshall(createAppAuthorizationRequest.getTenant(), TENANT_BINDING);
            protocolMarshaller.marshall(createAppAuthorizationRequest.getAuthType(), AUTHTYPE_BINDING);
            protocolMarshaller.marshall(createAppAuthorizationRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createAppAuthorizationRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
