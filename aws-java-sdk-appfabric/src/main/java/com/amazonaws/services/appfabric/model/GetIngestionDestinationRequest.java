...
public class GetIngestionDestinationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetIngestionDestinationRequest withAppBundleIdentifier(String appBundleIdentifier) {
    ...
    public GetIngestionDestinationRequest withIngestionIdentifier(String ingestionIdentifier) {
    ...
    public GetIngestionDestinationRequest withIngestionDestinationIdentifier(String ingestionDestinationIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIngestionDestinationRequest == false)
            return false;
        GetIngestionDestinationRequest other = (GetIngestionDestinationRequest) obj;
    ...
    @Override
    public GetIngestionDestinationRequest clone() {
        return (GetIngestionDestinationRequest) super.clone();
    }
