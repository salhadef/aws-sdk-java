...
public class CreateAppAuthorizationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateAppAuthorizationResult withAppAuthorization(AppAuthorization appAuthorization) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAppAuthorizationResult == false)
            return false;
        CreateAppAuthorizationResult other = (CreateAppAuthorizationResult) obj;
    ...
    @Override
    public CreateAppAuthorizationResult clone() {
        try {
            return (CreateAppAuthorizationResult) super.clone();
