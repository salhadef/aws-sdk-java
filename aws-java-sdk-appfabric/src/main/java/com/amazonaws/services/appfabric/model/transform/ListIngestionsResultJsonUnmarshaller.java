...
/**
 * ListIngestionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListIngestionsResultJsonUnmarshaller implements Unmarshaller<ListIngestionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ingestions", targetDepth)) {
                    context.nextToken();
                    listIngestionsResult.setIngestions(new ListUnmarshaller<IngestionSummary>(IngestionSummaryJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listIngestionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
