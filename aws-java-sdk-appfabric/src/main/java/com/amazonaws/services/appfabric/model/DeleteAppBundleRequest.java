...
public class DeleteAppBundleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID or Amazon Resource Name (ARN) of the app bundle that needs to be deleted.
     */
    ...
    public DeleteAppBundleRequest withAppBundleIdentifier(String appBundleIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAppBundleRequest == false)
            return false;
        DeleteAppBundleRequest other = (DeleteAppBundleRequest) obj;
    ...
    @Override
    public DeleteAppBundleRequest clone() {
        return (DeleteAppBundleRequest) super.clone();
    }
