...
public class Oauth2CredentialMarshaller {
    ...
    public void marshall(Oauth2Credential oauth2Credential, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(oauth2Credential.getClientId(), CLIENTID_BINDING);
            protocolMarshaller.marshall(oauth2Credential.getClientSecret(), CLIENTSECRET_BINDING);
        } catch (Exception e) {
