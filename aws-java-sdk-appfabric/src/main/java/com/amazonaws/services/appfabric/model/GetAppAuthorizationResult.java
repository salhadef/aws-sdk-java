...
public class GetAppAuthorizationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetAppAuthorizationResult withAppAuthorization(AppAuthorization appAuthorization) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAppAuthorizationResult == false)
            return false;
        GetAppAuthorizationResult other = (GetAppAuthorizationResult) obj;
    ...
    @Override
    public GetAppAuthorizationResult clone() {
        try {
            return (GetAppAuthorizationResult) super.clone();
