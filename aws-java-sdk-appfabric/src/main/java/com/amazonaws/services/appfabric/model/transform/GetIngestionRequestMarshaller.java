...
public class GetIngestionRequestMarshaller {
    ...
    private static final GetIngestionRequestMarshaller instance = new GetIngestionRequestMarshaller();

    public static GetIngestionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetIngestionRequest getIngestionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getIngestionRequest.getAppBundleIdentifier(), APPBUNDLEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getIngestionRequest.getIngestionIdentifier(), INGESTIONIDENTIFIER_BINDING);
        } catch (Exception e) {
