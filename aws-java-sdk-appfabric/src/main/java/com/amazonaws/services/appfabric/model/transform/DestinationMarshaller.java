...
public class DestinationMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> FIREHOSESTREAM_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("firehoseStream").build();
    ...
    public void marshall(Destination destination, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(destination.getS3Bucket(), S3BUCKET_BINDING);
            protocolMarshaller.marshall(destination.getFirehoseStream(), FIREHOSESTREAM_BINDING);
        } catch (Exception e) {
