...
public class ListAppBundlesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAppBundlesRequest withMaxResults(Integer maxResults) {
    ...
    public ListAppBundlesRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAppBundlesRequest == false)
            return false;
        ListAppBundlesRequest other = (ListAppBundlesRequest) obj;
    ...
    @Override
    public ListAppBundlesRequest clone() {
        return (ListAppBundlesRequest) super.clone();
    }
