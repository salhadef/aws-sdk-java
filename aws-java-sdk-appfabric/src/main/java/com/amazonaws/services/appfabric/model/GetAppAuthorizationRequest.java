...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appfabric-2023-05-19/GetAppAuthorization" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetAppAuthorizationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetAppAuthorizationRequest withAppBundleIdentifier(String appBundleIdentifier) {
    ...
    public GetAppAuthorizationRequest withAppAuthorizationIdentifier(String appAuthorizationIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAppAuthorizationRequest == false)
            return false;
        GetAppAuthorizationRequest other = (GetAppAuthorizationRequest) obj;
    ...
    @Override
    public GetAppAuthorizationRequest clone() {
        return (GetAppAuthorizationRequest) super.clone();
    }
