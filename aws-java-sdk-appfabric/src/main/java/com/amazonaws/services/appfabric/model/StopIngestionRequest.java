...
public class StopIngestionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StopIngestionRequest withIngestionIdentifier(String ingestionIdentifier) {
    ...
    public StopIngestionRequest withAppBundleIdentifier(String appBundleIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopIngestionRequest == false)
            return false;
        StopIngestionRequest other = (StopIngestionRequest) obj;
    ...
    @Override
    public StopIngestionRequest clone() {
        return (StopIngestionRequest) super.clone();
    }
