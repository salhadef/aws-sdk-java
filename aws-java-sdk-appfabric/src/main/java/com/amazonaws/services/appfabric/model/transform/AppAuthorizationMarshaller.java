...
/**
 * AppAuthorizationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AppAuthorizationMarshaller {
    ...
    private static final MarshallingInfo<String> AUTHURL_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("authUrl").build();

    private static final AppAuthorizationMarshaller instance = new AppAuthorizationMarshaller();

    public static AppAuthorizationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AppAuthorization appAuthorization, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(appAuthorization.getAppAuthorizationArn(), APPAUTHORIZATIONARN_BINDING);
            protocolMarshaller.marshall(appAuthorization.getAppBundleArn(), APPBUNDLEARN_BINDING);
            protocolMarshaller.marshall(appAuthorization.getApp(), APP_BINDING);
            protocolMarshaller.marshall(appAuthorization.getTenant(), TENANT_BINDING);
            protocolMarshaller.marshall(appAuthorization.getAuthType(), AUTHTYPE_BINDING);
            protocolMarshaller.marshall(appAuthorization.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(appAuthorization.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(appAuthorization.getUpdatedAt(), UPDATEDAT_BINDING);
            protocolMarshaller.marshall(appAuthorization.getPersona(), PERSONA_BINDING);
            protocolMarshaller.marshall(appAuthorization.getAuthUrl(), AUTHURL_BINDING);
        } catch (Exception e) {
