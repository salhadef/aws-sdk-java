...
/**
 * DeleteAppAuthorizationResult JSON Unmarshaller
 */
...
public class DeleteAppAuthorizationResultJsonUnmarshaller implements Unmarshaller<DeleteAppAuthorizationResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppAuthorizationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppAuthorizationResult deleteAppAuthorizationResult = new DeleteAppAuthorizationResult();
