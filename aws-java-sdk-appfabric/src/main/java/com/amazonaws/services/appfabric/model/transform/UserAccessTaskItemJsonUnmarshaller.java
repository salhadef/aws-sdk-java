...
/**
 * UserAccessTaskItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UserAccessTaskItemJsonUnmarshaller implements Unmarshaller<UserAccessTaskItem, JsonUnmarshallerContext> {

    public UserAccessTaskItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        UserAccessTaskItem userAccessTaskItem = new UserAccessTaskItem();
    ...
    private static UserAccessTaskItemJsonUnmarshaller instance;

    public static UserAccessTaskItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UserAccessTaskItemJsonUnmarshaller();
        return instance;
    }
}
