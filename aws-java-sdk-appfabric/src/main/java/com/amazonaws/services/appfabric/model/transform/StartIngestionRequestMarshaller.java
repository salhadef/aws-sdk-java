...
public class StartIngestionRequestMarshaller {
    ...
    private static final StartIngestionRequestMarshaller instance = new StartIngestionRequestMarshaller();

    public static StartIngestionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartIngestionRequest startIngestionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startIngestionRequest.getIngestionIdentifier(), INGESTIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(startIngestionRequest.getAppBundleIdentifier(), APPBUNDLEIDENTIFIER_BINDING);
        } catch (Exception e) {
