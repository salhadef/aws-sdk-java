...
public class GetIngestionDestinationRequestMarshaller {
    ...
    private static final GetIngestionDestinationRequestMarshaller instance = new GetIngestionDestinationRequestMarshaller();

    public static GetIngestionDestinationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetIngestionDestinationRequest getIngestionDestinationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getIngestionDestinationRequest.getAppBundleIdentifier(), APPBUNDLEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getIngestionDestinationRequest.getIngestionIdentifier(), INGESTIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getIngestionDestinationRequest.getIngestionDestinationIdentifier(), INGESTIONDESTINATIONIDENTIFIER_BINDING);
        } catch (Exception e) {
