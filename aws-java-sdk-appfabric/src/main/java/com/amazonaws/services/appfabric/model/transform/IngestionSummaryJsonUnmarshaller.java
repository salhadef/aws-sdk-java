...
/**
 * IngestionSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IngestionSummaryJsonUnmarshaller implements Unmarshaller<IngestionSummary, JsonUnmarshallerContext> {

    public IngestionSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static IngestionSummaryJsonUnmarshaller instance;

    public static IngestionSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IngestionSummaryJsonUnmarshaller();
        return instance;
    }
}
