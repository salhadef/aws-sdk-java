...
public class GetIngestionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetIngestionRequest withAppBundleIdentifier(String appBundleIdentifier) {
    ...
    public GetIngestionRequest withIngestionIdentifier(String ingestionIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIngestionRequest == false)
            return false;
        GetIngestionRequest other = (GetIngestionRequest) obj;
    ...
    @Override
    public GetIngestionRequest clone() {
        return (GetIngestionRequest) super.clone();
    }
