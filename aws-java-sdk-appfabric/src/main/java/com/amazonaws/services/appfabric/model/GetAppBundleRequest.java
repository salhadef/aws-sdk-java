...
public class GetAppBundleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetAppBundleRequest withAppBundleIdentifier(String appBundleIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAppBundleRequest == false)
            return false;
        GetAppBundleRequest other = (GetAppBundleRequest) obj;
    ...
    @Override
    public GetAppBundleRequest clone() {
        return (GetAppBundleRequest) super.clone();
    }
