...
public class CreateIngestionDestinationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateIngestionDestinationResult withIngestionDestination(IngestionDestination ingestionDestination) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateIngestionDestinationResult == false)
            return false;
        CreateIngestionDestinationResult other = (CreateIngestionDestinationResult) obj;
    ...
    @Override
    public CreateIngestionDestinationResult clone() {
        try {
            return (CreateIngestionDestinationResult) super.clone();
