...
/**
 * DeleteOpsItemResult JSON Unmarshaller
 */
...
public class DeleteOpsItemResultJsonUnmarshaller implements Unmarshaller<DeleteOpsItemResult, JsonUnmarshallerContext> {
    ...
    public DeleteOpsItemResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteOpsItemResult deleteOpsItemResult = new DeleteOpsItemResult();

        return deleteOpsItemResult;
    }
