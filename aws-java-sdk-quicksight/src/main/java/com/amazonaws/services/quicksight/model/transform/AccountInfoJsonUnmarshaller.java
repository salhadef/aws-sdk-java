...
/**
 * AccountInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AccountInfoJsonUnmarshaller implements Unmarshaller<AccountInfo, JsonUnmarshallerContext> {

    public AccountInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static AccountInfoJsonUnmarshaller instance;

    public static AccountInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AccountInfoJsonUnmarshaller();
        return instance;
    }
}
