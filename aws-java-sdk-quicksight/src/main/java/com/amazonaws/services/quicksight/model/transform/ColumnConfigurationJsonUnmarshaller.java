        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Column", targetDepth)) {
                    context.nextToken();
                    columnConfiguration.setColumn(ColumnIdentifierJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("FormatConfiguration", targetDepth)) {
                    context.nextToken();
                    columnConfiguration.setFormatConfiguration(FormatConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Role", targetDepth)) {
                    context.nextToken();
                    columnConfiguration.setRole(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ColorsConfiguration", targetDepth)) {
                    context.nextToken();
                    columnConfiguration.setColorsConfiguration(ColorsConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
