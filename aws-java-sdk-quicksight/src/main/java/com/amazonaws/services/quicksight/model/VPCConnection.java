 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/VPCConnection" target="_top">AWS API
 *      Documentation</a>
 */
...
public class VPCConnection implements Serializable, Cloneable, StructuredPojo {
    ...
    public VPCConnection withSecurityGroupIds(java.util.Collection<String> securityGroupIds) {
    ...
    public VPCConnection withDnsResolvers(java.util.Collection<String> dnsResolvers) {
    ...
    public VPCConnection withNetworkInterfaces(java.util.Collection<NetworkInterface> networkInterfaces) {
    ...
    public VPCConnection withCreatedTime(java.util.Date createdTime) {
    ...
    public VPCConnection withLastUpdatedTime(java.util.Date lastUpdatedTime) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.VPCConnectionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
