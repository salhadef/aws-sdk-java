...
/**
 * FilterOperationSelectedFieldsConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FilterOperationSelectedFieldsConfigurationMarshaller {

    private static final MarshallingInfo<List> SELECTEDFIELDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
    ...
    public static FilterOperationSelectedFieldsConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FilterOperationSelectedFieldsConfiguration filterOperationSelectedFieldsConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (filterOperationSelectedFieldsConfiguration == null) {
