...
/**
 * FilterScopeConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FilterScopeConfigurationMarshaller {
    ...
    public static FilterScopeConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FilterScopeConfiguration filterScopeConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (filterScopeConfiguration == null) {
