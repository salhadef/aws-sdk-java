...
/**
 * ScatterPlotCategoricallyAggregatedFieldWells JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScatterPlotCategoricallyAggregatedFieldWellsJsonUnmarshaller implements
        Unmarshaller<ScatterPlotCategoricallyAggregatedFieldWells, JsonUnmarshallerContext> {

    public ScatterPlotCategoricallyAggregatedFieldWells unmarshall(JsonUnmarshallerContext context) throws Exception {
        ScatterPlotCategoricallyAggregatedFieldWells scatterPlotCategoricallyAggregatedFieldWells = new ScatterPlotCategoricallyAggregatedFieldWells();
    ...
    private static ScatterPlotCategoricallyAggregatedFieldWellsJsonUnmarshaller instance;

    public static ScatterPlotCategoricallyAggregatedFieldWellsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ScatterPlotCategoricallyAggregatedFieldWellsJsonUnmarshaller();
        return instance;
    }
}
