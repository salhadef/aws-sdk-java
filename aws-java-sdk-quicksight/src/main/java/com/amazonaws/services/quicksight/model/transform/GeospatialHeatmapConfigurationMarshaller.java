...
/**
 * GeospatialHeatmapConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GeospatialHeatmapConfigurationMarshaller {

    private static final MarshallingInfo<StructuredPojo> HEATMAPCOLOR_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("HeatmapColor").build();
