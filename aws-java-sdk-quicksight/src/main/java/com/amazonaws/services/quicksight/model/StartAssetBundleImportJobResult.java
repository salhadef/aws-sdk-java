...
public class StartAssetBundleImportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartAssetBundleImportJobResult == false)
            return false;
        StartAssetBundleImportJobResult other = (StartAssetBundleImportJobResult) obj;
    ...
    public StartAssetBundleImportJobResult clone() {
        try {
            return (StartAssetBundleImportJobResult) super.clone();
