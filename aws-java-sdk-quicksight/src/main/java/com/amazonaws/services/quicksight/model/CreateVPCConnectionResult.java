...
public class CreateVPCConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     *        The ID for the VPC connection that you're creating. This ID is unique per Amazon Web Services Region for
     ...
     * </p>
     * 
     * @return The ID for the VPC connection that you're creating. This ID is unique per Amazon Web Services Region for
     *         each Amazon Web Services account.
     */
     ...
     * </p>
     * 
     * @return The status of the creation of the VPC connection.
     * @see VPCConnectionResourceStatus
     */
