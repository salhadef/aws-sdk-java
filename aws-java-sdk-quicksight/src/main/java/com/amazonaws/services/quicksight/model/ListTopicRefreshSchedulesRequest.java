...
public class ListTopicRefreshSchedulesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param awsAccountId
     *        The ID of the Amazon Web Services account that contains the topic whose refresh schedule you want
     *        described.
     */
     ...
     * </p>
     * 
     * @return The ID of the Amazon Web Services account that contains the topic whose refresh schedule you want
     *         described.
     */
    ...
    public ListTopicRefreshSchedulesRequest withAwsAccountId(String awsAccountId) {
    ...
    public ListTopicRefreshSchedulesRequest withTopicId(String topicId) {
        setTopicId(topicId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTopicRefreshSchedulesRequest == false)
            return false;
        ListTopicRefreshSchedulesRequest other = (ListTopicRefreshSchedulesRequest) obj;
    ...
    @Override
    public ListTopicRefreshSchedulesRequest clone() {
        return (ListTopicRefreshSchedulesRequest) super.clone();
    }
