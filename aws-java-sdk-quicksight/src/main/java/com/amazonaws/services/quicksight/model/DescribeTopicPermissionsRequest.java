...
public class DescribeTopicPermissionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon Web Services account that contains the topic that you want described.
     */
    ...
    public DescribeTopicPermissionsRequest withAwsAccountId(String awsAccountId) {
    ...
    public DescribeTopicPermissionsRequest withTopicId(String topicId) {
        setTopicId(topicId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeTopicPermissionsRequest == false)
            return false;
        DescribeTopicPermissionsRequest other = (DescribeTopicPermissionsRequest) obj;
    ...
    @Override
    public DescribeTopicPermissionsRequest clone() {
