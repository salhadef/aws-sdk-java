...
public class StartDashboardSnapshotJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The ID of the job. The job ID is set when you start a new job with a <code>StartDashboardSnapshotJob</code> API
     * call.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) for the dashboard snapshot job.
     */
    ...
    public StartDashboardSnapshotJobResult withSnapshotJobId(String snapshotJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartDashboardSnapshotJobResult == false)
            return false;
        StartDashboardSnapshotJobResult other = (StartDashboardSnapshotJobResult) obj;
    ...
    public StartDashboardSnapshotJobResult clone() {
        try {
            return (StartDashboardSnapshotJobResult) super.clone();
