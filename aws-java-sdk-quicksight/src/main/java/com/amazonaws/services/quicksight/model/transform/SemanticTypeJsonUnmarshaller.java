...
/**
 * SemanticType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SemanticTypeJsonUnmarshaller implements Unmarshaller<SemanticType, JsonUnmarshallerContext> {

    public SemanticType unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SemanticTypeJsonUnmarshaller instance;

    public static SemanticTypeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SemanticTypeJsonUnmarshaller();
        return instance;
    }
}
