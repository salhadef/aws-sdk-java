...
public class DeleteTopicResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The ID of the topic that you want to delete. This ID is unique per Amazon Web Services Region for each Amazon Web
     * Services account.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The ID of the topic that you want to delete. This ID is unique per Amazon Web Services Region for each
     *         Amazon Web Services account.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTopicResult == false)
            return false;
        DeleteTopicResult other = (DeleteTopicResult) obj;
    ...
    public DeleteTopicResult clone() {
        try {
            return (DeleteTopicResult) super.clone();
