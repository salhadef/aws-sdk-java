...
public class DeleteTopicRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon Web Services account that contains the topic that you want to delete.
     */
    ...
    public DeleteTopicRequest withAwsAccountId(String awsAccountId) {
    ...
    public DeleteTopicRequest withTopicId(String topicId) {
        setTopicId(topicId);
        return this;
    }
