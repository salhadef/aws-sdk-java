 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/KPIVisualLayoutOptions" target="_top">AWS
 *      API Documentation</a>
 */
...
public class KPIVisualLayoutOptions implements Serializable, Cloneable, StructuredPojo {
    ...
    public KPIVisualLayoutOptions withStandardLayout(KPIVisualStandardLayout standardLayout) {
        setStandardLayout(standardLayout);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KPIVisualLayoutOptions == false)
            return false;
        KPIVisualLayoutOptions other = (KPIVisualLayoutOptions) obj;
        if (other.getStandardLayout() == null ^ this.getStandardLayout() == null)
            return false;
        if (other.getStandardLayout() != null && other.getStandardLayout().equals(this.getStandardLayout()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getStandardLayout() == null) ? 0 : getStandardLayout().hashCode());
        return hashCode;
    }

    @Override
    public KPIVisualLayoutOptions clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.KPIVisualLayoutOptionsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
