...
/**
 * ReferenceLineDataConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ReferenceLineDataConfigurationMarshaller {

    private static final MarshallingInfo<StructuredPojo> STATICCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("StaticConfiguration").build();
    private static final MarshallingInfo<StructuredPojo> DYNAMICCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public static ReferenceLineDataConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ReferenceLineDataConfiguration referenceLineDataConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (referenceLineDataConfiguration == null) {
