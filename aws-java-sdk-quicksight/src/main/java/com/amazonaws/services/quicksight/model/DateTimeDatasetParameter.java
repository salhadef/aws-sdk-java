 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DateTimeDatasetParameter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DateTimeDatasetParameter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private DateTimeDatasetParameterDefaultValues defaultValues;
     ...
     * </p>
     * 
     * @return An identifier for the parameter that is created in the dataset.
     */
     ...
     * </p>
     * 
     * @return The name of the date time parameter that is created in the dataset.
     */
     ...
     * </p>
     * 
     * @return The time granularity of the date time parameter.
     * @see TimeGranularity
     */
     ...
     * </p>
     * 
     * @return A list of default values for a given date time parameter. This structure only accepts static values.
     */

    public DateTimeDatasetParameterDefaultValues getDefaultValues() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DateTimeDatasetParameter == false)
            return false;
        DateTimeDatasetParameter other = (DateTimeDatasetParameter) obj;
    ...
    public DateTimeDatasetParameter clone() {
        try {
            return (DateTimeDatasetParameter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.DateTimeDatasetParameterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
