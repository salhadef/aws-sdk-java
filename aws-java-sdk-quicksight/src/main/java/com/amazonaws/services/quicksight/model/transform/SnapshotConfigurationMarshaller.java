...
/**
 * SnapshotConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SnapshotConfigurationMarshaller {
    ...
    private static final SnapshotConfigurationMarshaller instance = new SnapshotConfigurationMarshaller();

    public static SnapshotConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SnapshotConfiguration snapshotConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(snapshotConfiguration.getFileGroups(), FILEGROUPS_BINDING);
            protocolMarshaller.marshall(snapshotConfiguration.getDestinationConfiguration(), DESTINATIONCONFIGURATION_BINDING);
            protocolMarshaller.marshall(snapshotConfiguration.getParameters(), PARAMETERS_BINDING);
        } catch (Exception e) {
