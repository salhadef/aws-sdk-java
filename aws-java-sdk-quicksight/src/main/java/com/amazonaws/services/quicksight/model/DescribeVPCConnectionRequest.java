...
public class DescribeVPCConnectionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param awsAccountId
     *        The Amazon Web Services account ID of the account that contains the VPC connection that you want
     *        described.
     */
     ...
     * </p>
     * 
     * @return The Amazon Web Services account ID of the account that contains the VPC connection that you want
     *         described.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeVPCConnectionRequest == false)
            return false;
        DescribeVPCConnectionRequest other = (DescribeVPCConnectionRequest) obj;
    ...
    public DescribeVPCConnectionRequest clone() {
        return (DescribeVPCConnectionRequest) super.clone();
    }
