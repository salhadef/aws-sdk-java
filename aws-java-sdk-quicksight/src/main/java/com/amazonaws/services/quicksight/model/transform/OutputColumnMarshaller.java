...
/**
 * OutputColumnMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OutputColumnMarshaller {
    ...
    private static final OutputColumnMarshaller instance = new OutputColumnMarshaller();

    public static OutputColumnMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OutputColumn outputColumn, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(outputColumn.getSubType(), SUBTYPE_BINDING);
        } catch (Exception e) {
