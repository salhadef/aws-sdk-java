 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/RelativeDateTimeControlDisplayOptions"
...
public class RelativeDateTimeControlDisplayOptions implements Serializable, Cloneable, StructuredPojo {
    ...
    public RelativeDateTimeControlDisplayOptions withTitleOptions(LabelOptions titleOptions) {
    ...
    public RelativeDateTimeControlDisplayOptions withDateTimeFormat(String dateTimeFormat) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RelativeDateTimeControlDisplayOptions == false)
            return false;
        RelativeDateTimeControlDisplayOptions other = (RelativeDateTimeControlDisplayOptions) obj;
    ...
    @Override
    public RelativeDateTimeControlDisplayOptions clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.RelativeDateTimeControlDisplayOptionsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
