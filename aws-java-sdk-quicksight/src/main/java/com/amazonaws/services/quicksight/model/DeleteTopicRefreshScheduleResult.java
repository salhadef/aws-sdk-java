...
public class DeleteTopicRefreshScheduleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTopicRefreshScheduleResult == false)
            return false;
        DeleteTopicRefreshScheduleResult other = (DeleteTopicRefreshScheduleResult) obj;
    ...
    public DeleteTopicRefreshScheduleResult clone() {
        try {
            return (DeleteTopicRefreshScheduleResult) super.clone();
