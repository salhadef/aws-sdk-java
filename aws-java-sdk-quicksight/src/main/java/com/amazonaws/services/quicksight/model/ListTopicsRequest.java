...
public class ListTopicsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon Web Services account that contains the topics that you want to list.
     */
    ...
    public ListTopicsRequest withAwsAccountId(String awsAccountId) {
    ...
    public ListTopicsRequest withMaxResults(Integer maxResults) {
