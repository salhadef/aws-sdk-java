...
public class S3BucketConfigurationMarshaller {
    ...
    public void marshall(S3BucketConfiguration s3BucketConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3BucketConfiguration.getBucketName(), BUCKETNAME_BINDING);
            protocolMarshaller.marshall(s3BucketConfiguration.getBucketPrefix(), BUCKETPREFIX_BINDING);
            protocolMarshaller.marshall(s3BucketConfiguration.getBucketRegion(), BUCKETREGION_BINDING);
        } catch (Exception e) {
