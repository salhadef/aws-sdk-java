...
/**
 * PivotTableFieldOptionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PivotTableFieldOptionsMarshaller {
    ...
    public static PivotTableFieldOptionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PivotTableFieldOptions pivotTableFieldOptions, ProtocolMarshaller protocolMarshaller) {

        if (pivotTableFieldOptions == null) {
