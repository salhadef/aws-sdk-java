...
/**
 * RelativeDateTimeControlDisplayOptionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RelativeDateTimeControlDisplayOptionsMarshaller {
    ...
    public static RelativeDateTimeControlDisplayOptionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RelativeDateTimeControlDisplayOptions relativeDateTimeControlDisplayOptions, ProtocolMarshaller protocolMarshaller) {

        if (relativeDateTimeControlDisplayOptions == null) {
