...
public class UpdateTopicRefreshScheduleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateTopicRefreshScheduleRequest withAwsAccountId(String awsAccountId) {
    ...
    public UpdateTopicRefreshScheduleRequest withTopicId(String topicId) {
        setTopicId(topicId);
        return this;
    }
    ...
    public UpdateTopicRefreshScheduleRequest withDatasetId(String datasetId) {
    ...
    public UpdateTopicRefreshScheduleRequest withRefreshSchedule(TopicRefreshSchedule refreshSchedule) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTopicRefreshScheduleRequest == false)
            return false;
    ...
    @Override
    public UpdateTopicRefreshScheduleRequest clone() {
