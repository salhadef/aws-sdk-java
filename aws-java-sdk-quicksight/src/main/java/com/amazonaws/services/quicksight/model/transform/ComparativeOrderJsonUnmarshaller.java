...
/**
 * ComparativeOrder JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComparativeOrderJsonUnmarshaller implements Unmarshaller<ComparativeOrder, JsonUnmarshallerContext> {

    public ComparativeOrder unmarshall(JsonUnmarshallerContext context) throws Exception {
        ComparativeOrder comparativeOrder = new ComparativeOrder();
    ...
    private static ComparativeOrderJsonUnmarshaller instance;

    public static ComparativeOrderJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComparativeOrderJsonUnmarshaller();
        return instance;
    }
}
