...
public class DisplayFormatOptionsMarshaller {
    ...
    private static final MarshallingInfo<Boolean> USEBLANKCELLFORMAT_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UseBlankCellFormat").build();
    private static final MarshallingInfo<String> BLANKCELLFORMAT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    private static final MarshallingInfo<String> GROUPINGSEPARATOR_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("GroupingSeparator").build();
    private static final MarshallingInfo<Boolean> USEGROUPING_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UseGrouping").build();
    private static final MarshallingInfo<Integer> FRACTIONDIGITS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
    ...
    private static final MarshallingInfo<String> UNITSCALER_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UnitScaler").build();
    private static final MarshallingInfo<StructuredPojo> NEGATIVEFORMAT_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("NegativeFormat").build();
    private static final MarshallingInfo<String> CURRENCYSYMBOL_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
