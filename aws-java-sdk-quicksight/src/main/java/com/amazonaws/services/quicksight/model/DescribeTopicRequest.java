...
public class DescribeTopicRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeTopicRequest withAwsAccountId(String awsAccountId) {
    ...
    public DescribeTopicRequest withTopicId(String topicId) {
        setTopicId(topicId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeTopicRequest == false)
            return false;
        DescribeTopicRequest other = (DescribeTopicRequest) obj;
    ...
    public DescribeTopicRequest clone() {
        return (DescribeTopicRequest) super.clone();
    }
