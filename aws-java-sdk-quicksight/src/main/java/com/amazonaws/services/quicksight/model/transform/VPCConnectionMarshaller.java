...
public class VPCConnectionMarshaller {
    ...
    public void marshall(VPCConnection vPCConnection, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(vPCConnection.getVPCConnectionId(), VPCCONNECTIONID_BINDING);
            protocolMarshaller.marshall(vPCConnection.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(vPCConnection.getName(), NAME_BINDING);
            protocolMarshaller.marshall(vPCConnection.getVPCId(), VPCID_BINDING);
            protocolMarshaller.marshall(vPCConnection.getSecurityGroupIds(), SECURITYGROUPIDS_BINDING);
            protocolMarshaller.marshall(vPCConnection.getDnsResolvers(), DNSRESOLVERS_BINDING);
            protocolMarshaller.marshall(vPCConnection.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(vPCConnection.getAvailabilityStatus(), AVAILABILITYSTATUS_BINDING);
            protocolMarshaller.marshall(vPCConnection.getNetworkInterfaces(), NETWORKINTERFACES_BINDING);
            protocolMarshaller.marshall(vPCConnection.getRoleArn(), ROLEARN_BINDING);
            protocolMarshaller.marshall(vPCConnection.getCreatedTime(), CREATEDTIME_BINDING);
            protocolMarshaller.marshall(vPCConnection.getLastUpdatedTime(), LASTUPDATEDTIME_BINDING);
        } catch (Exception e) {
