...
/**
 * KPIOptions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KPIOptionsJsonUnmarshaller implements Unmarshaller<KPIOptions, JsonUnmarshallerContext> {

    public KPIOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
        KPIOptions kPIOptions = new KPIOptions();
    ...
    private static KPIOptionsJsonUnmarshaller instance;

    public static KPIOptionsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new KPIOptionsJsonUnmarshaller();
        return instance;
    }
}
