...
public enum AssetBundleImportJobStatus {
    ...
    private AssetBundleImportJobStatus(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return AssetBundleImportJobStatus corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static AssetBundleImportJobStatus fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (AssetBundleImportJobStatus enumEntry : AssetBundleImportJobStatus.values()) {
