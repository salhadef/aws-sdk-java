...
/**
 * SliderControlDisplayOptionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SliderControlDisplayOptionsMarshaller {
    ...
    public static SliderControlDisplayOptionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SliderControlDisplayOptions sliderControlDisplayOptions, ProtocolMarshaller protocolMarshaller) {

        if (sliderControlDisplayOptions == null) {
