...
/**
 * DecimalParameterDeclarationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DecimalParameterDeclarationMarshaller {
    ...
    public static DecimalParameterDeclarationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DecimalParameterDeclaration decimalParameterDeclaration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(decimalParameterDeclaration.getParameterValueType(), PARAMETERVALUETYPE_BINDING);
