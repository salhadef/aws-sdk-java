...
public class NetworkInterfaceMarshaller {
    ...
    public void marshall(NetworkInterface networkInterface, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(networkInterface.getErrorMessage(), ERRORMESSAGE_BINDING);
            protocolMarshaller.marshall(networkInterface.getStatus(), STATUS_BINDING);
