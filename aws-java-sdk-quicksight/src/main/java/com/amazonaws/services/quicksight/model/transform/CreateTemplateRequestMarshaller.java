...
public class CreateTemplateRequestMarshaller {
    ...
    public void marshall(CreateTemplateRequest createTemplateRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createTemplateRequest.getAwsAccountId(), AWSACCOUNTID_BINDING);
            protocolMarshaller.marshall(createTemplateRequest.getTemplateId(), TEMPLATEID_BINDING);
            protocolMarshaller.marshall(createTemplateRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createTemplateRequest.getPermissions(), PERMISSIONS_BINDING);
            ...
            protocolMarshaller.marshall(createTemplateRequest.getValidationStrategy(), VALIDATIONSTRATEGY_BINDING);
        } catch (Exception e) {
