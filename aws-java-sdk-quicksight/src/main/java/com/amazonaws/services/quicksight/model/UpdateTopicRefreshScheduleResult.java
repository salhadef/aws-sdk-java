...
public class UpdateTopicRefreshScheduleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTopicRefreshScheduleResult == false)
            return false;
        UpdateTopicRefreshScheduleResult other = (UpdateTopicRefreshScheduleResult) obj;
    ...
    public UpdateTopicRefreshScheduleResult clone() {
        try {
            return (UpdateTopicRefreshScheduleResult) super.clone();
