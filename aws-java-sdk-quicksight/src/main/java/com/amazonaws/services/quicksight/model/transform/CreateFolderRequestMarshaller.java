...
/**
 * CreateFolderRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateFolderRequestMarshaller {
    ...
    private static final MarshallingInfo<String> FOLDERTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("FolderType").build();
    private static final MarshallingInfo<String> PARENTFOLDERARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ParentFolderArn").build();
    ...
    public static CreateFolderRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(CreateFolderRequest createFolderRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createFolderRequest.getAwsAccountId(), AWSACCOUNTID_BINDING);
            protocolMarshaller.marshall(createFolderRequest.getFolderId(), FOLDERID_BINDING);
            protocolMarshaller.marshall(createFolderRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createFolderRequest.getFolderType(), FOLDERTYPE_BINDING);
