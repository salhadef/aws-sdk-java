...
public class UpdateTopicResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTopicResult == false)
            return false;
        UpdateTopicResult other = (UpdateTopicResult) obj;
    ...
    public UpdateTopicResult clone() {
        try {
            return (UpdateTopicResult) super.clone();
