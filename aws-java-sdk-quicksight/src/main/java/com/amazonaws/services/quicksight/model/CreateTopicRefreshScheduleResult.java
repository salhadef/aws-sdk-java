...
public class CreateTopicRefreshScheduleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTopicRefreshScheduleResult == false)
            return false;
        CreateTopicRefreshScheduleResult other = (CreateTopicRefreshScheduleResult) obj;
    ...
    public CreateTopicRefreshScheduleResult clone() {
        try {
            return (CreateTopicRefreshScheduleResult) super.clone();
