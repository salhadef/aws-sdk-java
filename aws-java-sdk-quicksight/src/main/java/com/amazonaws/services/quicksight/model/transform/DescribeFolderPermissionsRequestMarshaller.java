...
public class DescribeFolderPermissionsRequestMarshaller {
    ...
    public static DescribeFolderPermissionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeFolderPermissionsRequest describeFolderPermissionsRequest, ProtocolMarshaller protocolMarshaller) {

        if (describeFolderPermissionsRequest == null) {
