 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/CollectiveConstant" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CollectiveConstant implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return A list of values for the collective constant.
     */
    ...
    public CollectiveConstant withValueList(String... valueList) {
    ...
    public CollectiveConstant withValueList(java.util.Collection<String> valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CollectiveConstant == false)
            return false;
        CollectiveConstant other = (CollectiveConstant) obj;
    ...
    public CollectiveConstant clone() {
        try {
            return (CollectiveConstant) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.CollectiveConstantMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
