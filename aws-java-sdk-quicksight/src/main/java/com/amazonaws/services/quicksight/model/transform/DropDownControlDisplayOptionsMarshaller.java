...
/**
 * DropDownControlDisplayOptionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DropDownControlDisplayOptionsMarshaller {
    ...
    public static DropDownControlDisplayOptionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DropDownControlDisplayOptions dropDownControlDisplayOptions, ProtocolMarshaller protocolMarshaller) {

        if (dropDownControlDisplayOptions == null) {
