...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DescribeVPCConnection" target="_top">AWS
 *      API Documentation</a>
 */
...
public class DescribeVPCConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A response object that provides information for the specified VPC connection.
     */

    public VPCConnection getVPCConnection() {
    ...
    public DescribeVPCConnectionResult withVPCConnection(VPCConnection vPCConnection) {
        setVPCConnection(vPCConnection);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getVPCConnection() != null)
            sb.append("VPCConnection: ").append(getVPCConnection()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getVPCConnection() == null ^ this.getVPCConnection() == null)
            return false;
        if (other.getVPCConnection() != null && other.getVPCConnection().equals(this.getVPCConnection()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getVPCConnection() == null) ? 0 : getVPCConnection().hashCode());
