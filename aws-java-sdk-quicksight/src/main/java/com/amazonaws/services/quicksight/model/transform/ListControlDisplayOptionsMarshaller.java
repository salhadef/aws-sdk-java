...
/**
 * ListControlDisplayOptionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListControlDisplayOptionsMarshaller {

    private static final MarshallingInfo<StructuredPojo> SEARCHOPTIONS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SearchOptions").build();
    private static final MarshallingInfo<StructuredPojo> SELECTALLOPTIONS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public static ListControlDisplayOptionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListControlDisplayOptions listControlDisplayOptions, ProtocolMarshaller protocolMarshaller) {

        if (listControlDisplayOptions == null) {
