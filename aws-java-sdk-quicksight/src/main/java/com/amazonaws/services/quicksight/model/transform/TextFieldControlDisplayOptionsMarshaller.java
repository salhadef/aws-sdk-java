...
/**
 * TextFieldControlDisplayOptionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TextFieldControlDisplayOptionsMarshaller {
    ...
    public static TextFieldControlDisplayOptionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TextFieldControlDisplayOptions textFieldControlDisplayOptions, ProtocolMarshaller protocolMarshaller) {

        if (textFieldControlDisplayOptions == null) {
