...
public class StartAssetBundleExportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartAssetBundleExportJobResult == false)
            return false;
        StartAssetBundleExportJobResult other = (StartAssetBundleExportJobResult) obj;
    ...
    public StartAssetBundleExportJobResult clone() {
        try {
            return (StartAssetBundleExportJobResult) super.clone();
