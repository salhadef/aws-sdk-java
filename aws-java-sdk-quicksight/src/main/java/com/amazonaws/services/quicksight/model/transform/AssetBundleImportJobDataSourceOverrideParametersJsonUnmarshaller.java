...
/**
 * AssetBundleImportJobDataSourceOverrideParameters JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssetBundleImportJobDataSourceOverrideParametersJsonUnmarshaller implements
        Unmarshaller<AssetBundleImportJobDataSourceOverrideParameters, JsonUnmarshallerContext> {

    public AssetBundleImportJobDataSourceOverrideParameters unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssetBundleImportJobDataSourceOverrideParameters assetBundleImportJobDataSourceOverrideParameters = new AssetBundleImportJobDataSourceOverrideParameters();
    ...
    private static AssetBundleImportJobDataSourceOverrideParametersJsonUnmarshaller instance;

    public static AssetBundleImportJobDataSourceOverrideParametersJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssetBundleImportJobDataSourceOverrideParametersJsonUnmarshaller();
        return instance;
    }
}
