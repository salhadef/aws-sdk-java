...
/**
 * DeleteAccountPolicyResult JSON Unmarshaller
 */
...
public class DeleteAccountPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteAccountPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteAccountPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAccountPolicyResult deleteAccountPolicyResult = new DeleteAccountPolicyResult();

        return deleteAccountPolicyResult;
    }
