...
public class DeleteAccountPolicyRequestMarshaller {
    ...
    private static final DeleteAccountPolicyRequestMarshaller instance = new DeleteAccountPolicyRequestMarshaller();

    public static DeleteAccountPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteAccountPolicyRequest deleteAccountPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteAccountPolicyRequest.getPolicyName(), POLICYNAME_BINDING);
            protocolMarshaller.marshall(deleteAccountPolicyRequest.getPolicyType(), POLICYTYPE_BINDING);
        } catch (Exception e) {
