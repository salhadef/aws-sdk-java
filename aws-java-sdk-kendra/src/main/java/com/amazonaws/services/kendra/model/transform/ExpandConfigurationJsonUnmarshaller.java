...
/**
 * ExpandConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExpandConfigurationJsonUnmarshaller implements Unmarshaller<ExpandConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MaxResultItemsToExpand", targetDepth)) {
                    context.nextToken();
                    expandConfiguration.setMaxResultItemsToExpand(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("MaxExpandedResultsPerItem", targetDepth)) {
                    context.nextToken();
                    expandConfiguration.setMaxExpandedResultsPerItem(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
