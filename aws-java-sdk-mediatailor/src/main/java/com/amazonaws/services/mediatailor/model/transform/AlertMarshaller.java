...
public class AlertMarshaller {
    ...
    private static final MarshallingInfo<String> ALERTCODE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    private static final MarshallingInfo<List> RELATEDRESOURCEARNS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RelatedResourceArns").build();
