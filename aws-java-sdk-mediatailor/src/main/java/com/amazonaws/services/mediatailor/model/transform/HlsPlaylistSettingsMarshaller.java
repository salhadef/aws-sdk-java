...
public class HlsPlaylistSettingsMarshaller {
    ...
    private static final HlsPlaylistSettingsMarshaller instance = new HlsPlaylistSettingsMarshaller();

    public static HlsPlaylistSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HlsPlaylistSettings hlsPlaylistSettings, ProtocolMarshaller protocolMarshaller) {
