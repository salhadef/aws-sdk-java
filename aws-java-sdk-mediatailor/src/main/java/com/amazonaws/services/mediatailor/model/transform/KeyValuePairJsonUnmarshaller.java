...
public class KeyValuePairJsonUnmarshaller implements Unmarshaller<KeyValuePair, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    keyValuePair.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static KeyValuePairJsonUnmarshaller instance;

    public static KeyValuePairJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new KeyValuePairJsonUnmarshaller();
        return instance;
    }
}
