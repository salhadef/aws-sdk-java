...
public class AvailSuppressionMarshaller {
    ...
    private static final AvailSuppressionMarshaller instance = new AvailSuppressionMarshaller();

    public static AvailSuppressionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AvailSuppression availSuppression, ProtocolMarshaller protocolMarshaller) {

        if (availSuppression == null) {
