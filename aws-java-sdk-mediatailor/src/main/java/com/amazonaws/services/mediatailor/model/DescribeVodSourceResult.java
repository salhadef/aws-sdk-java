...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediatailor-2018-04-23/DescribeVodSource" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeVodSourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeVodSourceResult withCreationTime(java.util.Date creationTime) {
    ...
    public DescribeVodSourceResult withHttpPackageConfigurations(HttpPackageConfiguration... httpPackageConfigurations) {
    ...
    public DescribeVodSourceResult withHttpPackageConfigurations(java.util.Collection<HttpPackageConfiguration> httpPackageConfigurations) {
    ...
    public DescribeVodSourceResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public DescribeVodSourceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see DescribeVodSourceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DescribeVodSourceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public DescribeVodSourceResult clone() {
        try {
            return (DescribeVodSourceResult) super.clone();
