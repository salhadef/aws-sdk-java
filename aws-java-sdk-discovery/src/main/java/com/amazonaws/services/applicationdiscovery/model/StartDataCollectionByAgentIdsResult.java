...
public class StartDataCollectionByAgentIdsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public StartDataCollectionByAgentIdsResult withAgentsConfigurationStatus(java.util.Collection<AgentConfigurationStatus> agentsConfigurationStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartDataCollectionByAgentIdsResult == false)
            return false;
        StartDataCollectionByAgentIdsResult other = (StartDataCollectionByAgentIdsResult) obj;
    ...
    public StartDataCollectionByAgentIdsResult clone() {
        try {
            return (StartDataCollectionByAgentIdsResult) super.clone();
