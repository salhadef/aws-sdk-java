...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/GetAnalysisTemplate" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetAnalysisTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetAnalysisTemplateRequest withMembershipIdentifier(String membershipIdentifier) {
    ...
    public GetAnalysisTemplateRequest withAnalysisTemplateIdentifier(String analysisTemplateIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAnalysisTemplateRequest == false)
            return false;
    ...
    @Override
    public GetAnalysisTemplateRequest clone() {
        return (GetAnalysisTemplateRequest) super.clone();
    }
