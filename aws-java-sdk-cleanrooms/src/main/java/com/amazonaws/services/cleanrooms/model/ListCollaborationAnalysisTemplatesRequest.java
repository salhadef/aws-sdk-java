...
public class ListCollaborationAnalysisTemplatesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListCollaborationAnalysisTemplatesRequest withCollaborationIdentifier(String collaborationIdentifier) {
    ...
    public ListCollaborationAnalysisTemplatesRequest withNextToken(String nextToken) {
    ...
    public ListCollaborationAnalysisTemplatesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCollaborationAnalysisTemplatesRequest == false)
            return false;
        ListCollaborationAnalysisTemplatesRequest other = (ListCollaborationAnalysisTemplatesRequest) obj;
    ...
    @Override
    public ListCollaborationAnalysisTemplatesRequest clone() {
        return (ListCollaborationAnalysisTemplatesRequest) super.clone();
    }
