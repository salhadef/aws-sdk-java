...
/**
 * ConfiguredTableAnalysisRulePolicyV1Marshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ConfiguredTableAnalysisRulePolicyV1Marshaller {
    ...
    public static ConfiguredTableAnalysisRulePolicyV1Marshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ConfiguredTableAnalysisRulePolicyV1 configuredTableAnalysisRulePolicyV1, ProtocolMarshaller protocolMarshaller) {

        if (configuredTableAnalysisRulePolicyV1 == null) {
