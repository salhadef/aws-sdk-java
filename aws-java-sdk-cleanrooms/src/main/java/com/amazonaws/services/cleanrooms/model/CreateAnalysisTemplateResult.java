...
public class CreateAnalysisTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateAnalysisTemplateResult withAnalysisTemplate(AnalysisTemplate analysisTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAnalysisTemplateResult == false)
            return false;
        CreateAnalysisTemplateResult other = (CreateAnalysisTemplateResult) obj;
    ...
    @Override
    public CreateAnalysisTemplateResult clone() {
        try {
            return (CreateAnalysisTemplateResult) super.clone();
