...
/**
 * DeleteAnalysisTemplateResult JSON Unmarshaller
 */
...
public class DeleteAnalysisTemplateResultJsonUnmarshaller implements Unmarshaller<DeleteAnalysisTemplateResult, JsonUnmarshallerContext> {
    ...
    public DeleteAnalysisTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAnalysisTemplateResult deleteAnalysisTemplateResult = new DeleteAnalysisTemplateResult();
