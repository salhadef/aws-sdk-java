...
/**
 * ProtectedQueryOutputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ProtectedQueryOutputMarshaller {
    ...
    public static ProtectedQueryOutputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ProtectedQueryOutput protectedQueryOutput, ProtocolMarshaller protocolMarshaller) {

        if (protectedQueryOutput == null) {
