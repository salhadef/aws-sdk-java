 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/AnalysisTemplate" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AnalysisTemplate implements Serializable, Cloneable, StructuredPojo {
    ...
    public AnalysisTemplate withCreateTime(java.util.Date createTime) {
    ...
    public AnalysisTemplate withUpdateTime(java.util.Date updateTime) {
    ...
    public AnalysisTemplate withAnalysisParameters(AnalysisParameter... analysisParameters) {
    ...
    public AnalysisTemplate withAnalysisParameters(java.util.Collection<AnalysisParameter> analysisParameters) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AnalysisTemplate == false)
            return false;
    ...
    public AnalysisTemplate clone() {
        try {
            return (AnalysisTemplate) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cleanrooms.model.transform.AnalysisTemplateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
