...
public class DescribeTestSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The test set Id for the test set request.
     */
    ...
    public DescribeTestSetRequest withTestSetId(String testSetId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeTestSetRequest == false)
            return false;
        DescribeTestSetRequest other = (DescribeTestSetRequest) obj;
    ...
    @Override
    public DescribeTestSetRequest clone() {
        return (DescribeTestSetRequest) super.clone();
    }
