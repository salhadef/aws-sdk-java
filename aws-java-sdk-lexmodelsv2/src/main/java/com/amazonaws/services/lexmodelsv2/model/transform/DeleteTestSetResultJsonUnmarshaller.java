...
/**
 * DeleteTestSetResult JSON Unmarshaller
 */
...
public class DeleteTestSetResultJsonUnmarshaller implements Unmarshaller<DeleteTestSetResult, JsonUnmarshallerContext> {
    ...
    public DeleteTestSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTestSetResult deleteTestSetResult = new DeleteTestSetResult();

        return deleteTestSetResult;
    }
