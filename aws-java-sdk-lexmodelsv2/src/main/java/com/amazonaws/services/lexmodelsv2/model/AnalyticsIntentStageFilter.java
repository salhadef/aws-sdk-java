 ...
 * </ul>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/AnalyticsIntentStageFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AnalyticsIntentStageFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * 
     * @param name
     *        The category by which to filter the intent stages. The descriptions for each option are as follows:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        <code>BotAlias</code> – The name of the bot alias.
    ...
    public AnalyticsIntentStageFilter withName(String name) {
        setName(name);
        return this;
    }
    ...
    public AnalyticsIntentStageFilter withName(AnalyticsIntentStageFilterName name) {
    ...
    public AnalyticsIntentStageFilter withOperator(String operator) {
    ...
    public AnalyticsIntentStageFilter withOperator(AnalyticsFilterOperator operator) {
    ...
    public AnalyticsIntentStageFilter withValues(String... values) {
        if (this.values == null) {
    ...
    public AnalyticsIntentStageFilter withValues(java.util.Collection<String> values) {
        setValues(values);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AnalyticsIntentStageFilter == false)
            return false;
    ...
    @Override
    public AnalyticsIntentStageFilter clone() {
        try {
            return (AnalyticsIntentStageFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lexmodelsv2.model.transform.AnalyticsIntentStageFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
