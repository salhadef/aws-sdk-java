...
public class DescribeTestExecutionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The execution Id of the test set execution.
     */
    ...
    public DescribeTestExecutionRequest withTestExecutionId(String testExecutionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeTestExecutionRequest == false)
            return false;
        DescribeTestExecutionRequest other = (DescribeTestExecutionRequest) obj;
    ...
    @Override
    public DescribeTestExecutionRequest clone() {
