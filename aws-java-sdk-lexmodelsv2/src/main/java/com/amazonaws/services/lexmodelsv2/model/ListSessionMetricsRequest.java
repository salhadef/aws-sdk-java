...
public class ListSessionMetricsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<AnalyticsSessionMetric> metrics;
    /**
     * <p>
     ...
     * <li>
     * <p>
     * <code>ConversationEndState</code> – The final state of the conversation. The possible end states are detailed in
     * <a href="https://docs.aws.amazon.com/analytics-key-definitions-conversations">Key definitions</a> in the user
     * guide.
     * </p>
     * </li>
     * <li>
     ...
     * </ul>
     */
    private java.util.List<AnalyticsSessionGroupBySpecification> groupBy;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The identifier for the bot for which you want to retrieve session metrics.
     */
    ...
    public ListSessionMetricsRequest withStartDateTime(java.util.Date startDateTime) {
     ...
     * </p>
     * 
     * @return The date and time that marks the end of the range of time for which you want to see session metrics.
     */
    ...
    public ListSessionMetricsRequest withEndDateTime(java.util.Date endDateTime) {
    ...
    public java.util.List<AnalyticsSessionMetric> getMetrics() {
        return metrics;
    }
    ...
    public void setMetrics(java.util.Collection<AnalyticsSessionMetric> metrics) {
        if (metrics == null) {
            this.metrics = null;
            return;
        }

        this.metrics = new java.util.ArrayList<AnalyticsSessionMetric>(metrics);
    }
    ...
    public ListSessionMetricsRequest withMetrics(AnalyticsSessionMetric... metrics) {
        if (this.metrics == null) {
            setMetrics(new java.util.ArrayList<AnalyticsSessionMetric>(metrics.length));
        }
        for (AnalyticsSessionMetric ele : metrics) {
    ...
    public ListSessionMetricsRequest withMetrics(java.util.Collection<AnalyticsSessionMetric> metrics) {
        setMetrics(metrics);
        return this;
    }
    ...
    public ListSessionMetricsRequest withBinBy(AnalyticsBinBySpecification... binBy) {
        if (this.binBy == null) {
    ...
    public ListSessionMetricsRequest withBinBy(java.util.Collection<AnalyticsBinBySpecification> binBy) {
        setBinBy(binBy);
        return this;
    }
     ...
     *         <li>
     *         <p>
     *         <code>ConversationEndState</code> – The final state of the conversation. The possible end states are
     *         detailed in <a href="https://docs.aws.amazon.com/analytics-key-definitions-conversations">Key
    ...
    public java.util.List<AnalyticsSessionGroupBySpecification> getGroupBy() {
        return groupBy;
    }
    ...
    public void setGroupBy(java.util.Collection<AnalyticsSessionGroupBySpecification> groupBy) {
        if (groupBy == null) {
            this.groupBy = null;
            return;
        }

        this.groupBy = new java.util.ArrayList<AnalyticsSessionGroupBySpecification>(groupBy);
    }
    ...
    public ListSessionMetricsRequest withGroupBy(AnalyticsSessionGroupBySpecification... groupBy) {
        if (this.groupBy == null) {
            setGroupBy(new java.util.ArrayList<AnalyticsSessionGroupBySpecification>(groupBy.length));
        }
        for (AnalyticsSessionGroupBySpecification ele : groupBy) {
    ...
    public ListSessionMetricsRequest withGroupBy(java.util.Collection<AnalyticsSessionGroupBySpecification> groupBy) {
        setGroupBy(groupBy);
        return this;
    }
    ...
    public ListSessionMetricsRequest withFilters(AnalyticsSessionFilter... filters) {
    ...
    public ListSessionMetricsRequest withFilters(java.util.Collection<AnalyticsSessionFilter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSessionMetricsRequest == false)
            return false;
        ListSessionMetricsRequest other = (ListSessionMetricsRequest) obj;
    ...
    public ListSessionMetricsRequest clone() {
        return (ListSessionMetricsRequest) super.clone();
    }
