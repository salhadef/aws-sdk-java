...
/**
 * ImportResourceSpecification JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportResourceSpecificationJsonUnmarshaller implements Unmarshaller<ImportResourceSpecification, JsonUnmarshallerContext> {

    public ImportResourceSpecification unmarshall(JsonUnmarshallerContext context) throws Exception {
        ImportResourceSpecification importResourceSpecification = new ImportResourceSpecification();
    ...
    private static ImportResourceSpecificationJsonUnmarshaller instance;

    public static ImportResourceSpecificationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImportResourceSpecificationJsonUnmarshaller();
        return instance;
    }
}
