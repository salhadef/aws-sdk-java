...
/**
 * AnalyticsSessionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AnalyticsSessionResultJsonUnmarshaller implements Unmarshaller<AnalyticsSessionResult, JsonUnmarshallerContext> {

    public AnalyticsSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AnalyticsSessionResult analyticsSessionResult = new AnalyticsSessionResult();
    ...
    private static AnalyticsSessionResultJsonUnmarshaller instance;

    public static AnalyticsSessionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AnalyticsSessionResultJsonUnmarshaller();
        return instance;
    }
}
