...
/**
 * UpdateTestSetResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateTestSetResultJsonUnmarshaller implements Unmarshaller<UpdateTestSetResult, JsonUnmarshallerContext> {

    public UpdateTestSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateTestSetResult updateTestSetResult = new UpdateTestSetResult();
    ...
    private static UpdateTestSetResultJsonUnmarshaller instance;

    public static UpdateTestSetResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateTestSetResultJsonUnmarshaller();
        return instance;
    }
}
