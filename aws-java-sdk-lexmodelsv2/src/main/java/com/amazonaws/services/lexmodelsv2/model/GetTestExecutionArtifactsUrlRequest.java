...
public class GetTestExecutionArtifactsUrlRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetTestExecutionArtifactsUrlRequest withTestExecutionId(String testExecutionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTestExecutionArtifactsUrlRequest == false)
            return false;
    ...
    @Override
    public GetTestExecutionArtifactsUrlRequest clone() {
        return (GetTestExecutionArtifactsUrlRequest) super.clone();
    }
