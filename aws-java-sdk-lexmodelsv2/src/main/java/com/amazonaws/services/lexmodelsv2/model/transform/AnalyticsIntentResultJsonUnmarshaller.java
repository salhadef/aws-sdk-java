...
/**
 * AnalyticsIntentResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AnalyticsIntentResultJsonUnmarshaller implements Unmarshaller<AnalyticsIntentResult, JsonUnmarshallerContext> {

    public AnalyticsIntentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AnalyticsIntentResult analyticsIntentResult = new AnalyticsIntentResult();
    ...
    private static AnalyticsIntentResultJsonUnmarshaller instance;

    public static AnalyticsIntentResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AnalyticsIntentResultJsonUnmarshaller();
        return instance;
    }
}
