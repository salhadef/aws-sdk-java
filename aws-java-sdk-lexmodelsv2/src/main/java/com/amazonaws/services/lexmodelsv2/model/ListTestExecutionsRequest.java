...
public class ListTestExecutionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private TestExecutionSortBy sortBy;
    /**
     * <p>
     * The maximum number of test executions to return in each page. If there are fewer results than the max page size,
     ...
     * </p>
     * 
     * @return The sort order of the test set executions.
     */

    public TestExecutionSortBy getSortBy() {
        return this.sortBy;
    }
     ...
     * </p>
     * 
     * @return The maximum number of test executions to return in each page. If there are fewer results than the max
     ...
     * </p>
     * 
     * @return If the response from the ListTestExecutions operation contains more results than specified in the
     *         maxResults parameter, a token is returned in the response. Use that token in the nextToken parameter to
     *         return the next page of results.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTestExecutionsRequest == false)
            return false;
        ListTestExecutionsRequest other = (ListTestExecutionsRequest) obj;
    ...
    public ListTestExecutionsRequest clone() {
        return (ListTestExecutionsRequest) super.clone();
    }
