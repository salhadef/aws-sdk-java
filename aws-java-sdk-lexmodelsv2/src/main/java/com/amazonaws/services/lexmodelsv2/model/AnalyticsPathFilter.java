 ...
 * </ul>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/models.lex.v2-2020-08-07/AnalyticsPathFilter" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AnalyticsPathFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * 
     * @param name
     *        The category by which to filter the intent paths. The descriptions for each option are as follows:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        <code>BotAlias</code> – The name of the bot alias.
     ...
     * </ul>
     * 
     * @return The category by which to filter the intent paths. The descriptions for each option are as follows:</p>
     *         <ul>
     *         <li>
     *         <p>
     *         <code>BotAlias</code> – The name of the bot alias.
    ...
    public AnalyticsPathFilter withName(String name) {
        setName(name);
        return this;
    }
    ...
    public AnalyticsPathFilter withName(AnalyticsCommonFilterName name) {
    ...
    public AnalyticsPathFilter withOperator(String operator) {
    ...
    public AnalyticsPathFilter withOperator(AnalyticsFilterOperator operator) {
    ...
    public AnalyticsPathFilter withValues(String... values) {
        if (this.values == null) {
    ...
    public AnalyticsPathFilter withValues(java.util.Collection<String> values) {
        setValues(values);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AnalyticsPathFilter == false)
            return false;
        AnalyticsPathFilter other = (AnalyticsPathFilter) obj;
    ...
    @Override
    public AnalyticsPathFilter clone() {
        try {
            return (AnalyticsPathFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lexmodelsv2.model.transform.AnalyticsPathFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
