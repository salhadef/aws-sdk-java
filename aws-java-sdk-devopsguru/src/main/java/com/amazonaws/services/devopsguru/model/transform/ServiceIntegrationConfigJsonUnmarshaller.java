...
/**
 * ServiceIntegrationConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServiceIntegrationConfigJsonUnmarshaller implements Unmarshaller<ServiceIntegrationConfig, JsonUnmarshallerContext> {

    public ServiceIntegrationConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ServiceIntegrationConfig serviceIntegrationConfig = new ServiceIntegrationConfig();
    ...
    private static ServiceIntegrationConfigJsonUnmarshaller instance;

    public static ServiceIntegrationConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServiceIntegrationConfigJsonUnmarshaller();
        return instance;
    }
}
