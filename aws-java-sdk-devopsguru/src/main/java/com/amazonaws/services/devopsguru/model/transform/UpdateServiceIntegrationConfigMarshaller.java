...
/**
 * UpdateServiceIntegrationConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateServiceIntegrationConfigMarshaller {
    ...
    public static UpdateServiceIntegrationConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateServiceIntegrationConfig updateServiceIntegrationConfig, ProtocolMarshaller protocolMarshaller) {

        if (updateServiceIntegrationConfig == null) {
