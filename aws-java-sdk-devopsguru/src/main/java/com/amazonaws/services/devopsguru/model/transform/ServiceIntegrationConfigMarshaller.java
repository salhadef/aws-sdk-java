...
/**
 * ServiceIntegrationConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ServiceIntegrationConfigMarshaller {
    ...
    public static ServiceIntegrationConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ServiceIntegrationConfig serviceIntegrationConfig, ProtocolMarshaller protocolMarshaller) {

        if (serviceIntegrationConfig == null) {
