...
/**
 * CreateExportJobResult JSON Unmarshaller
 */
...
public class CreateExportJobResultJsonUnmarshaller implements Unmarshaller<CreateExportJobResult, JsonUnmarshallerContext> {
    ...
    public CreateExportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateExportJobResult createExportJobResult = new CreateExportJobResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobId", targetDepth)) {
                    context.nextToken();
                    createExportJobResult.setJobId(context.getUnmarshaller(String.class).unmarshall(context));
                }
