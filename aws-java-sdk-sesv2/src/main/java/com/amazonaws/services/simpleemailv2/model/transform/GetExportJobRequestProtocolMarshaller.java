...
public class GetExportJobRequestProtocolMarshaller implements Marshaller<Request<GetExportJobRequest>, GetExportJobRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON).requestUri("/v2/email/export-jobs/{JobId}")
            .httpMethodName(HttpMethodName.GET).hasExplicitPayloadMember(false).hasPayloadMembers(false).serviceName("AmazonSimpleEmailServiceV2").build();
