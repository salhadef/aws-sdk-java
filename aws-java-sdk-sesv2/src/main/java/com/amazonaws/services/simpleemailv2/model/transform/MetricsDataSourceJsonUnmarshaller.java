...
/**
 * MetricsDataSource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricsDataSourceJsonUnmarshaller implements Unmarshaller<MetricsDataSource, JsonUnmarshallerContext> {

    public MetricsDataSource unmarshall(JsonUnmarshallerContext context) throws Exception {
        MetricsDataSource metricsDataSource = new MetricsDataSource();
    ...
    private static MetricsDataSourceJsonUnmarshaller instance;

    public static MetricsDataSourceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MetricsDataSourceJsonUnmarshaller();
        return instance;
    }
}
