...
public class ExportDestinationMarshaller {
    ...
    public void marshall(ExportDestination exportDestination, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(exportDestination.getDataFormat(), DATAFORMAT_BINDING);
            protocolMarshaller.marshall(exportDestination.getS3Url(), S3URL_BINDING);
        } catch (Exception e) {
