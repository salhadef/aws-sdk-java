...
/**
 * CancelExportJobResult JSON Unmarshaller
 */
...
public class CancelExportJobResultJsonUnmarshaller implements Unmarshaller<CancelExportJobResult, JsonUnmarshallerContext> {
    ...
    public CancelExportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelExportJobResult cancelExportJobResult = new CancelExportJobResult();

        return cancelExportJobResult;
    }
