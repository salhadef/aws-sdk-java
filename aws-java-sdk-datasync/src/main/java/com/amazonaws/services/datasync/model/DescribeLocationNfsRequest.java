...
public class DescribeLocationNfsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the Amazon Resource Name (ARN) of the NFS location that you want information about.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeLocationNfsRequest == false)
            return false;
        DescribeLocationNfsRequest other = (DescribeLocationNfsRequest) obj;
    ...
    @Override
    public DescribeLocationNfsRequest clone() {
        return (DescribeLocationNfsRequest) super.clone();
    }
