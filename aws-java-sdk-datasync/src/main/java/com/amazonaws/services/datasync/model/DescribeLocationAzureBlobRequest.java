...
public class DescribeLocationAzureBlobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the Amazon Resource Name (ARN) of your Azure Blob Storage transfer location.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeLocationAzureBlobRequest == false)
            return false;
        DescribeLocationAzureBlobRequest other = (DescribeLocationAzureBlobRequest) obj;
    ...
    public DescribeLocationAzureBlobRequest clone() {
        return (DescribeLocationAzureBlobRequest) super.clone();
    }
