...
public class CreateLocationAzureBlobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the Azure Blob Storage transfer location that you created.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLocationAzureBlobResult == false)
            return false;
        CreateLocationAzureBlobResult other = (CreateLocationAzureBlobResult) obj;
    ...
    public CreateLocationAzureBlobResult clone() {
        try {
            return (CreateLocationAzureBlobResult) super.clone();
