...
public class CreateLocationNfsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLocationNfsResult == false)
            return false;
        CreateLocationNfsResult other = (CreateLocationNfsResult) obj;
    ...
    public CreateLocationNfsResult clone() {
        try {
            return (CreateLocationNfsResult) super.clone();
