...
/**
 * ReportOverrides JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReportOverridesJsonUnmarshaller implements Unmarshaller<ReportOverrides, JsonUnmarshallerContext> {

    public ReportOverrides unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ReportOverridesJsonUnmarshaller instance;

    public static ReportOverridesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReportOverridesJsonUnmarshaller();
        return instance;
    }
}
