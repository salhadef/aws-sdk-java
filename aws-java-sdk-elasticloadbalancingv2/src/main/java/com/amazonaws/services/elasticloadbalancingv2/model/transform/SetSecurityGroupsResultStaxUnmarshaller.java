...
public class SetSecurityGroupsResultStaxUnmarshaller implements Unmarshaller<SetSecurityGroupsResult, StaxUnmarshallerContext> {

    public SetSecurityGroupsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        SetSecurityGroupsResult setSecurityGroupsResult = new SetSecurityGroupsResult();
    ...
    private static SetSecurityGroupsResultStaxUnmarshaller instance;

    public static SetSecurityGroupsResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new SetSecurityGroupsResultStaxUnmarshaller();
        return instance;
    }
}
