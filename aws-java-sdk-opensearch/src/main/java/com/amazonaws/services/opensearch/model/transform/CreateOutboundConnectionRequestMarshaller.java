...
public class CreateOutboundConnectionRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> LOCALDOMAININFO_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("LocalDomainInfo").build();
    private static final MarshallingInfo<StructuredPojo> REMOTEDOMAININFO_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public static CreateOutboundConnectionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateOutboundConnectionRequest createOutboundConnectionRequest, ProtocolMarshaller protocolMarshaller) {
