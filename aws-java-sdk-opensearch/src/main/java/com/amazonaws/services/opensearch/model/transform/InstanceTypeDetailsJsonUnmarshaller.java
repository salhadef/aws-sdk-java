...
/**
 * InstanceTypeDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceTypeDetailsJsonUnmarshaller implements Unmarshaller<InstanceTypeDetails, JsonUnmarshallerContext> {

    public InstanceTypeDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static InstanceTypeDetailsJsonUnmarshaller instance;

    public static InstanceTypeDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstanceTypeDetailsJsonUnmarshaller();
        return instance;
    }
}
