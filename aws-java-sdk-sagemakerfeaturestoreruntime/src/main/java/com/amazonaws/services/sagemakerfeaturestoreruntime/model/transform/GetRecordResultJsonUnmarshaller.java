...
/**
 * GetRecordResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetRecordResultJsonUnmarshaller implements Unmarshaller<GetRecordResult, JsonUnmarshallerContext> {

    public GetRecordResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetRecordResult getRecordResult = new GetRecordResult();
    ...
    private static GetRecordResultJsonUnmarshaller instance;

    public static GetRecordResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetRecordResultJsonUnmarshaller();
        return instance;
    }
}
