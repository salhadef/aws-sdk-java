 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/customer-profiles-2020-08-15/Profile" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Profile implements Serializable, Cloneable, StructuredPojo {
     ...
     *
     * @see Profile#withAttributes
     * @returns a reference to this object so that method calls can be chained together.
     */

    public Profile addAttributesEntry(String key, String value) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.customerprofiles.model.transform.ProfileMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
