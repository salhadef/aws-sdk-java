...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/customer-profiles-2020-08-15/GetDomain" target="_top">AWS API
 *      Documentation</a>
 */
...
public class GetDomainResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetDomainResult withDomainName(String domainName) {
    ...
    public GetDomainResult withDefaultExpirationDays(Integer defaultExpirationDays) {
    ...
    public GetDomainResult withDefaultEncryptionKey(String defaultEncryptionKey) {
    ...
    public GetDomainResult withDeadLetterQueueUrl(String deadLetterQueueUrl) {
    ...
    public void setStats(DomainStats stats) {
        this.stats = stats;
    }
    ...
    public GetDomainResult withStats(DomainStats stats) {
        setStats(stats);
        return this;
    }
