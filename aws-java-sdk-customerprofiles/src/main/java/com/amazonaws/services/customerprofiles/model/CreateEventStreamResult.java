...
public class CreateEventStreamResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateEventStreamResult withEventStreamArn(String eventStreamArn) {
    ...
    public CreateEventStreamResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateEventStreamResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateEventStreamResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateEventStreamResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateEventStreamResult == false)
            return false;
        CreateEventStreamResult other = (CreateEventStreamResult) obj;
    ...
    @Override
    public CreateEventStreamResult clone() {
        try {
            return (CreateEventStreamResult) super.clone();
