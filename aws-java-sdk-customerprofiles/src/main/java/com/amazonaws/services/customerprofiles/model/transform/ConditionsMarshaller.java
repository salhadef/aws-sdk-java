...
public class ConditionsMarshaller {
    ...
    private static final MarshallingInfo<Integer> OBJECTCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ObjectCount").build();
    ...
    public void marshall(Conditions conditions, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(conditions.getRange(), RANGE_BINDING);
            protocolMarshaller.marshall(conditions.getObjectCount(), OBJECTCOUNT_BINDING);
            protocolMarshaller.marshall(conditions.getThreshold(), THRESHOLD_BINDING);
        } catch (Exception e) {
