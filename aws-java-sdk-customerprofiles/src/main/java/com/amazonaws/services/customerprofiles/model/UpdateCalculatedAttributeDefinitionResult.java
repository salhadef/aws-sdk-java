...
public class UpdateCalculatedAttributeDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateCalculatedAttributeDefinitionResult withCreatedAt(java.util.Date createdAt) {
    ...
    public UpdateCalculatedAttributeDefinitionResult withLastUpdatedAt(java.util.Date lastUpdatedAt) {
     ...
     * </p>
     * 
     * @return The mathematical expression and a list of attribute items specified in that expression.
     */
    ...
    public UpdateCalculatedAttributeDefinitionResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateCalculatedAttributeDefinitionResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateCalculatedAttributeDefinitionResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateCalculatedAttributeDefinitionResult == false)
            return false;
        UpdateCalculatedAttributeDefinitionResult other = (UpdateCalculatedAttributeDefinitionResult) obj;
    ...
    public UpdateCalculatedAttributeDefinitionResult clone() {
        try {
            return (UpdateCalculatedAttributeDefinitionResult) super.clone();
