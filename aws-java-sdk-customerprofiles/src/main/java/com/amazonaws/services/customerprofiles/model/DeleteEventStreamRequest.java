...
public class DeleteEventStreamRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteEventStreamRequest withDomainName(String domainName) {
    ...
    public DeleteEventStreamRequest withEventStreamName(String eventStreamName) {
    ...
    public String toString() {
        ...
        if (getEventStreamName() != null)
            sb.append("EventStreamName: ").append(getEventStreamName());
        sb.append("}");
        return sb.toString();
    }
