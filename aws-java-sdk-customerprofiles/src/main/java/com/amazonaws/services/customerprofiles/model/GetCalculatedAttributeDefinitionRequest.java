...
public class GetCalculatedAttributeDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetCalculatedAttributeDefinitionRequest withDomainName(String domainName) {
    ...
    public GetCalculatedAttributeDefinitionRequest withCalculatedAttributeName(String calculatedAttributeName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCalculatedAttributeDefinitionRequest == false)
            return false;
        GetCalculatedAttributeDefinitionRequest other = (GetCalculatedAttributeDefinitionRequest) obj;
    ...
    @Override
    public GetCalculatedAttributeDefinitionRequest clone() {
        return (GetCalculatedAttributeDefinitionRequest) super.clone();
    }
