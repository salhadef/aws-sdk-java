...
public class DeleteCalculatedAttributeDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteCalculatedAttributeDefinitionRequest withDomainName(String domainName) {
    ...
    public DeleteCalculatedAttributeDefinitionRequest withCalculatedAttributeName(String calculatedAttributeName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteCalculatedAttributeDefinitionRequest == false)
            return false;
        DeleteCalculatedAttributeDefinitionRequest other = (DeleteCalculatedAttributeDefinitionRequest) obj;
    ...
    @Override
    public DeleteCalculatedAttributeDefinitionRequest clone() {
