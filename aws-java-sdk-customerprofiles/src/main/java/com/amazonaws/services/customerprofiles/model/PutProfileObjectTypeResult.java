...
public class PutProfileObjectTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The format of your <code>sourceLastUpdatedTimestamp</code> that was previously set up in fields that were parsed
     * using <a href="https://docs.oracle.com/javase/10/docs/api/java/text/SimpleDateFormat.html">SimpleDateFormat</a>.
    ...
    public PutProfileObjectTypeResult withObjectTypeName(String objectTypeName) {
    ...
    public PutProfileObjectTypeResult withDescription(String description) {
    ...
    public PutProfileObjectTypeResult withTemplateId(String templateId) {
    ...
    public PutProfileObjectTypeResult withExpirationDays(Integer expirationDays) {
    ...
    public PutProfileObjectTypeResult withEncryptionKey(String encryptionKey) {
    ...
    public PutProfileObjectTypeResult withAllowProfileCreation(Boolean allowProfileCreation) {
     ...
     *        The format of your <code>sourceLastUpdatedTimestamp</code> that was previously set up in fields that were
     *        parsed using <a
     *        href="https://docs.oracle.com/javase/10/docs/api/java/text/SimpleDateFormat.html">SimpleDateFormat</a>. If
     *        you have <code>sourceLastUpdatedTimestamp</code> in your field, you must set up
     *        <code>sourceLastUpdatedTimestampFormat</code>.
     */
     ...
     * </p>
     * 
     * @return The format of your <code>sourceLastUpdatedTimestamp</code> that was previously set up in fields that were
     *         parsed using <a
    ...
    public PutProfileObjectTypeResult withSourceLastUpdatedTimestampFormat(String sourceLastUpdatedTimestampFormat) {
    ...
    public PutProfileObjectTypeResult withFields(java.util.Map<String, ObjectTypeField> fields) {
        setFields(fields);
        return this;
    }
     ...
     *
     * @see PutProfileObjectTypeResult#withFields
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PutProfileObjectTypeResult addFieldsEntry(String key, ObjectTypeField value) {
        if (null == this.fields) {
    ...
    public PutProfileObjectTypeResult clearFieldsEntries() {
        this.fields = null;
        return this;
    }
    ...
    public PutProfileObjectTypeResult withKeys(java.util.Map<String, java.util.List<ObjectTypeKey>> keys) {
        setKeys(keys);
        return this;
    }
     ...
     *
     * @see PutProfileObjectTypeResult#withKeys
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PutProfileObjectTypeResult addKeysEntry(String key, java.util.List<ObjectTypeKey> value) {
        if (null == this.keys) {
    ...
    public PutProfileObjectTypeResult clearKeysEntries() {
        this.keys = null;
        return this;
    }
    ...
    public PutProfileObjectTypeResult withCreatedAt(java.util.Date createdAt) {
    ...
    public PutProfileObjectTypeResult withLastUpdatedAt(java.util.Date lastUpdatedAt) {
    ...
    public PutProfileObjectTypeResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see PutProfileObjectTypeResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PutProfileObjectTypeResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public PutProfileObjectTypeResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutProfileObjectTypeResult == false)
            return false;
        PutProfileObjectTypeResult other = (PutProfileObjectTypeResult) obj;
    ...
    @Override
    public PutProfileObjectTypeResult clone() {
        try {
            return (PutProfileObjectTypeResult) super.clone();
