...
public class CreateCalculatedAttributeDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateCalculatedAttributeDefinitionResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateCalculatedAttributeDefinitionResult withLastUpdatedAt(java.util.Date lastUpdatedAt) {
    ...
    public CreateCalculatedAttributeDefinitionResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateCalculatedAttributeDefinitionResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateCalculatedAttributeDefinitionResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCalculatedAttributeDefinitionResult == false)
            return false;
        CreateCalculatedAttributeDefinitionResult other = (CreateCalculatedAttributeDefinitionResult) obj;
    ...
    public CreateCalculatedAttributeDefinitionResult clone() {
        try {
            return (CreateCalculatedAttributeDefinitionResult) super.clone();
