...
/**
 * DatasetOrgAttributesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DatasetOrgAttributesMarshaller {
    ...
    private static final DatasetOrgAttributesMarshaller instance = new DatasetOrgAttributesMarshaller();

    public static DatasetOrgAttributesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DatasetOrgAttributes datasetOrgAttributes, ProtocolMarshaller protocolMarshaller) {

        if (datasetOrgAttributes == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(datasetOrgAttributes.getGdg(), GDG_BINDING);
            protocolMarshaller.marshall(datasetOrgAttributes.getPo(), PO_BINDING);
            protocolMarshaller.marshall(datasetOrgAttributes.getPs(), PS_BINDING);
            protocolMarshaller.marshall(datasetOrgAttributes.getVsam(), VSAM_BINDING);
        } catch (Exception e) {
