 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/m2-2021-04-28/HighAvailabilityConfig" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HighAvailabilityConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HighAvailabilityConfig == false)
            return false;
        HighAvailabilityConfig other = (HighAvailabilityConfig) obj;
    ...
    public HighAvailabilityConfig clone() {
        try {
            return (HighAvailabilityConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mainframemodernization.model.transform.HighAvailabilityConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
