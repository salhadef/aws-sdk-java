...
/**
 * S3BatchJobIdentifierMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class S3BatchJobIdentifierMarshaller {
    ...
    private static final S3BatchJobIdentifierMarshaller instance = new S3BatchJobIdentifierMarshaller();

    public static S3BatchJobIdentifierMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(S3BatchJobIdentifier s3BatchJobIdentifier, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3BatchJobIdentifier.getBucket(), BUCKET_BINDING);
            protocolMarshaller.marshall(s3BatchJobIdentifier.getIdentifier(), IDENTIFIER_BINDING);
            protocolMarshaller.marshall(s3BatchJobIdentifier.getKeyPrefix(), KEYPREFIX_BINDING);
        } catch (Exception e) {
