...
/**
 * DatasetOrgAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DatasetOrgAttributesJsonUnmarshaller implements Unmarshaller<DatasetOrgAttributes, JsonUnmarshallerContext> {

    public DatasetOrgAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        DatasetOrgAttributes datasetOrgAttributes = new DatasetOrgAttributes();
    ...
    private static DatasetOrgAttributesJsonUnmarshaller instance;

    public static DatasetOrgAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DatasetOrgAttributesJsonUnmarshaller();
        return instance;
    }
}
