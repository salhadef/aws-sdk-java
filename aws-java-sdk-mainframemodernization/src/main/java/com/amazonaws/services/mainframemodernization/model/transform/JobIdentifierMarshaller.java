...
/**
 * JobIdentifierMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class JobIdentifierMarshaller {
    ...
    private static final JobIdentifierMarshaller instance = new JobIdentifierMarshaller();

    public static JobIdentifierMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(JobIdentifier jobIdentifier, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(jobIdentifier.getFileName(), FILENAME_BINDING);
            protocolMarshaller.marshall(jobIdentifier.getScriptName(), SCRIPTNAME_BINDING);
        } catch (Exception e) {
