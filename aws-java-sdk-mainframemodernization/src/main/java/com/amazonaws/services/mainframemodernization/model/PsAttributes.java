 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/m2-2021-04-28/PsAttributes" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PsAttributes implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PsAttributes == false)
            return false;
        PsAttributes other = (PsAttributes) obj;
    ...
    @Override
    public PsAttributes clone() {
        try {
            return (PsAttributes) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mainframemodernization.model.transform.PsAttributesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
