...
/**
 * BatchJobIdentifierMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BatchJobIdentifierMarshaller {
    ...
    private static final BatchJobIdentifierMarshaller instance = new BatchJobIdentifierMarshaller();

    public static BatchJobIdentifierMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchJobIdentifier batchJobIdentifier, ProtocolMarshaller protocolMarshaller) {
