...
/**
 * ExecutionStartedEventDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExecutionStartedEventDetailsJsonUnmarshaller implements Unmarshaller<ExecutionStartedEventDetails, JsonUnmarshallerContext> {

    public ExecutionStartedEventDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExecutionStartedEventDetails executionStartedEventDetails = new ExecutionStartedEventDetails();
    ...
    private static ExecutionStartedEventDetailsJsonUnmarshaller instance;

    public static ExecutionStartedEventDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExecutionStartedEventDetailsJsonUnmarshaller();
        return instance;
    }
}
