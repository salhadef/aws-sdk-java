...
public class ListStateMachineVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListStateMachineVersionsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListStateMachineVersionsRequest == false)
            return false;
        ListStateMachineVersionsRequest other = (ListStateMachineVersionsRequest) obj;
    ...
    @Override
    public ListStateMachineVersionsRequest clone() {
        return (ListStateMachineVersionsRequest) super.clone();
    }
