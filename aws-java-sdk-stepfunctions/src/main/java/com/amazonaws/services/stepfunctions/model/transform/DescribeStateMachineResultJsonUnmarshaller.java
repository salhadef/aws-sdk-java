...
/**
 * DescribeStateMachineResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeStateMachineResultJsonUnmarshaller implements Unmarshaller<DescribeStateMachineResult, JsonUnmarshallerContext> {

    public DescribeStateMachineResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("stateMachineArn", targetDepth)) {
                    context.nextToken();
                    describeStateMachineResult.setStateMachineArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    describeStateMachineResult.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    describeStateMachineResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("definition", targetDepth)) {
                    context.nextToken();
                    describeStateMachineResult.setDefinition(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static DescribeStateMachineResultJsonUnmarshaller instance;

    public static DescribeStateMachineResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeStateMachineResultJsonUnmarshaller();
        return instance;
    }
}
