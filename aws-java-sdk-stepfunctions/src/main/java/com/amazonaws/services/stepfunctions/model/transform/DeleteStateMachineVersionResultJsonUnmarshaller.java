...
/**
 * DeleteStateMachineVersionResult JSON Unmarshaller
 */
...
public class DeleteStateMachineVersionResultJsonUnmarshaller implements Unmarshaller<DeleteStateMachineVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteStateMachineVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteStateMachineVersionResult deleteStateMachineVersionResult = new DeleteStateMachineVersionResult();

        return deleteStateMachineVersionResult;
    }
