...
/**
 * DeleteStateMachineAliasResult JSON Unmarshaller
 */
...
public class DeleteStateMachineAliasResultJsonUnmarshaller implements Unmarshaller<DeleteStateMachineAliasResult, JsonUnmarshallerContext> {
    ...
    public DeleteStateMachineAliasResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteStateMachineAliasResult deleteStateMachineAliasResult = new DeleteStateMachineAliasResult();

        return deleteStateMachineAliasResult;
    }
