...
public class ListStateMachineAliasesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        The Amazon Resource Name (ARN) of the state machine for which you want to list aliases.</p>
     *        <p>
     *        If you specify a state machine version ARN, this API returns a list of aliases for that version.
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the state machine for which you want to list aliases.</p>
     *         <p>
     *         If you specify a state machine version ARN, this API returns a list of aliases for that version.
     */
    ...
    public ListStateMachineAliasesRequest withStateMachineArn(String stateMachineArn) {
    ...
    public ListStateMachineAliasesRequest withNextToken(String nextToken) {
    ...
    public ListStateMachineAliasesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListStateMachineAliasesRequest == false)
            return false;
        ListStateMachineAliasesRequest other = (ListStateMachineAliasesRequest) obj;
    ...
    @Override
    public ListStateMachineAliasesRequest clone() {
        return (ListStateMachineAliasesRequest) super.clone();
    }
