...
/**
 * DeleteProfileResult JSON Unmarshaller
 */
...
public class DeleteProfileResultJsonUnmarshaller implements Unmarshaller<DeleteProfileResult, JsonUnmarshallerContext> {
    ...
    public DeleteProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteProfileResult deleteProfileResult = new DeleteProfileResult();
