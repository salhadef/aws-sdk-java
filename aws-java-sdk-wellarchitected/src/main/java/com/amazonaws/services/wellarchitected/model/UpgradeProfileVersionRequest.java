...
public class UpgradeProfileVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpgradeProfileVersionRequest withWorkloadId(String workloadId) {
    ...
    public UpgradeProfileVersionRequest withProfileArn(String profileArn) {
    ...
    public UpgradeProfileVersionRequest withMilestoneName(String milestoneName) {
    ...
    public UpgradeProfileVersionRequest withClientRequestToken(String clientRequestToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpgradeProfileVersionRequest == false)
            return false;
        UpgradeProfileVersionRequest other = (UpgradeProfileVersionRequest) obj;
    ...
    @Override
    public UpgradeProfileVersionRequest clone() {
        return (UpgradeProfileVersionRequest) super.clone();
    }
