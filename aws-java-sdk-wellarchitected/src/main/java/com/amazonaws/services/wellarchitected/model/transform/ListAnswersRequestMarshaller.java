...
/**
 * ListAnswersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListAnswersRequestMarshaller {
    ...
    public static ListAnswersRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListAnswersRequest listAnswersRequest, ProtocolMarshaller protocolMarshaller) {

        if (listAnswersRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listAnswersRequest.getWorkloadId(), WORKLOADID_BINDING);
            protocolMarshaller.marshall(listAnswersRequest.getLensAlias(), LENSALIAS_BINDING);
            protocolMarshaller.marshall(listAnswersRequest.getPillarId(), PILLARID_BINDING);
