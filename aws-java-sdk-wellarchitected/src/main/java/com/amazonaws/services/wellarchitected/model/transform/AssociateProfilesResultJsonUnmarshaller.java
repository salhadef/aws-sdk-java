...
/**
 * AssociateProfilesResult JSON Unmarshaller
 */
...
public class AssociateProfilesResultJsonUnmarshaller implements Unmarshaller<AssociateProfilesResult, JsonUnmarshallerContext> {
    ...
    public AssociateProfilesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateProfilesResult associateProfilesResult = new AssociateProfilesResult();

        return associateProfilesResult;
    }
