...
/**
 * PillarReviewSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PillarReviewSummaryMarshaller {
    ...
    public static PillarReviewSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PillarReviewSummary pillarReviewSummary, ProtocolMarshaller protocolMarshaller) {

        if (pillarReviewSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(pillarReviewSummary.getPillarId(), PILLARID_BINDING);
