...
/**
 * ProfileNotificationSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProfileNotificationSummaryJsonUnmarshaller implements Unmarshaller<ProfileNotificationSummary, JsonUnmarshallerContext> {

    public ProfileNotificationSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ProfileNotificationSummary profileNotificationSummary = new ProfileNotificationSummary();
    ...
    private static ProfileNotificationSummaryJsonUnmarshaller instance;

    public static ProfileNotificationSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProfileNotificationSummaryJsonUnmarshaller();
        return instance;
    }
}
