...
public class ListLensReviewImprovementsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListLensReviewImprovementsRequest withMilestoneNumber(Integer milestoneNumber) {
    ...
    public ListLensReviewImprovementsRequest withMaxResults(Integer maxResults) {
    ...
    public ListLensReviewImprovementsRequest withQuestionPriority(String questionPriority) {
    ...
    public ListLensReviewImprovementsRequest withQuestionPriority(QuestionPriority questionPriority) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLensReviewImprovementsRequest == false)
            return false;
        ListLensReviewImprovementsRequest other = (ListLensReviewImprovementsRequest) obj;
    ...
    @Override
    public ListLensReviewImprovementsRequest clone() {
        return (ListLensReviewImprovementsRequest) super.clone();
    }
