...
public class ProfileSummaryMarshaller {
    ...
    public void marshall(ProfileSummary profileSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(profileSummary.getProfileArn(), PROFILEARN_BINDING);
            protocolMarshaller.marshall(profileSummary.getProfileVersion(), PROFILEVERSION_BINDING);
            protocolMarshaller.marshall(profileSummary.getProfileName(), PROFILENAME_BINDING);
            protocolMarshaller.marshall(profileSummary.getProfileDescription(), PROFILEDESCRIPTION_BINDING);
            protocolMarshaller.marshall(profileSummary.getOwner(), OWNER_BINDING);
            protocolMarshaller.marshall(profileSummary.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(profileSummary.getUpdatedAt(), UPDATEDAT_BINDING);
        } catch (Exception e) {
