...
/**
 * DisassociateProfilesResult JSON Unmarshaller
 */
...
public class DisassociateProfilesResultJsonUnmarshaller implements Unmarshaller<DisassociateProfilesResult, JsonUnmarshallerContext> {
    ...
    public DisassociateProfilesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateProfilesResult disassociateProfilesResult = new DisassociateProfilesResult();

        return disassociateProfilesResult;
    }
