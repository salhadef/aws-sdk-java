...
/**
 * ProfileChoiceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ProfileChoiceMarshaller {
    ...
    private static final ProfileChoiceMarshaller instance = new ProfileChoiceMarshaller();

    public static ProfileChoiceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ProfileChoice profileChoice, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(profileChoice.getChoiceId(), CHOICEID_BINDING);
            protocolMarshaller.marshall(profileChoice.getChoiceTitle(), CHOICETITLE_BINDING);
            protocolMarshaller.marshall(profileChoice.getChoiceDescription(), CHOICEDESCRIPTION_BINDING);
        } catch (Exception e) {
