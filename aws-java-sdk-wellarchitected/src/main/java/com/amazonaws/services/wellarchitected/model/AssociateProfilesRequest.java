...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wellarchitected-2020-03-31/AssociateProfiles" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssociateProfilesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The list of profile ARNs to associate with the workload.
     */
    ...
    public AssociateProfilesRequest withProfileArns(String... profileArns) {
    ...
    public AssociateProfilesRequest withProfileArns(java.util.Collection<String> profileArns) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateProfilesRequest == false)
            return false;
        AssociateProfilesRequest other = (AssociateProfilesRequest) obj;
