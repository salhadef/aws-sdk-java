...
/**
 * DeleteTemplateShareResult JSON Unmarshaller
 */
...
public class DeleteTemplateShareResultJsonUnmarshaller implements Unmarshaller<DeleteTemplateShareResult, JsonUnmarshallerContext> {
    ...
    public DeleteTemplateShareResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTemplateShareResult deleteTemplateShareResult = new DeleteTemplateShareResult();

        return deleteTemplateShareResult;
    }
