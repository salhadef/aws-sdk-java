 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wellarchitected-2020-03-31/ReviewTemplateAnswer"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReviewTemplateAnswer implements Serializable, Cloneable, StructuredPojo {
     ...
     *        The helpful resource text to be displayed for a custom lens.</p> <note>
     *        <p>
     *        This field does not apply to Amazon Web Services official lenses.
     *        </p>
     */
     ...
     * </note>
     * 
     * @return The helpful resource text to be displayed for a custom lens.</p> <note>
     *         <p>
     *         This field does not apply to Amazon Web Services official lenses.
     *         </p>
     */
    ...
    public ReviewTemplateAnswer withChoices(java.util.Collection<Choice> choices) {
        setChoices(choices);
        return this;
    }
    ...
    public ReviewTemplateAnswer withSelectedChoices(java.util.Collection<String> selectedChoices) {
     ...
     * </p>
     * 
     * @return A list of selected choices to a question in your review template.
     */
    ...
    public ReviewTemplateAnswer withChoiceAnswers(ChoiceAnswer... choiceAnswers) {
    ...
    public ReviewTemplateAnswer withChoiceAnswers(java.util.Collection<ChoiceAnswer> choiceAnswers) {
     ...
     * </p>
     * 
     * @return The reason why the question is not applicable to your review template.
     * @see AnswerReason
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReviewTemplateAnswer == false)
            return false;
    ...
    public ReviewTemplateAnswer clone() {
        try {
            return (ReviewTemplateAnswer) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.wellarchitected.model.transform.ReviewTemplateAnswerMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
