...
/**
 * ListShareInvitationsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListShareInvitationsRequestMarshaller {
    ...
    public static ListShareInvitationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListShareInvitationsRequest listShareInvitationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listShareInvitationsRequest == null) {
