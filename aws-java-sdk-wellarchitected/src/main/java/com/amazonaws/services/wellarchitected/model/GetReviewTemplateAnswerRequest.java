...
public class GetReviewTemplateAnswerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetReviewTemplateAnswerRequest withTemplateArn(String templateArn) {
    ...
    public GetReviewTemplateAnswerRequest withLensAlias(String lensAlias) {
    ...
    public GetReviewTemplateAnswerRequest withQuestionId(String questionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetReviewTemplateAnswerRequest == false)
            return false;
        GetReviewTemplateAnswerRequest other = (GetReviewTemplateAnswerRequest) obj;
    ...
    @Override
    public GetReviewTemplateAnswerRequest clone() {
        return (GetReviewTemplateAnswerRequest) super.clone();
    }
