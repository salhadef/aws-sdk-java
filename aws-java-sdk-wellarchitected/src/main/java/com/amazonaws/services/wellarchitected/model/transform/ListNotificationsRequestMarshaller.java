...
public class ListNotificationsRequestMarshaller {
    ...
    public void marshall(ListNotificationsRequest listNotificationsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listNotificationsRequest.getWorkloadId(), WORKLOADID_BINDING);
            ...
            protocolMarshaller.marshall(listNotificationsRequest.getResourceArn(), RESOURCEARN_BINDING);
        } catch (Exception e) {
