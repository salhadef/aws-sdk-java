...
public class UpdateProfileRequestMarshaller {
    ...
    public void marshall(UpdateProfileRequest updateProfileRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateProfileRequest.getProfileDescription(), PROFILEDESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateProfileRequest.getProfileQuestions(), PROFILEQUESTIONS_BINDING);
        } catch (Exception e) {
