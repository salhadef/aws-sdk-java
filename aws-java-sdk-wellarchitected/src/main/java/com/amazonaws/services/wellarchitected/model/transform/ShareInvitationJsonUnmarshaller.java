...
/**
 * ShareInvitation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ShareInvitationJsonUnmarshaller implements Unmarshaller<ShareInvitation, JsonUnmarshallerContext> {

    public ShareInvitation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("TemplateArn", targetDepth)) {
                    context.nextToken();
                    shareInvitation.setTemplateArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ShareInvitationJsonUnmarshaller instance;

    public static ShareInvitationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ShareInvitationJsonUnmarshaller();
        return instance;
    }
}
