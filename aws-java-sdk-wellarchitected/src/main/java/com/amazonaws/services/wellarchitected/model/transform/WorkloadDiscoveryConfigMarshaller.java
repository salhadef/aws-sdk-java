...
/**
 * WorkloadDiscoveryConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class WorkloadDiscoveryConfigMarshaller {
    ...
    public static WorkloadDiscoveryConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(WorkloadDiscoveryConfig workloadDiscoveryConfig, ProtocolMarshaller protocolMarshaller) {

        if (workloadDiscoveryConfig == null) {
