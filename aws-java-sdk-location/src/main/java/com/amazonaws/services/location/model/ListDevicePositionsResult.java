...
public class ListDevicePositionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListDevicePositionsResult withEntries(ListDevicePositionsResponseEntry... entries) {
        if (this.entries == null) {
            setEntries(new java.util.ArrayList<ListDevicePositionsResponseEntry>(entries.length));
        }
        for (ListDevicePositionsResponseEntry ele : entries) {
    ...
    public ListDevicePositionsResult withEntries(java.util.Collection<ListDevicePositionsResponseEntry> entries) {
        setEntries(entries);
        return this;
    }
    ...
    @Override
    public ListDevicePositionsResult clone() {
        try {
            return (ListDevicePositionsResult) super.clone();
