...
public class BatchPutGeofenceRequestEntry implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchPutGeofenceRequestEntry withGeofenceProperties(java.util.Map<String, String> geofenceProperties) {
     ...
     *
     * @see BatchPutGeofenceRequestEntry#withGeofenceProperties
