...
public class ListGeofenceResponseEntry implements Serializable, Cloneable, StructuredPojo {
    ...
    public ListGeofenceResponseEntry clone() {
        try {
            return (ListGeofenceResponseEntry) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.location.model.transform.ListGeofenceResponseEntryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
