...
/**
 * BatchPutGeofenceRequestEntryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BatchPutGeofenceRequestEntryMarshaller {
    ...
    public static BatchPutGeofenceRequestEntryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchPutGeofenceRequestEntry batchPutGeofenceRequestEntry, ProtocolMarshaller protocolMarshaller) {

        if (batchPutGeofenceRequestEntry == null) {
