...
/**
 * SearchForSuggestionsResultMarshaller
 */
...
public class SearchForSuggestionsResultMarshaller {
    ...
    public static SearchForSuggestionsResultMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SearchForSuggestionsResult searchForSuggestionsResult, ProtocolMarshaller protocolMarshaller) {

        if (searchForSuggestionsResult == null) {
