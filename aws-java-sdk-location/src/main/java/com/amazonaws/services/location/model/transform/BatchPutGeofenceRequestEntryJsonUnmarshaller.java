...
/**
 * BatchPutGeofenceRequestEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchPutGeofenceRequestEntryJsonUnmarshaller implements Unmarshaller<BatchPutGeofenceRequestEntry, JsonUnmarshallerContext> {

    public BatchPutGeofenceRequestEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
