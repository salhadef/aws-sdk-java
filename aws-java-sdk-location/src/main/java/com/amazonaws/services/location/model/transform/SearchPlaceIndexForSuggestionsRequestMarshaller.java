...
public class SearchPlaceIndexForSuggestionsRequestMarshaller {
    ...
    private static final SearchPlaceIndexForSuggestionsRequestMarshaller instance = new SearchPlaceIndexForSuggestionsRequestMarshaller();

    public static SearchPlaceIndexForSuggestionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SearchPlaceIndexForSuggestionsRequest searchPlaceIndexForSuggestionsRequest, ProtocolMarshaller protocolMarshaller) {
