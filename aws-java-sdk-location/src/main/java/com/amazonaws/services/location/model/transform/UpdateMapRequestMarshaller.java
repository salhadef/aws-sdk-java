...
public class UpdateMapRequestMarshaller {
    ...
    private static final UpdateMapRequestMarshaller instance = new UpdateMapRequestMarshaller();

    public static UpdateMapRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateMapRequest updateMapRequest, ProtocolMarshaller protocolMarshaller) {
