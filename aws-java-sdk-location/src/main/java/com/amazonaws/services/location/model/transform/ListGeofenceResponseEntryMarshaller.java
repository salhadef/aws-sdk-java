...
/**
 * ListGeofenceResponseEntryMarshaller
 */
...
public class ListGeofenceResponseEntryMarshaller {
    ...
    public static ListGeofenceResponseEntryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListGeofenceResponseEntry listGeofenceResponseEntry, ProtocolMarshaller protocolMarshaller) {

        if (listGeofenceResponseEntry == null) {
