 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/MemoryDBInstanceDetails" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MemoryDBInstanceDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public MemoryDBInstanceDetails withFamily(String family) {
        setFamily(family);
        return this;
    }
     ...
     * </p>
     * 
     * @return The node type of the recommended reservation.
     */
    ...
    public MemoryDBInstanceDetails withNodeType(String nodeType) {
    ...
    public MemoryDBInstanceDetails withRegion(String region) {
        setRegion(region);
        return this;
    }
    ...
    public MemoryDBInstanceDetails withCurrentGeneration(Boolean currentGeneration) {
    ...
    public MemoryDBInstanceDetails withSizeFlexEligible(Boolean sizeFlexEligible) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MemoryDBInstanceDetails == false)
            return false;
        MemoryDBInstanceDetails other = (MemoryDBInstanceDetails) obj;
    ...
    @Override
    public MemoryDBInstanceDetails clone() {
        try {
            return (MemoryDBInstanceDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.costexplorer.model.transform.MemoryDBInstanceDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
