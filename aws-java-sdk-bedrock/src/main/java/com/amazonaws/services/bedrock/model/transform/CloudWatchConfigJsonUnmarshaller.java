...
/**
 * CloudWatchConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CloudWatchConfigJsonUnmarshaller implements Unmarshaller<CloudWatchConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("logGroupName", targetDepth)) {
                    context.nextToken();
                    cloudWatchConfig.setLogGroupName(context.getUnmarshaller(String.class).unmarshall(context));
                }
