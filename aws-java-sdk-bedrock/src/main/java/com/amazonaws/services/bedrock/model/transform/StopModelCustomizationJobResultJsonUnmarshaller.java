...
/**
 * StopModelCustomizationJobResult JSON Unmarshaller
 */
...
public class StopModelCustomizationJobResultJsonUnmarshaller implements Unmarshaller<StopModelCustomizationJobResult, JsonUnmarshallerContext> {
    ...
    public StopModelCustomizationJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopModelCustomizationJobResult stopModelCustomizationJobResult = new StopModelCustomizationJobResult();
