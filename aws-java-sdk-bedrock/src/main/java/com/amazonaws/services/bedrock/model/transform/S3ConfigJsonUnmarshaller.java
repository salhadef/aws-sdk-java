        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("bucketName", targetDepth)) {
                    context.nextToken();
                    s3Config.setBucketName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("keyPrefix", targetDepth)) {
                    context.nextToken();
                    s3Config.setKeyPrefix(context.getUnmarshaller(String.class).unmarshall(context));
                }
