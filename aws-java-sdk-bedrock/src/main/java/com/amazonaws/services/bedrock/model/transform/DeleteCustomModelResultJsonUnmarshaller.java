...
/**
 * DeleteCustomModelResult JSON Unmarshaller
 */
...
public class DeleteCustomModelResultJsonUnmarshaller implements Unmarshaller<DeleteCustomModelResult, JsonUnmarshallerContext> {
    ...
    public DeleteCustomModelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCustomModelResult deleteCustomModelResult = new DeleteCustomModelResult();
