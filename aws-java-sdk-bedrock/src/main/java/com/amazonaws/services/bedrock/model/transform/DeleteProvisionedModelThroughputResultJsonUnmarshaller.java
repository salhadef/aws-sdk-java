...
/**
 * DeleteProvisionedModelThroughputResult JSON Unmarshaller
 */
...
public class DeleteProvisionedModelThroughputResultJsonUnmarshaller implements Unmarshaller<DeleteProvisionedModelThroughputResult, JsonUnmarshallerContext> {
    ...
    public DeleteProvisionedModelThroughputResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteProvisionedModelThroughputResult deleteProvisionedModelThroughputResult = new DeleteProvisionedModelThroughputResult();
