...
@SdkInternalApi
public class UpdatePhoneNumberRequestItemMarshaller {
    ...
    public static UpdatePhoneNumberRequestItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdatePhoneNumberRequestItem updatePhoneNumberRequestItem, ProtocolMarshaller protocolMarshaller) {

        if (updatePhoneNumberRequestItem == null) {
