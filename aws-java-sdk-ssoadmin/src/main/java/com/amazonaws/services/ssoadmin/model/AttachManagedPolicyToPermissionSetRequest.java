...
public class AttachManagedPolicyToPermissionSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Web Services managed policy ARN to be attached to a permission set.
     */
    ...
    public String toString() {
        ...
        if (getManagedPolicyArn() != null)
            sb.append("ManagedPolicyArn: ").append(getManagedPolicyArn()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttachManagedPolicyToPermissionSetRequest == false)
            return false;
    ...
    public AttachManagedPolicyToPermissionSetRequest clone() {
        return (AttachManagedPolicyToPermissionSetRequest) super.clone();
    }
