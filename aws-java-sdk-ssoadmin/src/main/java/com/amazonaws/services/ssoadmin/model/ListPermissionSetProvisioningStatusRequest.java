...
public class ListPermissionSetProvisioningStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListPermissionSetProvisioningStatusRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPermissionSetProvisioningStatusRequest == false)
            return false;
        ListPermissionSetProvisioningStatusRequest other = (ListPermissionSetProvisioningStatusRequest) obj;
    ...
    @Override
    public ListPermissionSetProvisioningStatusRequest clone() {
        return (ListPermissionSetProvisioningStatusRequest) super.clone();
    }
