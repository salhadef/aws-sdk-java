...
public class ListAccountAssignmentDeletionStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAccountAssignmentDeletionStatusRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAccountAssignmentDeletionStatusRequest == false)
            return false;
    ...
    @Override
    public ListAccountAssignmentDeletionStatusRequest clone() {
        return (ListAccountAssignmentDeletionStatusRequest) super.clone();
    }
