...
/**
 * PermissionSet JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PermissionSetJsonUnmarshaller implements Unmarshaller<PermissionSet, JsonUnmarshallerContext> {

    public PermissionSet unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static PermissionSetJsonUnmarshaller instance;

    public static PermissionSetJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PermissionSetJsonUnmarshaller();
        return instance;
    }
}
