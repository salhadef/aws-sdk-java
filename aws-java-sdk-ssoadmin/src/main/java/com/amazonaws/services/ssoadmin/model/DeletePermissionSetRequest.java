...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sso-admin-2020-07-20/DeletePermissionSet" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeletePermissionSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the permission set that should be deleted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeletePermissionSetRequest == false)
            return false;
        DeletePermissionSetRequest other = (DeletePermissionSetRequest) obj;
    ...
    @Override
    public DeletePermissionSetRequest clone() {
        return (DeletePermissionSetRequest) super.clone();
    }
