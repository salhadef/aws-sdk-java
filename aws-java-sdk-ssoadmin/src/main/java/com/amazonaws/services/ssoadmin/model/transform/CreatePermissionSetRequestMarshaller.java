...
/**
 * CreatePermissionSetRequestMarshaller
 */
...
public class CreatePermissionSetRequestMarshaller {
    ...
    private static final CreatePermissionSetRequestMarshaller instance = new CreatePermissionSetRequestMarshaller();

    public static CreatePermissionSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreatePermissionSetRequest createPermissionSetRequest, ProtocolMarshaller protocolMarshaller) {
