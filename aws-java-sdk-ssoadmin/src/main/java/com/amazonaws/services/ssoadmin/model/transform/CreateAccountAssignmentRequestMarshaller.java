...
@SdkInternalApi
public class CreateAccountAssignmentRequestMarshaller {
    ...
    public static CreateAccountAssignmentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateAccountAssignmentRequest createAccountAssignmentRequest, ProtocolMarshaller protocolMarshaller) {
