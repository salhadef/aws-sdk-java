...
public class ListPermissionSetsRequestMarshaller {
    ...
    public static ListPermissionSetsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListPermissionSetsRequest listPermissionSetsRequest, ProtocolMarshaller protocolMarshaller) {
