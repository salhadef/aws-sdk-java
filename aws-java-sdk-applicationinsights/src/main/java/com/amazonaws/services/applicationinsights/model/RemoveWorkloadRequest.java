...
public class RemoveWorkloadRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public RemoveWorkloadRequest withResourceGroupName(String resourceGroupName) {
    ...
    public RemoveWorkloadRequest withComponentName(String componentName) {
    ...
    public RemoveWorkloadRequest withWorkloadId(String workloadId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RemoveWorkloadRequest == false)
            return false;
        RemoveWorkloadRequest other = (RemoveWorkloadRequest) obj;
    ...
    @Override
    public RemoveWorkloadRequest clone() {
        return (RemoveWorkloadRequest) super.clone();
    }
