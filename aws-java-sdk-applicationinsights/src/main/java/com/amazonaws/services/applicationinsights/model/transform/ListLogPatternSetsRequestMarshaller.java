...
@SdkInternalApi
public class ListLogPatternSetsRequestMarshaller {
    ...
    public static ListLogPatternSetsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListLogPatternSetsRequest listLogPatternSetsRequest, ProtocolMarshaller protocolMarshaller) {

        if (listLogPatternSetsRequest == null) {
