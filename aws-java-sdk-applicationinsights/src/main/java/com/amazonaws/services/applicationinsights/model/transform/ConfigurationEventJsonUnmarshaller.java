...
/**
 * ConfigurationEvent JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConfigurationEventJsonUnmarshaller implements Unmarshaller<ConfigurationEvent, JsonUnmarshallerContext> {

    public ConfigurationEvent unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ConfigurationEventJsonUnmarshaller instance;

    public static ConfigurationEventJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConfigurationEventJsonUnmarshaller();
        return instance;
    }
}
