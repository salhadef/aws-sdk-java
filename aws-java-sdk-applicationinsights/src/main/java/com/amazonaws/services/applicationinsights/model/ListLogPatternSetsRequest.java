...
public class ListLogPatternSetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListLogPatternSetsRequest withMaxResults(Integer maxResults) {
    ...
    public ListLogPatternSetsRequest withAccountId(String accountId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLogPatternSetsRequest == false)
            return false;
        ListLogPatternSetsRequest other = (ListLogPatternSetsRequest) obj;
    ...
    public ListLogPatternSetsRequest clone() {
        return (ListLogPatternSetsRequest) super.clone();
    }
