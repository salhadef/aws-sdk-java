...
/**
 * RemoveWorkloadRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RemoveWorkloadRequestMarshaller {
    ...
    private static final RemoveWorkloadRequestMarshaller instance = new RemoveWorkloadRequestMarshaller();

    public static RemoveWorkloadRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RemoveWorkloadRequest removeWorkloadRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(removeWorkloadRequest.getResourceGroupName(), RESOURCEGROUPNAME_BINDING);
            protocolMarshaller.marshall(removeWorkloadRequest.getComponentName(), COMPONENTNAME_BINDING);
            protocolMarshaller.marshall(removeWorkloadRequest.getWorkloadId(), WORKLOADID_BINDING);
        } catch (Exception e) {
