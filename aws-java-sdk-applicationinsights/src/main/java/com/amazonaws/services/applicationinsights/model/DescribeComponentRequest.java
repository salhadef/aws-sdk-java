...
public class DescribeComponentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeComponentRequest withAccountId(String accountId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeComponentRequest == false)
            return false;
        DescribeComponentRequest other = (DescribeComponentRequest) obj;
    ...
    @Override
    public DescribeComponentRequest clone() {
        return (DescribeComponentRequest) super.clone();
    }
