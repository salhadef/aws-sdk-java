...
public class ListLogPatternsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListLogPatternsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLogPatternsRequest == false)
            return false;
        ListLogPatternsRequest other = (ListLogPatternsRequest) obj;
    ...
    @Override
    public ListLogPatternsRequest clone() {
        return (ListLogPatternsRequest) super.clone();
    }
