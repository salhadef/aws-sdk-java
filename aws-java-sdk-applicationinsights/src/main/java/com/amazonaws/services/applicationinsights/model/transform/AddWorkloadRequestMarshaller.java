...
/**
 * AddWorkloadRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AddWorkloadRequestMarshaller {
    ...
    private static final AddWorkloadRequestMarshaller instance = new AddWorkloadRequestMarshaller();

    public static AddWorkloadRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AddWorkloadRequest addWorkloadRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(addWorkloadRequest.getResourceGroupName(), RESOURCEGROUPNAME_BINDING);
            protocolMarshaller.marshall(addWorkloadRequest.getComponentName(), COMPONENTNAME_BINDING);
            protocolMarshaller.marshall(addWorkloadRequest.getWorkloadConfiguration(), WORKLOADCONFIGURATION_BINDING);
        } catch (Exception e) {
