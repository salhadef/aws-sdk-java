...
public class WorkloadMarshaller {
    ...
    private static final MarshallingInfo<String> WORKLOADREMARKS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("WorkloadRemarks").build();
    ...
    public void marshall(Workload workload, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(workload.getComponentName(), COMPONENTNAME_BINDING);
            protocolMarshaller.marshall(workload.getWorkloadName(), WORKLOADNAME_BINDING);
            protocolMarshaller.marshall(workload.getTier(), TIER_BINDING);
            protocolMarshaller.marshall(workload.getWorkloadRemarks(), WORKLOADREMARKS_BINDING);
        } catch (Exception e) {
