...
@SdkInternalApi
public class ListLogPatternsRequestMarshaller {
    ...
    public static ListLogPatternsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListLogPatternsRequest listLogPatternsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listLogPatternsRequest.getResourceGroupName(), RESOURCEGROUPNAME_BINDING);
