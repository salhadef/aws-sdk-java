...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/application-insights-2018-11-25/AddWorkload" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AddWorkloadRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AddWorkloadRequest withResourceGroupName(String resourceGroupName) {
    ...
    public AddWorkloadRequest withComponentName(String componentName) {
    ...
    public AddWorkloadRequest withWorkloadConfiguration(WorkloadConfiguration workloadConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddWorkloadRequest == false)
            return false;
        AddWorkloadRequest other = (AddWorkloadRequest) obj;
    ...
    @Override
    public AddWorkloadRequest clone() {
        return (AddWorkloadRequest) super.clone();
    }
