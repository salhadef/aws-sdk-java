...
/**
 * UpdateProblemResult JSON Unmarshaller
 */
...
public class UpdateProblemResultJsonUnmarshaller implements Unmarshaller<UpdateProblemResult, JsonUnmarshallerContext> {
    ...
    public UpdateProblemResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateProblemResult updateProblemResult = new UpdateProblemResult();
