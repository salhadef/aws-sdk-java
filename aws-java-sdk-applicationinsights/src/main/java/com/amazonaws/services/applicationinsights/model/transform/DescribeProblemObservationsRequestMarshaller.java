...
/**
 * DescribeProblemObservationsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeProblemObservationsRequestMarshaller {
    ...
    public static DescribeProblemObservationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeProblemObservationsRequest describeProblemObservationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (describeProblemObservationsRequest == null) {
