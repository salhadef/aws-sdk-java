...
/**
 * DeleteCapacityReservationResult JSON Unmarshaller
 */
...
public class DeleteCapacityReservationResultJsonUnmarshaller implements Unmarshaller<DeleteCapacityReservationResult, JsonUnmarshallerContext> {
    ...
    public DeleteCapacityReservationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCapacityReservationResult deleteCapacityReservationResult = new DeleteCapacityReservationResult();

        return deleteCapacityReservationResult;
    }
