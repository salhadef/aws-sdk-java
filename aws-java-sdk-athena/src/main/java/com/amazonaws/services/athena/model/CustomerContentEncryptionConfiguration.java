...
public class CustomerContentEncryptionConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CustomerContentEncryptionConfiguration == false)
            return false;
        CustomerContentEncryptionConfiguration other = (CustomerContentEncryptionConfiguration) obj;
    ...
    public CustomerContentEncryptionConfiguration clone() {
        try {
            return (CustomerContentEncryptionConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.athena.model.transform.CustomerContentEncryptionConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
