 ...
 * interface VPC endpoints (Amazon Web Services PrivateLink)</a> in the <i>Amazon CodeGuru Reviewer User Guide</i>.
 * </p>
 */
@ThreadSafe
...
public class AmazonCodeGuruReviewerClient extends AmazonWebServiceClient implements AmazonCodeGuruReviewer {
     ...
     * connect to CodeGuru Reviewer. For more information, see <a
     ...
     * Amazon CodeGuru Reviewer. To associate a GitHub repository, use the console. For more information, see <a
