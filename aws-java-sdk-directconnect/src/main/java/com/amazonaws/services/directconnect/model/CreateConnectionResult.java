...
public class CreateConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateConnectionResult withLoaIssueTime(java.util.Date loaIssueTime) {
    ...
    public CreateConnectionResult withLagId(String lagId) {
        setLagId(lagId);
        return this;
    }
    ...
    public CreateConnectionResult withAwsDevice(String awsDevice) {
    ...
    public CreateConnectionResult withJumboFrameCapable(Boolean jumboFrameCapable) {
    ...
    public CreateConnectionResult withAwsDeviceV2(String awsDeviceV2) {
    ...
    public CreateConnectionResult withAwsLogicalDeviceId(String awsLogicalDeviceId) {
    ...
    public CreateConnectionResult withHasLogicalRedundancy(String hasLogicalRedundancy) {
    ...
    public CreateConnectionResult withHasLogicalRedundancy(HasLogicalRedundancy hasLogicalRedundancy) {
    ...
    public CreateConnectionResult withProviderName(String providerName) {
    ...
    public CreateConnectionResult withMacSecCapable(Boolean macSecCapable) {
    ...
    public CreateConnectionResult withPortEncryptionStatus(String portEncryptionStatus) {
    ...
    public CreateConnectionResult withEncryptionMode(String encryptionMode) {
    ...
    public CreateConnectionResult withMacSecKeys(MacSecKey... macSecKeys) {
    ...
    public CreateConnectionResult withMacSecKeys(java.util.Collection<MacSecKey> macSecKeys) {
