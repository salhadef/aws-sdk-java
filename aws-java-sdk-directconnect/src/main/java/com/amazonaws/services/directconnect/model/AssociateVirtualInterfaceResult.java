...
public class AssociateVirtualInterfaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateVirtualInterfaceResult withVirtualInterfaceType(String virtualInterfaceType) {
    ...
    public AssociateVirtualInterfaceResult withAddressFamily(String addressFamily) {
    ...
    public AssociateVirtualInterfaceResult withVirtualInterfaceState(String virtualInterfaceState) {
    ...
    public AssociateVirtualInterfaceResult withRouteFilterPrefixes(RouteFilterPrefix... routeFilterPrefixes) {
    ...
    public AssociateVirtualInterfaceResult withRouteFilterPrefixes(java.util.Collection<RouteFilterPrefix> routeFilterPrefixes) {
    ...
    public AssociateVirtualInterfaceResult withBgpPeers(BGPPeer... bgpPeers) {
    ...
    public AssociateVirtualInterfaceResult withBgpPeers(java.util.Collection<BGPPeer> bgpPeers) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateVirtualInterfaceResult == false)
            return false;
        AssociateVirtualInterfaceResult other = (AssociateVirtualInterfaceResult) obj;
    ...
    @Override
    public AssociateVirtualInterfaceResult clone() {
        try {
            return (AssociateVirtualInterfaceResult) super.clone();
