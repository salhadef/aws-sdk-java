...
public class AllocateHostedConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AllocateHostedConnectionResult withJumboFrameCapable(Boolean jumboFrameCapable) {
    ...
    public AllocateHostedConnectionResult withAwsDeviceV2(String awsDeviceV2) {
    ...
    public AllocateHostedConnectionResult withAwsLogicalDeviceId(String awsLogicalDeviceId) {
    ...
    public AllocateHostedConnectionResult withHasLogicalRedundancy(String hasLogicalRedundancy) {
    ...
    public AllocateHostedConnectionResult withHasLogicalRedundancy(HasLogicalRedundancy hasLogicalRedundancy) {
    ...
    public AllocateHostedConnectionResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public AllocateHostedConnectionResult withMacSecCapable(Boolean macSecCapable) {
    ...
    public AllocateHostedConnectionResult withPortEncryptionStatus(String portEncryptionStatus) {
    ...
    public AllocateHostedConnectionResult withEncryptionMode(String encryptionMode) {
    ...
    public AllocateHostedConnectionResult withMacSecKeys(MacSecKey... macSecKeys) {
    ...
    public AllocateHostedConnectionResult withMacSecKeys(java.util.Collection<MacSecKey> macSecKeys) {
