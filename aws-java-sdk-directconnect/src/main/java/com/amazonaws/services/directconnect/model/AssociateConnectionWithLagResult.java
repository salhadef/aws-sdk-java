...
public class AssociateConnectionWithLagResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateConnectionWithLagResult withOwnerAccount(String ownerAccount) {
    ...
    public AssociateConnectionWithLagResult withConnectionId(String connectionId) {
    ...
    public AssociateConnectionWithLagResult withConnectionName(String connectionName) {
    ...
    public AssociateConnectionWithLagResult withConnectionState(String connectionState) {
    ...
    public AssociateConnectionWithLagResult withRegion(String region) {
        setRegion(region);
        return this;
    }
    ...
    public AssociateConnectionWithLagResult withLocation(String location) {
    ...
    public AssociateConnectionWithLagResult withBandwidth(String bandwidth) {
    ...
    public AssociateConnectionWithLagResult withVlan(Integer vlan) {
        setVlan(vlan);
        return this;
    }
    ...
    public AssociateConnectionWithLagResult withPartnerName(String partnerName) {
    ...
    public AssociateConnectionWithLagResult withLoaIssueTime(java.util.Date loaIssueTime) {
    ...
    public AssociateConnectionWithLagResult withLagId(String lagId) {
        setLagId(lagId);
        return this;
    }
    ...
    public AssociateConnectionWithLagResult withAwsDevice(String awsDevice) {
    ...
    public AssociateConnectionWithLagResult withJumboFrameCapable(Boolean jumboFrameCapable) {
    ...
    public AssociateConnectionWithLagResult withAwsDeviceV2(String awsDeviceV2) {
    ...
    public AssociateConnectionWithLagResult withAwsLogicalDeviceId(String awsLogicalDeviceId) {
    ...
    public AssociateConnectionWithLagResult withHasLogicalRedundancy(String hasLogicalRedundancy) {
    ...
    public AssociateConnectionWithLagResult withHasLogicalRedundancy(HasLogicalRedundancy hasLogicalRedundancy) {
    ...
    public AssociateConnectionWithLagResult withProviderName(String providerName) {
    ...
    public AssociateConnectionWithLagResult withMacSecCapable(Boolean macSecCapable) {
    ...
    public AssociateConnectionWithLagResult withPortEncryptionStatus(String portEncryptionStatus) {
    ...
    public AssociateConnectionWithLagResult withEncryptionMode(String encryptionMode) {
    ...
    public AssociateConnectionWithLagResult withMacSecKeys(MacSecKey... macSecKeys) {
    ...
    public AssociateConnectionWithLagResult withMacSecKeys(java.util.Collection<MacSecKey> macSecKeys) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateConnectionWithLagResult == false)
            return false;
        AssociateConnectionWithLagResult other = (AssociateConnectionWithLagResult) obj;
    ...
    @Override
    public AssociateConnectionWithLagResult clone() {
        try {
            return (AssociateConnectionWithLagResult) super.clone();
