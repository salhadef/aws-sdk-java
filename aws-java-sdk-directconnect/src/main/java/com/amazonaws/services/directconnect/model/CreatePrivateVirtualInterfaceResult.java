...
public class CreatePrivateVirtualInterfaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreatePrivateVirtualInterfaceResult withAmazonSideAsn(Long amazonSideAsn) {
    ...
    public CreatePrivateVirtualInterfaceResult withAddressFamily(String addressFamily) {
    ...
    public CreatePrivateVirtualInterfaceResult withMtu(Integer mtu) {
        setMtu(mtu);
        return this;
    }
    ...
    public CreatePrivateVirtualInterfaceResult withJumboFrameCapable(Boolean jumboFrameCapable) {
    ...
    public CreatePrivateVirtualInterfaceResult withDirectConnectGatewayId(String directConnectGatewayId) {
    ...
    public CreatePrivateVirtualInterfaceResult withBgpPeers(BGPPeer... bgpPeers) {
    ...
    public CreatePrivateVirtualInterfaceResult withBgpPeers(java.util.Collection<BGPPeer> bgpPeers) {
    ...
    public CreatePrivateVirtualInterfaceResult withRegion(String region) {
        setRegion(region);
        return this;
    }
    ...
    public CreatePrivateVirtualInterfaceResult withAwsDeviceV2(String awsDeviceV2) {
    ...
    public CreatePrivateVirtualInterfaceResult withAwsLogicalDeviceId(String awsLogicalDeviceId) {
    ...
    public CreatePrivateVirtualInterfaceResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public CreatePrivateVirtualInterfaceResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public CreatePrivateVirtualInterfaceResult withSiteLinkEnabled(Boolean siteLinkEnabled) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePrivateVirtualInterfaceResult == false)
            return false;
    ...
    @Override
    public CreatePrivateVirtualInterfaceResult clone() {
        try {
            return (CreatePrivateVirtualInterfaceResult) super.clone();
