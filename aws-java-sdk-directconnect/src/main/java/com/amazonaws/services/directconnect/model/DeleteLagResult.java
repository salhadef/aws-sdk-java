...
public class DeleteLagResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteLagResult withMacSecKeys(java.util.Collection<MacSecKey> macSecKeys) {
