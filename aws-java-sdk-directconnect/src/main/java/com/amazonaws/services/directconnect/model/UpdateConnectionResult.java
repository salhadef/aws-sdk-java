...
public class UpdateConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateConnectionResult withLoaIssueTime(java.util.Date loaIssueTime) {
    ...
    public UpdateConnectionResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public UpdateConnectionResult withMacSecKeys(java.util.Collection<MacSecKey> macSecKeys) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConnectionResult == false)
            return false;
        UpdateConnectionResult other = (UpdateConnectionResult) obj;
    ...
    public UpdateConnectionResult clone() {
        try {
            return (UpdateConnectionResult) super.clone();
