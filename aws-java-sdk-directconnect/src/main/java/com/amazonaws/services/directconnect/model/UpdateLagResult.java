...
public class UpdateLagResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateLagResult withAwsLogicalDeviceId(String awsLogicalDeviceId) {
    ...
    public UpdateLagResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public UpdateLagResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public UpdateLagResult withProviderName(String providerName) {
    ...
    public UpdateLagResult withMacSecCapable(Boolean macSecCapable) {
    ...
    public UpdateLagResult withMacSecKeys(MacSecKey... macSecKeys) {
    ...
    public UpdateLagResult withMacSecKeys(java.util.Collection<MacSecKey> macSecKeys) {
