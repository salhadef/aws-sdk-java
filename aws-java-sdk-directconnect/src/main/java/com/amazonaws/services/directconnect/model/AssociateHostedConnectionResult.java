...
public class AssociateHostedConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateHostedConnectionResult withOwnerAccount(String ownerAccount) {
    ...
    public AssociateHostedConnectionResult withConnectionId(String connectionId) {
    ...
    public AssociateHostedConnectionResult withConnectionName(String connectionName) {
    ...
    public AssociateHostedConnectionResult withConnectionState(String connectionState) {
    ...
    public AssociateHostedConnectionResult withRegion(String region) {
        setRegion(region);
        return this;
    }
    ...
    public AssociateHostedConnectionResult withLocation(String location) {
    ...
    public AssociateHostedConnectionResult withBandwidth(String bandwidth) {
    ...
    public AssociateHostedConnectionResult withVlan(Integer vlan) {
        setVlan(vlan);
        return this;
    }
    ...
    public AssociateHostedConnectionResult withPartnerName(String partnerName) {
    ...
    public AssociateHostedConnectionResult withLoaIssueTime(java.util.Date loaIssueTime) {
    ...
    public AssociateHostedConnectionResult withLagId(String lagId) {
        setLagId(lagId);
        return this;
    }
    ...
    public AssociateHostedConnectionResult withAwsDevice(String awsDevice) {
    ...
    public AssociateHostedConnectionResult withJumboFrameCapable(Boolean jumboFrameCapable) {
    ...
    public AssociateHostedConnectionResult withAwsDeviceV2(String awsDeviceV2) {
    ...
    public AssociateHostedConnectionResult withAwsLogicalDeviceId(String awsLogicalDeviceId) {
    ...
    public AssociateHostedConnectionResult withHasLogicalRedundancy(String hasLogicalRedundancy) {
    ...
    public AssociateHostedConnectionResult withHasLogicalRedundancy(HasLogicalRedundancy hasLogicalRedundancy) {
    ...
    public AssociateHostedConnectionResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public AssociateHostedConnectionResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public AssociateHostedConnectionResult withProviderName(String providerName) {
    ...
    public AssociateHostedConnectionResult withMacSecCapable(Boolean macSecCapable) {
    ...
    public AssociateHostedConnectionResult withMacSecKeys(MacSecKey... macSecKeys) {
    ...
    public AssociateHostedConnectionResult withMacSecKeys(java.util.Collection<MacSecKey> macSecKeys) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateHostedConnectionResult == false)
            return false;
        AssociateHostedConnectionResult other = (AssociateHostedConnectionResult) obj;
    ...
    @Override
    public AssociateHostedConnectionResult clone() {
        try {
            return (AssociateHostedConnectionResult) super.clone();
