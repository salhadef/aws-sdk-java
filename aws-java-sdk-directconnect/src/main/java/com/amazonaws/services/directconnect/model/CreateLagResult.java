...
public class CreateLagResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateLagResult withConnections(Connection... connections) {
    ...
    public CreateLagResult withConnections(java.util.Collection<Connection> connections) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLagResult == false)
            return false;
        CreateLagResult other = (CreateLagResult) obj;
