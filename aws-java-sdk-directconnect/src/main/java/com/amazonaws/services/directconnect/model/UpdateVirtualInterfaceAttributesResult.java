...
public class UpdateVirtualInterfaceAttributesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
    ...
    public UpdateVirtualInterfaceAttributesResult withAwsLogicalDeviceId(String awsLogicalDeviceId) {
    ...
    public UpdateVirtualInterfaceAttributesResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public UpdateVirtualInterfaceAttributesResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public UpdateVirtualInterfaceAttributesResult withSiteLinkEnabled(Boolean siteLinkEnabled) {
