...
public class UpdatePolicyTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdatePolicyTemplateResult withCreatedDate(java.util.Date createdDate) {
    ...
    public UpdatePolicyTemplateResult withLastUpdatedDate(java.util.Date lastUpdatedDate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePolicyTemplateResult == false)
            return false;
        UpdatePolicyTemplateResult other = (UpdatePolicyTemplateResult) obj;
    ...
    @Override
    public UpdatePolicyTemplateResult clone() {
        try {
            return (UpdatePolicyTemplateResult) super.clone();
