...
/**
 * ValidationExceptionFieldMarshaller
 */
...
public class ValidationExceptionFieldMarshaller {
    ...
    public static ValidationExceptionFieldMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ValidationExceptionField validationExceptionField, ProtocolMarshaller protocolMarshaller) {

        if (validationExceptionField == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(validationExceptionField.getPath(), PATH_BINDING);
