...
@SdkInternalApi
public class IsAuthorizedRequestMarshaller {
    ...
    private static final IsAuthorizedRequestMarshaller instance = new IsAuthorizedRequestMarshaller();

    public static IsAuthorizedRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(IsAuthorizedRequest isAuthorizedRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(isAuthorizedRequest.getPolicyStoreId(), POLICYSTOREID_BINDING);
            protocolMarshaller.marshall(isAuthorizedRequest.getPrincipal(), PRINCIPAL_BINDING);
            protocolMarshaller.marshall(isAuthorizedRequest.getAction(), ACTION_BINDING);
            protocolMarshaller.marshall(isAuthorizedRequest.getResource(), RESOURCE_BINDING);
            protocolMarshaller.marshall(isAuthorizedRequest.getContext(), CONTEXT_BINDING);
            protocolMarshaller.marshall(isAuthorizedRequest.getEntities(), ENTITIES_BINDING);
        } catch (Exception e) {
