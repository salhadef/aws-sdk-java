...
/**
 * IdentitySourceDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IdentitySourceDetailsJsonUnmarshaller implements Unmarshaller<IdentitySourceDetails, JsonUnmarshallerContext> {

    public IdentitySourceDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        IdentitySourceDetails identitySourceDetails = new IdentitySourceDetails();
    ...
    private static IdentitySourceDetailsJsonUnmarshaller instance;

    public static IdentitySourceDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IdentitySourceDetailsJsonUnmarshaller();
        return instance;
    }
}
