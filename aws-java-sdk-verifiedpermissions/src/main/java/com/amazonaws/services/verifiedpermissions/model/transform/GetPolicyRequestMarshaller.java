...
public class GetPolicyRequestMarshaller {
    ...
    public void marshall(GetPolicyRequest getPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getPolicyRequest.getPolicyStoreId(), POLICYSTOREID_BINDING);
            protocolMarshaller.marshall(getPolicyRequest.getPolicyId(), POLICYID_BINDING);
        } catch (Exception e) {
