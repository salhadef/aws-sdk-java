...
/**
 * DeletePolicyTemplateResult JSON Unmarshaller
 */
...
public class DeletePolicyTemplateResultJsonUnmarshaller implements Unmarshaller<DeletePolicyTemplateResult, JsonUnmarshallerContext> {
    ...
    public DeletePolicyTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeletePolicyTemplateResult deletePolicyTemplateResult = new DeletePolicyTemplateResult();
