...
@SdkInternalApi
public class IsAuthorizedWithTokenRequestMarshaller {
    ...
    private static final IsAuthorizedWithTokenRequestMarshaller instance = new IsAuthorizedWithTokenRequestMarshaller();

    public static IsAuthorizedWithTokenRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(IsAuthorizedWithTokenRequest isAuthorizedWithTokenRequest, ProtocolMarshaller protocolMarshaller) {

        if (isAuthorizedWithTokenRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(isAuthorizedWithTokenRequest.getPolicyStoreId(), POLICYSTOREID_BINDING);
            protocolMarshaller.marshall(isAuthorizedWithTokenRequest.getIdentityToken(), IDENTITYTOKEN_BINDING);
            protocolMarshaller.marshall(isAuthorizedWithTokenRequest.getAccessToken(), ACCESSTOKEN_BINDING);
            protocolMarshaller.marshall(isAuthorizedWithTokenRequest.getAction(), ACTION_BINDING);
            protocolMarshaller.marshall(isAuthorizedWithTokenRequest.getResource(), RESOURCE_BINDING);
            protocolMarshaller.marshall(isAuthorizedWithTokenRequest.getContext(), CONTEXT_BINDING);
            protocolMarshaller.marshall(isAuthorizedWithTokenRequest.getEntities(), ENTITIES_BINDING);
        } catch (Exception e) {
