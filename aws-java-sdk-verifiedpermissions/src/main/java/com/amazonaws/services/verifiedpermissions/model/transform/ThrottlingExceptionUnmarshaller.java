...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.verifiedpermissions.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.verifiedpermissions.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.verifiedpermissions.model.ThrottlingException throttlingException = new com.amazonaws.services.verifiedpermissions.model.ThrottlingException(
                null);
