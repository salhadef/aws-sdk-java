...
public class GetPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the ID of the policy store that contains the policy that you want information about.
     */
    ...
    public GetPolicyRequest withPolicyStoreId(String policyStoreId) {
     ...
     * </p>
     * 
     * @return Specifies the ID of the policy you want information about.
     */
