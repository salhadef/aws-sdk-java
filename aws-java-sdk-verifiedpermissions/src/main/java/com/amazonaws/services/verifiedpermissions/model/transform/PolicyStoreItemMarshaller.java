...
/**
 * PolicyStoreItemMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PolicyStoreItemMarshaller {
    ...
    public static PolicyStoreItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PolicyStoreItem policyStoreItem, ProtocolMarshaller protocolMarshaller) {

        if (policyStoreItem == null) {
