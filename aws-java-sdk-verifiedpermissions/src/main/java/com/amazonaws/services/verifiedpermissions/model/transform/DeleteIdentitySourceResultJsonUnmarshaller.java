...
/**
 * DeleteIdentitySourceResult JSON Unmarshaller
 */
...
public class DeleteIdentitySourceResultJsonUnmarshaller implements Unmarshaller<DeleteIdentitySourceResult, JsonUnmarshallerContext> {
    ...
    public DeleteIdentitySourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteIdentitySourceResult deleteIdentitySourceResult = new DeleteIdentitySourceResult();
