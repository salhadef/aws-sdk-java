...
/**
 * PolicyFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PolicyFilterMarshaller {
    ...
    private static final PolicyFilterMarshaller instance = new PolicyFilterMarshaller();

    public static PolicyFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PolicyFilter policyFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(policyFilter.getPrincipal(), PRINCIPAL_BINDING);
            protocolMarshaller.marshall(policyFilter.getResource(), RESOURCE_BINDING);
            protocolMarshaller.marshall(policyFilter.getPolicyType(), POLICYTYPE_BINDING);
            protocolMarshaller.marshall(policyFilter.getPolicyTemplateId(), POLICYTEMPLATEID_BINDING);
        } catch (Exception e) {
