...
public class GetPolicyTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the ID of the policy store that contains the policy template that you want information about.
     */
    ...
    public GetPolicyTemplateRequest withPolicyStoreId(String policyStoreId) {
     ...
     * </p>
     * 
     * @return Specifies the ID of the policy template that you want information about.
     */
    ...
    public GetPolicyTemplateRequest withPolicyTemplateId(String policyTemplateId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPolicyTemplateRequest == false)
            return false;
        GetPolicyTemplateRequest other = (GetPolicyTemplateRequest) obj;
    ...
    @Override
    public GetPolicyTemplateRequest clone() {
