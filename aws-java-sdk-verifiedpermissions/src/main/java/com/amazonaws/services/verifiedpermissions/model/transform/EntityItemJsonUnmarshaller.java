...
/**
 * EntityItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EntityItemJsonUnmarshaller implements Unmarshaller<EntityItem, JsonUnmarshallerContext> {

    public EntityItem unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static EntityItemJsonUnmarshaller instance;

    public static EntityItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EntityItemJsonUnmarshaller();
        return instance;
    }
}
