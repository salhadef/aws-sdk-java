...
/**
 * UpdatePolicyTemplateResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdatePolicyTemplateResultJsonUnmarshaller implements Unmarshaller<UpdatePolicyTemplateResult, JsonUnmarshallerContext> {

    public UpdatePolicyTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePolicyTemplateResult updatePolicyTemplateResult = new UpdatePolicyTemplateResult();
    ...
    private static UpdatePolicyTemplateResultJsonUnmarshaller instance;

    public static UpdatePolicyTemplateResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdatePolicyTemplateResultJsonUnmarshaller();
        return instance;
    }
}
