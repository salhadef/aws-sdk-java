...
public class ListPoliciesRequestMarshaller {
    ...
    public void marshall(ListPoliciesRequest listPoliciesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listPoliciesRequest.getPolicyStoreId(), POLICYSTOREID_BINDING);
            ...
            protocolMarshaller.marshall(listPoliciesRequest.getFilter(), FILTER_BINDING);
        } catch (Exception e) {
