...
/**
 * UpdateCognitoUserPoolConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateCognitoUserPoolConfigurationMarshaller {
    ...
    public static UpdateCognitoUserPoolConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateCognitoUserPoolConfiguration updateCognitoUserPoolConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (updateCognitoUserPoolConfiguration == null) {
