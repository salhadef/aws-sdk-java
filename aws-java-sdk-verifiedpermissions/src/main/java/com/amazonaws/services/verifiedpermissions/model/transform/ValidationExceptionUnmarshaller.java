...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.verifiedpermissions.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.verifiedpermissions.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.verifiedpermissions.model.ValidationException validationException = new com.amazonaws.services.verifiedpermissions.model.ValidationException(
                null);
