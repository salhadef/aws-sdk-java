...
/**
 * DeletePolicyStoreResult JSON Unmarshaller
 */
...
public class DeletePolicyStoreResultJsonUnmarshaller implements Unmarshaller<DeletePolicyStoreResult, JsonUnmarshallerContext> {
    ...
    public DeletePolicyStoreResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeletePolicyStoreResult deletePolicyStoreResult = new DeletePolicyStoreResult();
