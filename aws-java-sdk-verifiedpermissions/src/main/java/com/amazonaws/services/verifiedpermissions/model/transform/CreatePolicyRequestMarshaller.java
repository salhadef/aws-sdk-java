...
public class CreatePolicyRequestMarshaller {
    ...
    public void marshall(CreatePolicyRequest createPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createPolicyRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createPolicyRequest.getPolicyStoreId(), POLICYSTOREID_BINDING);
            protocolMarshaller.marshall(createPolicyRequest.getDefinition(), DEFINITION_BINDING);
        } catch (Exception e) {
