...
public class ListIdentitySourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<IdentitySourceFilter> filters;
    ...
    public ListIdentitySourcesRequest withPolicyStoreId(String policyStoreId) {
    ...
    public ListIdentitySourcesRequest withNextToken(String nextToken) {
    ...
    public ListIdentitySourcesRequest withMaxResults(Integer maxResults) {
    ...
    public java.util.List<IdentitySourceFilter> getFilters() {
        return filters;
    }
    ...
    public void setFilters(java.util.Collection<IdentitySourceFilter> filters) {
        if (filters == null) {
            this.filters = null;
            return;
        }

        this.filters = new java.util.ArrayList<IdentitySourceFilter>(filters);
    }
    ...
    public ListIdentitySourcesRequest withFilters(IdentitySourceFilter... filters) {
        if (this.filters == null) {
            setFilters(new java.util.ArrayList<IdentitySourceFilter>(filters.length));
        }
        for (IdentitySourceFilter ele : filters) {
    ...
    public ListIdentitySourcesRequest withFilters(java.util.Collection<IdentitySourceFilter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListIdentitySourcesRequest == false)
            return false;
    ...
    @Override
    public ListIdentitySourcesRequest clone() {
        return (ListIdentitySourcesRequest) super.clone();
    }
