 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/TemplateLinkedPolicyDefinitionDetail"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TemplateLinkedPolicyDefinitionDetail implements Serializable, Cloneable, StructuredPojo {
    ...
    public TemplateLinkedPolicyDefinitionDetail withPolicyTemplateId(String policyTemplateId) {
    ...
    public TemplateLinkedPolicyDefinitionDetail withPrincipal(EntityIdentifier principal) {
    ...
    public TemplateLinkedPolicyDefinitionDetail withResource(EntityIdentifier resource) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TemplateLinkedPolicyDefinitionDetail == false)
            return false;
    ...
    @Override
    public TemplateLinkedPolicyDefinitionDetail clone() {
        try {
            return (TemplateLinkedPolicyDefinitionDetail) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.TemplateLinkedPolicyDefinitionDetailMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
