...
public class GetPolicyStoreRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the ID of the policy store that you want information about.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPolicyStoreRequest == false)
            return false;
        GetPolicyStoreRequest other = (GetPolicyStoreRequest) obj;
    ...
    @Override
    public GetPolicyStoreRequest clone() {
        return (GetPolicyStoreRequest) super.clone();
    }
