...
public class GetIdentitySourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the ID of the policy store that contains the identity source you want information about.
     */
    ...
    public GetIdentitySourceRequest withPolicyStoreId(String policyStoreId) {
     ...
     * </p>
     * 
     * @return Specifies the ID of the identity source you want information about.
     */
    ...
    public GetIdentitySourceRequest withIdentitySourceId(String identitySourceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIdentitySourceRequest == false)
            return false;
        GetIdentitySourceRequest other = (GetIdentitySourceRequest) obj;
    ...
    @Override
    public GetIdentitySourceRequest clone() {
