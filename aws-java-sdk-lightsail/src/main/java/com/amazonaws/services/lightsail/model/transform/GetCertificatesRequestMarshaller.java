...
/**
 * GetCertificatesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetCertificatesRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> INCLUDECERTIFICATEDETAILS_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
    ...
    public static GetCertificatesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetCertificatesRequest getCertificatesRequest, ProtocolMarshaller protocolMarshaller) {
