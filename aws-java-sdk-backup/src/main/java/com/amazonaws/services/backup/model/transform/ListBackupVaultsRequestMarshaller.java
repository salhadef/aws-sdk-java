...
/**
 * ListBackupVaultsRequestMarshaller
 */
...
public class ListBackupVaultsRequestMarshaller {
    ...
    private static final ListBackupVaultsRequestMarshaller instance = new ListBackupVaultsRequestMarshaller();

    public static ListBackupVaultsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListBackupVaultsRequest listBackupVaultsRequest, ProtocolMarshaller protocolMarshaller) {
