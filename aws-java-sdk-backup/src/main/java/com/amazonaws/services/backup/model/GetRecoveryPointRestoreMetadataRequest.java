...
public class GetRecoveryPointRestoreMetadataRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetRecoveryPointRestoreMetadataRequest withBackupVaultName(String backupVaultName) {
    ...
    public GetRecoveryPointRestoreMetadataRequest withRecoveryPointArn(String recoveryPointArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetRecoveryPointRestoreMetadataRequest == false)
            return false;
        GetRecoveryPointRestoreMetadataRequest other = (GetRecoveryPointRestoreMetadataRequest) obj;
    ...
    @Override
    public GetRecoveryPointRestoreMetadataRequest clone() {
        return (GetRecoveryPointRestoreMetadataRequest) super.clone();
    }
