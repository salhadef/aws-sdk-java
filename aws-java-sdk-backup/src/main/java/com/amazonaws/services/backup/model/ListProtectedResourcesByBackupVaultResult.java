...
public class ListProtectedResourcesByBackupVaultResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public ListProtectedResourcesByBackupVaultResult withResults(java.util.Collection<ProtectedResource> results) {
        setResults(results);
        return this;
    }
