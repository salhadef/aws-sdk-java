...
/**
 * RecoveryPointMemberMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RecoveryPointMemberMarshaller {
    ...
    public static RecoveryPointMemberMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RecoveryPointMember recoveryPointMember, ProtocolMarshaller protocolMarshaller) {

        if (recoveryPointMember == null) {
