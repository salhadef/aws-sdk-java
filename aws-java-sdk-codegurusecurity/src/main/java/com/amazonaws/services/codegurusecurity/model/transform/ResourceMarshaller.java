...
public class ResourceMarshaller {
    ...
    private static final MarshallingInfo<String> SUBRESOURCEID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("subResourceId").build();
    ...
    public void marshall(Resource resource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(resource.getSubResourceId(), SUBRESOURCEID_BINDING);
        } catch (Exception e) {
