        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("text", targetDepth)) {
                    context.nextToken();
                    recommendation.setText(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("url", targetDepth)) {
                    context.nextToken();
                    recommendation.setUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
