...
@SdkInternalApi
public class ScanNameWithFindingNumMarshaller {
    ...
    private static final ScanNameWithFindingNumMarshaller instance = new ScanNameWithFindingNumMarshaller();

    public static ScanNameWithFindingNumMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ScanNameWithFindingNum scanNameWithFindingNum, ProtocolMarshaller protocolMarshaller) {

        if (scanNameWithFindingNum == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(scanNameWithFindingNum.getFindingNumber(), FINDINGNUMBER_BINDING);
            protocolMarshaller.marshall(scanNameWithFindingNum.getScanName(), SCANNAME_BINDING);
        } catch (Exception e) {
