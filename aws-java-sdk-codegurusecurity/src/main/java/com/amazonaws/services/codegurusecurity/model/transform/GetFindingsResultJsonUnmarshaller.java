...
/**
 * GetFindingsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetFindingsResultJsonUnmarshaller implements Unmarshaller<GetFindingsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("findings", targetDepth)) {
                    context.nextToken();
                    getFindingsResult.setFindings(new ListUnmarshaller<Finding>(FindingJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    getFindingsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
