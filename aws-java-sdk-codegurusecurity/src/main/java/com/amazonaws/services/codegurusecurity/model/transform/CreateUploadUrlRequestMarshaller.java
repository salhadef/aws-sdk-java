...
public class CreateUploadUrlRequestMarshaller {
    ...
    private static final CreateUploadUrlRequestMarshaller instance = new CreateUploadUrlRequestMarshaller();

    public static CreateUploadUrlRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateUploadUrlRequest createUploadUrlRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createUploadUrlRequest.getScanName(), SCANNAME_BINDING);
        } catch (Exception e) {
