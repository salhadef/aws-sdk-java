...
public class ListScansRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListScansRequest withMaxResults(Integer maxResults) {
    ...
    public ListScansRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListScansRequest == false)
            return false;
        ListScansRequest other = (ListScansRequest) obj;
    ...
    public ListScansRequest clone() {
        return (ListScansRequest) super.clone();
    }
