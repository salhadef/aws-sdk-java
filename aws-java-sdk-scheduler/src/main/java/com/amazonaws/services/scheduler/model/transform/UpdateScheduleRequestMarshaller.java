...
public class UpdateScheduleRequestMarshaller {
    ...
    public void marshall(UpdateScheduleRequest updateScheduleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateScheduleRequest.getFlexibleTimeWindow(), FLEXIBLETIMEWINDOW_BINDING);
            protocolMarshaller.marshall(updateScheduleRequest.getGroupName(), GROUPNAME_BINDING);
            protocolMarshaller.marshall(updateScheduleRequest.getKmsKeyArn(), KMSKEYARN_BINDING);
            protocolMarshaller.marshall(updateScheduleRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateScheduleRequest.getScheduleExpression(), SCHEDULEEXPRESSION_BINDING);
            protocolMarshaller.marshall(updateScheduleRequest.getScheduleExpressionTimezone(), SCHEDULEEXPRESSIONTIMEZONE_BINDING);
            protocolMarshaller.marshall(updateScheduleRequest.getStartDate(), STARTDATE_BINDING);
            protocolMarshaller.marshall(updateScheduleRequest.getState(), STATE_BINDING);
            protocolMarshaller.marshall(updateScheduleRequest.getTarget(), TARGET_BINDING);
        } catch (Exception e) {
