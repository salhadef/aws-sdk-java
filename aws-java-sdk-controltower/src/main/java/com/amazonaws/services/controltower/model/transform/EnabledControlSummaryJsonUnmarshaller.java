...
/**
 * EnabledControlSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EnabledControlSummaryJsonUnmarshaller implements Unmarshaller<EnabledControlSummary, JsonUnmarshallerContext> {

    public EnabledControlSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        EnabledControlSummary enabledControlSummary = new EnabledControlSummary();
    ...
    private static EnabledControlSummaryJsonUnmarshaller instance;

    public static EnabledControlSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EnabledControlSummaryJsonUnmarshaller();
        return instance;
    }
}
