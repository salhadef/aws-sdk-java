...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.bedrockruntime.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.bedrockruntime.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bedrockruntime.model.InternalServerException internalServerException = new com.amazonaws.services.bedrockruntime.model.InternalServerException(
                null);
