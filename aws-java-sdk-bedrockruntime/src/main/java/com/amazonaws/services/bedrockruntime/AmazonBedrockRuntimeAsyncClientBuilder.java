...
/**
 * Fluent builder for {@link com.amazonaws.services.bedrockruntime.AmazonBedrockRuntimeAsync}. Use of the builder is
...
public final class AmazonBedrockRuntimeAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonBedrockRuntimeAsyncClientBuilder, AmazonBedrockRuntimeAsync> {
     ...
     * @return Fully configured implementation of AmazonBedrockRuntimeAsync.
     */
    @Override
    protected AmazonBedrockRuntimeAsync build(AwsAsyncClientParams params) {
        return new AmazonBedrockRuntimeAsyncClient(params);
    }
