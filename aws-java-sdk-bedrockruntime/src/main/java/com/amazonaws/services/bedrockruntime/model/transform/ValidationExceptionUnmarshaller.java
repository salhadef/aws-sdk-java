...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.bedrockruntime.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.bedrockruntime.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bedrockruntime.model.ValidationException validationException = new com.amazonaws.services.bedrockruntime.model.ValidationException(
                null);
