...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.bedrockruntime.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.bedrockruntime.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bedrockruntime.model.ThrottlingException throttlingException = new com.amazonaws.services.bedrockruntime.model.ThrottlingException(
                null);
