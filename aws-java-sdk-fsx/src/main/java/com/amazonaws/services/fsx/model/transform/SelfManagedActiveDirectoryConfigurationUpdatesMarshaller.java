...
/**
 * SelfManagedActiveDirectoryConfigurationUpdatesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SelfManagedActiveDirectoryConfigurationUpdatesMarshaller {
    ...
    public static SelfManagedActiveDirectoryConfigurationUpdatesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SelfManagedActiveDirectoryConfigurationUpdates selfManagedActiveDirectoryConfigurationUpdates, ProtocolMarshaller protocolMarshaller) {

        if (selfManagedActiveDirectoryConfigurationUpdates == null) {
