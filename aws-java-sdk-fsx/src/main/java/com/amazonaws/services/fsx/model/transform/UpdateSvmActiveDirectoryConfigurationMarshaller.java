...
/**
 * UpdateSvmActiveDirectoryConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateSvmActiveDirectoryConfigurationMarshaller {
    ...
    public static UpdateSvmActiveDirectoryConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateSvmActiveDirectoryConfiguration updateSvmActiveDirectoryConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (updateSvmActiveDirectoryConfiguration == null) {
