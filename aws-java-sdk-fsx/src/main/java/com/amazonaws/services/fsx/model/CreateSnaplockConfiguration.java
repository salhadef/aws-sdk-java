 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/fsx-2018-03-01/CreateSnaplockConfiguration" target="_top">AWS
 *      API Documentation</a>
 */
...
public class CreateSnaplockConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     * periods. <code>PERMANENTLY_DISABLED</code> is a terminal state. If privileged delete is permanently disabled on a
     * SnapLock volume, you can't re-enable it. The default value is <code>DISABLED</code>.
     * </p>
     * <p>
     * For more information, see <a
     ...
     *        active retention periods. <code>PERMANENTLY_DISABLED</code> is a terminal state. If privileged delete is
