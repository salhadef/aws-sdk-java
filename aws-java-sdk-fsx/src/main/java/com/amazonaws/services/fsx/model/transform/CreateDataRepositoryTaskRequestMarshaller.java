...
/**
 * CreateDataRepositoryTaskRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateDataRepositoryTaskRequestMarshaller {
    ...
    public static CreateDataRepositoryTaskRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateDataRepositoryTaskRequest createDataRepositoryTaskRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createDataRepositoryTaskRequest.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(createDataRepositoryTaskRequest.getPaths(), PATHS_BINDING);
            protocolMarshaller.marshall(createDataRepositoryTaskRequest.getFileSystemId(), FILESYSTEMID_BINDING);
