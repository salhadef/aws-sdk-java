...
/**
 * WriteApplicationSettingsRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WriteApplicationSettingsRequestJsonUnmarshaller implements Unmarshaller<WriteApplicationSettingsRequest, JsonUnmarshallerContext> {

    public WriteApplicationSettingsRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
