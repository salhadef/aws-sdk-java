...
public class GetIpAccessSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIpAccessSettingsResult == false)
            return false;
        GetIpAccessSettingsResult other = (GetIpAccessSettingsResult) obj;
    ...
    public GetIpAccessSettingsResult clone() {
        try {
            return (GetIpAccessSettingsResult) super.clone();
