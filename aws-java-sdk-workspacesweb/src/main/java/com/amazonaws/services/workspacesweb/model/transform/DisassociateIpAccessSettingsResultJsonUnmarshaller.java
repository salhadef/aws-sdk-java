...
/**
 * DisassociateIpAccessSettingsResult JSON Unmarshaller
 */
...
public class DisassociateIpAccessSettingsResultJsonUnmarshaller implements Unmarshaller<DisassociateIpAccessSettingsResult, JsonUnmarshallerContext> {
    ...
    public DisassociateIpAccessSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateIpAccessSettingsResult disassociateIpAccessSettingsResult = new DisassociateIpAccessSettingsResult();

        return disassociateIpAccessSettingsResult;
    }
