...
public class DisassociateIpAccessSettingsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DisassociateIpAccessSettingsRequest withPortalArn(String portalArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateIpAccessSettingsRequest == false)
            return false;
        DisassociateIpAccessSettingsRequest other = (DisassociateIpAccessSettingsRequest) obj;
    ...
    @Override
    public DisassociateIpAccessSettingsRequest clone() {
        return (DisassociateIpAccessSettingsRequest) super.clone();
    }
