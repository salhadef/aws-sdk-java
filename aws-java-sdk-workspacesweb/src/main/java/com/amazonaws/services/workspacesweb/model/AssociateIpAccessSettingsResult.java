...
public class AssociateIpAccessSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateIpAccessSettingsResult == false)
            return false;
        AssociateIpAccessSettingsResult other = (AssociateIpAccessSettingsResult) obj;
    ...
    public AssociateIpAccessSettingsResult clone() {
        try {
            return (AssociateIpAccessSettingsResult) super.clone();
