...
/**
 * DeleteIpAccessSettingsResult JSON Unmarshaller
 */
...
public class DeleteIpAccessSettingsResultJsonUnmarshaller implements Unmarshaller<DeleteIpAccessSettingsResult, JsonUnmarshallerContext> {
    ...
    public DeleteIpAccessSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteIpAccessSettingsResult deleteIpAccessSettingsResult = new DeleteIpAccessSettingsResult();

        return deleteIpAccessSettingsResult;
    }
