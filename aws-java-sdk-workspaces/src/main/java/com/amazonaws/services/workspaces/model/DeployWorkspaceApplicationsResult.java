...
public class DeployWorkspaceApplicationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public WorkSpaceApplicationDeployment getDeployment() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeployWorkspaceApplicationsResult == false)
            return false;
        DeployWorkspaceApplicationsResult other = (DeployWorkspaceApplicationsResult) obj;
    ...
    public DeployWorkspaceApplicationsResult clone() {
        try {
            return (DeployWorkspaceApplicationsResult) super.clone();
