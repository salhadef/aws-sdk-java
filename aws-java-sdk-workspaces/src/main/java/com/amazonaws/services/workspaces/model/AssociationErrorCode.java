...
public enum AssociationErrorCode {
    ...
    ValidationErrorUnsupportedOperatingSystem("ValidationError.UnsupportedOperatingSystem"),
     ...
     * @param value
     *        real value
     * @return AssociationErrorCode corresponding to the value
     *
    ...
    public static AssociationErrorCode fromValue(String value) {
        ...
        for (AssociationErrorCode enumEntry : AssociationErrorCode.values()) {
