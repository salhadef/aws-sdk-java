...
public class AssociateWorkspaceApplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateWorkspaceApplicationResult == false)
            return false;
        AssociateWorkspaceApplicationResult other = (AssociateWorkspaceApplicationResult) obj;
    ...
    public AssociateWorkspaceApplicationResult clone() {
        try {
            return (AssociateWorkspaceApplicationResult) super.clone();
