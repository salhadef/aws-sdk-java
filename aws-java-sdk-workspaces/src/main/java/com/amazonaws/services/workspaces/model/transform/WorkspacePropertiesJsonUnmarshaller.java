...
/**
 * WorkspaceProperties JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkspacePropertiesJsonUnmarshaller implements Unmarshaller<WorkspaceProperties, JsonUnmarshallerContext> {

    public WorkspaceProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static WorkspacePropertiesJsonUnmarshaller instance;

    public static WorkspacePropertiesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorkspacePropertiesJsonUnmarshaller();
        return instance;
    }
}
