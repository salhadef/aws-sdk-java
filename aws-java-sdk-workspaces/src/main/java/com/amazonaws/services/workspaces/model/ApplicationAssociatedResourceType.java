...
public enum ApplicationAssociatedResourceType {
     ...
     * @param value
     *        real value
     * @return ApplicationAssociatedResourceType corresponding to the value
     *
    ...
    public static ApplicationAssociatedResourceType fromValue(String value) {
        ...
        for (ApplicationAssociatedResourceType enumEntry : ApplicationAssociatedResourceType.values()) {
