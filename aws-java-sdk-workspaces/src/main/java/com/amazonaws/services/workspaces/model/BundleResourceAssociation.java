 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-2015-04-08/BundleResourceAssociation"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BundleResourceAssociation implements Serializable, Cloneable, StructuredPojo {
    ...
    public BundleResourceAssociation withAssociatedResourceType(String associatedResourceType) {
    ...
    public BundleResourceAssociation withAssociatedResourceType(BundleAssociatedResourceType associatedResourceType) {
    ...
    public BundleResourceAssociation withCreated(java.util.Date created) {
        setCreated(created);
        return this;
    }
    ...
    public BundleResourceAssociation withLastUpdatedTime(java.util.Date lastUpdatedTime) {
     ...
     * </p>
     * 
     * @return The status of the bundle resource association.
     * @see AssociationState
     */
    ...
    public BundleResourceAssociation withState(String state) {
        setState(state);
        return this;
    }
    ...
    public BundleResourceAssociation withState(AssociationState state) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BundleResourceAssociation == false)
            return false;
    ...
    @Override
    public BundleResourceAssociation clone() {
        try {
            return (BundleResourceAssociation) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.workspaces.model.transform.BundleResourceAssociationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
