...
/**
 * DataQualityTargetTableMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DataQualityTargetTableMarshaller {
    ...
    public static DataQualityTargetTableMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DataQualityTargetTable dataQualityTargetTable, ProtocolMarshaller protocolMarshaller) {

        if (dataQualityTargetTable == null) {
