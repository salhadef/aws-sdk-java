...
/**
 * DataQualityRuleResultMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DataQualityRuleResultMarshaller {

    private static final MarshallingInfo<String> NAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Name").build();
    private static final MarshallingInfo<String> DESCRIPTION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("Description").build();
    private static final MarshallingInfo<String> EVALUATIONMESSAGE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public static DataQualityRuleResultMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DataQualityRuleResult dataQualityRuleResult, ProtocolMarshaller protocolMarshaller) {

        if (dataQualityRuleResult == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(dataQualityRuleResult.getName(), NAME_BINDING);
