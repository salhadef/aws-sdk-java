...
/**
 * HudiTarget JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HudiTargetJsonUnmarshaller implements Unmarshaller<HudiTarget, JsonUnmarshallerContext> {

    public HudiTarget unmarshall(JsonUnmarshallerContext context) throws Exception {
        HudiTarget hudiTarget = new HudiTarget();
    ...
    private static HudiTargetJsonUnmarshaller instance;

    public static HudiTargetJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new HudiTargetJsonUnmarshaller();
        return instance;
    }
}
