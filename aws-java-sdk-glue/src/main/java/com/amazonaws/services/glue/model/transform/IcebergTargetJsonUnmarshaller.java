...
/**
 * IcebergTarget JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IcebergTargetJsonUnmarshaller implements Unmarshaller<IcebergTarget, JsonUnmarshallerContext> {

    public IcebergTarget unmarshall(JsonUnmarshallerContext context) throws Exception {
        IcebergTarget icebergTarget = new IcebergTarget();
    ...
    private static IcebergTargetJsonUnmarshaller instance;

    public static IcebergTargetJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IcebergTargetJsonUnmarshaller();
        return instance;
    }
}
