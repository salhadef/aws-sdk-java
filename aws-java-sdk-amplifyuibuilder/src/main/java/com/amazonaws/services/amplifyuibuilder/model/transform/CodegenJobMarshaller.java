...
/**
 * CodegenJobMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CodegenJobMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> ASSET_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("asset").build();
    ...
    public static CodegenJobMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CodegenJob codegenJob, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(codegenJob.getId(), ID_BINDING);
            protocolMarshaller.marshall(codegenJob.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(codegenJob.getEnvironmentName(), ENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(codegenJob.getRenderConfig(), RENDERCONFIG_BINDING);
            protocolMarshaller.marshall(codegenJob.getGenericDataSchema(), GENERICDATASCHEMA_BINDING);
            protocolMarshaller.marshall(codegenJob.getAutoGenerateForms(), AUTOGENERATEFORMS_BINDING);
            protocolMarshaller.marshall(codegenJob.getFeatures(), FEATURES_BINDING);
            protocolMarshaller.marshall(codegenJob.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(codegenJob.getStatusMessage(), STATUSMESSAGE_BINDING);
            protocolMarshaller.marshall(codegenJob.getAsset(), ASSET_BINDING);
