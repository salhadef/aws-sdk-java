...
/**
 * ReactStartCodegenJobData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReactStartCodegenJobDataJsonUnmarshaller implements Unmarshaller<ReactStartCodegenJobData, JsonUnmarshallerContext> {

    public ReactStartCodegenJobData unmarshall(JsonUnmarshallerContext context) throws Exception {
        ReactStartCodegenJobData reactStartCodegenJobData = new ReactStartCodegenJobData();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("dependencies", targetDepth)) {
                    context.nextToken();
                    reactStartCodegenJobData.setDependencies(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
    ...
    private static ReactStartCodegenJobDataJsonUnmarshaller instance;

    public static ReactStartCodegenJobDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReactStartCodegenJobDataJsonUnmarshaller();
        return instance;
    }
}
