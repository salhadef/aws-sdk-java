...
public class StartCodegenJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The code generation job for a UI component that is associated with an Amplify app.
     */

    public CodegenJob getEntity() {
        return this.entity;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartCodegenJobResult == false)
            return false;
        StartCodegenJobResult other = (StartCodegenJobResult) obj;
    ...
    public StartCodegenJobResult clone() {
        try {
            return (StartCodegenJobResult) super.clone();
