...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-identity-2021-04-20/DescribeAppInstanceUserEndpoint"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeAppInstanceUserEndpointRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeAppInstanceUserEndpointRequest withAppInstanceUserArn(String appInstanceUserArn) {
    ...
    public DescribeAppInstanceUserEndpointRequest withEndpointId(String endpointId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAppInstanceUserEndpointRequest == false)
            return false;
        DescribeAppInstanceUserEndpointRequest other = (DescribeAppInstanceUserEndpointRequest) obj;
    ...
    @Override
    public DescribeAppInstanceUserEndpointRequest clone() {
        return (DescribeAppInstanceUserEndpointRequest) super.clone();
    }
