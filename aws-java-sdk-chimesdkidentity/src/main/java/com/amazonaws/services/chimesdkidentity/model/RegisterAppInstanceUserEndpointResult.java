...
public class RegisterAppInstanceUserEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    @Override
    public RegisterAppInstanceUserEndpointResult clone() {
        try {
            return (RegisterAppInstanceUserEndpointResult) super.clone();
