...
@SdkInternalApi
public class UpdateAppInstanceBotRequestMarshaller {

    private static final MarshallingInfo<String> APPINSTANCEBOTARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("appInstanceBotArn").build();
    ...
    public static UpdateAppInstanceBotRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateAppInstanceBotRequest updateAppInstanceBotRequest, ProtocolMarshaller protocolMarshaller) {
