...
public class UpdateAppInstanceUserEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAppInstanceUserEndpointResult == false)
            return false;
        UpdateAppInstanceUserEndpointResult other = (UpdateAppInstanceUserEndpointResult) obj;
    ...
    public UpdateAppInstanceUserEndpointResult clone() {
        try {
            return (UpdateAppInstanceUserEndpointResult) super.clone();
