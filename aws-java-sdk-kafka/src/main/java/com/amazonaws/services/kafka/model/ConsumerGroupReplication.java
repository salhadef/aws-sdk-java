 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/ConsumerGroupReplication" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ConsumerGroupReplication implements Serializable, Cloneable, StructuredPojo {
    ...
    public ConsumerGroupReplication withConsumerGroupsToExclude(java.util.Collection<String> consumerGroupsToExclude) {
    ...
    public ConsumerGroupReplication withConsumerGroupsToReplicate(String... consumerGroupsToReplicate) {
    ...
    public ConsumerGroupReplication withConsumerGroupsToReplicate(java.util.Collection<String> consumerGroupsToReplicate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConsumerGroupReplication == false)
            return false;
    ...
    @Override
    public ConsumerGroupReplication clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafka.model.transform.ConsumerGroupReplicationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
