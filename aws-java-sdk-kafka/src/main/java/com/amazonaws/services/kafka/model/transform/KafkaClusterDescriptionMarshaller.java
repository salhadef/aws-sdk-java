...
/**
 * KafkaClusterDescriptionMarshaller
 */
...
public class KafkaClusterDescriptionMarshaller {
    ...
    public void marshall(KafkaClusterDescription kafkaClusterDescription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(kafkaClusterDescription.getAmazonMskCluster(), AMAZONMSKCLUSTER_BINDING);
            protocolMarshaller.marshall(kafkaClusterDescription.getKafkaClusterAlias(), KAFKACLUSTERALIAS_BINDING);
            protocolMarshaller.marshall(kafkaClusterDescription.getVpcConfig(), VPCCONFIG_BINDING);
        } catch (Exception e) {
