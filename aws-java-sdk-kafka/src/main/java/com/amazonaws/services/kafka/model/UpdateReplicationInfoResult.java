...
public class UpdateReplicationInfoResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateReplicationInfoResult == false)
            return false;
        UpdateReplicationInfoResult other = (UpdateReplicationInfoResult) obj;
    ...
    public UpdateReplicationInfoResult clone() {
        try {
            return (UpdateReplicationInfoResult) super.clone();
