...
/**
 * TopicReplicationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TopicReplicationMarshaller {
    ...
    private static final TopicReplicationMarshaller instance = new TopicReplicationMarshaller();

    public static TopicReplicationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TopicReplication topicReplication, ProtocolMarshaller protocolMarshaller) {

        if (topicReplication == null) {
