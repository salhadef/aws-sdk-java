...
/**
 * As2ConnectorConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class As2ConnectorConfigJsonUnmarshaller implements Unmarshaller<As2ConnectorConfig, JsonUnmarshallerContext> {

    public As2ConnectorConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        As2ConnectorConfig as2ConnectorConfig = new As2ConnectorConfig();
    ...
    private static As2ConnectorConfigJsonUnmarshaller instance;

    public static As2ConnectorConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new As2ConnectorConfigJsonUnmarshaller();
        return instance;
    }
}
