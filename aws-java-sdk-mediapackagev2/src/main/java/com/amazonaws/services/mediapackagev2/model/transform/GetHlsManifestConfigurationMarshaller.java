...
/**
 * GetHlsManifestConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetHlsManifestConfigurationMarshaller {
    ...
    public static GetHlsManifestConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetHlsManifestConfiguration getHlsManifestConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (getHlsManifestConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(getHlsManifestConfiguration.getManifestName(), MANIFESTNAME_BINDING);
            protocolMarshaller.marshall(getHlsManifestConfiguration.getUrl(), URL_BINDING);
            protocolMarshaller.marshall(getHlsManifestConfiguration.getChildManifestName(), CHILDMANIFESTNAME_BINDING);
