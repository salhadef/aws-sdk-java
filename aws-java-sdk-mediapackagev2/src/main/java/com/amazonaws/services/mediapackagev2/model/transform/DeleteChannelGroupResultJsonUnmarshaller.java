...
/**
 * DeleteChannelGroupResult JSON Unmarshaller
 */
...
public class DeleteChannelGroupResultJsonUnmarshaller implements Unmarshaller<DeleteChannelGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteChannelGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteChannelGroupResult deleteChannelGroupResult = new DeleteChannelGroupResult();

        return deleteChannelGroupResult;
    }
