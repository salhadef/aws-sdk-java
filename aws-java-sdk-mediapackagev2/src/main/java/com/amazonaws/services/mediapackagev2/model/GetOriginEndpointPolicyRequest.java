...
public class GetOriginEndpointPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetOriginEndpointPolicyRequest withChannelGroupName(String channelGroupName) {
    ...
    public GetOriginEndpointPolicyRequest withChannelName(String channelName) {
    ...
    public GetOriginEndpointPolicyRequest withOriginEndpointName(String originEndpointName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOriginEndpointPolicyRequest == false)
            return false;
        GetOriginEndpointPolicyRequest other = (GetOriginEndpointPolicyRequest) obj;
    ...
    @Override
    public GetOriginEndpointPolicyRequest clone() {
        return (GetOriginEndpointPolicyRequest) super.clone();
    }
