...
/**
 * GetChannelResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetChannelResultJsonUnmarshaller implements Unmarshaller<GetChannelResult, JsonUnmarshallerContext> {

    public GetChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static GetChannelResultJsonUnmarshaller instance;

    public static GetChannelResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetChannelResultJsonUnmarshaller();
        return instance;
    }
}
