...
/**
 * PutChannelPolicyRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutChannelPolicyRequestMarshaller {
    ...
    private static final PutChannelPolicyRequestMarshaller instance = new PutChannelPolicyRequestMarshaller();

    public static PutChannelPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutChannelPolicyRequest putChannelPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putChannelPolicyRequest.getChannelGroupName(), CHANNELGROUPNAME_BINDING);
            protocolMarshaller.marshall(putChannelPolicyRequest.getChannelName(), CHANNELNAME_BINDING);
            protocolMarshaller.marshall(putChannelPolicyRequest.getPolicy(), POLICY_BINDING);
        } catch (Exception e) {
