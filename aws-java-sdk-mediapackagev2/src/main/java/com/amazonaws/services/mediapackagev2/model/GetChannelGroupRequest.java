...
public class GetChannelGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetChannelGroupRequest withChannelGroupName(String channelGroupName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetChannelGroupRequest == false)
            return false;
        GetChannelGroupRequest other = (GetChannelGroupRequest) obj;
    ...
    @Override
    public GetChannelGroupRequest clone() {
        return (GetChannelGroupRequest) super.clone();
    }
