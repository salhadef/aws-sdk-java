...
public class SpekeKeyProviderMarshaller {
    ...
    private static final MarshallingInfo<List> DRMSYSTEMS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("DrmSystems").build();
    ...
    public void marshall(SpekeKeyProvider spekeKeyProvider, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(spekeKeyProvider.getDrmSystems(), DRMSYSTEMS_BINDING);
