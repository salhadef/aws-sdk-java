...
public class ListOriginEndpointsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<OriginEndpointListConfiguration> items;
    /**
     * <p>
    ...
    public java.util.List<OriginEndpointListConfiguration> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<OriginEndpointListConfiguration> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<OriginEndpointListConfiguration>(items);
    }
    ...
    public ListOriginEndpointsResult withItems(OriginEndpointListConfiguration... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<OriginEndpointListConfiguration>(items.length));
        }
        for (OriginEndpointListConfiguration ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListOriginEndpointsResult withItems(java.util.Collection<OriginEndpointListConfiguration> items) {
        setItems(items);
        return this;
    }
