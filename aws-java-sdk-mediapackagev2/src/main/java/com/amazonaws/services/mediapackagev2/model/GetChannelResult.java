...
public class GetChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetChannelResult withIngestEndpoints(java.util.Collection<IngestEndpoint> ingestEndpoints) {
    ...
    public GetChannelResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
