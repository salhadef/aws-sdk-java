...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediapackagev2-2022-12-25/GetChannelGroup" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetChannelGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The output domain where the source stream should be sent. Integrate the domain with a downstream CDN (such as
     ...
     * </p>
     * 
     * @return The output domain where the source stream should be sent. Integrate the domain with a downstream CDN
    ...
    public GetChannelGroupResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetChannelGroupResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public GetChannelGroupResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetChannelGroupResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetChannelGroupResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetChannelGroupResult == false)
            return false;
        GetChannelGroupResult other = (GetChannelGroupResult) obj;
    ...
    public GetChannelGroupResult clone() {
        try {
            return (GetChannelGroupResult) super.clone();
