...
/**
 * DeleteOriginEndpointPolicyResult JSON Unmarshaller
 */
...
public class DeleteOriginEndpointPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteOriginEndpointPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteOriginEndpointPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteOriginEndpointPolicyResult deleteOriginEndpointPolicyResult = new DeleteOriginEndpointPolicyResult();

        return deleteOriginEndpointPolicyResult;
    }
