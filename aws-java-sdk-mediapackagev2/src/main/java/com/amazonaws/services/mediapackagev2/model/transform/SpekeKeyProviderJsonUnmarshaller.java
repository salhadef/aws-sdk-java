...
/**
 * SpekeKeyProvider JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SpekeKeyProviderJsonUnmarshaller implements Unmarshaller<SpekeKeyProvider, JsonUnmarshallerContext> {

    public SpekeKeyProvider unmarshall(JsonUnmarshallerContext context) throws Exception {
        SpekeKeyProvider spekeKeyProvider = new SpekeKeyProvider();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("DrmSystems", targetDepth)) {
                    context.nextToken();
                    spekeKeyProvider.setDrmSystems(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
                ...
                if (context.testExpression("Url", targetDepth)) {
                    context.nextToken();
                    spekeKeyProvider.setUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static SpekeKeyProviderJsonUnmarshaller instance;

    public static SpekeKeyProviderJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SpekeKeyProviderJsonUnmarshaller();
        return instance;
    }
}
