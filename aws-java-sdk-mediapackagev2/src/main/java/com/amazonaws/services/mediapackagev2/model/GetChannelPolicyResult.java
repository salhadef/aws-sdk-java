...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediapackagev2-2022-12-25/GetChannelPolicy" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetChannelPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetChannelPolicyResult withChannelGroupName(String channelGroupName) {
    ...
    public GetChannelPolicyResult withChannelName(String channelName) {
     ...
     * </p>
     * 
     * @return The policy assigned to the channel.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetChannelPolicyResult == false)
            return false;
        GetChannelPolicyResult other = (GetChannelPolicyResult) obj;
    ...
    public GetChannelPolicyResult clone() {
        try {
            return (GetChannelPolicyResult) super.clone();
