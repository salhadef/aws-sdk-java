...
/**
 * DeleteChannelRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteChannelRequestMarshaller {
    ...
    private static final DeleteChannelRequestMarshaller instance = new DeleteChannelRequestMarshaller();

    public static DeleteChannelRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DeleteChannelRequest deleteChannelRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteChannelRequest.getChannelGroupName(), CHANNELGROUPNAME_BINDING);
