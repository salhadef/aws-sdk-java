...
public class ListOriginEndpointsRequestMarshaller {
    ...
    public void marshall(ListOriginEndpointsRequest listOriginEndpointsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listOriginEndpointsRequest.getChannelGroupName(), CHANNELGROUPNAME_BINDING);
            protocolMarshaller.marshall(listOriginEndpointsRequest.getChannelName(), CHANNELNAME_BINDING);
