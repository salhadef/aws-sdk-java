...
/**
 * DeleteOriginEndpointResult JSON Unmarshaller
 */
...
public class DeleteOriginEndpointResultJsonUnmarshaller implements Unmarshaller<DeleteOriginEndpointResult, JsonUnmarshallerContext> {
    ...
    public DeleteOriginEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteOriginEndpointResult deleteOriginEndpointResult = new DeleteOriginEndpointResult();
