...
public class GetOriginEndpointRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetOriginEndpointRequest withChannelGroupName(String channelGroupName) {
    ...
    public GetOriginEndpointRequest withChannelName(String channelName) {
    ...
    public GetOriginEndpointRequest withOriginEndpointName(String originEndpointName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOriginEndpointRequest == false)
            return false;
        GetOriginEndpointRequest other = (GetOriginEndpointRequest) obj;
    ...
    @Override
    public GetOriginEndpointRequest clone() {
        return (GetOriginEndpointRequest) super.clone();
    }
