...
@SdkInternalApi
public class UpdateChannelGroupRequestMarshaller {
    ...
    private static final UpdateChannelGroupRequestMarshaller instance = new UpdateChannelGroupRequestMarshaller();

    public static UpdateChannelGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateChannelGroupRequest updateChannelGroupRequest, ProtocolMarshaller protocolMarshaller) {
