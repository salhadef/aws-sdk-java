...
public class GetChannelRequestMarshaller {
    ...
    private static final GetChannelRequestMarshaller instance = new GetChannelRequestMarshaller();

    public static GetChannelRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetChannelRequest getChannelRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getChannelRequest.getChannelGroupName(), CHANNELGROUPNAME_BINDING);
            protocolMarshaller.marshall(getChannelRequest.getChannelName(), CHANNELNAME_BINDING);
        } catch (Exception e) {
