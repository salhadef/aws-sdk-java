...
/**
 * OriginEndpointListConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OriginEndpointListConfigurationJsonUnmarshaller implements Unmarshaller<OriginEndpointListConfiguration, JsonUnmarshallerContext> {

    public OriginEndpointListConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        OriginEndpointListConfiguration originEndpointListConfiguration = new OriginEndpointListConfiguration();
    ...
    private static OriginEndpointListConfigurationJsonUnmarshaller instance;

    public static OriginEndpointListConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OriginEndpointListConfigurationJsonUnmarshaller();
        return instance;
    }
}
