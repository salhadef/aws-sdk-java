...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediapackagev2-2022-12-25/DeleteChannelPolicy" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteChannelPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteChannelPolicyRequest withChannelGroupName(String channelGroupName) {
    ...
    public DeleteChannelPolicyRequest withChannelName(String channelName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteChannelPolicyRequest == false)
            return false;
        DeleteChannelPolicyRequest other = (DeleteChannelPolicyRequest) obj;
    ...
    @Override
    public DeleteChannelPolicyRequest clone() {
        return (DeleteChannelPolicyRequest) super.clone();
    }
