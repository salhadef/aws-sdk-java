...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediapackagev2-2022-12-25/UpdateChannel" target="_top">AWS API
 *      Documentation</a>
 */
...
public class UpdateChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateChannelResult withCreatedAt(java.util.Date createdAt) {
    ...
    public UpdateChannelResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public UpdateChannelResult withIngestEndpoints(java.util.Collection<IngestEndpoint> ingestEndpoints) {
