...
public class UpdateOriginEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateOriginEndpointResult withCreatedAt(java.util.Date createdAt) {
    ...
    public UpdateOriginEndpointResult withModifiedAt(java.util.Date modifiedAt) {
     ...
     * </p>
     * 
     * @return The description of the origin endpoint.
     */
    ...
    public UpdateOriginEndpointResult withHlsManifests(GetHlsManifestConfiguration... hlsManifests) {
    ...
    public UpdateOriginEndpointResult withHlsManifests(java.util.Collection<GetHlsManifestConfiguration> hlsManifests) {
    ...
    public UpdateOriginEndpointResult withLowLatencyHlsManifests(GetLowLatencyHlsManifestConfiguration... lowLatencyHlsManifests) {
    ...
    public UpdateOriginEndpointResult withLowLatencyHlsManifests(java.util.Collection<GetLowLatencyHlsManifestConfiguration> lowLatencyHlsManifests) {
