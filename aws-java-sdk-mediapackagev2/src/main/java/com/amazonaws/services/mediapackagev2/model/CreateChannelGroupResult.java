...
public class CreateChannelGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The output domain where the source stream should be sent. Integrate the egress domain with a downstream CDN (such
    ...
    public CreateChannelGroupResult withChannelGroupName(String channelGroupName) {
    ...
    public CreateChannelGroupResult withArn(String arn) {
        setArn(arn);
        return this;
    }
     ...
     * 
     * @param egressDomain
     *        The output domain where the source stream should be sent. Integrate the egress domain with a downstream
     ...
     * </p>
     * 
     * @return The output domain where the source stream should be sent. Integrate the egress domain with a downstream
     *         CDN (such as Amazon CloudFront) or playback device.
     */
    ...
    public CreateChannelGroupResult withEgressDomain(String egressDomain) {
    ...
    public CreateChannelGroupResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateChannelGroupResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public CreateChannelGroupResult withDescription(String description) {
    ...
    public CreateChannelGroupResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateChannelGroupResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateChannelGroupResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateChannelGroupResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateChannelGroupResult == false)
            return false;
        CreateChannelGroupResult other = (CreateChannelGroupResult) obj;
    ...
    @Override
    public CreateChannelGroupResult clone() {
        try {
            return (CreateChannelGroupResult) super.clone();
