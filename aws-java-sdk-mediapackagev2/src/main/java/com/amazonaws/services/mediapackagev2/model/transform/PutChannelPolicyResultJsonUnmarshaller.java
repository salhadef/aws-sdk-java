...
/**
 * PutChannelPolicyResult JSON Unmarshaller
 */
...
public class PutChannelPolicyResultJsonUnmarshaller implements Unmarshaller<PutChannelPolicyResult, JsonUnmarshallerContext> {
    ...
    public PutChannelPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutChannelPolicyResult putChannelPolicyResult = new PutChannelPolicyResult();
