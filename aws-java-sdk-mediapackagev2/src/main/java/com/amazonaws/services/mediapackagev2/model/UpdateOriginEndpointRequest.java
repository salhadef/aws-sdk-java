...
public class UpdateOriginEndpointRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateOriginEndpointRequest withHlsManifests(CreateHlsManifestConfiguration... hlsManifests) {
    ...
    public UpdateOriginEndpointRequest withHlsManifests(java.util.Collection<CreateHlsManifestConfiguration> hlsManifests) {
    ...
    public UpdateOriginEndpointRequest withLowLatencyHlsManifests(CreateLowLatencyHlsManifestConfiguration... lowLatencyHlsManifests) {
    ...
    public UpdateOriginEndpointRequest withLowLatencyHlsManifests(java.util.Collection<CreateLowLatencyHlsManifestConfiguration> lowLatencyHlsManifests) {
