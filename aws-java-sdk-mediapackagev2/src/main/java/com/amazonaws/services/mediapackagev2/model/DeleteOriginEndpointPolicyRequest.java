...
public class DeleteOriginEndpointPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteOriginEndpointPolicyRequest withChannelGroupName(String channelGroupName) {
    ...
    public DeleteOriginEndpointPolicyRequest withChannelName(String channelName) {
    ...
    public DeleteOriginEndpointPolicyRequest withOriginEndpointName(String originEndpointName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteOriginEndpointPolicyRequest == false)
            return false;
        DeleteOriginEndpointPolicyRequest other = (DeleteOriginEndpointPolicyRequest) obj;
    ...
    @Override
    public DeleteOriginEndpointPolicyRequest clone() {
        return (DeleteOriginEndpointPolicyRequest) super.clone();
    }
