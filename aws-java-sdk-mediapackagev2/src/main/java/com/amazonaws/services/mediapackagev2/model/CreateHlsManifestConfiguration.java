 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediapackagev2-2022-12-25/CreateHlsManifestConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateHlsManifestConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public CreateHlsManifestConfiguration withManifestName(String manifestName) {
    ...
    public CreateHlsManifestConfiguration withChildManifestName(String childManifestName) {
    ...
    public CreateHlsManifestConfiguration withScteHls(ScteHls scteHls) {
        setScteHls(scteHls);
        return this;
    }
    ...
    public CreateHlsManifestConfiguration withManifestWindowSeconds(Integer manifestWindowSeconds) {
    ...
    public CreateHlsManifestConfiguration withProgramDateTimeIntervalSeconds(Integer programDateTimeIntervalSeconds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateHlsManifestConfiguration == false)
            return false;
    ...
    @Override
    public CreateHlsManifestConfiguration clone() {
        try {
            return (CreateHlsManifestConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediapackagev2.model.transform.CreateHlsManifestConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
