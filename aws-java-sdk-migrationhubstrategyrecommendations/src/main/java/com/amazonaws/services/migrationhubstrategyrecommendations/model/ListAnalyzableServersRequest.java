...
public class ListAnalyzableServersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * to this action returned 100 items, but you set maxResults to 10. You'll receive a set of 10 results along with a
     ...
     * </p>
     * 
     * @return Specifies whether to sort by ascending (ASC) or descending (DESC) order.
     * @see SortOrder
     */
    ...
    public ListAnalyzableServersRequest withSort(String sort) {
        setSort(sort);
        return this;
    }
    ...
    public ListAnalyzableServersRequest withSort(SortOrder sort) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAnalyzableServersRequest == false)
            return false;
        ListAnalyzableServersRequest other = (ListAnalyzableServersRequest) obj;
    ...
    @Override
    public ListAnalyzableServersRequest clone() {
        return (ListAnalyzableServersRequest) super.clone();
    }
