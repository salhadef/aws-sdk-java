...
public class StartInferenceSchedulerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartInferenceSchedulerResult withModelArn(String modelArn) {
    ...
    public StartInferenceSchedulerResult withModelName(String modelName) {
    ...
    public StartInferenceSchedulerResult withInferenceSchedulerName(String inferenceSchedulerName) {
    ...
    public StartInferenceSchedulerResult withInferenceSchedulerArn(String inferenceSchedulerArn) {
    ...
    public StartInferenceSchedulerResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public StartInferenceSchedulerResult withStatus(InferenceSchedulerStatus status) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartInferenceSchedulerResult == false)
            return false;
        StartInferenceSchedulerResult other = (StartInferenceSchedulerResult) obj;
    ...
    @Override
    public StartInferenceSchedulerResult clone() {
        try {
            return (StartInferenceSchedulerResult) super.clone();
