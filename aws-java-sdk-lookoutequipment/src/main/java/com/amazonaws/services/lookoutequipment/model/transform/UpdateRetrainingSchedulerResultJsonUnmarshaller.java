...
/**
 * UpdateRetrainingSchedulerResult JSON Unmarshaller
 */
...
public class UpdateRetrainingSchedulerResultJsonUnmarshaller implements Unmarshaller<UpdateRetrainingSchedulerResult, JsonUnmarshallerContext> {
    ...
    public UpdateRetrainingSchedulerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateRetrainingSchedulerResult updateRetrainingSchedulerResult = new UpdateRetrainingSchedulerResult();

        return updateRetrainingSchedulerResult;
    }
