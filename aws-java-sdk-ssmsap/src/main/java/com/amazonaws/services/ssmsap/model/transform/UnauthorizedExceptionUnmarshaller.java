...
public class UnauthorizedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnauthorizedExceptionUnmarshaller() {
        super(com.amazonaws.services.ssmsap.model.UnauthorizedException.class, "UnauthorizedException");
    }

    @Override
    public com.amazonaws.services.ssmsap.model.UnauthorizedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ssmsap.model.UnauthorizedException unauthorizedException = new com.amazonaws.services.ssmsap.model.UnauthorizedException(null);
