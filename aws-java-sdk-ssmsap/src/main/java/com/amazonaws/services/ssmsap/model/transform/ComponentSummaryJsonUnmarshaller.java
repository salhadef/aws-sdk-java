        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ApplicationId", targetDepth)) {
                    context.nextToken();
                    componentSummary.setApplicationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ComponentId", targetDepth)) {
                    context.nextToken();
                    componentSummary.setComponentId(context.getUnmarshaller(String.class).unmarshall(context));
                }
