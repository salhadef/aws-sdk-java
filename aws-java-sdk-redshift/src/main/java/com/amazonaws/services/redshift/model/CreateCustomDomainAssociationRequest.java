...
public class CreateCustomDomainAssociationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The custom domain name for a custom domain association.
     */
     ...
     * </p>
     * 
     * @return The certificate Amazon Resource Name (ARN) for the custom domain name association.
     */
     ...
     * </p>
     * 
     * @return The cluster identifier that the custom domain is associated with.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCustomDomainAssociationRequest == false)
            return false;
        CreateCustomDomainAssociationRequest other = (CreateCustomDomainAssociationRequest) obj;
    ...
    public CreateCustomDomainAssociationRequest clone() {
        return (CreateCustomDomainAssociationRequest) super.clone();
    }
