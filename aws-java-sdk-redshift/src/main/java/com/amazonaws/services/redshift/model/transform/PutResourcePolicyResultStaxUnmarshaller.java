...
/**
 * PutResourcePolicyResult StAX Unmarshaller
 */
...
public class PutResourcePolicyResultStaxUnmarshaller implements Unmarshaller<PutResourcePolicyResult, StaxUnmarshallerContext> {
    ...
    public PutResourcePolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ResourcePolicy", targetDepth)) {
                    putResourcePolicyResult.setResourcePolicy(ResourcePolicyStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
