...
/**
 * AssertionRule JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssertionRuleJsonUnmarshaller implements Unmarshaller<AssertionRule, JsonUnmarshallerContext> {

    public AssertionRule unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Owner", targetDepth)) {
                    context.nextToken();
                    assertionRule.setOwner(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static AssertionRuleJsonUnmarshaller instance;

    public static AssertionRuleJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssertionRuleJsonUnmarshaller();
        return instance;
    }
}
