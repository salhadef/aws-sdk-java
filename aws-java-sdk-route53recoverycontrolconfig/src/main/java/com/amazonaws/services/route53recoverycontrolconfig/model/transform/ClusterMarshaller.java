...
public class ClusterMarshaller {
    ...
    private static final MarshallingInfo<List> CLUSTERENDPOINTS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ClusterEndpoints").build();
    ...
    public void marshall(Cluster cluster, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(cluster.getClusterEndpoints(), CLUSTERENDPOINTS_BINDING);
            protocolMarshaller.marshall(cluster.getName(), NAME_BINDING);
            protocolMarshaller.marshall(cluster.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(cluster.getOwner(), OWNER_BINDING);
        } catch (Exception e) {
