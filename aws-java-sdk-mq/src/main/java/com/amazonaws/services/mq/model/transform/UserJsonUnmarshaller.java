        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("consoleAccess", targetDepth)) {
                    context.nextToken();
                    user.setConsoleAccess(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                ...
                if (context.testExpression("password", targetDepth)) {
                    context.nextToken();
                    user.setPassword(context.getUnmarshaller(String.class).unmarshall(context));
                }
