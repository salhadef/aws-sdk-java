...
public class DeleteScheduledActionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteScheduledActionRequest withServiceNamespace(String serviceNamespace) {
    ...
    public DeleteScheduledActionRequest withScalableDimension(String scalableDimension) {
